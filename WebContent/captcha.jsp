...
<%
 ...
 try {
   ...
   //#FFEE9D
   Color backgroundColor = Color.decode("#25587E");
   Color borderColor = Color.decode("#ADDFFF");  
   Color textColor = Color.YELLOW;
   Color circleColor = new Color(160,160,160);
   //Century Schoolbook L
   Font textFont = new Font("Times New Romon", Font.ROMAN_BASELINE, paramInt(request, "fontSize", 30));
   int charsToPrint = 6;
   ...
   float imageQuality = 0.99f; // max is 1.0 (this is for jpeg)
   double rotationRange = 0; // this is radians
...
//System.out.println("x=" + x + " height=" + height + " charDim=" + charDim + " y=" + y + " advance=" + maxAdvance + " fontHeight=" + fontHeight + " ascent=" + fontMetrics.getAscent());
   ...
   if( iter.hasNext() ) {
	...
	//	 System.out.println("entered in jpg :"+imageFormat);
       iwp.setCompressionMode(ImageWriteParam.MODE_EXPLICIT);
       iwp.setCompressionQuality(imageQuality);
     }
     writer.setOutput(ImageIO.createImageOutputStream(response.getOutputStream()));
     IIOImage imageIO = new IIOImage(bufferedImage, null, null);
//	  System.out.println("entered in image :");
     writer.write(null, imageIO, iwp);
	//  System.out.println("entered in image12 :");
   } else {
     throw new RuntimeException("no encoder found for jsp");
   }

   // let's stick the final string in the session
   // System.out.println("entered in image12 finalString:"+ finalString);
   session.setAttribute("key", finalString.toString());
