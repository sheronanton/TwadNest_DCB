	  ...
	  <form name="frmindex" id="frmindex" >
            <tr>
                <td bgcolor="#FFEE9D" width="40%" height="30%" align="right" valign="middle">
		  		...
		  		<input type="text" name="txtID" class="tb2" title="Enter UserName" maxlength="12" size="12" onblur="killChars(this);stripQuotes(this);"  >
           ...
           <tr>
                ...
                <td bgcolor="#FFEE9D" width="60%" height="30%" align="center" valign="middle">        
                <input type="password" name="txtPassword" class="textbox" maxlength="12" size="12" onKeyPress="return buttonsubmit(event)"  title="Enter Password" onblur="killChars(this);stripQuotes(this);" >
