...
function cleanTbodyFai()
{
    ...
    document.getElementById("SearchScreenKeyword").value="";
    
    var cellcmbpagination=document.getElementById("cmbpagination");
    cellcmbpagination.value=5;      
}

function penAppForm1Search(command)
{
	
	var opt1=document.getElementById('SearchScreenOptions');
	var srctxt1=document.getElementById("SearchScreenKeyword");
	...
	else{penAppForm1Search1(command);}
	}

	else if(opt1.selectedIndex==3)
	{
	...
	{
		penAppForm1Search1(command);
	}	
}



function penAppForm1Search1(command)
{
	var SearchScreenOptions=document.forms[0].SearchScreenOptions.value;
	var SearchScreenKeyword=document.forms[0].SearchScreenKeyword.value;
    if(command=="Search")
	  {
    	
    	
      var url="PensionApplicationForm1Search.html?penAppform1Srch.SearchScreenKeyword="+SearchScreenKeyword+"&penAppform1Srch.SearchScreenOptions="+SearchScreenOptions;
