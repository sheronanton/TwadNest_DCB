...
function callServerSearch(command)
{
	var opt1=document.getElementById("options");
	var srctxt1=document.getElementById("searchText");
	...
	if(opt1.selectedIndex==0  )
	{
		...
		{
		callServerSearch1(command);
		
		}
}
	
	function callServerSearch1(command)
	{
	    ...
	    if(command=="Search")
		  {
		   ...
		   var url="../searchMenu1.html?objsearchpojo.searchText="+searchText+"&objsearchpojo.options="+options;
