...
function getTransport()
	...
	function callServer(command)
	{
	    ...
	    if(command=="Search")
		  {
  //alert("IM in validate method.....");
//		   alert("options value"+options);
		   var url="../searchvalidate.html?objsearchpojo.searchText="+searchText+"&objsearchpojo.options="+options;
	...
	{   
	      ...
	      {          
	                           ...
	                           if(record1.length==0)
	                           {
                                   ...
                                   // document.forms[0].options.value=0;
                               }   
