...
<title>Accounts Group Master</title>
...
<body onload="page_size(),master(7,3)">
<form > 
<table class=table width=100% align="center" border="1" style="border-collapse: collapse;border-color: skyblue"   >
		<tr> 
			<th  colspan="2" align="center" class="tdH" >Accounts <label class="headlbl"> Group Master </label> </th>		 
		</tr>
		...
		<tr> 
		 	<td align="left"> <label class="lbl">Accounts Group </label></td>
			<td align="left"><input type="text" name="desc" id="desc" style="width: 33em;"/></td>		
		 </tr>		    
		 <tr class="tdH">		 	 
			<th align="center" colspan="2" > 
					<input type="button" value="Add"   id="add" onclick="master(7,1)"    />
					<input  type=button value="Update" class="btn" onclick="master(7,2)"/>
					<input type=button value="Delete"  class="btn" onclick="master(7,4)"/>
