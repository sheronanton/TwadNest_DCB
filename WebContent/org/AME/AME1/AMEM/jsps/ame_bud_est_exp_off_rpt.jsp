...
<script type="text/javascript">
	function report_open()
	{
		...
		window.open('ame_bud_est_exp_off_rpt_xls.jsp'+params,'Abstract ','width=400,height=200')
	} 
</script> 
...
{  
	...
	<table width="95%" align="center">
		...
		<tr>
			<td colspan="4">&nbsp;</td>
			<td colspan="<%out.print(col_count+5);%>" align="center" style="border-left-color: black;" ><b>Expenditure incurred</b> </td> 
		</tr>	
		<tr> 
			<th>Sl.No</th>
			<th>Division Name</th>
			...
			<tr>
				<td><%=row%></td> 
				<td><a href="ame_bud_est_exp_rpt.jsp?pyear=<%=inp_year%>&circle_id=<%=circle_id%>&region_id=<%=region_id%>&Office_id=<%=Office_id%>"><%=office_name%></a></td>
				...
				while (i < ir.length)
				{
					...
					double amt_res=item_obj.getAmt_net_off(); 
