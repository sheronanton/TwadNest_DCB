...
<%@ page language="java" charset=ISO-8859-1" pageEncoding="ISO-8859-1"%>
...
{  
	...
	String office_cond="";
		...
		br.append(" SUM(a.am_est_amt) AS am_est_amt FROM pms_ame_trn_abstract a WHERE FIN_YEAR='2015-2016' GROUP BY FIN_YEAR, office_id  )  GROUP BY FIN_YEAR,region_office_id  ");
		...
		br.append("  SUM(BUDGET_EST_AMT) AS BUDGET_EST_AMT FROM PMS_AME_TRN_BUDGET a WHERE FIN_YEAR='2015-2016'  GROUP BY FIN_YEAR, OFFICE_ID  ");
	...
	<table width="95%" align="center" border=1>
		...
		<tr>
			<td colspan="4">&nbsp;</td>
			<td colspan="<%out.print(col_count+1);%>" align="center" style="border-left-color: black;" ><b>Expenditure incurred</b> </td> 
		</tr>
		<tr> 
			<th>Sl.No</th>
			<th>Region Name</th>
