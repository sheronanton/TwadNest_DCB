...
function report_open()
{
	...
	window.open('ame_bud_est_exp_reg_up_xls.jsp'+params,'Abstract ','width=400,height=200')
} 
</script> 
</head>
...
{  
	...
	String Office_id = obj.setValue("Office_id",request);//obj.getValue("HRM_EMP_CURRENT_POSTING", "OFFICE_ID","where EMPLOYEE_ID in ( select EMPLOYEE_ID	 from SEC_MST_USERS where USER_ID='"+ userid + "')");
	...
	String region_office_id=Office_id;; 
	...
	<table width="95%" align="center"> 
		...
		<tr>
			<th colspan="<%out.print(col_count+9);%>" align="left">TWAD,HO</th>
		</tr>
		<tr>
			<td colspan="4">&nbsp;</td>
		...
		<tr> 
			...
			<tr> 
				<td><%=row%></td> 
				<td><a href="ame_bud_est_exp_cir_uprpt.jsp?upto_month=<%=upto_month%>&pyear=<%=inp_year%>&Office_id=<%=Office_id%>"><%=office_name%></a></td>				
	...
	<tr><th colspan="2"  align="right">Total</th>
	 ...
	 <tr>
			...
			<input type="hidden" name="Office_id" value="<%=region_office_id%>"/> 
	<%	
		}catch(Exception e)
		{
			out.println(e);      
