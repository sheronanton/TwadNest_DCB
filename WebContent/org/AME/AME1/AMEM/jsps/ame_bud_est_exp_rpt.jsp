...
{  
	...
	prv_msg="TWAD HO-->"+obj.getValue("com_mst_all_offices_view", "OFFICE_NAME","where OFFICE_ID="+region_id+ "  ")+"-->"+obj.getValue("com_mst_all_offices_view", "OFFICE_NAME","where OFFICE_ID="+circle_id+ "  ")+"-->"+Office_Name.trim(); 
