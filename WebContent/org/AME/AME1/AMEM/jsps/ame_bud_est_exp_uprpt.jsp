...
function report_open()
{
	...
	try { circle_id=document.pms_ame_reports.circle_id.value;} catch(e) {};
	...
	params = "?region_id="+region_id+"&circle_id="+circle_id+"&pyear="+pyear +"&Office_id=" +Office_id+"&upto_month="+upto_month; 
	window.open('ame_bud_est_exp_uprptxls.jsp'+params,'Abstract ','width=400,height=200')
} 
</script> 
</head>
...
{  
	...
	br.append(" )budget ");
	br.append(" on budget.OFFICE_ID=sch_.OFFICE_ID and budget.SCH_SNO=sch_.sch_sno  order by sch_sno");
