...
<title>Budget Estimate Report </title> 
...
%>
<table width="100%" class="table" align="center" border=1 cellpadding="10">
	<tr>
		<th colspan="3" align="center" class="tdH">Budget Estimate Report </th>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="2"><select  id="pyear" name="pyear" style="width: 130pt;"  >
		<option value="0">Select</option>
		<% for (int j=year;j<=year+year_incr;j++) 
		{  
			if (j-1==prvfinyear)
			{
		%>    
	...
	<tr><td colspan="3" align="center"> 
			...
			<input type="button" value="Exit"  class="btn" onclick="self.close()"/> 
		</td></tr>
</table>
</body>
</html>
