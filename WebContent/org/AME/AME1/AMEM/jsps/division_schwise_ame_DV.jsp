...
<body>
			...
			String pyear=obj.setValue("fin_year",request);
			String monthvalue=obj.month_val(fmonth);
			
			int year2=0; 
		    if (Integer.parseInt(fmonth)>3)  
				 year2=Integer.parseInt(pyear.split("-")[0]);
			 else
				 year2=Integer.parseInt(pyear.split("-")[1]);  
			...
			<table id="table1"  border="0" align="center"   cellspacing="1" cellpadding="1" width="60%">
				...
				<tr >
					...
					<td colspan="2" align="center"><B><%=pyear%></B>				 
					</td>
					<td colspan="4" align="center">	<b><%=monthvalue%>-<%=year2%></b>			 
					</td>
				</tr>
