...
<tr  class = "tdH"><td width=20%  >Uploaded Data </td><td align="right"><font color='green' size=4><b><%=msg%></b></font></td></tr> 
 ...
 <%   
 	out.println("<table border=1 width='100%'><tr><td>Sl.No</td><td>Scheme No</td><td width='10%'>TWAD Project ID</td><td>Scheme Name</td><td>Design Qty (MLD)</td><td>Pumped Qty (MLD)</td><td>Month </td><td>Year</td></tr>");
 	
 	  String qry=" select OFFICE_ID,TWAD_SCH_SNO,SCH_SNO,DESIGN_QTY,PUMPING_QTY,MONTH,YEAR from PMS_AME_TRN_SCH_DPQTY where office_id="+Office_id;
