...
<%    
	...
	<form id="sch_master" name="sch_master" method="GET"  >
      ...
      <table id="Existing" border="1" width="100%" cellspacing="3" class="table" align="center"  style="border-collapse: collapse;border-color: skyblue" >
       <tr align="center"  > 
		          <td colspan="5">
		          	<!-- 	<A HREF="javascript:load(2);" > <font  class="fnt">Budget Estimate Entry</font></A>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; -->		   
		               	<A HREF="javascript:load(1);" ><font  class="fnt" style="font-weight: bold;color: green;font-size:12">Annual Maintenance Estimate </font></A>                     			            		            		            
		           </td>
		           </tr>
           <tr >  
