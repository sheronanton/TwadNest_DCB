...
<script type="text/javascript">
	...
	{
		 window.open("Ame_scheme_Abstract_o.jsp?flag=C&circle_office_id="+circle_office_id+"&region_office_id="+region_office_id+"&pyear="+pyear);
		...
		<div id='dataid'>
			...
			while(rs.next())
			{
				...
				{				
					...
					String cond=" where GROUP_SNO="+gsno+" AND MAIN_ITEM_SNO="+msno+" and SUB_ITEM_SNO="+ssno+" and   FIN_YEAR='"+pyear+"' and    circle_office_id="+circle_office_id+"   "  ;				
					String amount="0";				 
					amount=obj_data.getGSValue("PMS_AME_ABSTRACT_DATA","AM_EST_AMT",cond,"circle_office_id");
