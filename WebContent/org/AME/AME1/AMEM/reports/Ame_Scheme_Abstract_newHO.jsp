		...
		<div id='dataid'>
			...
			while(rs.next())
			{
				...
				{				
					...
					String cond=" where GROUP_SNO="+gsno+" AND MAIN_ITEM_SNO="+msno+" and SUB_ITEM_SNO="+ssno+" and sch_sno="+sch_sno+" and FIN_YEAR='"+pyear+"' and  office_id="+Office_id+"   "  ;				
					String amount="0";				 
					amount=obj_data.getValue("PMS_AME_TRN_ABSTRACT","AM_EST_AMT",cond);
