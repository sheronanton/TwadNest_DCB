...
<script type="text/javascript">
	...
	{
		 window.open("Ame_Scheme_Abstract_c.jsp?flag=C&region_office_id="+region_office_id+"&pyear="+pyear);
...
<% 
	...
	//	pmonth="5";
		...
		<div id='dataid'>
			...
			<tr>
				<td align="center" colspan="<%=(innerrow+2) %>"> &nbsp;&nbsp;&nbsp;&nbsp; Financial Year &nbsp;:&nbsp; <%=year %></td>
			</tr>
			<% out.println("</tr>"); %>
				<td>Sl.No</td>
			...
			while(rs.next())
			{
				...
				{				
					...
					String cond=" where  GROUP_SNO="+gsno+" and MAIN_ITEM_SNO="+msno+" and SUB_ITEM_SNO="+ssno+"  and  FIN_YEAR='"+pyear+"' AND region_office_id="+reg_id+"   "  ;				
					String amount="0";				 
						amount=obj_data.getGSValue("PMS_AME_ABSTRACT_DATA","AM_EST_AMT",cond,"region_office_id");
