...
<script type="text/javascript">
	...
	{
		 window.open("Ame_scheme_Budget_c.jsp?flag=C&region_office_id="+region_office_id+"&pmonth="+pmonth+"&pyear="+pyear);
...
<% 
		...
		<div id='dataid'>
			...
			<tr>
				...
				<td align="center" >Budget Estimate Amount (Rs. in lakhs)</td>
			</tr>
			<%
			double total_=0.0f,amt=0.0;
			String query=" select distinct sch_sno, sch_name from pms_dcb_reg_cir_div_sch where office_id="+Office_id+" order by sch_sno ";
			...
			{ 
				...
				qry.append(" select budget_est_amt as bdamt from pms_ame_trn_budget where office_id="+Office_id+" and fin_year='"+pyear+"' and sch_sno="+sch_sno);							 							 
