...
<script type="text/javascript">
	...
	{
		 window.open("Ame_scheme_Item_Wise_new.jsp?flag=C&circle_office_id="+circle_office_id+"&office_id="+office_id+"&region_office_id="+region_office_id+"&pmonth="+pmonth+"&pyear="+pyear);
		...
		<div id='dataid'>
			...
			while(rs.next())
			{
				...
				{				
					...
					String cond=" where GROUP_SNO="+gsno+" AND MAIN_ITEM_SNO="+msno+" and SUB_ITEM_SNO="+ssno+" and month="+pmonth+" and  year="+pyear+" and office_id="+office_id+"   "  ;				
					String amount="0";				 
					amount=obj_data.getGSValue("PMS_AME_ITEM_WISE_DATA","bill_amt",cond,"office_id");
