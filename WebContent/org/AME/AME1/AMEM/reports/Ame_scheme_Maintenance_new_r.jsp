...
<title>  Scheme Budget </title>
<link href="../../../../../css/AME.css" rel="stylesheet" media="screen"/>
<script type="text/javascript">

	function reload(region_office_id,pmonth,pyear)
	{
		 window.open("Ame_scheme_Performance_new_c.jsp?flag=C&region_office_id="+region_office_id+"&pmonth="+pmonth+"&pyear="+pyear);
...
<% 
		...
		<div id='dataid'>
			...
			{								
					out.println("<td align='center'>"+data1.getDisplayinfo()+"</td>"); 
			}
			out.println("</tr>");
			...
			while(rs.next())
			{
				...
				out.println("<tr><td align='center'>"+(++row)+"</td><td align='left'><a href='javascript:reload("+reg_id+","+pmonth+","+pyear+")'>"+obj.isNull(rs.getString("region_name"),1)+"</td>");				
				for(Pms_Ame_Masters data1 : list) 
				{				
					...
					String cond=" where MAIN_ITEM_SNO="+msno+" and SUB_ITEM_SNO="+ssno+" and GROUP_SNO="+gsno+" AND region_office_id="+reg_id+" and FIN_YEAR='2012-2013'  "  ;				
					String amount="0";				 
						amount=obj_data.getValue("pms_ame_reg_maint_sum","AM_EST_AMT",cond);
