		...
		<div id='dataid'>
			...
			while(rs.next())
			{
				...
				{				
					...
					String cond=" where  PERFORM_DESC_SNO="+performancesno+" AND region_office_id="+reg_id+" and MONTH ="+pmonth+" AND YEAR="+pyear ;				
					String amount="0";				 
					if ("1".equalsIgnoreCase(data1.getDatatype()) ||  "2".equalsIgnoreCase(data1.getDatatype()))
					{ 
						amount=obj_data.getValue("pms_ame_reg_sch_sum","QTY_OR_AMOUNT",cond);
