...
try
{
	...
	int year = cal.get(Calendar.YEAR);
		...
		String office_cond="";
 		office_cond=" Office_id="+Office_id+" and ";// Office_id="+Office_id+" and ";
...
<table align="center" border="1" width="100%">
		...
		<tr>
      		<td width="25%">
      		      	<label class="fnt"> Financial Year</label> &nbsp;: &nbsp;  <%=fin_year%> 
			...
			try
			{
		 	...
		 	//	table1+=" </table>";
		 		...
		 		if (button_app.equals("View"))
		 		{
				 		...
				 		String sch_sno="0";
				 		String temp_sno="0";
				 		String qry_1=" select a.sch_name as sch_name,a.sch_sno as sch_sno from pms_sch_master a where  exists    (SELECT distinct SCHEME_SNO FROM PMS_DCB_MST_BENEFICIARY_METRE where   a.sch_sno=SCHEME_SNO  and METER_STATUS='L'  and "+office_cond+" (1=1) )";
