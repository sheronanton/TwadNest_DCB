...
<%   
	...
	response.setHeader ("Content-Disposition", "attachment;filename=\"Division_Scheme_Data.xls\"");
	try  
	{
		...
		String table2="<tr><th width='3%' valign='top'>Sl.No</th><th width='10%' valign='top'>Scheme Name</th>";
				int row=0;
				int cols=1;
				String prv_msno="0"; 
				String main_desc="";
				String sub_desc="";       
			 	...
			 	while(rs1.next())
			 	{
			 		...
			 		table1+="<th align='right' valign='top'>"+df.format(row_sum)+"&nbsp;</th></tr>";
			 		row_sum=0.0f;
			 	} 
