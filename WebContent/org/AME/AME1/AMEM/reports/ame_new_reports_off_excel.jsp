...
<%   
	...
	response.setHeader ("Content-Disposition", "attachment;filename=\"Division_Data.xls\"");
	try  
	{
		...
		String table2="<tr><th width='3%' valign='top'>Sl.No</th><th width='10%' valign='top'>Office Name</th><td width='5%' valign='top'>Total <br> Maint.<br> Schemes</td>";
				int row=0;
				int cols=1;
				String prv_msno="0"; 
				String main_desc="";
				String sub_desc="";       
	 			...
	 			" where office_level_id='DN' and circle_office_id="+circle_office_id+" and  region_office_id="+region_office_id+" and office_id in (select office_id from PMS_DCB_DIV_DIST_MAP ) and "+  
	 			 " office_id in (select office_id from PMS_AME_TRN_ABSTRACT where fin_year='"+fin_year+"' )  ";		 		PreparedStatement ps1=con.prepareStatement(qry_1);
