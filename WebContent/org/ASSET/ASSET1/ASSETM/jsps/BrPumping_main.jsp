...
<script type="text/javascript" src="../scripts/BrPumping_main.js"></script>
...
function pdf_rpt()
{
	var sno=document.getElementById("sid").value;
	   window.open("../../../../../BrPumping_main?comment=PDF&sno="+sno);
...
function tech(a)
{
	...
	disabled1('addb1');
	var sno = document.getElementById("PMS_ASSET_BRANCH_PMAIN_SNO" + a).value;
...
<link href="../../../../../css/pmsSchemeStyle.css" rel="stylesheet"
	...
	<%
   String  id="",main_type="",class_type="",src_comp="",sub_src_comp="";
   String sch_name="",main="",type_class="";
	try {
...
<table cellspacing="0" cellpadding="7" border="1" width="70%"
	align="center" >
	<tr class="tdH">
		<td colspan="4" align="center">Branch Pumping Main</td>
	</tr>
	   <tr><td>Scheme Name</td><td colspan="3"><%= sch_name%></td></tr>
	<tr><td>Location</td><td colspan="3"><br>From:&nbsp;&nbsp;&nbsp;<input type="text" id="from" name="from" style="width:70%"><br><br>
       ...
       <td>Class Of Main</td><td><%=type_class %></td></tr>
        <tr><td> Diameter &nbsp;(mm)</td><td><input type="text" id="dim" name="dim"  size="7mm" maxlength="7" onchange="validateNumber(this)"></td>
       <td>Length Of Main&nbsp;(m)</td><td><input type="text" id="len_main" name="len_main"  size="7mm" maxlength="7" onchange="validateNumber(this)"></td></tr>
       <tr><td  colspan="4"><center> 
       
       <input type="button" value="ADD"  id="addb1" class="btn" onclick="insert_()"/>
      <input type="reset" value="CLEAR"  class="btn" onclick="enabledtb('addb1')"/>
       ...
       <input type="button" value="DELETE"  id="delb1" class="btn" onclick="delete_1()"/>
       <input type="button" value="REPORT"  class="btn" onclick="pdf_rpt()"/>
       <input type="button" value="EXIT"  id="exitb1" class="btn1" onclick="fun()"/></center> </td></tr>
	<tr>
	<td colspan="6">
