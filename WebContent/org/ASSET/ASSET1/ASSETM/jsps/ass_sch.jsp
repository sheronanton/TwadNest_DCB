   		...
   		for(var i=0; i<sel.length; i++)
   		{
   			if(document.getElementsByName("chdcb")[i].checked==true)
   			{
				...
				//alert(params+"params");
			   		...
			   		{
   	   				    //alert(params+"params");
			   			window.open('AssGenDetail1.jsp?'+params,"mywindow", "location=1,status=1,scrollbars=1,resizable=1");
			   		}
			   		else if(sn==2 && flag==1)
			   		{
				   		//alert(params+"params");
			   			window.open('SchemeTechDetails.jsp?'+params,"mywindow", "location=1,status=1,scrollbars=1,resizable=1");
			   		}
			   		else
			   		{
