...
<body onload="">
   ...
   <%
    ...
    String sch_name="";
   String ben_typeid="",type_ben="",id="",src_comp="",sub_src_comp="";
	try 
	{
	 ...
	 sch_name="SELECT met.SCHEME_SNO,"
			 ...
			 +" AND office_id           =5982 and BENEFICIARY_SNO  in (select BENEFICIARY_SNO from PMS_SCH_ASSET_SR where OFFICE_ID=5982) )ben"
			 +" JOIN"
	...
	%>
			...
			<tr  class="tdH"><td colspan="6" align="center">Service Reservoirs(Local Body Beneficiaries)</td></tr>
			...
			while(rs.next()) 
			{
				...
				while(rs2.next()) 
				{
					...
					String val="<table  border=1 width='100%'><tbody id='c"+row+"'><tr><td width='20%'>";
					 ...
					 val+="<input type='button' value='SUBMIT' onclick='update("+row+","+innerrow+")'>"+"&nbsp;";
