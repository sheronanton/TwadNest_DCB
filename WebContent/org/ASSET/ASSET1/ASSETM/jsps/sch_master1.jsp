...
<html>
  ...
  <head>   
    ...
    function tech(a)
    {
    	...
    	if (comm=="--")   
    		document.getElementById("label1").innerHTML="<font color='blue'>No Data found in PMS Scheme Master</font>";
    	if (date_of_compl=="")   
    		document.getElementById("label2").innerHTML="<font color='blue'>No Data found in PMS Scheme Master</font>";
  ...
  {  
	  ...
	  for(var i=0; i<sel.length; i++)
 	  {
 			...
 			{
	   			schsno=document.getElementById("SCH_SNO"+(i+1)).value;
 			}
 		}      
	   var v=window.open("../../../../../Assetreport?command=pdf1&schsno="+schsno,"mywindow", "location=1,status=1,scrollbars=1,resizable=1");
	 }
   ...
   function load(sn)
   {
		...
		{
   	   		//alert(params+"params");
			var v=window.open('AssGenDetail1.jsp?'+params,"mywindow", "location=1,status=1,scrollbars=1,resizable=1");
		}
		else if(sn==2 && flag==1)
		{
			//alert(params+"params");
			var v=window.open('SourceAssetGeneralDetail.jsp?'+params,"mywindow", "location=1,status=1,scrollbars=1,resizable=1");
		}
		else
		{
...
%>  
      ...
      <tr>
      <th align ="center" colspan ="5" class = "tdH">Scheme Master -<%=Office_Name %></th></tr>       
      <tr class="lbl">  
	  		<td width="30%"><font  class="fnt" color='blue'>Category</font> </td>
	  		<td width="70%" colspan ="4"><%=category %></td> 
	  </tr>  
      <tr>
	  	<td>
	  		<label class="lbl"><font class="fnt" color="blue">Scheme Financial Year</font></label>
	  	 </td>
	     <td colspan="4"><%=sch_fin_year%></td>
	  </tr> 
      <tr class="lbl">
        ...
        <tr align="center" class="tdH">
		          <td colspan="5">
		          <input type="button" name="SUBMIT" id="SUBMIT" value="SUBMIT"  style="COLOR: #005500;" onclick="load(1)  "/>&nbsp;&nbsp;
      ...
      <table id="Existing" border="1" width="100%" cellspacing="3" class="table" align="center"   style="border-collapse: collapse;border-color: skyblue" >
          <!-- <tr >
			...
			<td colspan ="6" align="center">
        		...
        		<A HREF="javascript:load(2);" > <font  class="fnt">Scheme Technical Details</font></A> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        	 	<A HREF="javascript:rpt();" > <font  class="fnt">Report</font></A> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         	    </td>  </tr>
         	     -->  
      <tr class="tdH" >
          ...
          <th> <font  class="fnt">Estimated Cost</font></th>
      ...
      <table  class="fb2" cellspacing="0" cellpadding="2" border="1" width="100%" align="center"   style="border-collapse: collapse;border-color: skyblue" > 
