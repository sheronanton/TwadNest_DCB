...
function insert_() 
{
	...
	var flag2=val_check('len_main','Enter Main Length  Value');
	var flag3=val_check('from','Enter From Location  Value');
	var flag4=val_check('to','Enter To Location Value');
	...
	{
		url = "../../../../../BrPumping_main?comment=add&sno=" + sno + "&comp=" + comp  +
		"&sub_comp="+"&main_type=" + main_type +  "&class_type=" + class_type +  "&dim="
...
{  
	...
	var to = document.getElementById('to').value;
	var url = "";
	url = "../../../../../BrPumping_main?comment=view"+"&t="+Math.random();
	xmlHttp.open("GET", url, true);
	xmlHttp.onreadystatechange = function() 
	{
...
function view_result(xmlHttp) 
{
	...
	var bR = xmlHttp.responseXML.getElementsByTagName("response")[0];
	var len = bR.getElementsByTagName("PMS_ASSET_BRANCH_PMAIN_SNO").length;
	for ( var i = 0; i < len; i++) {
	//  function cell(major,item,type,name,value,size,sclass,url,istyle,tdwidth,tdalign,funtype,funname)
		...
		var PMS_ASSET_BRANCH_PMAIN_SNO = xmlValue(bR, "PMS_ASSET_BRANCH_PMAIN_SNO", i);
		...
		var sno_cell = cell("TD", "input", "hidden", "PMS_ASSET_BRANCH_PMAIN_SNO"	+ (i + 1), PMS_ASSET_BRANCH_PMAIN_SNO, 2, "tdText", "", "", "2%", "", "","");				
...
function modify_data() {
	...
	if (flag1==0 && flag2==0 && flag3==0 && flag4==0 )
	{
	url = "../../../../../BrPumping_main?comment=modify&sno=" 
...
function delete_1() {
	...
	var url = "";
	xmlHttp = createObject();
	url = "../../../../../BrPumping_main?comment=pop&sno=" + sno+"&t="+Math.random();
	xmlHttp.open("GET", url, true);
	xmlHttp.onreadystatechange = function() 
	{
