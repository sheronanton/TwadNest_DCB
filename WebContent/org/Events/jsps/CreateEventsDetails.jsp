...
<html>
  <head>
    ...
    <title>Create Events Details</title>    
   
    <script type="text/javascript" src="../scripts/CreateEventsDetailsValidations.js"></script>
...
{
//alert('in try');
	var key_val=(window.event) ? event.keyCode : e.keyCode;
        //alert("*"+key_val);
        if (122 == key_val)
	{
		event.keyCode = 0;
...
if (122 == e.which)
 ...
 %>
  <form name="frmCreateEvent" method="POST" action="../../../ServletCreateEventsDetails.con" onsubmit="return nullCheck()">
      <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Create New Event Details</b></center>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <tr>
                  ...
                  <td width="64%">
                    ...
                    try
                           {
                                 results=statement.executeQuery("select max(event_id) from com_mst_events"); 
                                 while(results.next())
                                 {
               ...
               // java.util.Date eve_date=new java.util.Date();
                  String DateToBeDisplayed="";
                    ...
                    <input type="text" id="txtEventDate" name="txtEventDate" size="10" maxlength="10"
                           ...
                           <img src="../../../images/calendr3.gif"  onclick="showCalendarControl(document.frmCreateEvent.txtEventDate);" alt="Show Calendar"></img>
                ...
                <tr>
                    ...
                    <td width="64%">
                  <input type="text" id="txtTargetURL" name="txtTargetURL" size="40"/>                </td>
                </tr>
              </table>
          </td>
        </tr>        
