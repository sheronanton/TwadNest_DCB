...
<html>
  <head>
    ...
    <title>Validate/Publish Events</title>    
   
    <script type="text/javascript" src="../scripts/ValidateAndPublishEventsValids.js"></script>
    <script type="text/javascript" src="../scripts/ValidateAndPublishEventsAjax.js"></script>
 ...
 %>
  <form name="frmPublishEvent" method="POST" action="../../../ServletValidateAndPublishEvent.con" onsubmit="return nullCheck()">
      <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Validate/Publish Events</b></center>
            </td>
        </tr>
        <tr>
            <td>
               ...
               // java.util.Date eve_date=new java.util.Date();
                  String DateToBeDisplayed="";
                    ...
                    <input type="hidden" id="txtEventDate_h" name="txtEventDate_h" value=<%=DateToBeDisplayed%>></input>
                           ...
                           onFocus="javascript:vDateType='3'" onBlur="DateFormat(this,this.value,event,true,'3');" onchange="return chk_for_expired_date(this);" onkeypress="return  calins(event,this)"/>                   
                           <img src="../../../images/calendr3.gif"  onclick="showCalendarControl(document.frmPublishEvent.txtEventDate);" alt="Show Calendar"></img>
                ...
                <tr>
                <td  width="36%">Event Status<label style="color:rgb(255,0,0);">&nbsp;*</label></td>
                <td width="64%">
