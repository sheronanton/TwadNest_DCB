...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Misc_Rep_AnnexureIV_JS.js"></script>
  ...
  <form action="../../../../../../Misc_Rep_AnnexureIV_Serv" name="miscRep" method="post" onsubmit="return checknull()">
