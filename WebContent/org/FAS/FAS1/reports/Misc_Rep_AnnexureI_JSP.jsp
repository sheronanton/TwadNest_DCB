...
<html>
  <head>
    ...
    <script language="javascript" type="text/javascript" src="../scripts/Misc_Rep_AnnexureI_JS.js"></script>
  ...
  <form action="../../../../../../Misc_Rep_AnnexureI_Serv" name="miscRep" method="post" onsubmit="return checknull()">
  <table cellspacing="2" cellpadding="3" border="1" width="100%">
  <tr>
        <td class="tdH" colspan="2"><center>Annexure I</center></td>
  </tr>
  <tr align="left">
          <td class="table">
          <div align="right">
