...
<html>
  <head>
    ...
    <title> Average age for Employees - Designation wise</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/Avg_age_emp_desig.js"></script>
  ...
  <body><form name="Avg_age_emp_desig" method="POST" 
                       action="../../../../../../EmployeeDetailReportServ_New_Interface">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong>  Average age for Employees - Designation wise</strong></td>
                </tr>
...
"WHERE rownum  =1"
                    ...
                    <div id="divallofficelevel" style="cursor:hand">                          
                      ...
                      <input type="radio" name="rad_off" id="rad_aud" value="lb" onclick="selectoption2()"></input>Lab
                             <input type="radio" name="rad_off" id="rad_all" value="all" onclick="hidden1()"></input>All
                    </div>
          ...
          <tr class=table id="divdeputation" style="display:none">
            <td colspan=2 align=left><input type="checkbox" name="alldept" id="alldept" value="include_deput">Include Deputation</input></td>
          </tr>
          
             <tr>
                  <td colspan="2" class="tdH">Selection of Cadre</td>
                </tr>
               
                          
                 <tr class="table" id="divselect"  >                  
                <td> <input type="radio" value="Dest"  onclick="designa();" 
                             name="optselect" id="optselect" ></input>
                      Specific Designation
                      <input type="radio" value="ALL"  onclick="designa1();" 
        ...
        %>
               ...
               <td>
               <div class="scroll" align='left' style='width:125%'  id="divdesignation">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
               </td>
               </tr>  
