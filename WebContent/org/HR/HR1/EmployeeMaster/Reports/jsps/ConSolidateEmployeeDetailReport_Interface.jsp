...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/ConsolidateEmployeeDetailReport.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../ConsolidateEmployeeDetailReport">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong>Consolidate Staff Report on Current Posting Details - All or Specific Offices</strong></td>
                </tr>
