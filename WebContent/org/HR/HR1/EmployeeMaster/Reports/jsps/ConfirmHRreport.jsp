...
<html>
  <head>
    ...
    <title> HR Transaction Monitoring Report - Summary</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
       <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
            
    <script type="text/javascript"
            src="../scripts/ConfirmHRreport.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../EmpValidationSummaryServ_New_Interface">
      ...
      <div align="center">
        <table border='2' width="100%">
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> HR Transaction Monitoring Report - Summary</strong></td>
                </tr>
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
             <input type="text" name="txtyear" id="txtyear"  maxlength="4"   size="5"  onblur="monthcall()"/>                       
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <select name="txtmonth" id="txtmonth" onchange="fnoption()">                       
            ...
            <option value="12">December</option>-->
              ...
              <div id=option style="display:none">
                <input type="radio" name="selmnth" id="currentmonth" value="currentmonth" checked="checked"> View the Current Month Report
                <input type="radio" name="selmnth" id="premonth" value="premonth">View the Previous Six Months Reports Also
              </div>
            </td>
          </tr>
        ...
        <tr class="table">
            <td>
              <div align="left">All data updated
              <font color="#ff2121">*</font>
              </div>
            </td>
            <td>
              <div align="left">
                <select name="updated" id="updated">                       
                        ...
                        <input type="hidden" name="tupdated">
              </div>
            </td>
          </tr>  
