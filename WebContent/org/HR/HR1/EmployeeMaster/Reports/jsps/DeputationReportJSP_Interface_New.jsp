...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/DeputationReportJS_Interface_New.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../DeputationReportServ_Interface_New?radopt=pdf">
      ...
      <div align="center">
        <table border='2' width="100%">
            <tr>
              <td colspan='2' class="tdH" align="center"><strong> Report on Employees who are on Deputation, Undergone Studies & Proceeded Abroad</strong></td>
            </tr>
