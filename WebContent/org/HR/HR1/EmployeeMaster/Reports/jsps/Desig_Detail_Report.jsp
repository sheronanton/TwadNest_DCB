...
<html>
  ...
  <body onload="emp_status()"><form name="frmValidationSummaryRep">
      ...
      <div align="center">
       ...
       <tr>
         ...
         <tr>
            <td colspan="3" ><input type="radio" name="desType" value="All" id="desType" onclick="Hiddendesig()" checked="checked" >All &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				    <input type="radio" name="desType" id="desType" value="Specific" onclick="visibledesig()">Specific	
        ...
        %>  
               ...
               <tr class="tdH">
  <td colspan="3" align="left">Selection of Office </td>
  </tr>
   ...
   <tr><td align="left"><input type="checkbox" name="select1" value="WKG" id="worselect" checked="checked">Working </td>
   ...
   <td align="left"><input type="checkbox" name="select1" value="TRA" id="worselect">Training</td>
          ...
          <tr>
            <td colspan="2" class="tdH" align="center"><input type="button" value="Submit" onclick="frmsubmits()">
