...
<html>
  <head>
    ...
    <title> Designation Wise Detail Report(New)</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/Desig_Detail_Report_With_Pension.js"></script>
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Designation Wise Detail Report (New)</strong></td>
                </tr>
   ...
   <tr>
             ...
             <td colspan="2" align="left" valign="top" class="table">
              <div align="center">
                <table border="0" width="100%">
                  <tr  class="tdH">
                    <td colspan="4">Employee Category</td>
                  </tr>
                  <tr>
