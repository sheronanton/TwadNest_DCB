...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/EmpDetailsRep_QueryBased_orderby.js"></script>
     <script type="text/javascript"
            src="../scripts/emp_query_based_report_orderby.js"></script>
    <style type="text/css">
          body 
          {
  ...
  <body>
  <form name="frmEmployeeorderby" method="GET" class="table">
  <%
    ...
    <table border="2" width="100%">
      ...
      <tr>
            ...
            <table cellspacing="2" cellpadding="3" border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="left"><strong> Order By</strong></td>
                </tr>
                <tr>
                <td>
                          <input type="checkbox" name="orderby_off" id="orderby_off" onclick="getcheck()" >  Offices
                        </td>
                </tr>
     <tr>
                <td>
                          <input type="checkbox" name="orderby_off" id="orderby_off" onclick="getcheck1()" >  Designations
                        </td>
                </tr>
                <tr>
                <td>
                          <input type="checkbox" name="orderby_off" id="orderby_off" onclick="getcheck2()" > Employee Id</td>
                </tr>
                <tr>
                <td>
                          <input type="checkbox" name="orderby_off" id="orderby_off" onclick="getcheck3()" > Employee Name</td>
                </tr>
      <tr>
