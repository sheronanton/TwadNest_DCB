...
<html>
  <head>
    ...
    <title> Employee Records Validation Report - Summary</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
       <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
            
    <script type="text/javascript"
            src="../scripts/EmpValidationSummaryJS_New_Interface.js"></script>
            
           <!--interface js for loading region, circle,division--> 
    <script type="text/javascript"
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Employee Records Validation Report - Summary</strong></td>
                </tr>
