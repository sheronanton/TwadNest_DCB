...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/EmployeeDetailReportJS1.js"></script>
  ...
  <body><form name="frmEmployeeDetailRep" method="POST" action="">
      ...
      <div align="center">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong>Employee&nbsp;Detail Report (Office/Designation wise)</strong></td>
                </tr>
                <tr>
        ...
        <%}%>
          ...
          <td>
          <div align="left">
               <input type="radio" name="optdetail" checked="checked" value="SUMMARY"> Summary Report 
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="optdetail" value="DETAIL">Detailed Report
            </div>  
            </td>
        </tr>
          <tr>
