...
<html>
  <head>
    ...
    <title> Report on Current Posting details - All or Specific employee</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/EmployeeDetailReportJS_New_Interface.js"></script>
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Report on Current Posting details - All or Specific employee</strong></td>
                </tr>
