...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/EmployeeDetailsReportJS_New.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../EmployeeDetailsReportServ_New">
      ...
      <div align="center">
        ...
        <tr class="table">    
        <td>       
              <input type="radio" value="RadAl" name="optselect" id="chkone" checked="checked" onclick="hidedesig()">
               All Designation
         
               <!--input type="checkbox" name="chkall" onclick="sellectall()"--> 
               <input type="radio" value="radsel" onclick="sellectall()" name="optselect">
