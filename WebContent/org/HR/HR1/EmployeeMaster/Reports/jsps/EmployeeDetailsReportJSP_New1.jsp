...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/EmployeeDetailsReportJS_New1.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../EmployeeDetailsReportServ_New1">
       ...
       <tr class="table" id="divselect" style="display:none">                  
        ...
        <%}%>
          ...
          <tr class=table id="divallhier" style="display:none">
            <td colspan=2 align=left><input type="checkbox" name="allhier" id="allhier" value="checked">Include all Hierarchy</input></td>
          </tr>
          <tr>
