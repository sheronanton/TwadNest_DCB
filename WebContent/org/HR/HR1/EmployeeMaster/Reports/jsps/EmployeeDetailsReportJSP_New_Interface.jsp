...
<html>
  <head>
    ...
    <title> Report on Current Posting Details - All or Specific Offices / Designations</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/EmployeeDetailsReportJS_New_Interface.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../EmployeeDetailsReportServ_New_Interface">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Report on Current Posting Details - All or Specific Offices / Designations</strong></td>
                </tr>
       ...
       <tr class="table" id="divselect" style="display:block">                  
        ...
        %>
                ...
                <tr>
                  <td class="table" align="left">
                    ...
                    <% }
                      ...
                      <div id="divallofficelevel" style="cursor:hand">   
                      <input type="radio" name="rad_off" id="rad_all" value="all" checked="checked" onclick="selectoption1()"></input>All                                            
          ...
          <tr class=table id="divallhier" style="display:block">
            <td colspan=2 align=left><input type="checkbox" name="allhier" id="allhier" value="include" disabled>Include all Offices down the Hierarchy</input></td>
          </tr>
          <tr>
