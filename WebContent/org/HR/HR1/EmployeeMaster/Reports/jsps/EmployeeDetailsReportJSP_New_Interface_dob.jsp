...
<html>
  <head>
    ...
    <title> Report on Current Posting Details - All or Specific Offices / Designations With DOB</title>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../EmployeeDetailsReportServ_New_Interface_dob">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Report on Current Posting Details - All or Specific Offices / Designations (Including Date of Birth Details)</strong></td>
                </tr>
