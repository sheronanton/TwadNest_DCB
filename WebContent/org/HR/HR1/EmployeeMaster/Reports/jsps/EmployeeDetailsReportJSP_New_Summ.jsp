...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/EmployeeDetailsReportJS_New_Summ.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../EmployeeDetailsReportServ_New_Summ">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> Employee Details Report</strong></td>
                </tr>
