...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/EmployeeServiceReport_Interface.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../EmployeeServiceReport_Interface">
        ...
        <table border='2' width="100%">
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Services Based on office nature of work</strong></td>
                </tr>
                <tr>
                ...
                <tr>
                	<td colspan="2">
                	<input type="radio" id="rank" name="rank" checked="checked" value='AE'>AE</input>
                	<input type="radio" id="rank" name="rank" value='AEE'>AEE</input>
                	<input type="radio" id="rank" name="rank" value='EE'>EE</input>
                	</td>
                </tr>
                <tr>
          ...
          <tr class=table id="divallhier" style="display:block">
           ...
           <tr>
                ...
                <tr>
                	<td>
                		<input type="radio" name="order" id="order" checked="checked" onclick="callService()" value='office'>Office</input>
                		<input type="radio" name="order" id="order" onclick="callService()" value='service'>Service Type</input>
                	</td>
                	<td>
                		<input type="radio" name="order_desc" id="order_desc" checked="checked" value='asc'>Ascending</input>
                		<input type="radio" name="order_desc" id="order_desc" value='desc'>Descending </input>
                	</td>
                </tr>
                <tr>
                	<td>
