...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/EmployeeServiceReport_Interface_New.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../EmployeeServiceReport_Interface_New">
      ...
      <div align="center" >
        <table border='2' width="100%">
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> SR Report - AE/JE/AEE/EE Report</strong></td>
                </tr>
                <tr>
          ...
          <tr class=table id="divallhier" style="display:block">
           ...
           <tr>
                	<td colspan="2" class="tdH">Report Order</td>
                </tr>
                <tr>
                	<td>
                		<input type="radio" name="order" id="order" checked="checked" onclick="callService()" value='office'>Office
                		<input type="radio" name="order" id="order" onclick="callService()" value='service'>Service Type
                	</td>
                	<td>
                 ...
                 <tr>
                	<td colspan="2" class="tdH">Report Type</td>
                </tr>
                <tr>
                	<td colspan="2">
                		<input type="radio" name="report_type" id="repabtstract" checked="checked" value='abst' onclick="hideService('A')">Abstract
                		<input type="radio" name="report_type" id="repdetails" value='dets' onclick="hideService('D')">Details
                	</td>
                </tr>
                <tr>
                	<td>
                		<div id="orderdiv">
                            ...
                            <div id="orderdivabs"  style="display:none">
                			<select name="service1" id="service1"     >
                                 
                                    <option value="pfoff">PF_Office_Service</option>
                                    <option value="other">Other Service</option>                                    
                            </select>
                            <span id="otype">
                            <input type="radio" name="ordtype" value="I" id="individual" checked>individual
                            <input type="radio" name="ordtype" value="C" id="combined">Combined</span>
                		</div>
                		</div>
                	</td>
                </tr>
