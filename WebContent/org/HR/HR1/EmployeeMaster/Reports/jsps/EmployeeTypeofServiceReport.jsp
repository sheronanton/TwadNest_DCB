...
<html>
  <head>
    ...
    <title> Services Based on office nature of work</title>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../EmployeeTypeofServiceReport">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr> 
                  <td colspan='2' class="tdH" align="center"><strong> Type of Service - AE/JE/AEE/EE</strong></td>
                </tr>
                <tr>
                	<td colspan="2" class="tdH">Rank</td>
                </tr>
                <tr>
                	<td colspan="2">
                	<input type="radio" id="rank" name="rank" checked="checked" value='AE' onclick="callService()" >AE
                	<input type="radio" id="rank" name="rank" value='AEE' onclick="callService()">AEE
                	<input type="radio" id="rank" name="rank" value='EE' onclick="callService()">EE
                	</td>
                </tr>
                <tr>
                  ...
                  <td class="table" align="left">
                    ...
                    String deptid="",offlevel="";
                         ...
                         try
                        {
                                ...
                                ps=connection.prepareStatement("SELECT c.OFFICE_LEVEL_ID, " +
"  a.office_id, " +
"  OFF_ORDER " +
"FROM " +
"  (SELECT office_id " +
...
"WHERE rownum  =1" );
          ...
          <tr class=table id="divallhier" style="display:block">
            ...
            <tr class="tdH" height="30">
                	<td colspan="2" >
                	<input type="radio" name="rType" value="PDESIGN" checked >In present designation
                	<input type="radio" name="rType" value="POFFICE"  >In Present Office
					<input type="radio" name="rType" value="ALL" >Entire service
           ...
           <tr>
                ...
                <tr>
                	<td>
                		...
                		<span  onclick="selectAll()" style="cursor:pointer;color:blue" >Select All </span><br>
                		<input type="checkbox" name="service" checked value="PF" >PF<br>
                		<input type="checkbox" name="service" checked value="RL" >RWS<br>
                		<input type="checkbox" name="service" checked value="UR">Urban<br>
                		<input type="checkbox" name="service" checked value="SW">Sewerage<br>
                		</div>
                		<div style="float:left">
                		<span onclick="clearAll()" style="cursor:pointer;color:blue" >Clear All </span><br>
                		<input type="checkbox" name="service" checked value="MN" >Maintenance<br>
                		<input type="checkbox" name="service" checked value="Office" >Office <br>
                		<input type="checkbox" name="service" checked value="DN" >Deputation<br>
                		<input type="checkbox" name="service" checked value="HO" >Head Office<br>
                		</div>
                	
                	
                	</td>
                	<td>
                		<input type="radio" name="order_desc" id="order_desc"  value='asc'>Ascending
                		<input type="radio" name="order_desc" id="order_desc" value='desc' checked="checked">Descending 
                	</td>
                </tr>
                     <tr>
                	<td colspan="2" >
