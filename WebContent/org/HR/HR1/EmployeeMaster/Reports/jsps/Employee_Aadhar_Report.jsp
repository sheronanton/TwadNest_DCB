...
<html>
  <head>
    ...
    <title> Report on Aadhar Number Updation</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/EmployeeDetailReport_post_count_Interface.js"></script>
      ...
      <div align="center">
        <table border='2' width="100%">
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong>Report on Aadhar Number Updation</strong></td>
                </tr>
          ...
          <tr class=table id="divallhier" style="display:block">
            ...
            <input type="checkbox" name="allhier" id="allhier" value="include">Include all Offices down the Hierarchy</input></td>
          </tr>
          <tr>
             ...
             <td colspan="2" align="left" valign="top" class="table">
              <div align="center">
                <table border="0" width="100%">
                  <tr>
                    <td colspan="2" class="tdH">Report Output Format
                    <input type="hidden" name="command" value="Aadhar">
                    </td>
                  </tr>
                  <tr>
          ...
          <tr>
            <td colspan="2" class="tdH" align="center"><input type="button" value="Submit" onclick="aadhar_count()">
