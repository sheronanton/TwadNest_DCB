...
<html>
  <head>
    ...
    <title> Report on Desig / Rank / Cadre -wise Status Report</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/Employee_DetailsReport_Interface.js"></script>
  ...
  <body onload="getStatus()"><form name="frmValidationSummaryRep" method="POST" 
      ...
      <div align="center">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Report on Desig / Rank / Cadre -wise Status Report</strong></td>
                </tr>
               <tr>
                 ...
                 <tr>
                     <td>
                            <table border="0" cellpadding="0" cellspacing="0"
                              ...
                              <tr>
                                <td>
                                  <select onclick="getStatus()" name="cmbstatus" id="cmdstatus"
       ...
       <tr class="table" id="divselect" style="display:block">                  
                <td> <input type="radio" value="Dest"  onclick="selectoption1();selectoption4()"
                             name="optselect" id="optselect1" ></input>
                       Designation
                      <input type="radio" value="Rank" name="optselect"  onclick="selectoption1();selectoption4()"
                             id="optselect2" ></input>
                       Rank
                ...
                <td><input type="radio" value="range" name="optselect"  onclick="selectoption2();selectoption3()"
                             id="optselect4" >Employee Id Range From :
                           <input style="display:none" type="text" name="emp_frm" id="emp_frm" size="5" maxlength="5"  onkeypress="return numbersonly1(event,this)">To:
                           <input style="display:none" type="text" name="emp_to" id="emp_to" size="5" maxlength="5"  onkeypress="return numbersonly1(event,this)">   </td>
        ...
        %>
              ...
              <tr class="table" id="desigblock" style="display:none">
               ...
               <div class="scroll" align='left' style='width:37%'  id="divdesignation">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                      ...
                      <tr>
                  <td colspan="2" class="tdH">Order By</td>
                </tr>
                <tr>
                <td><input type="radio" name="orderbyname" id="orderbyname" checked="checked"> Alphabetical 
               
               <input type="radio" name="orderbyname" id="orderbyname1"> Joining date
                </td>
                </tr>          
          <tr>
