...
<html>
  <head>
    ...
    <title>Abstract Report for  Employee sanction strength and vacancy position</title>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../Employee_Sanction_Strength_Summary">
            ...
            <input type="hidden" name="ordertype">
             <input type="hidden" name="reptype" value="fillup">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="100%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong>Abstract Report for  Employee sanction strength and vacancy position</strong></td>
                </tr>
