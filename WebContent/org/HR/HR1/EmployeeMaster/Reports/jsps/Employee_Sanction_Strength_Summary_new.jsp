...
<html>
  <head>
    ...
    <title> Report on Sanction Strength -summary</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/Employee_Sanction_Strength_Summary_new.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../Employee_Sanction_Strength_Summary_new">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="100%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong>Report on Sanction Strength -summary</strong></td>
                </tr>
