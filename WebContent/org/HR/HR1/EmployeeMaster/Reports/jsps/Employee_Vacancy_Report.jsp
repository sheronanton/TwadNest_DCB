...
<html>
  <head>
    ...
    <title> Report on Negative Vacancy - All or Specific Offices</title>
      ...
      <div align="center">
        <table border='2' width="100%">
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Report on Negative Vacancy - All or Specific Offices</strong></td>
                </tr>
          ...
          <tr class=table id="divallhier" style="display:block">
            ...
            <input type="checkbox" name="allhier" id="allhier" value="include">Include all Offices down the Hierarchy</input>
          ...
          <tr>
            <td colspan="2" class="tdH" align="center"><input type="button" value="Submit" onclick="frmsubmit_Vacancy_aadhar()">
