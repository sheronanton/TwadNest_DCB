...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/Employee_contact_details_rep.js"></script>
  ...
  <body onload="Caders();"><form name="Employee_contact_details_rep" method="POST" 
                       action="../../../../../../Employee_contact_details_rep">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr> 
                  <td colspan='2' class="tdH" align="center"><strong> Employee Contact Details Reprot</strong></td>
                </tr>
...
"WHERE rownum  =1" );
          ...
          <tr class=table id="divallhier" style="display:block">
           ...
           <tr class="table"  >                  
                <td> 
                       <input type="radio" value="Cadr" name="optselect"  onblur=""
                             id="optselect3" checked="checked" ></input>
                       Cadre
                </td>
