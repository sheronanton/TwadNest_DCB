...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/Employee_serv_order_by_cl_dn_sd.js"></script>
  ...
  <body onload="hideoff()"><form name="Employee_serv_order_by_cl_dn_sd" method="POST" 
                       action="Employee_serv_order_by_cl_dn_sd">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr> 
                  <td colspan='2' class="tdH" align="center"><strong> List of Employee Details Report</strong></td>
                </tr>
  ...
  ps.setInt(1,empid);
                    ...
                    %>
                     ...
                     <div id="divallofficelevel" style="cursor:hand"  >                          
                      ...
                      <input type="radio" name="rad_off" id="rad_cir" value="cr" onclick="selectoption2()" checked ></input>Circle
