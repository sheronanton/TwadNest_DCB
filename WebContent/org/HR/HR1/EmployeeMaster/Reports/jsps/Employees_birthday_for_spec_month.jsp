...
<html>
  <head>
    ...
    <title> Report on Specific Month Birthday Employee List</title>
  ...
  <body onload="load_month()"><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../Emp_bday_spec_month">
      ...
      <div align="center">
        <table border='2' width="100%">
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Report on specific month Birthday -Employee List </strong></td>
                </tr>
               
                       
               <tr>
               <td>Select Month <select id="month" name="month">
               </select></td>
               </tr>
                <tr>
          ...
          <tr>
            <td colspan="2" class="tdH" align="center"><input type="button" value="Submit" onclick="frmnewsubmit()">
