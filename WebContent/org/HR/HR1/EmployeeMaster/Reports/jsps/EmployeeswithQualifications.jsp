...
<html>
  <head>
    ...
    <title>  Employee List - All or Specific Offices / Designations With Qualifications</title>
      ...
      <div align="center">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Employee List With Qualifications - All or Specific Offices / Designations </strong></td>
                </tr>
       ...
       <tr class="table" id="divselect" style="display:block">                  
        ...
        %>
          ...
          <tr>
            <td colspan="2" class="tdH" align="center"><input type="button" value="Submit" onclick="frmqualsubmit()">
