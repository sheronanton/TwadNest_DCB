...
<html>
  ...
  <body>
  <form name="frmValidationSummaryRep" method="POST" onsubmit="return formsub()" action="../../../../../../Status_Summary_ReportServ">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Engineering Service Class I - Summary Report</strong></td>
                </tr>
  ...
  <th colspan="3" align="left">Selection of Office </th>
   ...
   <tr>
      ...
      <tr>
            ...
            <td colspan=5 align=left><input type="checkbox" checked name="allhier" id="allhier" value="checked" onclick="clearvalue()">Include Hierarchy</input></td>
          </tr>
       ...
       <tr>
        ...
        <tr class="table" id="divselect" style="display:block">                  
                 <td colspan="3" ><input type="radio" name="OffType" value="All" id="OffType" onclick="HideOfficeType();"  >All&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				    <input type="radio" name="OffType" id="OffType" checked value="Specific" onclick="VisibleOfficeType();">Specific	
    ...
    document.getElementById("cmbsgroup").value=4;
    callsubmit();
