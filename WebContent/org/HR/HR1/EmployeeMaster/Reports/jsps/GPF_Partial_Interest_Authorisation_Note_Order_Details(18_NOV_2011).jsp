	...
	if(document.frmEmployeeProfile.txtGpf.value==""){
   	 ...
   	 if(document.frmEmployeeProfile.notice.options[0].selected){
          ...
          return false;
              ...
              document.frmEmployeeProfile.action="../../../../../../GPF_Authorisation_Note_Order_Details.av?Command=Report";
...
function wedraft12(){
	...
	if(nullCheck23())
    {
	document.frmEmployeeProfile.action="../../../../../../GPF_Authorisation_Note_Order_Details.av?Command=draft";
    document.frmEmployeeProfile.method="POST";
    document.frmEmployeeProfile.submit();
    }
}
