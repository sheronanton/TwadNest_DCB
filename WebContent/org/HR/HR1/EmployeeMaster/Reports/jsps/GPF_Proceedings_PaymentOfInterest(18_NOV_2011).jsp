...
<input type="text" name="txtGpf"  onchange="callServer('Existg','null')" onkeypress="return  numbersonly1(event,this)" id="txtGpf" maxlength="10" size="6" />
 ...
 <tr class="table">
        ...
        <tr class="table">
          ...
          <tr class="table">
          	<td>6.<font color="#347C17"> Add Subsequent deposit</font></td>
          	<td>
          	<div align="right">
          ...
          <tr class="table">
          	<td>7. <font color="#347C17"> Interest from <span id="spanFrom"> </span> to</font><font color=#347C17> <span id="spanTo2" > </span> </font></td>
          	<td>
          ...
          <tr class="table">
          	<td>1.<font color=#E41B17>  Excess Credit </font></td>
          	<td>
          		<div align="right">
          ...
          <tr class="table">
          	<td>2.<font color=#E41B17>  Missing Debit </font></td>
          	<td>
          		<div align="right">
          ...
          <tr class="table">
          	<td>3.<font color=#E41B17>  Interest for Excess Credit upto <span id="spanTo3" > </span></font></td>
          	<td>
          		<div align="right">
          	...
          	<td>
                  ...
                  <tr class="table">
          	<td>4.<font color=#E41B17>  Interest for Missing Debit upto <span id="span33To3" > </span></font></td>
          	<td>
          		<div align="right">
          ...
          <tr class="table">
          	<td>5.<font color=#E41B17> Subsequent Withdrawls</font></td>
          	<td>
          		<div align="right">
          ...
          <tr class="table">
          	<td>6.<font color=#E41B17>  Amount Already Authorised</font></td>
          	<td>
          		<div align="right">
    ...
    <div id="fragment-2">
       ...
       <tr class="table">
        ...
        <tr class="table">
         ...
         <input type="text" name="txtPDat" id="txtPDat" size="20" class="disab"readonly="readonly" value="<%=dateFormat.format(d)%>"/>
            </div>
          </td>
        </tr>
        <tr class="table">
          ...
          <td colspan="2">
            <div align="center">
              ...
              <input type="button" id="draft" name="draft" value="Generate Draft"
                     onclick="wedraft12()"/>                      
             <input type="button" disabled="disabled" name="validate" value="Validate" onclick="validate12()"/>
