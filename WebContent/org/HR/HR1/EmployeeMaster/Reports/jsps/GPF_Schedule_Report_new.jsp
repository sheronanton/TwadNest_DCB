...
<html>
  <head>
    ...
    <title>GPF Schedule Report for Closed Offices</title>
...
return true;
  ...
  return false;
    ...
    <script type="text/javascript" src="../scripts/GPF_Schedule_Report_new.js"></script>
  ...
  <body >
  <form name="frmlist_service" id="frmlist_service" onsubmit="return frmrolesubmit1()" action="../../../../../../GPF_Schedule_Report_new" method="post">
  ...
  <tr class="tdH">
  <th colspan="3" align="center">GPF Schedule Reports For Closed Offices</th>
  </tr>
   ...
   //int year=fyear-10;
    %><select name="txtYear" id="txtYear" onchange="getRegion()">
   ...
   <%} %>
                                    ...
                                    <tr class="table" id="trofficeselection1" >
                                      <td colspan="5" class="tdH" style="width: 1025px">Selection of Office</td>
                                    </tr>
                                    <tr class="table" id="trofficeselection"  VALIGN="TOP">
                                      <td colspan="5">
                                        <div align="left">
                                                  ...
                                                  <tr VALIGN="TOP">
                                                    <td>
                                                      <select name="cmbregion" id="cmbregion"
                                                        ...
                                                        <option>Select the offices</option>
                                                      </select>                                </td>
                                                  </tr>
                                                  <tr>
                                                    <td>
