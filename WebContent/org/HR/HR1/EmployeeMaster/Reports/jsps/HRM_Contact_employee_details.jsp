...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/HRM_Contact_employee_details.js"></script>
  ...
  <body><form name="HRM_Contact_employee_details" method="POST" 
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong>  Employee Contact Details Report</strong></td>
                </tr>
...
"WHERE rownum  =1"
          ...
          <tr class=table id="divallhier" style="display:block">
           ...
           <tr class="table"  >                  
                <td> 
                       <input type="radio" value="Cadr" name="optselect"  onclick="Caders();"
                             id="optselect3"  ></input>
                       Cadre
                </td>
        ...
        %>
               ...
               <div class="scroll" align='left' style='width:100%'  id="divdesignation">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                ...
                <tr class="tdH"><td>Address Option</td></tr>
                <tr>
                <td><input type="radio" name="Address" value="WithAddress" checked="checked"/>With Address
                <input type="radio" name="Address" value="WithAddress"/>WithOut Address</td>
                </tr>
