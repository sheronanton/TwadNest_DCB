...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/HRM_Emp_Seni_Report.js"></script>
  ...
  <body><form name="HRM_seniority_rep" >
           ...
           Employee Seniority Reports </b>
            ...
            <%
            String sql="SELECT CADRE_ID, CADRE_NAME FROM HRM_MST_CADRE ORDER BY CADRE_NAME";
