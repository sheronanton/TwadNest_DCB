...
<html>
  <head>
    ...
    <title> Entry Details Checking</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/HRM_Employee_Details_checklist.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../HRM_Employee_Details_checklist">
      ...
      <div align="center">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Entry Details Checking</strong></td>
                </tr>
                
                <tr>
                  <td colspan="2" class="tdH"><strong>Selection of Office Jurisdiction</strong></td>
                </tr>
                <tr>
       ...
       <tr class="table" id="divselect" style="display:block">                  
                <td> <input type="radio" value="All"  onclick="hide_rank()" checked="checked"
                             name="opsel" id="optselect1" ></input>
                       All Employees
                      <input type="radio" value="Rank" name="opsel"  onclick="selectoption1()"
                             id="optselect2" ></input>
                      Specific Designation</td>
          ...
          <tr class="table" id="divrank" style="display:none">
                  <td colspan='2'>
                    ...
                    <select name="cmbsgroup1" id="cmbsgroup1" style="display: block" onchange="getDesignation()">
        ...
        %>
         ...
         <tr>
              ...
              <div align="center">
                <table border="0" width="100%">
              <tr>
             <td colspan="2" class="tdH" align="left"><strong>Options For Entry Details</strong></td>
             </tr>
             <tr>
             
             <td colspan="2" class="table" align="left">
             <div>
             <input  type="radio" name="entry_list" value="Ser"  ></input>Service Particulars-missed/overlapped
             </div>
             </td>
             ...
             <td colspan="2" class="table" align="left">
             <div>
             <input  type="radio" name="entry_list" value="Unfreeze"  ></input>Service Particulars-Unfreezed
             </div>
             </td>
             ...
             <td colspan="2" class="table" align="left">
             <div>
             <input  type="radio" name="entry_list"  value="Addl"></input>Additional Details
             </div>
             ...
             <td colspan="2" class="table" align="left">
              <div>
             <input  type="radio" name="entry_list"  value="Pho"></input>Photo Uploaded status
             </div>
             </td>
             </tr> 
             <tr>
            <td colspan="2" class="table" align="left">
              <div>
             <input  type="radio" name="entry_list" value="Off"></input>Office Details
             </div>
             </td>
             </tr>  
