...
<html>
  <head>
    ...
    <title> Entry Details Checking - Office wise Employee count</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/HRM_Employee_Details_checklist_count.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../HRM_Employee_Details_checklist_count">
      ...
      <div align="center">
        <table border='2' width="100%">
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong>Entry Details Checking - Office wise Employee count</strong></td>
                </tr>
         ...
         <tr>
             ...
             <div>
             <input  type="radio" name="entry_list" value="Ser" ></input>Service Particulars
             </div>
             </td>
