...
<html>
  <head>
    ...
    <title>Entry Details checking for unfreezed service details - office wise count of employees</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/HRM_Employee_Details_checklist_ser_count.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../HRM_Employee_Details_checklist_ser_count">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong>Entry Details checking for unfreezed service details - office wise count of employees</strong></td>
                </tr>
 ...
 <input type="radio" name="rad_off" id="rad_all" value="All" onclick="selectoption2()"></input>All
       ...
       <tr class="table" id="divselect" style="display:block">                  
                <td> <input type="radio" value="All"  onclick="hide_rank()"
                             name="opsel" id="optselect1" checked="checked" ></input>
                       All Employees
