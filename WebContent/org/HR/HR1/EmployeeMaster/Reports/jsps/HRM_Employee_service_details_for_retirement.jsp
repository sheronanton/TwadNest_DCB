...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/HRM_Employee_service_for_retirement_list.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../HRM_Employee_service_for_retirement_list">
            ...
            <input type="hidden" name="ordertype">
             <input type="hidden" name="reprtype" id="reprtype" value="old">
