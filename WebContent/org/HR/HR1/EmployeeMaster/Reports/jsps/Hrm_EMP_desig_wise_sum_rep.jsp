...
return false;
   ...
   if(document.Desig_wise_summ_rep.dep_str[0].checked==true)
	...
	document.Desig_wise_summ_rep.action="EMP_desig_wise_rep_Details.jsp?san="+san+"&status="+status+"&option="+option+"&optdes="+optdes+"&des_id="+des_id+"&rand_id="+rand_id+"&cadre_id="+cadre_id;
