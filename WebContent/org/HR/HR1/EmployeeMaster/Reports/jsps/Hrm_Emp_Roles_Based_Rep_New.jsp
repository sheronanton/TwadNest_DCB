...
<html>
  <head>
    ...
    <title>  Roles Based User List New</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/Hrm_Emp_Roles_Based_Rep_New.js"></script>
  ...
  <body><form name="Hrm_Emp_Roles_Based_Rep" method="POST" 
                       action="../../../../../../Hrm_Emp_Roles_Based_Rep">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Roles Based User List New </strong></td>
                </tr>
...
"WHERE rownum  =1"
          ...
          <tr class=table id="divallhier" style="display:block">
            <td colspan=2 align=left><input type="checkbox" name="allhier" id="allhier" value="include">Include all Offices down the Hierarchy</input></td>
             ...
             <tr>
                  <td colspan="2" class="tdH">Selection of Roles Menu</td>
                </tr>
                     ...
                     <%
                     String sql="select distinct(role_id) as roles_id,role_name from sec_mst_roles  order by role_name";
                     ps=connection.prepareStatement(sql);
                    results=ps.executeQuery();
                     while(results.next())
                     {
				                        
				              int  role_code=results.getInt("roles_id");
				              String  strname=results.getString("role_name");
				                
                             out.println("<option value='"+role_code+"'>"+strname+"</option>");
