...
<html>
  <head>
    ...
    <title> Report on Left Over Service - All or Specific Offices / Designations</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/Hrm_Employee_Left_Over_Service_Report.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../Hrm_Employee_Left_Over_Service_Report">
      ...
      <div align="center">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Report on Left Over Service Details - All or Specific Offices / Designations </strong></td>
                </tr>
               <tr style="display:none">
                  <td colspan="2" class="tdH">Selection of Status</td>
                </tr>
                 <tr style="display:none">
                     <td>
       ...
       <tr>
                  <td colspan="2" class="tdH">Selection of Designation / Rank / Cadre</td>
                </tr>
       ...
       <tr class="table" id="divselect" style="display:block">                  
                <td> <input type="radio" value="Dest"  onclick="selectoption1()"
                      ...
                      <input type="radio" value="Rank" name="optselect"  onclick="selectoption1()"
                       ...
                       <input type="radio" value="Cadr" name="optselect"  onclick="selectoption1()"
                             id="optselect3" ></input>
                       Cadre
                       <input checked="checked"  type="radio" value="All_cadre" name="optselect"  onclick="selectoption1()"
                             id="optselect3" ></input>
                       All
                </td>
        ...
        %>
                    ...
                    <div class="scroll" id="divdesignation1" align='left' style='width:100%'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                    </div>
                  </td>
                </tr>             
        ...
        %>
                  ...
                  <td class="table" align="left">
                    ...
                    %>
                     ...
                     <div id="divallofficelevel" style="cursor:hand">                          
                      ...
                      <input type="radio" name="rad_off" id="rad_aud" value="lb" onclick="selectoption2()"></input>Lab
                       <input type="radio" name="rad_off" id="rad_aud" value="All_office" onclick="selectoption2()" checked="checked" ></input>All
                    ...
                    <% }
                      ...
                      <input type="radio" name="rad_off" id="rad_aud" value="lb" onclick="selectoption2()" disabled="disabled"></input>Lab
          ...
          <tr>
                    <td colspan="" >Left Over Service </td>
                    <td colspan="" ><select id="leftService" name="leftService">
                    <option value="1"> <= 01 Year</option>
                    <option value="2">>01 Year - 05 Years</option>
                    <option value="3">>05 Year - 10 Years</option>
                    <option value="4">>10 Year - 15 Years</option>
                    <option value="5">>15 Year - 20 Years</option>
                  ...
                  <tr>
                    ...
                    <td>
                    <select id="Report_order" name="Report_order">
                    
                     <option value="service">LeftOverService</option>
                    <option value="office">Office Wise</option>                    
                    </select>
                     <input type="radio" value="asc" name="Report_ord" checked>Ascending
                     <input type="radio" value="desc" name="Report_ord">Descending
                    </td>
         ...
         <tr>
                    ...
                    <td>
                     ...
                     <input type="radio" value="Color" name="report_format">Color
                     <input type="radio" value="Black" name="report_format" checked>Black
                    </td>
