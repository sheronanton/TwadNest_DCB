...
<html>
  <head>
    ...
    <title> Employee Punishment Details Report</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/Hrm_Employee_Punishment_Det.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../EmployeeDetailReport_idServ_New_Interface">
            ...
            <input type="hidden" name="cadre">
            <input type="hidden" name="cadreype">
        ...
        <table border='2' width="100%">
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Employee Punishment Details Report</strong></td>
                </tr>
          ...
          <tr>
           ...
           <tr class="table" id="divselect" style="display:block">                  
                <td> <input type="radio"  
                             name="optselect" id="optselect1" value="All" onclick="cls()" checked="checked"></input>
                       All
                     
                       <input type="radio"  name="optselect"  onclick="selectoption1()"
                             id="optselect3" value="Spc"></input>
                       Specific
                </td>
