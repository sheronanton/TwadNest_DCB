...
<html>
  <head>
    ...
    <title> Punishment Details - Available </title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/Hrm_Punishment_Available.js"></script>
  ...
  <body><form name="HRM_punish_available" >
           ...
           Punishment Details - Available </b>
            </td>
            </tr>
            <tr class="tdH">
            ...
            <tr>
            <td>Punishment  details available          Yes  / No</td>
            <td><input type="radio" name="punish_yes" id="punish_yes" value="Y" >  Yes
            <input type="radio" name="punish_yes" id="punish_no"  value="N"> No </td>
            </tr>
