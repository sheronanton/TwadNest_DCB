...
return false;
   ...
   if(document.Desig_wise_summ_rep.dep_str[0].checked==true)
	...
	document.Desig_wise_summ_rep.action="desig_wise_rep_Details.jsp?san="+san+"&status="+status+"&option="+option+"&optdes="+optdes+"&des_id="+des_id+"&rand_id="+rand_id+"&cadre_id="+cadre_id;
     ...
     <tr>
      <td colspan="2" align="left" valign="top" class="table" width="60%">
       <table border="0" width="100%">
        <tr>
          	<td colspan="8" class="tdH" align="center"> Designation Summary Report</td>
        </tr>
         <tr>
        ...
        <tr>
	         ...
	         <input type="radio" id="Sanc_Str_exc" name="Sanc_Str"  value="EXC" onclick="showradio()"></input>
	         Exclude Sanction Strength</td>
	       
	                                                                                                                                        
       </tr>      
       <tr>
	         <td  colspan="8"> <input type="radio" id="dep_Str_inc" name="dep_str" disabled="disabled" value="INC_Dep" ></input>
	         Include Deputation
	         <input type="radio" id="desig_Str_inc" name="dep_str"  value="EXC_Dep" checked="checked" ></input>
	         Exclude Deputation</td>
      ...
      <tr class="table">    
        ...
        <tr class="table" id="divselect"  >                  
                <td> <input type="radio" value="Dest"  onclick="selectoption1();hide()" 
                             name="optselect" id="optselect1" disabled="disabled"></input>
                       Designation
                      <input type="radio" value="Rank" name="optselect"  onclick="selectoption1();hide();"
                       ...
                       <input type="radio" value="Cadr" name="optselect"  onclick="selectoption1();hide();"
                             id="optselect3" disabled="disabled" ></input>
                       Cadre
                </td>
