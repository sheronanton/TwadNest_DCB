...
<html>
  <head>
    ...
    <title>  Employee Office Address</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/Hrm_emp_off_address_Rep.js"></script>
  ...
  <body ><form name="Hrm_emp_off_address_Rep" method="POST" 
                       >
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr> 
                  <td colspan='2' class="tdH" align="center"><strong> Employee Office Address Details Reprot</strong></td>
                </tr>
