...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/JoiningReportJs.js">    </script>
  ...
  <form name="JoiningReport"
              action="../../../../../JoiningReportServ.rep"
              method="POST">
      <div align="center">
        <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
            <td colspan="2" align="center"><b>Employee Posting Report</b></td>
        </tr>
         <tr class="table">
         ...
         <tr class="table">
          <td>
            <div align="left">
              Posting Date on<font color="#e70000">&nbsp;</font>(dd/mm/yyyy) 
