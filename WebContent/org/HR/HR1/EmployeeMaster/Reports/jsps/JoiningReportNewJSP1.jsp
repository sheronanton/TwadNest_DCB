...
<html>
  <head>
   ...
   <title> Employee Posting Report</title>
 ...
 <script type="text/javascript"
    ...
    <script type="text/javascript"
            src="../scripts/JoiningReportNewJs1.js"></script>
  ...
  <body>
  <form name="JoiningReport" method="POST" action="">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> Employee Posting Report</strong></td>
                </tr>
                <tr>
            ...
            <div align="left">
             <input type="text" name="txtDateFrom" id="txtDateFrom"
                      ...
                      <img id="fromimg" src="../../../../../../images/calendr3.gif"
                           onclick=" showCalendarControl(document.JoiningReport.txtDateFrom);"
            ...
            <div align="left">
             <input type="text" name="txtDateTo" id="txtDateTo"
                      ...
                      <img id="toimg" src="../../../../../../images/calendr3.gif"
                           onclick="showCalendarControl(document.JoiningReport.txtDateTo);"
                           alt="Show Calendar"></img>
            </div>
          </td>
        </tr>  
