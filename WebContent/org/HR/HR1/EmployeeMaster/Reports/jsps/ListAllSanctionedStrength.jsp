...
<html>
  <head>
    ...
    <title> Employee Sanctioned Strength Report</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/ListAllSanctionedStrength.js"></script>
  ...
  <body onload="loadfyr()"><form   name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../ListAllSanctionedStrength">
      ...
      <div align="center">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Employee Sanctioned Strength Report</strong></td>
                </tr>
                <tr>
       ...
       <tr class="table" id="divselect" >                  
                ...
                <td>  <input type="radio" value="Rank" name="optselect"  onclick="selectoption1()"
                             id="optselect2" ></input>
                      Specific Rank
        ...
        <%--}--%>
          ...
          <tr class='table' id="divallhier" style="display:none">
            <td colspan=2 align=left><input type="checkbox" name="allhier" id="allhier" value="checked">Include Hierarchy</input></td>
          </tr>
