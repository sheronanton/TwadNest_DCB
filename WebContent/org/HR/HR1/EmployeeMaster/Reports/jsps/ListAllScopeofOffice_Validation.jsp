...
<html>
  <head>
    ...
    <title> Employee Records Validation Report - Abstract</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/ListAllScopeofOffice_Validation.js"></script>
                   <!--below  js for loading region, circle,division--> 
    <script type="text/javascript"
            src="../scripts/EmpValidationDetailJS_New_Interface.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../ListAllScopeofOffices_Validation">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Employee Records Validation Report - Abstract</strong></td>
                </tr>
