...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/ListofEmpValidationJS_New.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../ListofEmpValidationServ_New">
      ...
      <div align="center">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> List of All Employees Validation Status based on SR Controlling Office</strong></td>
                </tr>
        ...
        <!--tr class="table">    
        <td>       
              <input type="radio" value="RadAl" name="optselect" id="chkone" checked="checked" onclick="hidedesig()" style="cursor:hand">
               All Designation
         
               <input type="checkbox" name="chkall" onclick="sellectall()"> 
               <input type="radio" value="radsel" onclick="sellectall()" name="optselect" style="cursor:hand">
       ...
       <tr class="table" id="divselect" style="display:none">                  
        ...
        %>
                ...
                <tr class="table" id="divcadre" style="display:none">
                  <td>
                    <div align="left">
                    <select name="cmbsgroup2" id="cmbsgroup2" onclick="getDesignation2()">
                <option value="0">Select Service Group</option>
                        <%
            rs=null;
           try
        ...
        <%}%>
          ...
          <!--tr>
           <td colspan="2" class="tdH" align="left">Sorting Order</td>
         </tr>
         
        <tr class="table">    
        <td align="left">       
                     
              <input type="radio" value="sortemp" name="sort" id="semp" style="cursor:hand" checked="checked">
               By Employee Name
         
              <input type="radio" value="sortdesig" name="sort" id="sdesig" style="cursor:hand">
               By Designation                
       </td>    
       </tr-->
