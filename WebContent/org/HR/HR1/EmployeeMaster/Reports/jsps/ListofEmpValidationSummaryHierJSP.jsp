...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/ListofEmpValidationSummaryHierJS.js"></script>
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> List of All Employees Validation Status - Summary Hierarchical View</strong></td>
                </tr>
                <tr>
                  <td colspan="2" class="tdH">Select Office Level Upto</td>
                </tr>
                <tr>
