...
<html>
  <head>
    ...
    <title> List of All Employees Validation Status based on SR Controlling Office by grouping</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/ListofEmpValidationSummaryJS1.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" action="">
