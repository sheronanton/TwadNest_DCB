...
<html>
  <head>
    ...
    <title>Employees Deputation Order</title>
    <script type="text/javascript" src="../scripts/ListofEmp_FinalProceedDeput.js"></script>
  ...
  <form name="frmListEmpProceed"  method="POST">
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Generate Final Proceedings for Deputation Order</strong>
            </div>
          </td>
        </tr>
       <tr class="tdH">
          ...
          <td>
            ...
            <select size="1" name="cmbProceed" id="cmbProceed"
              ...
              <%
                ...
                ps1=con.prepareStatement("select distinct deputn_order_id from HRM_deputn_ORDERS where deputn_ISSUE_OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('FR') order by deputn_order_id desc");
                ...
                System.out.println("fine");
                    while(rs.next())
                    {
                    out.println("<option value='"+rs.getInt("deputn_order_id")+"'>"+rs.getInt("deputn_order_id")+"</option>");
                    }
                }
                catch(Exception e)
                {
