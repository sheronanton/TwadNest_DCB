...
<html>
  <head>
    ...
    <title>Employees Deputation Order Report</title>
    <script type="text/javascript" src="../scripts/ListofEmp_Proceed_Deputation.js"> </script>
  ...
  <form name="frmListEmpProceeddep"  method="POST">
          ...
          <td>
            ...
            <select size="1" name="cmbProceed" id="cmbProceed"
              ...
              <%
                ...
                ps1=con.prepareStatement("select distinct deputn_order_id from HRM_deputn_ORDERS where deputn_ISSUE_OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('CR','MD') order by deputn_order_id desc");
