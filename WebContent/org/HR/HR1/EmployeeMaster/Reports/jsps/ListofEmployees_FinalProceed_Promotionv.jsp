...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/ListofEmployees_FinalProceed_Promotionv.js"></script>
  ...
  <form name="frmListEmpProceed"  method="POST">
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Generate Final Proceedings for Promotion Order</strong>
            </div>
          </td>
        </tr>
       <tr class="tdH">
          ...
          <td>
            ...
            <select size="1" name="cmbProceed" id="cmbProceed"
              ...
              <%
                ...
                ps1=con.prepareStatement("select distinct Promotion_order_id from HRM_Promotion_ORDERS where Promotion_ISSUE_OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('FR') order by Promotion_order_id desc");
