...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/ListofEmployees_FinalProceed_Relival.js"></script>
  ...
  <form name="frmListEmpProceed"  method="POST">
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Generate Draft Final Proceedings for Relieval Order</strong>
            </div>
          </td>
        </tr>
       <tr class="tdH">
          ...
          <td>
            ...
            <select size="1" name="cmbProceed" id="cmbProceed"
              ...
              <%
                ...
                ps1=con.prepareStatement("select distinct RELIEVAL_SLNO,PROCEEDING_NO from HRM_EMP_RELIEVAL_ORDER where RELIEVAL_ISSUE_OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('FR') order by RELIEVAL_SLNO desc");
                ...
                System.out.println("fine");
                    ...
                    out.println("<option value='"+rs.getInt("RELIEVAL_SLNO")+"'>"+rs.getInt("RELIEVAL_SLNO")+"</option>");
                    }
                }
                catch(Exception e)
                {
