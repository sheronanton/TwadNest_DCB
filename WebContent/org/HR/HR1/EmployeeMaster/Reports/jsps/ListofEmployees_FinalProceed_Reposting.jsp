...
<html>
  <head>
    ...
    <title>Employees Reposting Order</title>
    <script type="text/javascript" src="../scripts/ListofEmployees_FinalProceed_Reposting.js"></script>
  ...
  <form name="frmListEmpProceed"  method="POST">
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Generate Final Proceedings for Reposting Order</strong>
            </div>
          </td>
        </tr>
       <tr class="tdH">
          ...
          <td>
            ...
            <select size="1" name="cmbProceed" id="cmbProceed"
              ...
              <%
                ...
                ps1=con.prepareStatement("select distinct REPOST_ORDER_ID,PROCEEDING_NO from HRM_REPOST_ORDERS where REPOST_ISSUE_OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('FR') order by REPOST_ORDER_ID desc");
                ...
                System.out.println("fine");
                    ...
                    out.println("<option value='"+rs.getInt("REPOST_ORDER_ID")+"'>"+rs.getInt("REPOST_ORDER_ID")+"</option>");
                    }
                }
                catch(Exception e)
                {
