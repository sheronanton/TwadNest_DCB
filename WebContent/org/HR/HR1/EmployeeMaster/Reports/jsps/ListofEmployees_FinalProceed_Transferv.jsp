...
<html>
  <head>
    ...
    <title>Employees Transfer Order</title>
    <script type="text/javascript" src="../scripts/ListofEmployees_FinalProceed_Transferv.js"></script>
  ...
  <form name="frmListEmpProceed"  method="POST">
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Generate Final Proceedings for Transfer Order</strong>
            </div>
          </td>
        </tr>
       <tr class="tdH">
          ...
          <td>
            ...
            <select size="1" name="cmbProceed" id="cmbProceed"
              ...
              <%
                ...
                ps1=con.prepareStatement("select distinct transfer_order_id,proceeding_no from HRM_TRANSFER_ORDERS where TRANSFER_ISSUE_OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('FR') order by transfer_order_id desc");
                ...
                System.out.println("fine");
                    ...
                    out.println("<option value='"+rs.getInt("transfer_order_id")+"'>"+rs.getInt("transfer_order_id")+"</option>");
                    }
                }
                catch(Exception e)
                {
        ...
        <tr class="table">
          ...
          <td>
            <div align="left">
             Prefix <input type="text" name="prefix"  id="prefix" size="7"/> <input type="text" name="txtPO" id="txtPO" size="50"/>  Suffix <input type="text" name="suffix"  id="suffix" size="12"/>
            </div>
          </td>
        </tr>
        <tr class="table">
          ...
          <td>
            <div align="left">
              <textarea name="txtRef" id="txtRef"
                        title="Don't type '&' Character while entering data"
                        cols="70" rows="4" onkeypress="return noEnter(event)"></textarea>
            </div>
          </td>
        </tr>
        <tr class="table">
          ...
          <td>
            <div align="left">
              <textarea name="txtPara1" id="txtPara1"
                        title="Don't type '&' Character while entering data"
                        cols="70" rows="6" onkeypress="return noEnter(event)"></textarea>
            </div>
          </td>
        </tr>
        <tr class="table">
        ...
        No
        <input type="radio" name="fsigned" value="N"  checked onclick="checkfwd()"/>
        </td>
        </tr>
        ...
        <td >
         <input type="text" name="fwoffdesig" id="fwoffdesig" maxlength="50"/>
       ...
       <tr  class="table">
        ...
        <td>
        Yes
        <input type="radio" name="signed" value="Y" checked/>
        <!--<input type="radio" name="signed" value="Y" checked onclick="checkfwd1()"/>-->
        No
        <input type="radio" name="signed" value="N" disabled="disabled"/>
        <!--<input type="radio" name="signed" value="N" onclick="checkfwd1()" disabled="disabled"/>-->
        </td>
        </tr>
        <!--<tr  class="table"  id="fwdoff1">
        <td>
