...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/ListofEmployees_Proceed_Deputation_Fair.js"> </script>
        ...
        <tr class="tdH">
          ...
          <tr class="table">
            ...
            <%
                try
                {
                ps=con.prepareStatement("select distinct Proceeding_no from HRM_EMP_RELIEVAL_DETAILS where process_flow_status_id !='FR' and Proceeding_no is not null");
                rs=ps.executeQuery();
                    while(rs.next())
                    {
