...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/ListofEmployees_Proceed_Fair.js"> </script>
  ...
  <form name="frmListEmpProceed"  method="POST">
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong>Generate Final Proceedings</strong>
               </div> 
            </td>
          </tr>
        <tr class="tdH">
      ...
      <td width="30%">
       ...
       <tr class="table">
          ...
          <tr class="table">
            ...
            <td><div align="left"><textarea name="txtRef" readonly id="txtRef"  title="Don't type '&' Character while entering data" cols="50" rows="2" onkeypress="return noEnter(event)"></textarea></div></td>
          </tr>
          <tr class="table">
