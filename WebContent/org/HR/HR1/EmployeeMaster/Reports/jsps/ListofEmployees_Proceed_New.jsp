...
<html>
  <head>
    ...
    <title>ListofEmployees_Proceed</title>
    <script type="text/javascript" src="../scripts/ListofEmployees_Proceed_New.js"> </script>
  ...
  <form name="frmListEmpProceed"  method="POST">
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
            <td colspan="2">
              <div align="center">
                <strong>Generate Draft Proceedings</strong>
               </div> 
            </td>
          </tr>
        <tr class="tdH">
          ...
          <tr class="table">
            ...
            <td>
               ...
               <!-- <input type="text" name="txtPNo" id="txtPNo"  maxlength="50"
                       size="20" />                       -->
                          
            <select size="1" name="cmbProceed" id="cmbProceed" onchange="loadServer('loadEmp')">
            <option value="">--Select Proceedings Number--</option>
            <%
                try
                {
                ps=con.prepareStatement("select distinct Proceeding_no from HRM_EMP_RELIEVAL_DETAILS where process_flow_status_id !='FR' and office_id=? and Proceeding_no is not null");
                ps.setInt(1,oid);
                rs=ps.executeQuery();
                    while(rs.next())
                    {
                    out.println("<option value="+rs.getString("Proceeding_no")+">"+rs.getString("Proceeding_no")+"</option>");
                    }
                }
                catch(Exception e)
                {
      ...
      <td width="30%">
       ...
       <tr class="table">
          ...
          <td>
            ...
            <td>
              <div align="left">
                <input type="text" name="txtPO" id="txtPO"
                       size="50" />                       
              </div>
            </td>
          </tr>
          <tr class="table">
            ...
            <td>
              <div align="left">
                <input type="text" name="txtPODesig" id="txtPODesig" 
                       size="50" />                       
              </div>
            </td>
          </tr>
          ...
          <tr class="table">
            ...
            <td><div align="left"><textarea name="txtRef" id="txtRef" readonly title="Don't type '&' Character while entering data" cols="50" rows="2" onkeypress="return noEnter(event)" readonly></textarea></div></td>
          </tr>
          <tr class="table">
          ...
          <tr class="table">
            ...
            <td>
              <div align="left">
                <textarea name="txtCopy" id="txtCopy"  title="Don't type '&' Character while entering the remarks" cols="40" rows="5" onkeypress="return noEnter(event)"></textarea>
              </div>
            </td>
          </tr>
          <!--tr class="tdH">
        ...
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <input type="submit" name="btnSubmit" value="Generate Report" onclick="return btnsubmit()"/>
               <input type="button" name="button" value="Clear All" onclick="return clearAll()"/>
