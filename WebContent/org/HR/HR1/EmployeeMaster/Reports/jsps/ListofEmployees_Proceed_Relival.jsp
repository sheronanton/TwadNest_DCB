...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/ListofEmployees_Proceed_Relival.js"></script>
  ...
  <form name="frmListEmpProceed"  method="POST">
      ...
      <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
          <td colspan="2">
            <div align="center">
              <strong>Generate Draft Proceedings for Relieval Order</strong>
            </div>
          </td>
        </tr>
       <tr class="tdH">
          ...
          <td>
            ...
            <select size="1" name="cmbProceed" id="cmbProceed"
              ...
              <%
                ...
                ps1=con.prepareStatement("select distinct RELIEVAL_SLNO,PROCEEDING_NO from HRM_EMP_RELIEVAL_ORDER where RELIEVAL_ISSUE_OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('CR','MD') order by RELIEVAL_SLNO desc");
