...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/ListofEmployees_Proceed_Transferv.js"></script>
          ...
          <td>
            ...
            <select size="1" name="cmbProceed" id="cmbProceed"
              ...
              <%
                ...
                ps1=con.prepareStatement("select distinct transfer_order_id,proceeding_no from HRM_TRANSFER_ORDERS where TRANSFER_ISSUE_OFFICE_ID=? and PROCESS_FLOW_STATUS_ID in ('CR','MD') order by transfer_order_id desc");
