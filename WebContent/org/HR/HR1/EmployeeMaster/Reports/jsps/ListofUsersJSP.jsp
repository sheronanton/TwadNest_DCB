...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/ListofUsersJS.js"></script>
  ...
  <body><form name="frmEmployeeDetailRep" method="POST" action="">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> List of User Accounts</strong></td>
                </tr>
                <tr>
            ...
            <tr>
             ...
             <td colspan="2" align="left" valign="top" class="table">
              <div align="center">
                <table border="0" width="100%">
                  <tr>
                    <td colspan="2" class="tdH">Account Type</td>
                  </tr>
                  <tr>
                    <td colspan="2" class="table" align="left">
                      <div onclick="document.frmEmployeeDetailRep.optaccounttype[0].checked=true;"
                           style="cursor:hand">
                        <input type="radio" name="optaccounttype" value="active" checked></input>Active Users
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td colspan="2" class="table" align="left">
                      <div onclick="document.frmEmployeeDetailRep.optaccounttype[1].checked=true;"
                           style="cursor:hand">
                        <input type="radio" name="optaccounttype"  value="deactive"></input>Deactivated Users
                      </div>
                    </td>
                  </tr>
