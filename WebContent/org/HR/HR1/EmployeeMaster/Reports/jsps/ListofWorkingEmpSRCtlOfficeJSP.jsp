...
<html>
  <head>
   ...
   <title> List of Working Employees &amp; SR Controlling Office</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/ListofWorkingEmpSRCtlOfficeJS.js"></script>
  ...
  <body><form name="frmSRCTRLofficeRep" method="POST" action="">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> List of Working Employees &amp; SR Controlling Office</strong></td>
                </tr>
                <tr>
