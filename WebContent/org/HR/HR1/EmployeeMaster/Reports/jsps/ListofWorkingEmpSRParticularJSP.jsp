...
<html>
  <head>
    ...
    <title> SR Particulars of All Employees in Specific Offices</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/ListofWorkingEmpSRParticularJS.js"></script>
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> SR Particulars of All Employees in Specific Offices</strong></td>
                </tr>
                <tr>
