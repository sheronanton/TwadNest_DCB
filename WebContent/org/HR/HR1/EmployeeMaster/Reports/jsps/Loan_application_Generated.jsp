...
<html>
  <head>
    ...
    <title> Loan Application Generated - Month Wise</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/Loan_application_Generated.js"></script>
  ...
  <body onload="Loadspec();"><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../Loan_application_Generated" >
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center" ><strong>Loan Application Generated - Month Wise Count</strong></td>
                </tr>
                 <tr>
                          <td colspan="2" class="tdH">Selection of Office Jurisdiction</td>
                </tr>
               <tr> 
               <td colspan="2" class="tdH"><input type="radio" name="rad_all" id="rad_all" value="All" checked="checked" onclick="Loadspec();"></input>All
                      <input type="radio" name="rad_all" id="rad_spec" value="sp" onclick="UnloadSp();"></input>Specific</td> 
                     </tr>
                  ...
                  <tr>
                    <td colspan="2" class="table" align="left">
                      <div onclick="document.frmEmployeeDetailRep.optoutputtype[0].checked=true;"
                           style="cursor:hand">
                        <input type="radio" value="pdf" name="optoutputtype" checked></input>PDF
                                                                         Format
                      </div>
                    </td>
                  </tr>
