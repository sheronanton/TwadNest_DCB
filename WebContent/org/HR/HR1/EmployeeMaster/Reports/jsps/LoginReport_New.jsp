...
<html>
  <head>
    ...
    <title>List of Users Currently Logged-in</title>
    <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <link href="../../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/> 
    <link href="../../../../../../css/Sample3.css" rel='stylesheet' media='screen'/>
    
    <!--<script type="text/javascript" src="../../scripts/CalendarControl.js"></script>-->
    <script type="text/javascript" src="../scripts/LoginReport_New.js"></script>
  ...
  <body class="table">
  <form action="../../../../../../LoginReportServ_New.rep"   name="frmReport" method="post" onsubmit="return nullcheck()">
      <table border="1" cellspacing="2" cellpadding="1" width="100%">
        <tr>
          <td class="tdH">
            <center>
              <b>List of Users Currently Logged-in </b>
            </center>
          </td>
        </tr>
        <tr>
