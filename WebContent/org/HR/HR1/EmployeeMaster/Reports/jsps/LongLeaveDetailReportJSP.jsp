...
<html>
 ...
 <script type="text/javascript"
    ...
    <script type="text/javascript"
            src="../scripts/LongLeaveDetailReportJS.js"></script>
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> Long Leave Detailed Report</strong></td>
                </tr>
                <tr>
