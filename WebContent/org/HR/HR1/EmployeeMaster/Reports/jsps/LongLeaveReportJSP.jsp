...
<script type="text/javascript" src="../scripts/LongLeaveReportJS.js">    </script>
  ...
  <form name="LongLeaveReport"
              action="../../../../../LongLeaveReportServ"
              method="POST">
      <div align="center">
        ...
        <tr class="table">
          <td>
            <div align="left">
              Date on<font color="#e70000">&nbsp;</font>(dd/mm/yyyy) 
