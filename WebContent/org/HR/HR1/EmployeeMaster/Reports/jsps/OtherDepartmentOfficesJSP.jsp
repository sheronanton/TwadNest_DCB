...
<html>
  <head>
    ...
    <title>Other Departments List</title>
     <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
     <!--script type="text/javascript" src="../../../../../org/Library/scripts/checkDate.js"></script -->
    <script language="javascript" type="text/javascript" src="../scripts/OtherDepartmentOffices.js"></script>
...
for(var i=year;i<endyear;i++)
  ...
  <body class="table" >
  <form name="frmOtherDeptList" method="POST">
   <%
  Connection con=null;
  ...
  <table cellspacing="2" cellpadding="3" width="100%" >
      ...
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>Other Departments Summary</strong>
          </div>
        </td>
      </tr>
    </table>
     <div>
            ...
            <tr class="table">
                <td> <input type="radio" name="optselect"  onclick="selectoption1()"
                             id="optselect2" value="All" checked>All Other Departments</input></td>
                <td><input type="radio" name="optselect"  onclick="selectoption1()"
                             id="optselect3" value="Specific">Specific Other Department</input></td>
            </tr>
             
              <tr class="table" id="divcadre" style="display:none;">
                  <td colspan='2'>
                    <div align="left">
                    <select name="cmbsgroup2" id="cmbsgroup2" onchange="getOffices()">
                <option value="0">Select Department</option>
                <%
            rs=null;
           try
           {
           ps=con.prepareStatement("select other_dept_id,other_dept_name from hrm_mst_other_depts order by other_dept_id");
            rs=ps.executeQuery();
              String strcode="";
            String strname="";          
            while(rs.next())
                    ...
                    <select size="1" name="cmbCadreName" id="cmbCadreName" tabindex="1">
                     <option value="0"> Select Cadre Name </option>
                      ...
                      try{
                                           ...
                                           //out.println("<frmOtherDeptList value="+0+">"+"-- Select Account Unit --"+"</frmOtherDeptList>");
         ...
         <!--     <tr class="table">
              ...
              <tr class="table">
                       ...
                       <td align="left"><select name="cmbReportType">
                            ...
                            <!--  <frmOtherDeptList value="TXT">TXT</frmOtherDeptList>-->
