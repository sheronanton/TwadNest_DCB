...
<script type="text/javascript" src="../scripts/RelievalTransferReportJs.js">    </script>
  ...
  <form name="RelievalTransferReport"
              action="../../../../../RelievalTransferReportServ.rep"
              method="POST">
      <div align="center">
        <table cellspacing="2" cellpadding="3" border="1" width="100%">
        <tr class="tdH">
            <td colspan="2" align="center"><b>Relieval Transfer Report</b></td>
        </tr>
         <tr class="table">
        ...
        <tr class="table">
          <td>
            <div align="left">
              Relival Transfer Date on<font color="#e70000">&nbsp;</font>(dd/mm/yyyy) 
