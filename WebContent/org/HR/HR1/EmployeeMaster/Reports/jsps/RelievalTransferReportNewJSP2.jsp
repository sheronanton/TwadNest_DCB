...
<html>
  <head>
   ...
   <title> Relieval Transfer Report</title>
 ...
 <script type="text/javascript"
    ...
    <script type="text/javascript"
            src="../scripts/RelievalTransferReportNewJs1.js"></script>
  ...
  <body>
  <form name="RelievalTransferReport" method="POST" action="">
      ...
      <div align="center">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center"><strong> Relieval Transfer Report</strong></td>
                </tr>
                <tr>
        ...
        <%}%>
                  ...
                  <td class="table">
                    ...
                    <input type=checkbox name="aggid" id=aggid value="Y" checked="checked">Aggregate Subdivision
                    </div>
                  </td>
                </tr>
          ...
          <td>
            <div align="left">
              Deputation Date From<font color="#e70000">&nbsp;</font>(dd/mm/yyyy) 
            ...
            <div align="left">
             <input type="text" name="txtDateFrom" id="txtDateFrom"
                      ...
                      <img id="fromimg" src="../../../../../../images/calendr3.gif"
                           onclick=" showCalendarControl(document.RelievalTransferReport.txtDateFrom);"
         ...
         <tr class="table">
          <td>
            <div align="left">
              Deputation Date To<font color="#e70000">&nbsp;</font>(dd/mm/yyyy) 
              <font color="#e70000">*</font>
            </div>
          </td>
          <td>
            <div align="left">
             <input type="text" name="txtDateTo" id="txtDateTo"
                      ...
                      <img id="toimg" src="../../../../../../images/calendr3.gif"
                           onclick="showCalendarControl(document.RelievalTransferReport.txtDateTo);"
                           alt="Show Calendar"></img>
            </div>
          </td>
        </tr>  
          ...
          <tr>
            <td colspan="2" class="tdH" align="center"><input type="button" value="Submit" onclick="frmsubmit()"><input type="button" id="cmdcancel" name="cancel" value="Cancel" onclick="self.close();"> </td>
          </tr>
        </table>
      </div>
    </form></body>
