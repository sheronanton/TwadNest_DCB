...
<html>
  <head>
    ...
    <title> Retirement Projection Report - Year Wise</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
       <script type="text/javascript"
            src="../../../../../../org/Library/scripts/checkDate.js"></script>
            
    <script type="text/javascript"
            src="../scripts/Retire_Cadre_5yearsJS_New.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../Retire_Cadre_5years_serv_New">
      ...
      <div align="center">
        <table border='2' width="100%">
            <tr>
              <td colspan='2' class="tdH" align="center"><strong> Retirement Projection Report - Year Wise</strong></td>
            </tr>
         ...
         <tr>
          ...
          <tr>
            ...
            <input type="submit" value="Submit" onclick="return frmsubmit();">
