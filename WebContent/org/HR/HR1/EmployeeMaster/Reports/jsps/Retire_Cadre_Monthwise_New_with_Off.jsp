...
<html>
  <head>
   ...
   <script type="text/javascript" src="../../scripts/CalendarControl_before.js"></script>
    <script type="text/javascript"
            src="../scripts/Retire_Cadre_MonthwiseJS_New_with_off.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" id="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../Retire_Cadre_Monthwise_New_Serv">
      ...
      <div align="center">
       ...
       <tr class="table">
                  ...
                  <td class="table" align="left">
                    ...
                    %>
                     ...
                     <div id="divallofficelevel" style="cursor:hand">                          
                      ...
                      <input type="radio" name="rad_off" id="ho_only" value="hoonly" onclick="selectoption2()"></input>HO
          ...
          <tr>
            ...
            <td colspan="2" align="left"><input type="checkbox" name="allhier" id="allhier" disabled="disabled" value="include">Include all Offices down the Hierarchy</td>
          </tr>
                  <tr>
