...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/RetirementList1_JS.js"></script>
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Retirement List</strong></td>
                </tr>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="txtfromdate" id="txtfromdate"
                         ...
                         onblur="return checkdat(); if(checkcurdt(this)==true)return checkdt1(this);"
                ...
                <td>
                  <input type="text" name="txttodate" id="txttodate"
                         onkeypress="return  calins(event,this)"
                         onblur="return checkdat1(); if(checkcurdt(this)==true)return checkdt1(this);"
                         onfocus="javascript:vDateType='3'" maxlength="10"/>
                  <img src="../../../../../../images/calendr3.gif"
