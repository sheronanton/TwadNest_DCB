...
<html>
  <head>
    ...
    <title> List of Employees Due for Retirement</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
          <link href="../../../../../../css/CalendarControl.css" rel="stylesheet" media="screen"/>
          <script type="text/javascript" src="../../../../../../org/Library/scripts/checkDate.js"></script> 
   <script type="text/javascript" src="../../scripts/CalendarControl.js"></script>
    <script type="text/javascript"
            src="../scripts/RetirementList1_New_all2_with_off.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" id="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../RetirementList1_Serv1_all_with_off">
      ...
      <div align="center">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> List of Employees Due for Retirement</strong></td>
                </tr>
               <tr>
        ...
        <td >       
              <input type="radio" value="RadAl" name="optselectgrp" id="chkone" checked="checked" onclick="hidedesig()">
               ...
               Specific Designation / Cadre / Rank               
       </td>   
       ...
       <tr class="table" id="divselect" style="display:none">                  
        ...
        %>
                  ...
                  <td class="table" align="left">
                    ...
                    %>
                     ...
                     <div id="divallofficelevel" style="cursor:hand">                          
                      <input type="radio" name="rad_off" id="rad_ho" value="ho" checked="checked" onclick="selectoption2()"></input>All Office
                      <input type="radio" name="rad_off" id="rad_reg" value="rg" onclick="selectoption2()"></input>Specific Region
          ...
          <tr class=table id="divallhier" style="display:block">
            <td colspan=2 align=left><input type="checkbox" name="allhier" id="allhier" disabled="disabled" value="include">Include all Offices down the Hierarchy</input></td>
          </tr>
          <tr>
                <td >From Date:
          ...
          <tr>
            <td colspan="2" class="tdH" align="center"><input type="button" value="Submit" onclick="nullcheck()">
