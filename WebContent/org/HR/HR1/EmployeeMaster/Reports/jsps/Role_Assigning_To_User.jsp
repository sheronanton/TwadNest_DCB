...
<html>
  <head>
    ...
    <script type="text/javascript"
            src="../scripts/Role_Assigning_To_User.js"></script>
  ...
  <body ><form   name="frmValidationSummaryRep" method="POST" 
          ...
          <tr>
            <td  align="left" valign="top" class="table" width="100%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td  class="tdH" align="center" colspan=3><strong>  Roles Assigning by Template</strong></td>
                </tr>
      ...
      <tr>
           ...
           <tr class="tdH">              
               ...
               <tr class="tdH">
                 <td align="left" valign="top" >
                        <select name="URoles" id="URoles" size="10" multiple>
                        </select>
                 </td>
               </tr>
         ...
         <tr>
            ...
            <td  class="tdH" align="center" colspan=4><input type="button" value="Submit" onclick="frmrolesubmit()">
