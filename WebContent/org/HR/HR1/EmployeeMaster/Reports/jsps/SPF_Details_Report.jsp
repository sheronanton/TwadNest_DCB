...
<html>
  <head>
    ...
    <title> Detail report of Employees subscribed to SPL. P.F</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/SPF_Details_Report.js"></script>
  ...
  <body><form name="SPF_Details_Report" method="POST" 
                       >
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong>Detail report of Employees subscribed to SPL. P.F</strong></td>
                </tr>
