...
<html>
  <head>
    ...
    <title> service Records Entry Pending Report</title>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../ServiceRecord_Pending_ReportServ.av">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong>Employees for Whom service Records Entry Pending Report</strong></td>
                </tr>
