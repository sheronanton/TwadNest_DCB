...
<html>
  <head>
    ...
    <title> Test List of Working Employees & SR Controlling Office</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/Test_ListofWorkingEmpSRCtlOfficeJS_NewInt.js"></script>
  ...
  <body><form name="frmValidationSummaryRep" method="POST" 
                       action="../../../../../../Test_ListofWorkingEmpSRCtlOfficeServ_NewInt">
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan='2' class="tdH" align="center"><strong> Test List of Working Employees & SR Controlling Office</strong></td>
                </tr>
                  ...
                  <td class="table" align="left">
                   ...
                   <%  if(offlevel.equalsIgnoreCase("HO") || profile.equalsIgnoreCase("other"))
                     ...
                     <div id="divallofficelevel" style="cursor:hand">                          
                      ...
                      <input type="radio" name="rad_off" id="rad_aw" value="aw" onclick="selectoption2()"></input>Audit Wing
                      ...
                      <table border="0" width="100%">
                        <tr>
                          ...
                          <td>
                           ...
                           <td>
                            <div id="divauditwing" style="display:none">Audit Wing</div>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <table border="0" cellpadding="0" cellspacing="0"
                              ...
                              <tr>
                                <td>
                                  <select name="cmbauditwing" id="cmbauditwing"
                                          style="display:none;width:100%"
                                          onclick="getAuditWing('null')">
                                    <option>Select the Audit Wing</option>
                                  </select>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <div class="scroll" id="diviframeauditwing">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                                </td>                               
                              </tr>
                            </table>
                          </td>
