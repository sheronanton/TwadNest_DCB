...
<html>
  <head>
    ...
    <title>List of Users and Roles (Excluding Individual Role users)</title>
      <script type="text/javascript" src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>

    <script type="text/javascript"
            src="../scripts/UnRoleEmp_Report_individual.js"></script>
          ...
          <tr>
            <td colspan="2" align="left" valign="top" class="table" width="60%">
              <table border="0" width="100%">
                ...
                <tr>
                  <td colspan="2" class="tdH" align="center">List of Users and Roles (Excluding Individual Role users)</td>
                </tr>
                <tr>
