...
<html>
  <head>
    <title>Employee Profile with SR and Photo</title>
    <script type="text/javascript"
            src="<%=request.getContextPath()%>/org/Library/scripts/comJS.js"></script>
    <script type="text/javascript" src="../scripts/db_Employee_ProfileJS_SR_punishment.js"></script>
    <link href="../../../../../../css/Sample3.css" rel="stylesheet"
          media="screen"/>
   </head>
  <body id="bodyid"><!--form name="frmEmployeeProfile" id="frmEmployeeProfile"
                  action="../../../../../../db_EmployeeProfileServSR" method="POST"-->
              ...
              <table cellspacing="2" cellpadding="3" border="1" width="100%">
                <tr class="tdH">
                  <th align="center" colspan="2">
                    <b>Employee Profile with Punishment  Details</b>
                  </th>
                </tr>
                <tr class="table">
                  <td>
                  ...
                  <td>
                    <div align="left">
                    <input tabindex="1" type="text" name="txtEmpId1" maxlength=5 size="5"
