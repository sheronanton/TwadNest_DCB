...
function reloadInfo(id)
{
	var txtemp=id;
	//alert(txtemp);
	var url="viewServiceParticular_with_photo.jsp?txtEmpId="+txtemp;
...
function reloadInfoNew(id)
{
	var txtemp=id;
	//alert(txtemp);
	var url="../Reports/jsps/viewServiceParticular_with_photo.jsp?txtEmpId="+txtemp;
	window.location.href=url;
}
...
if (winemp && winemp.open && !winemp.closed) winemp.close();
  ...
  <%
    ...
    if(request.getParameter("txtEmpId")!=null)
    {
        ...
        try{
                String sql="SELECT a.EMPLOYEE_NAME, " +
                		"  a.EMPLOYEE_INITIAL, " +
                		"  a.GPF_NO, " +
                		"  a.DATE_OF_BIRTH, " +
                		"  a.GENDER, " +
    ...
    <table border="1px" width="90%" align="center">
              ...
              <tr>
                ...
                <td  valign="center">
                  <table border="0" align="left">
                    <tr>
                      <td>
                        <input tabindex="1" type="text" name="txtEmpId"  id="txtEmpId" size="5"maxlength="5" value="<%=strEmpId%>"
                               onkeypress="return  numbersonly1(event,this)"  onchange="reloadInfo(this.value);"></input>
          ...
          <tr  id="wing" >
            ...
            <!--  <tr>
              ...
              <tr class="tdH"><th> <b><font face="Tahoma" color="#000000" size="2">S.No</font></b></th><th> <b><font face="Tahoma" color="#000000" size="2">Designation</font></b></th><th> <b><font face="Tahoma" color="#000000" size="2">Office Name</font></b></th><th> <b><font face="Tahoma" color="#000000" size="2">Date Effective From</font></b></th></tr>
              <%
              try
              {
...
"ORDER BY slno";
              ...
              <td colspan="2">
              <table width="100%" border="1" >
              <tr class="tdH"><th> <b><font face="Tahoma" color="#000000" size="2">S.No</font></b></th><th> <b><font face="Tahoma" color="#000000" size="2">Date From</font></b></th><th> <b><font face="Tahoma" color="#000000" size="2">Date To</font></b></th><th> <b><font face="Tahoma" color="#000000" size="2">Designation</font></b></th><th> <b><font face="Tahoma" color="#000000" size="2">Office Name</font></b></th><th> <b><font face="Tahoma" color="#000000" size="2">Status</font></b></th></tr>
              <%
              try
              {
            	  String s="SELECT A.EMPLOYEE_ID, " +
            			  ...
            			  "  AND A.PROCESS_FLOW_STATUS_ID ='FR' " +
            			  "  )A " +
            			  ...
            			  "ON d.other_dept_id        =a.office_dept_id " +
            			  "AND d.OTHER_DEPT_OFFICE_ID=a.Office_Id  " +
            			  "ORDER BY date_from_order";
            	  ...
            	  {
            		  a++;
            		  out.println(" <tr  ><td>"+a+"</td><td>"+rs.getString("DATE_FROM")+"</td><td>"+rs.getString("DATE_TO")+"</td><td>"+rs.getString("DESIGNATION")+"</td><td>"+rs.getString("OFFICE_NAME")+"</td><td>"+rs.getString("EMPLOYEE_STATUS_DESC")+"</td></tr>");
            	  }
