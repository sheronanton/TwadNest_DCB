 ...
 function getOfficesByLevel()
    {
        ...
        var level=document.DeputationReport.cmbControllingLevel.options[document.DeputationReport.cmbControllingLevel.selectedIndex].value;
        var levelt=document.DeputationReport.cmbControllingLevel.options[document.DeputationReport.cmbControllingLevel.selectedIndex].text;
       
        
        document.DeputationReport.chkall.checked=false;
        ...
        if(level=="DN" || level=="SD" || level=="SN" )
        {
            ...
            document.DeputationReport.cmbOfficeType.focus();      
    ...
    function loadOfficesByLevel(level)
    {
        ...
        startwaiting(document.DeputationReport);
        //alert('hai');
        var url="../../../../../../DeputationReportServ.view?Command=level&level="+level;
 ...
 function getOfficesByType()
    {
        ...
        items1=null;
         ...
         items5=null;
         items6=null;
        var own=document.DeputationReport.cmbOfficeType.options[document.DeputationReport.cmbOfficeType.selectedIndex].value;
        if(own=="0")
        {
             var cmbpage=document.getElementById("cmbpage");
        ...
        {
                var level=document.DeputationReport.cmbControllingLevel.options[document.DeputationReport.cmbControllingLevel.selectedIndex].value;
                var url="../../../../../../DeputationReportServ.view?Command=own&level="+level+"&own="+own;
                var req=getTransport();
                req.open("GET",url,true);        
                req.onreadystatechange=function()
                {
    ...
    function loadTable(req)
{
        ...
        if(req.readyState==4)
        {
          ...
          { 
               ...
               stopwaiting(document.DeputationReport);
...
function loadPage(page)
{
            ...
            document.DeputationReport.cmbpage.selectedIndex=page-1;
...
function btncancel()
{
 ...
 document.DeputationReport.cmbControllingLevel.selectedIndex=0;
 var tbody=document.getElementById("tb");
                try{tbody.innerHTML="";}
                          catch(e) {tbody.innerText="";}
}
...
if(v && items5)
{
        ...
        else
        {
            ...
            document.DeputationReport.txtseloff.value=s.substring(0,s.length-1);
            document.DeputationReport.action="../../../../../../DeputationReportServ.view";
          document.DeputationReport.method="POST";
          document.DeputationReport.submit();
            return true;
        }
...
{
//alert('hai');
var page=document.DeputationReport.cmbpage.value;
...
function sellectall()
{
        ...
        if(v && items5)
        {
            if(document.DeputationReport.chkall.checked==true)
            {
                for(i=0;i<items5.length;i++)
                {
                        items5[i]=true;
...
function changepagesize()
{
           ...
           __pagination=document.DeputationReport.cmbpagination.value;
            var v=document.getElementsByName("sel");
            //alert(v);
        if(v && items5)
        {
