...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmDeputationRep.cmbolevel.options[document.frmDeputationRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../DeputationReportNewServ.rep?OLevel=region" ;
     // alert(url);
      ...
      if(document.frmDeputationRep.chkregion)
      {
               if(document.frmDeputationRep.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../DeputationReportNewServ.rep?OLevel=circle&regions="+region;
                              // document.frmDeputationRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
            ...
            if(document.frmDeputationRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                               ...
                               // alert(divisionflag);
                                ...
                                var url="../../../../../../DeputationReportNewServ.rep?OLevel=division&circles="+circle;
                              // document.frmDeputationRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
...
{
    //alert('submit');
        var url="../../../../../../DeputationReportNewServ.rep?OLevel=submit" ;
    ...
    document.frmDeputationRep.action="../../../../../../DeputationReportNewServ.rep";
