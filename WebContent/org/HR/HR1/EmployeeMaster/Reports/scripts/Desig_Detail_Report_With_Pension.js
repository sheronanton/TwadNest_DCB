...
function frmsubmit()
{
	//alert('inside submit');
	 if(val()){
		 if(checkboxVal()){
    //alert('inside submit');chkdesig  desType  cmbsgroup
        var url="../../../../../../Desig_Detail_Report_With_Pension?OLevel=submit";
    ...
    document.frmValidationSummaryRep.action="../../../../../../Desig_Detail_Report_With_Pension";
...
if(document.frmValidationSummaryRep.chkdesig)
     ...
     // alert("1");
              ...
              //alert("2");
                            ...
                            var url="../../../../../../Desig_Detail_Report_With_Pension?desigs="+desig;
                            //alert(url);
                            }
               }
        }  
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../Desig_Detail_Report_With_Pension?OLevel=offtype" ;
         //alert(url);
