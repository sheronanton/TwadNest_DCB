...
function frmsubmit()
{
	...
	if(val()){
		if(checkboxVal()){
        var url="../../../../../../Desig_Summary_ReportServ?OLevel=submit";
    ...
    document.frmValidationSummaryRep.action="../../../../../../Desig_Summary_ReportServ";
...
if(document.frmValidationSummaryRep.chkdesig)
     ...
     // alert("1");
              ...
              //alert("2");
                            ...
                            var url="../../../../../../Desig_Summary_ReportServ?desigs="+desig;
                            //alert(url);
                            }
               }
        }  
...
if(document.frmValidationSummaryRep.chkdesig)
      ...
      //alert("1");
        ...
        //      alert("2");
                            ...
                            var url="../../../../../../Desig_Summary_ReportServ?ranks="+rank;
                            }
               }
        }  
...
if(document.frmValidationSummaryRep.chkcadre)
      ...
      //alert("1");
             ...
             // alert("2");
                            ...
                            var url="../../../../../../Desig_Summary_ReportServ?cadres="+cadre;
                            }
               }
        }  
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../Desig_Summary_ReportServ?OLevel=offtype" ;
         //alert(url);
