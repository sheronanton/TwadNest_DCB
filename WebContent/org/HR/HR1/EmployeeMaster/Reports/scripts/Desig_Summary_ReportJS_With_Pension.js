...
function frmsubmit()
{
	...
	if(val()){
		if(checkboxVal()){
        var url="../../../../../../Desig_Summary_ReportServ_With_Pension?OLevel=submit";
    ...
    document.frmValidationSummaryRep.action="../../../../../../Desig_Summary_ReportServ_With_Pension";
...
if(document.frmValidationSummaryRep.chkdesig)
     ...
     // alert("1");
              ...
              //alert("2");
                            ...
                            var url="../../../../../../Desig_Summary_ReportServ_With_Pension?desigs="+desig;
                            //alert(url);
                            }
               }
        }  
...
if(document.frmValidationSummaryRep.chkdesig)
      ...
      //alert("1");
        ...
        //      alert("2");
                            ...
                            var url="../../../../../../Desig_Summary_ReportServ_With_Pension?ranks="+rank;
                            }
               }
        }  
...
if(document.frmValidationSummaryRep.chkcadre)
      ...
      //alert("1");
             ...
             // alert("2");
                            ...
                            var url="../../../../../../Desig_Summary_ReportServ_With_Pension?cadres="+cadre;
                            }
               }
        }  
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../Desig_Summary_ReportServ_With_Pension?OLevel=offtype" ;
         //alert(url);
