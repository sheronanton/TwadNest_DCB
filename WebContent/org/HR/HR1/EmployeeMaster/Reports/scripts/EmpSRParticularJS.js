...
function servicepopupSR()
{
    ...
    if (winemp && winemp.open && !winemp.closed) 
    {
     ...
     //   alert('test');     
    winemp= window.open("../../../../../../org/HR/HR1/EmployeeMaster/jsps/EmpPopupHierCtrlOfficeJSP.jsp","Employeesearch","status=1,height=500,width=600,resizable=YES, scrollbars=yes"); 
    winemp.moveTo(250,250);  
    winemp.focus();
...
function callServer(command,param)
{
      if(command=="Existg")
       ...
       startwaiting(document.frmEmployeeProfile) ; 
          url="../../../../../../EmpSRParticularServ.rep?Command=Existg&EmpId=" + strEmpId;
...
function btnsubmit()
{
        ...
        if(c==true)
        {
              document.frmEmployeeProfile.action="../../../../../../EmpSRParticularServ.rep";
