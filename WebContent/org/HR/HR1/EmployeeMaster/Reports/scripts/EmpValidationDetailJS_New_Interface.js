                            ...
                            if(region!="")
                            {
                              // alert("inside 1");
                               ...
                               // alert("region1..."+region);
                                ...
                                var url="../../../../../../EmpValidationDetailServ_New_Interface?OLevel=circle&regions="+region;
                             //   alert(url);
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
...
function frmsubmit()
{
    ...
    //alert('inside submit');
        var url="../../../../../../EmpValidationDetailServ_New_Interface?OLevel=submit";
    ...
    document.frmValidationSummaryRep.action="../../../../../../EmpValidationDetailServ_New_Interface";
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../EmpValidationDetailServ_New_Interface?OLevel=offtype" ;
         //alert(url);
