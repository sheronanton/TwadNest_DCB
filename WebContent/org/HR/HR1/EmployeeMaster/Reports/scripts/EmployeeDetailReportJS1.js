...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmEmployeeDetailRep.cmbolevel.options[document.frmEmployeeDetailRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../EmployeeDetailReportServ2.rep?OLevel=region" ;
     // alert(url);
      ...
      if(document.frmEmployeeDetailRep.chkregion)
      {
               if(document.frmEmployeeDetailRep.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../EmployeeDetailReportServ2.rep?OLevel=circle&regions="+region;
                              // document.frmEmployeeDetailRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
            ...
            if(document.frmEmployeeDetailRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                               ...
                               // alert(divisionflag);
                                ...
                                var url="../../../../../../EmployeeDetailReportServ2.rep?OLevel=division&circles="+circle;
                              // document.frmEmployeeDetailRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
...
{
    //alert('submit');
    //if(optview=document.frmEmployeeDetailRep.optview[1].checked==true)
    
       
        var url="../../../../../../EmployeeDetailReportServ2.rep?OLevel=submit" ;
    ...
    document.frmEmployeeDetailRep.action="../../../../../../EmployeeDetailReportServ1.rep";
