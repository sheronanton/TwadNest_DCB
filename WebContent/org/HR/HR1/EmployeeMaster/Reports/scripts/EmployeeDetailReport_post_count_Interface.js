...
document.frmValidationSummaryRep.action="../../../../../../EmployeeDetailReport_post_count_Interface";
...
function frmsubmit()
{
    ...
    //alert('inside submit');
        var url="../../../../../../EmployeeDetailReport_post_count_Interface?OLevel=submit";
...
function frmsubmit_Vacancy_aadhar()
{
  

        var url="../../../../../../Employee_Vacancy_Aadhar_Report?OLevel=submit";
    ...
    document.frmValidationSummaryRep.action="../../../../../../Employee_Vacancy_Aadhar_Report?command=vacancy";
    document.frmValidationSummaryRep.submit();
   /* var req=getTransport();
    req.open("POST",url,false);  
    req.send(null);*/
...
function aadhar_count()
{
    ...
    document.frmValidationSummaryRep.action="../../../../../../Employee_Vacancy_Aadhar_Report?command=Aadhar";
    document.frmValidationSummaryRep.submit();
   /* var req=getTransport();
    req.open("POST",url,false);  
    req.send(null);*/
