...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../EmployeeDetailsReportServ_New?OLevel=region" ;
     // alert(url);
      ...
      if(document.frmValidationSummaryRep.chkregion)
      {
               if(document.frmValidationSummaryRep.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../EmployeeDetailsReportServ_New?OLevel=circle&regions="+region;
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
      ...
      if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../EmployeeDetailsReportServ_New?OLevel=division&circles="+circle;
...
{
    //alert('submit');
        var url="../../../../../../EmployeeDetailsReportServ_New?OLevel=submit" ;
    ...
    document.frmValidationSummaryRep.action="../../../../../../EmployeeDetailsReportServ_New";
