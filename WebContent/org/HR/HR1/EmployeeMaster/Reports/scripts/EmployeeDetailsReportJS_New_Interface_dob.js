...
function getRegion()
    {
      //  alert(regionflag);
        ...
        if(regionflag==true)
        {
         ...
         var url="../../../../../../ListofWorkingEmpSRCtlOfficeServ_New_Interface?OLevel=region" ;
       // alert(url);
...
//         }   
      ...
      //alert("hello");
         ...
         if(divisionflag==true && div=='null')
        {
          ...
          var url="../../../../../../ListofWorkingEmpSRCtlOfficeServ_New_Interface?OLevel=division&circles="+circle+"&offtype="+offtype+"&regions="+region;
          //alert("url"+url);
                                var req=getTransport();
                                req.open("GET",url,true);      
                                req.onreadystatechange=function()
                ...
                else
                {
                                      ...
                                      region=region.substring(0,region.length-1);
                                      circle=null; 
                                      var url="../../../../../../ListofWorkingEmpSRCtlOfficeServ_New_Interface?OLevel=division&regions="+region+"&offtype="+offtype+"&circles="+"nocircle";
                                       // alert(url);
                                      // document.frmValidationSummaryRep.cmbregion.focus();
                                        var req=getTransport();
                                        req.open("GET",url,true);  
...
function frmsubmit()
{
  ...
  //  alert('inside submit');
   ...
   //alert(url);
    ...
    document.frmValidationSummaryRep.action="../../../../../../EmployeeDetailsReportServ_New_Interface_dob?"+url;
...
function frmqualsubmit()
{
	  ...
	  //  alert('inside submit');
	   ...
	   //alert(url);
	    ...
	    document.frmValidationSummaryRep.action="../../../../../../EmployeeDetailsQualification?"+url;
	    document.frmValidationSummaryRep.submit();
	   /* var req=getTransport();
	    req.open("POST",url,false);  
	    req.send(null);*/
...
function frmnewsubmit(){
	  ...
	  //  alert('inside submit');
	   ...
	   //alert(url);
	    ...
	    document.frmValidationSummaryRep.action="../../../../../../Emp_bday_spec_month?month="+bmonth+url+"&month_val="+y[x].text;
	    document.frmValidationSummaryRep.submit();
	   /* var req=getTransport();
	    req.open("POST",url,false);  
	    req.send(null);*/
...
function getdesig()
{
   ...
   //var url="../../../../../../EmpServicePopupServ.view?Command=SGroup&cmbsgroup=" + type ;
   var url="../../../../../../DesigCadRankServ_New?Command=getdesig" ;
   //alert(url);
    var req=getTransport();
    var req=getTransport();
    req.open("GET",url,true);        
