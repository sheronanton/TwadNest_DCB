...
function getRegion()
    {
        ...
        if(regionflag==true)
        {
         ...
         var url="../../../../../../EmployeeServiceReport_Interface?OLevel=region" ;
        //alert(url);
                            ...
                            if(region!="")
                            {
                              // alert("inside 1");
                               ...
                               // alert("region1..."+region);
                                ...
                                var url="../../../../../../EmployeeServiceReport_Interface?OLevel=circle&regions="+region;
                             //   alert(url);
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
      ...
      if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../EmployeeServiceReport_Interface?OLevel=division&circles="+circle+"&offtype="+offtype+"&regions="+region;
                             //alert(url);
                ...
                else
                {
                             ...
                             if(document.frmValidationSummaryRep.chkcircle.checked==true)
                             {
                                      ...
                                      //  var url="../../../../../../ListofEmpValidationSummaryServ.rep?OLevel=division&circles="+circle;
                                     offtype=offtype.substring(0,offtype.length-1); 
                                      var url="../../../../../../EmployeeServiceReport_Interface?OLevel=division&circles="+circle+"&offtype="+offtype;
...
function frmsubmit()
{
    ...
    //alert('inside submit');
        var url="../../../../../../EmployeeServiceReport_Interface?OLevel=submit";
       ...
       // }
        ...
        if(document.frmValidationSummaryRep.order[0].checked==true)
        	url=url+"&order=OFFICE_WISE";
        else
        {
        	if(document.frmValidationSummaryRep.service.value=="")
        	{
        		alert("Select Order");
        		return;
        	}
        	else
        		url=url+"&order="+document.frmValidationSummaryRep.service.value;
        }
      
        if(document.frmValidationSummaryRep.order_desc[0].checked==true)
        	url=url+"&order_desc=asc";
        else
        	url=url+"&order_desc=desc";
    ...
    document.frmValidationSummaryRep.action="../../../../../../EmployeeServiceReport_Interface";
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../EmployeeServiceReport_Interface?OLevel=offtype" ;
         //alert(url);
...
{	
	if(document.frmValidationSummaryRep.order[1].checked==true)
		...
		document.frmValidationSummaryRep.service.style.display="none";
}
