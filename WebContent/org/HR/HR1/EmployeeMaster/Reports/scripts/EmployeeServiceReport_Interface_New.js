...
function frmsubmit()
{
    ...
    //alert('inside submit');
        var url="../../../../../../EmployeeServiceReport_Interface_New?OLevel=submit";
       ...
       // }
        ...
        {
        	if(document.frmValidationSummaryRep.service.value=="" && document.getElementById("repdetails").checked==true)
        	{
        		alert("Select Order");
        		return;
        	}
        	else if(document.frmValidationSummaryRep.service1.value=="" && document.getElementById("repabtstract").checked==true)
        	{
        		alert("Select Order");
        		return;
        	}
    ...
    document.frmValidationSummaryRep.action="../../../../../../EmployeeServiceReport_Interface_New";
