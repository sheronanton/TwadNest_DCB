...
function frmsubmit()
{
    ...
    //alert('inside submit');
       ...
       if(s==0)
    	   {
    	   	alert("Please Select atleast one Service type");
    	
    	   }
       else if(document.getElementsByName("yeartype")[1].checked==true &&  document.getElementById("nyear").value=="")
    	   {
    	   		alert("please Enter year of Service ");
    ...
    document.frmValidationSummaryRep.action="EmployeeTypeofServiceReport_Rep.jsp";
