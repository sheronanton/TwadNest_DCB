...
*/
function panelcrselectAll()
{

   if(document.frmValidationSummaryRep.chkpanelcdr)
      {
      
            
            for(i=0;i<document.frmValidationSummaryRep.chkpanelcdr.length;i++)
            {
                    document.frmValidationSummaryRep.chkpanelcdr[i].checked=true;
                    
            }
           //  regiononchange();
        }
}
function panelcrclose()
{
	
	 var iframe=document.getElementById("divdesign");
    iframe.style.visibility='hidden';
}
...
function frmsubmit()
{
        ...
        var url="../../../../../../Employee_DetailsReport_Interface?OLevel=submit";
    	...
    	if(count==0)
    	{
    	 ...
    	 else if(document.frmValidationSummaryRep.optselect[2].checked)
    	 {
    		 ...
    		 if(document.frmValidationSummaryRep.cmbsgroup2.value==0) 
    		 {
    			 alert("Select Service Group");
    			 return;
    		 }
    		 if(cadreChange().length==0)
    			 {
    			 alert("Select Cadre");
    			 return false;
    			 }
   	    ...
   	    {
   	    if(document.getElementById("emp_frm").value=="")
   		  {
   		  alert("Please Select Employee id from");
   		 document.getElementById("emp_frm").focus();
   		  return false;
   		  }
   	    if(document.getElementById("emp_to").value=="")
 		    {
 		     alert("Please Select Employee id to");
 		    document.getElementById("emp_to").focus();
 		     return false;
 		    }
   	    var emp_frm=document.getElementById("emp_frm").value;
   	    var emp_to=document.getElementById("emp_to").value;
   	    url=url+"&emp_frm="+emp_frm+"&emp_to="+emp_to;
   	  }
    	 else
    	 {
    		 alert("Selection of Designation / Rank / Cadre / Range");
    		 return;
    	 }
      if(document.frmValidationSummaryRep.orderbyname[0].checked==true)
    		  {
    	       url=url+"&ordrerby=orderbyname";
    		  }
      else if(document.frmValidationSummaryRep.orderbyname[1].checked==true)
      {
              url=url+"&ordrerby=joindate";
    ...
    //alert(url)
    document.frmValidationSummaryRep.action="../../../../../../Employee_DetailsReport_Interface?"+url;
...
function loadcadre(type)
{
   ...
   //var url="../../../../../../EmpServicePopupServ.view?Command=SGroup&cmbsgroup=" + type ;
   var url="../../../../../../DesigCadRankServ_New?Command=loadcadre&cmbsgroup=" + type ;
   //alert(url);
    var req=getTransport();
    var req=getTransport();
    req.open("GET",url,true);        
...
if(document.frmValidationSummaryRep.chkdesig)
     ...
     // alert("1");
              ...
              //alert("2");
                            ...
                            var url="../../../../../../Employee_DetailsReport_Interface?desigs="+desig;
                            }
               }
        }  
      return desig;
     ...
     // alert("1");
          ...
          //  alert("2");
                           ...
                           // alert("ids:"+rank);
                            ...
                            var url="../../../../../../Employee_DetailsReport_Interface?ranks="+rank;
                            }
               }
        }  
      return rank;
     ...
     // alert("1");
          ...
          //   alert("2");
                          ...
                          //  alert("ids:"+cadre);
                            ...
                            var url="../../../../../../Employee_DetailsReport_Interface?cadres="+cadre;
                            }
               }
        }  
     return cadre; 
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../Employee_DetailsReport_Interface?OLevel=offtype" ;
         //alert(url);
      ...
      if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../Employee_DetailsReport_Interface?OLevel=lab&circles="+circle+"&regions="+region;
                             //alert(url);
                ...
                else
                {
                             ...
                             if(document.frmValidationSummaryRep.chkcircle.checked==true)
                             {
                                      ...
                                      region=region.substring(0,region.length-1);
                                      //alert(region);
                                      var url="../../../../../../Employee_DetailsReport_Interface?OLevel=lab&circles="+circle;
                                      //alert(url);
                                      // document.frmValidationSummaryRep.cmbregion.focus();
                                        var req=getTransport();
                                        req.open("GET",url,true);       
...
function getStatus()
{
    ...
    var url="../../../../../../Employee_DetailsReport_Interface?OLevel=Status";
...
function loaddesig()
{
   ...
   //var url="../../../../../../EmpServicePopupServ.view?Command=SGroup&cmbsgroup=" + type ;
   var url="../../../../../../DesigCadRankServ_New?Command=Cadrepanel" ;
   //alert(url);
    var req=getTransport();
    var req=getTransport();
    req.open("GET",url,true);        
    req.onreadystatechange=function()
    {
        ...
        { 
            ...
            {  
        //alert(req.responseText);
        var divdes=document.getElementById("divdesign");
        divdes.style.visibility='visible';
        divdes.focus();
        //divdes.style.display='block';
       // var des=document.getElementById("cmbDesignation");
...
function selectoption2()
{
document.getElementById("emp_frm").style.display='';
document.getElementById("emp_to").style.display='';
}
function selectoption4()
{
	document.getElementById("emp_frm").style.display='none';
	document.getElementById("emp_to").style.display='none';
}
...
document.getElementById("divrank").style.display='none';
//document.getElementById("divdesignation1").style.display='none';
document.getElementById("divcadre").style.display='none';
//document.getElementById("divdesignation2").style.display='none';
}
