...
function callServer(command,param)
{
      if(command=="Existg")
       ...
       //startwaiting(document.frmEmployeeProfile) ; 
          url="../../../../../../EmployeeProfileServSR_NoPhoto_New?Command=Existg&EmpId=" + strEmpId;
         // alert(url);
	...
	if(val == true )
		{
              ...
              document.frmEmployeeProfile.action="../../../../../../EmployeeProfileServSR_NoPhoto_New";
...
function validation()
{
	...
	else if(document.getElementById("txtEmployee").value=="")
	{
	//alert("Given Employee Id is not in your controlling office");	
	callServer('Existg','null');
