...
function frmsubmit()
{
        ...
        var url="../../../../../../Employee_wise_community_report?OLevel=submit";
    	...
    	var stdata="";
    	        ...
    	        if(count!=0)
                {
                     ...
                     url=url+"&com_status="+stdata;
                     document.frmValidationSummaryRep.com_status.value=stdata;
      ...
      if(document.frmValidationSummaryRep.orderbyname[0].checked==true)
    		  {
    	       url=url+"&ordrerby=designation";
    	       document.frmValidationSummaryRep.ordrerby.value="designation_id";
    		  }
      else if(document.frmValidationSummaryRep.orderbyname[1].checked==true)
      {
              url=url+"&ordrerby=orderbyname";
              document.frmValidationSummaryRep.ordrerby.value="EMPLOYEE_NAME";
              
      }
      else if(document.frmValidationSummaryRep.orderbyname[2].checked==true)
      {
              url=url+"&ordrerby=joindate";
              document.frmValidationSummaryRep.ordrerby.value="datefrom";
    ...
    document.frmValidationSummaryRep.action="Employee_wise_community_details_report.jsp";
...
function getcommunity()
{
    ...
    var url="../../../../../../Employee_wise_community_report?OLevel=Status";
