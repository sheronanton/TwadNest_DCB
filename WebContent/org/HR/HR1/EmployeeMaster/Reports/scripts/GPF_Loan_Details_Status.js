...
function frmsubmit()
{
	...
	if(document.getElementById("month").value==0)
	{
        ...
        var url="../../../../../../Gpf_Loan_Application_Status?OLevel=submit";
       ...
       // }
        ...
        var year=document.getElementById("fin_year").value;
        var month=document.getElementById("month").value;
   url=url+"&yearss="+year+"&month="+month;
       // alert(url);           
    document.frmValidationSummaryRep.action="../../../../../../Gpf_Loan_Application_Status";
