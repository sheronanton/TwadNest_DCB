...
function stateChanged(req)
{
 ...
 function bodyload()
 {
	...
	function fillGpfData3(response){
        ...
        var subjectContent="GPF-Authorisation for the final payment of GPF(Regular) and GPF(impounded) Account in repect of "+empName+","+des+"- GPF Account No."+ff+" TWAD - "+retiredContent+" on "+date2+" Final payment Authorise - reg.";	
...
function validate12(){
	 ...
	 if(nullCheck())
    {
		 ...
		 url="../../../../../../Create_GPF_Proceeding.av?Command=Validate&txtGpf="+gpf_no+"&auth="+auth;
...
function Procc(response){
     ...
     document.frmEmployeeProfile.txtref.value=response.getElementsByTagName("PROC_REFE_NO")[0].firstChild.nodeValue;
     ...
     document.frmEmployeeProfile.txtPO.value=response.getElementsByTagName("PROC_OFFICER")[0].firstChild.nodeValue; 
     document.frmEmployeeProfile.txtPODesig.value=response.getElementsByTagName("PROC_OFFICE_DESIGNATION")[0].firstChild.nodeValue; 
     document.frmEmployeeProfile.txtSubject.value=response.getElementsByTagName("SUBJECT")[0].firstChild.nodeValue; 
     document.frmEmployeeProfile.txtRef.value=response.getElementsByTagName("REFERENCE")[0].firstChild.nodeValue;
     document.frmEmployeeProfile.txtbills.value=response.getElementsByTagName("BILLS")[0].firstChild.nodeValue;
     document.frmEmployeeProfile.txtbills1.value=nullcheck(response.getElementsByTagName("BILLS1")[0].firstChild.nodeValue);
     document.frmEmployeeProfile.txtbills2.value=nullcheck(response.getElementsByTagName("BILLS2")[0].firstChild.nodeValue);
     document.frmEmployeeProfile.txtCopy.value=response.getElementsByTagName("COPY_TO")[0].firstChild.nodeValue;
    // document.frmEmployeeProfile.txtpno.value=response.getElementsByTagName("PROC_NO")[0].firstChild.nodeValue;
    // document.frmEmployeeProfile.c1.value=response.getElementsByTagName("PERIOD")[0].firstChild.nodeValue;
     //alert(document.frmEmployeeProfile.c1[1].value);
