...
function doFunction(Command,param)
{
    ...
    {       
        ...
        //alert("EID:"+eid);
            ...
            //alert(offid)
            var url="../../../../../../GenerateProceeding_Report?Command=loademp&txtEmployeeid="+eid+"&offid="+offid;
         //alert(url);
        ...
        else if(Command=="loadReason")
        {
         ...
         {
         var url="../../../../../../GenerateProceeding_Report?Command=loadReason&txtEmployeeid="+eid+"&txtOffId="+txtOffId+"&txtRel_SLNO="+txtRel_SLNO;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        // alert("here");
         ...
         if(txtRel_SLNO.length!=0)
         {
         var url="../../../../../../GenerateProceeding_Report?Command=Validate_loadReason&txtEmployeeid="+eid+"&txtOffId="+txtOffId+"&txtRel_SLNO="+txtRel_SLNO;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
