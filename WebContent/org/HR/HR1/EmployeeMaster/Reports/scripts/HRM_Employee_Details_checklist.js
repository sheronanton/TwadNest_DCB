...
function hide_rank()
{
	...
	if(document.frmValidationSummaryRep.opsel[1].checked==true)
		{
		
		document.getElementById("divrank").style.display="block";
		}
	if(document.frmValidationSummaryRep.opsel[0].checked==true)
		{
...
//alert('test');
    ...
    if(document.frmValidationSummaryRep.opsel[1].checked)
    {
    ...
    else if(document.frmValidationSummaryRep.opsel[1].checked)
    {
    ...
    else if(document.frmValidationSummaryRep.opsel[2].checked)
    {
         ...
         // alert("1");
                  ...
                  //alert("2");
                                ...
                                desig=desig.substring(0,desig.length-1);
                                 url="../../../../../../HRM_Employee_Details_checklist_ser_count?desigs="+desig;
                                }
                   }
            }  
          return desig;
...
function frmsubmit()
{
    ...
    //alert('inside submit');
        var url="../../../../../../HRM_Employee_Details_checklist?OLevel=submit";
       ...
       // }
                         ...
                         if(document.frmValidationSummaryRep.opsel[0].checked)
                    	 {
                    	 url=url+"&optdesig=All";
                    	 }
                     if(document.frmValidationSummaryRep.opsel[1].checked)
                	 {
                		 url=url+"&optdesig=Desig";
                		
                		 if(document.frmValidationSummaryRep.cmbsgroup1.value==0 || desigChange().length==0)
                		 {
   ...
   if((document.frmValidationSummaryRep.entry_list[0].checked==false)&&
		   (document.frmValidationSummaryRep.entry_list[1].checked==false)&&
		   (document.frmValidationSummaryRep.entry_list[2].checked==false) &&
		   (document.frmValidationSummaryRep.entry_list[3].checked==false) &&
		   (document.frmValidationSummaryRep.entry_list[4].checked==false))
   {
	   alert("Please select any option from Entry Details ");
	   return
   }
   
  // if((document.frmValidationSummaryRep.entry_list[0].checked==true) && (document.frmValidationSummaryRep.allhier.checked==true))
  // {
//	   alert("Please avoid include hierarchy option for service details checking ");
	//   document.frmValidationSummaryRep.allhier.checked=false;
	//   document.frmValidationSummaryRep.entry_list[0].checked=false;
	//   return ;
 //  }
   
   else if (document.frmValidationSummaryRep.entry_list[0].checked==true)
   {
	   url=url+"&entry_list=Ser";
   }
   else if (document.frmValidationSummaryRep.entry_list[1].checked==true)
   {
	   url=url+"&entry_list=Unfreeze";
   }
   
   else if (document.frmValidationSummaryRep.entry_list[2].checked==true)
   {
	   url=url+"&entry_list=Addl";
   }
   
   else if (document.frmValidationSummaryRep.entry_list[3].checked==true)
   {
	   url=url+"&entry_list=Pho";
   }
   else if (document.frmValidationSummaryRep.entry_list[4].checked==true)
   {
	   url=url+"&entry_list=Off";
   }
   
    document.frmValidationSummaryRep.action="../../../../../../HRM_Employee_Details_checklist?"+url;
  // alert(url);
