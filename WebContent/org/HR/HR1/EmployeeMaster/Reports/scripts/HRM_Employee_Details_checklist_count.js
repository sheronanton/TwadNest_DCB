                            ...
                            if(region!="")
                            {
                              // alert("inside 1");
                               ...
                               // alert("region1..."+region);
                                ...
                                var url="../../../../../../HRM_Employee_Details_checklist_count?OLevel=circle&regions="+region;
                                //alert(url);
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,true);        
...
function frmsubmit()
{
    ...
    //alert('inside submit');
        var url="../../../../../../HRM_Employee_Details_checklist_count_count?OLevel=submit";
...
//   }
    document.frmValidationSummaryRep.action="../../../../../../HRM_Employee_Details_checklist_count";
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../HRM_Employee_Details_checklist_count?OLevel=offtype" ;
         //alert(url);
