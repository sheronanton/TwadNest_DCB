...
function getStatus()
{
    ...
    var url="../../../../../Trainning_Interface_Report?OLevel=Status";
                            ...
                            if(region!="")
                            {
                              // alert("inside 1");
                               ...
                               // alert("region1..."+region);
                                ...
                                var url="../../../../../../HRM_Employee_Details_checklist_ser_count?OLevel=circle&regions="+region;
                                //alert(url);
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
...
function frmsubmit()
{
   ...
   // alert('inside submit');
        var url="../../../../../../HRM_Employee_Details_checklist_ser_count?OLevel=submit";
...
//   else if (document.frmValidationSummaryRep.optoutputtype[0].checked==true)
//   {
...
//   }
//   else if (document.frmValidationSummaryRep.optoutputtype[3].checked==true)
//   {
//	   url=url+"&entry_list=Off";
//   }
       
   
    document.frmValidationSummaryRep.action="../../../../../../HRM_Employee_Details_checklist_ser_count?"+url;
    //alert(url);
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../HRM_Employee_Details_checklist_ser_count?OLevel=offtype" ;
         //alert(url);
