...
function getRegion()
    {
      //  alert(regionflag);
        ...
        if(regionflag==true)
        {
         ...
         var url="../../../../../../Hrm_Employee_Punishment_Det?OLevel=region" ;
                            ...
                            if(region!="")
                            {
                              // alert("inside 1");
                               ...
                               // alert("region1..."+region);
                                ...
                                var url="../../../../../../Hrm_Employee_Punishment_Det?OLevel=circle&regions="+region;
                             //   alert(url);
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
...
function frmsubmit()
{
   ...
   // alert('inside submit');
        var url="../../../../../../Hrm_Employee_Punishment_Det?OLevel=submit";
       ...
       // }
        ...
        //select the output type
                         ...
                         if(document.frmValidationSummaryRep.optselect[0].checked==true)
                         {
                                 url=url+"&cadreype=All";
                                 document.frmValidationSummaryRep.cadreype.value='All';
                         }
                         if(document.frmValidationSummaryRep.optselect[1].checked==true)
                         {
                                 url=url+"&cadreype=Spc";
                                 document.frmValidationSummaryRep.cadreype.value='Spc';
                         }
                         ...
                         {
                                 url=url+"&Cadre=All";
                                 document.frmValidationSummaryRep.cadre.value='All';
                         }
                         else if(document.frmValidationSummaryRep.optselect[1].checked==true)
                        	 {
                     			      ...
                     			      if(document.frmValidationSummaryRep.chkcadre.length )
                     			       {
                     				    for(i=0;i<document.frmValidationSummaryRep.chkcadre.length;i++)
                     			          ...
                     			          if(document.frmValidationSummaryRep.chkcadre[i].checked==true)
                     			        	 cadre_id= cadre_id+document.frmValidationSummaryRep.chkcadre[i].value +",";                                                                                                       
                                        ...
                                        if(cadre_id!="")
                                        {
                                        	cadre_id=cadre_id.substring(0,cadre_id.length-1);
                                             url=url+"&cadre="+cadre_id;
                                             document.frmValidationSummaryRep.cadre.value=cadre_id;
    ...
    //alert("url is---->"+url);
    document.frmValidationSummaryRep.action="emp_punishment_details_report.jsp";
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../Hrm_Employee_Punishment_Det?OLevel=offtype" ;
         //alert(url);
       ...
       var region="";
                if(document.frmValidationSummaryRep.chkregion.length > 0)
                {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../Hrm_Employee_Punishment_Det?OLevel=audit&regions="+region;
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
      ...
      if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../Hrm_Employee_Punishment_Det?OLevel=lab&circles="+circle+"&regions="+region;
                             //alert(url);
                ...
                else
                {
                             ...
                             if(document.frmValidationSummaryRep.chkcircle.checked==true)
                             {
                                      ...
                                      region=region.substring(0,region.length-1);
                                      //alert(region);
                                      var url="../../../../../../Hrm_Employee_Punishment_Det?OLevel=lab&circles="+circle;
                                      //alert(url);
                                      // document.frmValidationSummaryRep.cmbregion.focus();
                                        var req=getTransport();
                                        req.open("GET",url,false);        
