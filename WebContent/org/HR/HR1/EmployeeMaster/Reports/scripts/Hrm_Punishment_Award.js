  ...
  if(valid==true)
	{
		...
		var url="../../../../../../Hrm_Punishment_Award?command=employee_check&emp_id="+emp_id;
...
{
document.HRM_punish_award.emp_id.value=emp;
employee_check();
closeWin();
}
function closeWin()
...
function gosubmit()
{
	if(document.getElementById("emp_id").value =="")
		...
		document.HRM_punish_award.action='Employee_punish_award.jsp';
		document.HRM_punish_award.submit();
