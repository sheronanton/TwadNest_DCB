...
function getTransport()
 ...
 function getOfficesByLevel()
    {
        var level=document.JoiningReport.cmbControllingLevel.options[document.JoiningReport.cmbControllingLevel.selectedIndex].value;
        var levelt=document.JoiningReport.cmbControllingLevel.options[document.JoiningReport.cmbControllingLevel.selectedIndex].text;
       
        
        document.JoiningReport.chkall.checked=false;
        ...
        if(level=="DN" || level=="SD" || level=="SN" )
        {
            ...
            document.JoiningReport.cmbOfficeType.focus();      
    ...
    function loadOfficesByLevel(level)
    {
        ...
        var url="../../../../../../JoiningReportServ.rep?Command=level&level="+level;
 ...
 function getOfficesByType()
    {
        ...
        items1=null;
         ...
         items5=null;
         items6=null;
        var own=document.JoiningReport.cmbOfficeType.options[document.JoiningReport.cmbOfficeType.selectedIndex].value;
        if(own=="0")
        {
             var cmbpage=document.getElementById("cmbpage");
        ...
        {
                var level=document.JoiningReport.cmbControllingLevel.options[document.JoiningReport.cmbControllingLevel.selectedIndex].value;
                var url="../../../../../../JoiningReportServ.rep?Command=own&level="+level+"&own="+own;
                var req=getTransport();
                req.open("GET",url,true);        
                req.onreadystatechange=function()
                {
...
function loadPage(page)
{
            ...
            document.JoiningReport.cmbpage.selectedIndex=page-1;
...
function btncancel()
{
 ...
 document.JoiningReport.cmbControllingLevel.selectedIndex=0;
 var tbody=document.getElementById("tb");
                try{tbody.innerHTML="";}
                          catch(e) {tbody.innerText="";}
}
...
if(v && items5)
{
        ...
        else
        {
            ...
            document.JoiningReport.txtseloff.value=s.substring(0,s.length-1);
            document.JoiningReport.action="../../../../../../JoiningReportServ.rep";
          document.JoiningReport.method="POST";
...
{
//alert('hai');
var page=document.JoiningReport.cmbpage.value;
...
function sellectall()
{
        ...
        if(v && items5)
        {
            if(document.JoiningReport.chkall.checked==true)
            {
                for(i=0;i<items5.length;i++)
                {
                        items5[i]=true;
...
function changepagesize()
{
           ...
           __pagination=document.JoiningReport.cmbpagination.value;
            var v=document.getElementsByName("sel");
            //alert(v);
        if(v && items5)
        {
