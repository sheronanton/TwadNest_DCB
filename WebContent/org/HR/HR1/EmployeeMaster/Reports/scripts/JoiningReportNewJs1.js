      ...
      if(document.JoiningReport.chkregion)
      {
            ...
            else
            {
                             ...
                             if(document.JoiningReport.chkregion.checked==true)
                             {
                                       ...
                                       // region=region.substring(0,region.length-1);
                                        var url="../../../../../../JoiningReportNewServ1.rep?OLevel=circle&regions="+region;
                                      // document.JoiningReport.cmbregion.focus();
                                        var req=getTransport();
                                        req.open("GET",url,false);        
                                        req.onreadystatechange=function()
            ...
            if(document.JoiningReport.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                               ...
                               // alert(divisionflag);
                                ...
                                var url="../../../../../../JoiningReportNewServ1.rep?OLevel=division&circles="+circle;
                              // document.JoiningReport.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
...
{
    //alert('submit');
        var url="../../../../../../JoiningReportNewServ1.rep?OLevel=submit" ;
    ...
    document.JoiningReport.action="../../../../../../JoiningReportNewServ1.rep";
