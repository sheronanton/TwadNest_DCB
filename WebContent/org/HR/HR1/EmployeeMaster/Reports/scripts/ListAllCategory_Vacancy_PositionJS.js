...
function frmsubmit()
{
     ...
     if(nullcheck())
    {
        ...
        var url="../../../../../../ListAllCategory_Vacancy_Position?OLevel=submit" ;
   ...
   /*  document.frmValidationSummaryRep.action=url;
    //document.frmValidationSummaryRep.action="../../../../../../ListAllCategory_Vacancy_Position";
...
if(document.frmValidationSummaryRep.chkdesig)
     ...
     // alert("1");
              ...
              //alert("2");
                            ...
                            var url="../../../../../../ListAllCategory_Vacancy_Position?desigs="+desig;
                            }
               }
        }  
...
if(document.frmValidationSummaryRep.chkdesig)
      ...
      //alert("1");
        ...
        //      alert("2");
                            ...
                            var url="../../../../../../ListAllCategory_Vacancy_Position?ranks="+rank;
                            }
               }
        }  
...
if(document.frmValidationSummaryRep.chkcadre)
      ...
      //alert("1");
             ...
             // alert("2");
                            ...
                            var url="../../../../../../ListAllCategory_Vacancy_Position?cadres="+cadre;
                            }
               }
        }  
                ...
                // alert(document.frmValidationSummaryRep.chkregion.length);
                            ...
                            if(region!="")
                            {
                              // alert("inside 1");
                                ...
                                region=region.substring(0,region.length-1);
                               var url="../../../../../../ListAllCategory_Vacancy_Position?OLevel=audit&regions="+region;
       ...
       if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../ListAllCategory_Vacancy_Position?OLevel=lab&circles="+circle+"&regions="+region;
                              alert(url);
                ...
                else
                {
                             ...
                             if(document.frmValidationSummaryRep.chkcircle.checked==true)
                             {
                                      ...
                                      region=region.substring(0,region.length-1);
                                      //alert(region);
                                      var url="../../../../../../ListAllCategory_Vacancy_Position?OLevel=lab&circles="+circle;
                                       alert(url);
                                      // document.frmValidationSummaryRep.cmbregion.focus();
                                        var req=getTransport();
                                        req.open("GET",url,false);        
