...
function getRegion()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../ListAllSanctionedStrength?OLevel=region" ;
        //alert(url);
                            ...
                            if(region!="")
                            {
                              // alert("inside 1");
                               ...
                               // alert("region1..."+region);
                                ...
                                var url="../../../../../../ListAllSanctionedStrength?OLevel=circle&regions="+region;
                              //  alert(url);
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
      ...
      if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../ListAllSanctionedStrength?OLevel=division&circles="+circle+"&offtype="+offtype+"&regions="+region;
                             //alert(url);
                ...
                else
                {
                             ...
                             if(document.frmValidationSummaryRep.chkcircle.checked==true)
                             {
                                      ...
                                      region=region.substring(0,region.length-1);
                                      //alert(region);
                                      var url="../../../../../../ListAllSanctionedStrength?OLevel=division&circles="+circle+"&offtype="+offtype;
                                      //alert(url);
                                      // document.frmValidationSummaryRep.cmbregion.focus();
                                        var req=getTransport();
                                        req.open("GET",url,false);        
...
{
    //alert('inside submit');
    //var boolval=nullcheck();
   if(nullcheck())
    {
    //alert('cheecked');
    var cmbFinancialYear=document.getElementById("cmbFinancialYear").value;
    //alert(cmbFinancialYear);
        var url="../../../../../../ListAllSanctionedStrength?OLevel=submit&cmbFinYear="+cmbFinancialYear ;
        //alert(url);
...
if(document.frmValidationSummaryRep.chkdesig)
     ...
     // alert("1");
              ...
              //alert("2");
                            ...
                            var url="../../../../../../ListAllSanctionedStrength?desigs="+desig;
                            }
               }
        }  
...
if(document.frmValidationSummaryRep.chkdesig)
      ...
      //alert("1");
        ...
        //      alert("2");
                            ...
                            var url="../../../../../../ListAllSanctionedStrength?ranks="+rank;
                            }
               }
        }  
...
if(document.frmValidationSummaryRep.chkcadre)
      ...
      //alert("1");
             ...
             // alert("2");
                            ...
                            var url="../../../../../../ListAllSanctionedStrength?cadres="+cadre;
                            }
               }
        }  
   ...
   // alert('inside office');
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         //var url="../../../../../../ListofEmpValidationSummaryServ.rep?OLevel=region" ;
         var url="../../../../../../ListAllSanctionedStrength?OLevel=offtype" ;
         //alert(url);
 	...
 	if (parseInt(cmn) <= 2)
        {
                ...
                document.frmValidationSummaryRep.cmbFinancialYear.length=5;
                cmbFinancialYear.innerHTML="";
                var option=document.createElement("OPTION");
                option.text="--Select the Period--";
                option.value=0;
                try
                        {
