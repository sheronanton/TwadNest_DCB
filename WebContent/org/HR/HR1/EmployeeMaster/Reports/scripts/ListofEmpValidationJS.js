...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmEmployeeDetailRep.cmbolevel.options[document.frmEmployeeDetailRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../ListofEmpValidationServ.rep?OLevel=region" ;
     // alert(url);
      ...
      if(document.frmEmployeeDetailRep.chkregion)
      {
               if(document.frmEmployeeDetailRep.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../ListofEmpValidationServ.rep?OLevel=circle&regions="+region;
                              // document.frmEmployeeDetailRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
            ...
            if(document.frmEmployeeDetailRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                               ...
                               // alert(divisionflag);
                                ...
                                var url="../../../../../../ListofEmpValidationServ.rep?OLevel=division&circles="+circle;
                              // document.frmEmployeeDetailRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
...
{
    //alert('submit');
        var url="../../../../../../ListofEmpValidationServ.rep?OLevel=submit" ;
    ...
    document.frmEmployeeDetailRep.action="../../../../../../ListofEmpValidationServ.rep";
