...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../ListofEmpValidationServ_Hier.rep?OLevel=region" ;
     // alert(url);
      ...
      if(document.frmValidationSummaryRep.chkregion)
      {
               if(document.frmValidationSummaryRep.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../ListofEmpValidationServ_Hier.rep?OLevel=circle&regions="+region;
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                               ...
                               // alert(divisionflag);
                                ...
                                var url="../../../../../../ListofEmpValidationServ_Hier.rep?OLevel=division&circles="+circle;
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
...
{
    //alert('submit');
        var url="../../../../../../ListofEmpValidationServ_Hier.rep?OLevel=submit" ;
    ...
    document.frmValidationSummaryRep.action="../../../../../../ListofEmpValidationServ_Hier.rep";
