...
function hideofficelevel()
{
    ...
    offlevel.style.display="none";
    /*
    var off_heir=document.getElementById("heirar");
    //alert(document.frmValidationSummaryRep.optofficelevel[0].checked);
    if(document.frmValidationSummaryRep.optofficelevel[0].checked)
    {
    //var off_heir=document.getElementById("heirar");
    off_heir.style.display="none";
    }
    else
    {
      //var off_heir=document.getElementById("heirar");
      off_heir.style.display="block";
    }
    */
...
function showofficelevel()
{
    ...
    /*
    var off_heir=document.getElementById("heirar");
    if(document.frmValidationSummaryRep.optofficelevel[1].checked)
    {
...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../ListofEmpValidationServ_New_Part?OLevel=region" ;
     // alert(url);
      ...
      if(document.frmValidationSummaryRep.chkregion)
      {
               if(document.frmValidationSummaryRep.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../ListofEmpValidationServ_New_Part?OLevel=circle&regions="+region;
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
      ...
      if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../ListofEmpValidationServ_New_Part?OLevel=division&circles="+circle;
...
function loadOfficesByType(type)
    {
       ...
       var url="../../../../../../DesigCadRankServ?Command=Desig&cmbsgroup=" + type ;
       //alert(url);
        var req=getTransport();
...
{
    //alert('submit');
        var url="../../../../../../ListofEmpValidationServ_New_Part?OLevel=submit" ;
    ...
    document.frmValidationSummaryRep.action="../../../../../../ListofEmpValidationServ_New_Part";
