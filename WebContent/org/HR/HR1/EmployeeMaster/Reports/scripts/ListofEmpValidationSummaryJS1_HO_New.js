...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../ListofEmpValidationSummaryServ_HO_New.rep?OLevel=region" ;
     // alert(url);
      ...
      if(document.frmValidationSummaryRep.chkregion)
      {
               if(document.frmValidationSummaryRep.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../ListofEmpValidationSummaryServ_HO_New.rep?OLevel=circle&regions="+region;
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                               ...
                               // alert(divisionflag);
                                ...
                                var url="../../../../../../ListofEmpValidationSummaryServ_HO_New.rep?OLevel=division&circles="+circle+"&regions="+region;
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
                ...
                else
                {
                             ...
                             if(document.frmValidationSummaryRep.chkcircle.checked==true)
                             {
                                       ...
                                       // circle=circle.substring(0,circle.length-1);
                                        var url="../../../../../../ListofEmpValidationSummaryServ_HO_New.rep?OLevel=division&circles="+circle;
                                      // document.frmValidationSummaryRep.cmbregion.focus();
                                        var req=getTransport();
                                        req.open("GET",url,false);        
                                        req.onreadystatechange=function()
...
{
    //alert('submit');
        var url="../../../../../../ListofEmpValidationSummaryServ_HO_New.rep?OLevel=submit" ;
    ...
    document.frmValidationSummaryRep.action="../../../../../../ListofEmpValidationSummaryServ_HO_New.rep";
