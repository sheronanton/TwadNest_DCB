...
{
//alert('first');
//var prono=document.frmListEmpProceeddep.cmbProceed.value;
var prono=document.frmListEmpProceeddep.cmbProceed.options[document.frmListEmpProceeddep.cmbProceed.selectedIndex].value;
//alert('prono'+prono);
var order=prono;
var offid=document.frmListEmpProceeddep.txtOffId.value;
//alert(offid);
if(Command=='loadEmp')
  {
  ...
  //alert('second')
    ...
    var url="../../../../../../ListofEmp_Deputation_Proceed.av?Command=loadEmployee&order="+order+"&officeid="+offid;
 ...
 //  alert(url);
  ...
  {
 // alert("save");
  var prono=document.frmListEmpProceeddep.txtPNo.value;
  //alert(prono);
  var req=getTransport();
    var url="../../../../../../ListofEmp_Deputation_Proceed.av?Command=save&prono="+prono;
   //alert(url);
    req.open("Get",url,true);
    //alert(req);
    req.onreadystatechange=function()
   ...
   // alert(req.readyState+"state");
    if(req.status==200)
       ...
       // alert(baseRes);
                ...
                //alert('seven')
                        ...
                        // var signed=baseRes.getElementsByTagName("signed")[0].firstChild.nodeValue;
                          ...
                          var prefix=baseRes.getElementsByTagName("prefix")[0].firstChild.nodeValue;
                           var prono=baseRes.getElementsByTagName("pro_no")[0].firstChild.nodeValue;
                          document.frmListEmpProceeddep.txtref.value=prono;
                         // alert("signed"+signed);
                        // alert("suffix"+suffix);
                         // document.frmListEmpProceeddep.txtseloff.value=signed;
                     ...
                     // {
                      for(i=0;i<service.length;i++)
                       ...
                       if(empid[i]=='null')
                        ...
                        //  alert(ta_da);
                          //inaddress[i]=service[i].getElementsByTagName("inaddress")[0].firstChild.nodeValue;
                          dpn_design[i]=service[i].getElementsByTagName("dpn_design")[0].firstChild.nodeValue;
                         // alert(baseRes.getElementsByTagName("other_deptname")[0].firstChild.nodeValue);
                          other_deptname[i]=service[i].getElementsByTagName("other_deptname")[0].firstChild.nodeValue;
                          //alert( other_deptname[i+1]);
                            items5[i]=false;   
                            ...
                            if(dpn_design[i]=='null')
                            dpn_designat[i]="";
                            else
                            dpn_designat[i]=dpn_design[i];
        ...
        document.frmListEmpProceeddep.txtPDat.value="";
        else
        document.frmListEmpProceeddep.txtPDat.value=prdate;            

                 if(preoff=='null'||preoff=='undefined')
        document.frmListEmpProceeddep.txtPO.value="";
        else
        document.frmListEmpProceeddep.txtPO.value=preoff;
        
        if(predesig=='null' ||predesig=='undefined')
        document.frmListEmpProceeddep.txtPODesig.value="";
        else
        document.frmListEmpProceeddep.txtPODesig.value=predesig;
        
        if(subj=='null' || subj=='undefined')
        {
       // alert("fgfg");
        document.frmListEmpProceeddep.txtSubject.value="";
        }
        else
        {
       // alert("sub");
        document.frmListEmpProceeddep.txtSubject.value=subj;
        }
        
        if(refer=='null'||refer =='undefined')
        document.frmListEmpProceeddep.txtRef.value="";
        else
        document.frmListEmpProceeddep.txtRef.value=refer;
        
        if(addlparaone=='null'||addlparaone=='undefined')
        document.frmListEmpProceeddep.txtPara1.value="";
        else
        document.frmListEmpProceeddep.txtPara1.value=addlparaone;
        
        if(addlparatwo=='null'||addlparatwo=='undefined')
        document.frmListEmpProceeddep.txtPara2.value="";
        else
        document.frmListEmpProceeddep.txtPara2.value=addlparatwo;
        
        if(copyto=='null'||copyto=='undefined')
        document.frmListEmpProceeddep.txtCopy.value="";
        else
        document.frmListEmpProceeddep.txtCopy.value=copyto;
     
           if(suffix=='null' || suffix=='')
           document.frmListEmpProceeddep.suffix.value="";
           else
           document.frmListEmpProceeddep.suffix.value=suffix;
            if(prefix=='null' || prefix=='')
           document.frmListEmpProceeddep.prefix.value="";
           else
           document.frmListEmpProceeddep.prefix.value=prefix;
                // loadPage(baseRes);
                loadPage(1);
                }
                }
...
var i=0;
         ...
         /*   var p=__pagination*(page-1);
           ...
           // document.frmListEmpProceeddep.cmbpage.selectedIndex=page-1;
           // alert(empid.length);
...
var cell2=document.createElement("TD");
          ...
          /*
          var cell6=document.createElement("TD");
          var txtindiv=document.createTextNode(dpn_design[i]);
  ...
  {
  var prono=document.frmListEmpProceeddep.cmbProceed.value;
  var prdate=document.frmListEmpProceeddep.txtPDat.value;
  var preoff=document.frmListEmpProceeddep.txtPO.value;
  var predesig=document.frmListEmpProceeddep.txtPODesig.value;
 if (prono=="")
 {
...
function changepagesize()
{
           ...
           __pagination=document.frmListEmpProceeddep.cmbpagination.value;
...
function changepage()
{
var page=document.frmListEmpProceeddep.cmbpage.value;
...
var tbody=document.getElementById("grid_body");
    ...
    {tbody.innerText="";}
 document.frmListEmpProceeddep.cmbProceed.value="";
 document.frmListEmpProceeddep.txtPDat.value="";
 document.frmListEmpProceeddep.txtPO.value="";
 document.frmListEmpProceeddep.txtPODesig.value="";
 document.frmListEmpProceeddep.txtSubject.value="";
 ...
 document.frmListEmpProceeddep.txtCopy.value="";
 document.frmListEmpProceeddep.txtRef.value="";
 document.frmListEmpProceeddep.txtseloff.value="";
 document.frmListEmpProceeddep.suffix.value="";
...
if(v && items5)
{
        ...
        {*/
         ...
         //  alert(s.substring(0,s.length-1));
            //document.frmListEmpProceeddep.txtseloff.value=s.substring(0,s.length-1);
             document.frmListEmpProceeddep.txtPNo.value=document.frmListEmpProceeddep.cmbProceed.options[document.frmListEmpProceeddep.cmbProceed.selectedIndex].text;
            document.frmListEmpProceeddep.action="../../../../../../ListofEmp_Deputation_Proceed.av";
          document.frmListEmpProceeddep.method="POST";
          document.frmListEmpProceeddep.submit();
            return true;
        /*}
...
{
document.frmListEmpProceeddep.chkall.checked=false;
        var v=document.getElementsByName("sel");
        if(v && items5)
        {
                for(i=0;i<items5.length;i++)
...
function sellectall()
{
        ...
        if(v && items5)
        {
            if(document.frmListEmpProceeddep.chkall.checked==true)
            {
                for(i=0;i<items5.length;i++)
                {
                        items5[i]=true;
