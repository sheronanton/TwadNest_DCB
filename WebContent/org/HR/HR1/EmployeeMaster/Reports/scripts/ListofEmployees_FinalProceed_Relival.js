...
if(Command=='loadEmp')
  ...
  //alert('second')
    ...
    var url="../../../../../../ListofFinalEmp_Proceed_Relival.av?Command=loadEmployee&order="+order+"&officeid="+offid;
   // alert(url);
                      ...
                      for(i=0;i<service.length;i++)
                       ...
                       if(empid[i]=='null')
                         ...
                         empname[i]=service[i].getElementsByTagName("empname")[0].firstChild.nodeValue;
                          ...
                          emprelstatus[i]=service[i].getElementsByTagName("emprelifromoffice")[0].firstChild.nodeValue;
                          relivaldate[i]=service[i].getElementsByTagName("relivaldate")[0].firstChild.nodeValue;
                         //alert(relivaldate[i]);
                            items5[i]=false;               
                            if(empdesig[i]="-")
                            {
...
var cell2=document.createElement("TD");
       ...
       var cell6=document.createElement("TD");
          var txtrelivaldate=document.createTextNode(relivaldate[i]);
          cell6.appendChild(txtrelivaldate);
        ...
        /* if(document.frmListEmpProceed.signed[0].checked==true)
         ...
         document.frmListEmpProceed.txtPNo.value=document.frmListEmpProceed.cmbProceed.options[document.frmListEmpProceed.cmbProceed.selectedIndex].text;
          ...
          //  document.frmListEmpProceed.txtseloff.value=s.substring(0,s.length-1);
            document.frmListEmpProceed.action="../../../../../../ListofFinalEmp_Proceed_Relival.av";
