...
if(Command=='loadEmp')
  ...
  //alert('second')
    ...
    var url="../../../../../../ListofFinalEmp_Proceed_Reposting.av?Command=loadEmployee&order="+order+"&officeid="+offid;
   // alert(url);
                      ...
                      for(i=0;i<service.length;i++)
                       ...
                       if(empid[i]=='null')
                         ...
                         empname[i]=service[i].getElementsByTagName("empname")[0].firstChild.nodeValue;
                          ...
                          emprelstatus[i]=service[i].getElementsByTagName("empfromoffice")[0].firstChild.nodeValue;
                          emptrnfrom[i]=service[i].getElementsByTagName("emptooffice")[0].firstChild.nodeValue;
                          empprocessflow[i]=service[i].getElementsByTagName("repost_req")[0].firstChild.nodeValue;
...
function checknull()
{
 ...
 {
   if((document.frmListEmpProceed.fwoffdesig.value=="") || (document.frmListEmpProceed.fwoffdesig.value.length=0))
   {
     alert('Please Enter the Forwading Officer designation');
     return false;
   }
 }
 else
        ...
        {*/
         ...
         document.frmListEmpProceed.txtPNo.value=document.frmListEmpProceed.cmbProceed.options[document.frmListEmpProceed.cmbProceed.selectedIndex].text;
          ...
          //  document.frmListEmpProceed.txtseloff.value=s.substring(0,s.length-1);
            document.frmListEmpProceed.action="../../../../../../ListofFinalEmp_Proceed_Reposting.av";
