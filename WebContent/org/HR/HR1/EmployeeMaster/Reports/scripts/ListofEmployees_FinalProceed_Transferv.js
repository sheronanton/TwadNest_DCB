...
if(Command=='loadEmp')
  ...
  //alert('second')
    ...
    var url="../../../../../../ListofFinalEmp_Proceed_Transferv.av?Command=loadEmployee&order="+order+"&officeid="+offid;
   // alert(url);
...
else if(document.frmListEmpProceed.fsigned[0].checked==true)
 {
...
if(check)
{
         ...
         else (document.frmListEmpProceed.signed[1].checked==true)
         {
         ...
         else(document.frmListEmpProceed.fsigned[1].checked==true)
         {
         ...
         document.frmListEmpProceed.txtPNo.value=document.frmListEmpProceed.cmbProceed.options[document.frmListEmpProceed.cmbProceed.selectedIndex].text;
          ...
          //  document.frmListEmpProceed.txtseloff.value=s.substring(0,s.length-1);
            document.frmListEmpProceed.action="../../../../../../ListofFinalEmp_Proceed_Transferv.av";
