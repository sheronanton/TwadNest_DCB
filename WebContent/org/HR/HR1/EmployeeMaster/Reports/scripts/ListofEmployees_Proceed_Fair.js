...
if(Command=='loadEmp')
 ...
 // alert('second')
    ...
    var url="../../../../../../ListofEmployees_Proceed_Fair?Command=loadEmployee&prono="+prono+"&officeid="+offid;
   // alert(url);
  ...
  //alert(prono);
  var req=getTransport();
    var url="../../../../../../ListofEmployees_Proceed_Fair?Command=save&prono="+prono;
   // alert(url);
    req.open("Get",url,true);
    //alert(req);
    req.onreadystatechange=function()
                      ...
                      for(i=0;i<service.length;i++)
                        ...
                        // alert(empid[i]);
                         empname[i]=service[i].getElementsByTagName("empname")[0].firstChild.nodeValue;
                          ...
                          emprelstatus[i]=service[i].getElementsByTagName("emprelstatus")[0].firstChild.nodeValue;
                          
                          empprocessflow[i]=service[i].getElementsByTagName("processflow")[0].firstChild.nodeValue;
                          if(empprocessflow[i]=='FR')
                                   empprocessflow[i]="Freezed";
...
if(v && items5)
{
        ...
        else
        {
            ...
            document.frmListEmpProceed.action="../../../../../../ListofEmployees_Proceed_Fair";
