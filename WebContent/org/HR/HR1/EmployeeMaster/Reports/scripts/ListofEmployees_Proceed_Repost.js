...
if(Command=='loadEmp')
  ...
  //alert('second')
    ...
    var url="../../../../../../ListofEmployees_Proceed_Repost?Command=loadEmployee&order="+order+"&officeid="+offid;
   // alert(url);
...
var cell2=document.createElement("TD");
          ...
          var cell5=document.createElement("TD");
          var txtempstatus=document.createTextNode(empprocessflow[i]);
          cell5.appendChild(txtempstatus);
          mycurrent_row.appendChild(cell5);
          
           var cell6=document.createElement("TD");
          var txtempprocessstatus=document.createTextNode(emptrnfrom[i]);
        ...
        /* if(document.frmListEmpProceed.signed[0].checked==true)
         ...
         document.frmListEmpProceed.txtPNo.value=document.frmListEmpProceed.cmbProceed.options[document.frmListEmpProceed.cmbProceed.selectedIndex].text;
          ...
          //  document.frmListEmpProceed.txtseloff.value=s.substring(0,s.length-1);
            document.frmListEmpProceed.action="../../../../../../ListofEmployees_Proceed_Repost";
