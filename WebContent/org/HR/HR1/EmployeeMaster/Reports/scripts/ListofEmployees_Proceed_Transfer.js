...
if(Command=='loadEmp')
 ...
 // alert('second')
    ...
    var url="../../../../../../ListofEmployees_Proceed_Transfer?Command=loadEmployee&prono="+prono+"&officeid="+offid;
   // alert(url);
  ...
  //alert(prono);
  var req=getTransport();
    var url="../../../../../../ListofEmployees_Proceed_Transfer?Command=save&prono="+prono;
   // alert(url);
    req.open("Get",url,true);
    //alert(req);
    req.onreadystatechange=function()
...
if(v && items5)
{
        ...
        else
        {
            ...
            document.frmListEmpProceed.action="../../../../../../ListofEmployees_Proceed_Transfer";
