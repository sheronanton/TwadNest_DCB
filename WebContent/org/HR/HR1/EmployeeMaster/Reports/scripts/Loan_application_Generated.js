...
function Loadspec()
{
	   ...
	   var offlevel=document.getElementById("divallofficelevel");
...

{
     ...
     document.frmValidationSummaryRep.rad_off[0].checked=true;
...
function selectoption2()
{
   ...
   // document.getElementById("divallhier").style.display='block';
    ...
    divallhier.style.display="block";  
  ...
  else if(document.frmValidationSummaryRep.rad_off[4].checked==true)
  {
     var offlevel=document.getElementById("trofficeselection");
    offlevel.style.display="block";
    //document.getElementById("divallhier").style.display='block';
  ...
  else if(document.frmValidationSummaryRep.rad_off[5].checked==true)
  {
     var offlevel=document.getElementById("trofficeselection");
    offlevel.style.display="block";
    //document.getElementById("divallhier").style.display='block';
  ...
  document.frmValidationSummaryRep.cmbcircle.disabled=true;
   // document.frmValidationSummaryRep.cmbofftype.disabled=true;
    ...
    iframe.style.visibility='hidden';frmf
                            ...
                            if(region!="")
                            {
                              // alert("inside 1");
                               ...
                               // alert("region1..."+region);
                                ...
                                var url="../../../../../../EmployeeDetailReport_idServ_New_Interface?OLevel=circle&regions="+region;
                             //   alert(url);
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,true);        
...
function frmsubmit()
{
	...
	if(document.frmValidationSummaryRep.rad_all[0].checked)
	{
		var url="../../../../../../Loan_application_Generated?OLevel=submit&rad_off=All";
    ...
    //alert('inside submit');
        var url="../../../../../../Loan_application_Generated?OLevel=submit";
                                       ...
                                       if(document.frmValidationSummaryRep.chkaudit.length )
                                        {
                                                ...
                                                {
                                                            circle= document.frmValidationSummaryRep.chkaudit.value ;
                                                            document.frmValidationSummaryRep.officeselected.value=audit;
                                                           // alert(circle);
                                                }
                                                 else
  ...
  // alert(url);
    ...
    document.frmValidationSummaryRep.action="../../../../../../Loan_application_Generated";
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../EmployeeDetailReport_idServ_New_Interface?OLevel=offtype" ;
         //alert(url);
      ...
      if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../EmployeeDetailReport_idServ_New_Interface?OLevel=lab&circles="+circle+"&regions="+region;
                             //alert(url);
                ...
                else
                {
                             ...
                             if(document.frmValidationSummaryRep.chkcircle.checked==true)
                             {
                                      ...
                                      region=region.substring(0,region.length-1);
                                      //alert(region);
                                      var url="../../../../../../EmployeeDetailReport_idServ_New_Interface?OLevel=lab&circles="+circle;
                                      //alert(url);
                                      // document.frmValidationSummaryRep.cmbregion.focus();
                                        var req=getTransport();
                                        req.open("GET",url,true);        
