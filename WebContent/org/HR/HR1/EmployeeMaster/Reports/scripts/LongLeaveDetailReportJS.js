...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmDeputationRep.cmbolevel.options[document.frmDeputationRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../LongLeaveDetailReportServ.rep?OLevel=region" ;
     // alert(url);
      ...
      if(document.frmDeputationRep.chkregion)
      {
               if(document.frmDeputationRep.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../LongLeaveDetailReportServ.rep?OLevel=circle&regions="+region;
                              // document.frmDeputationRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
            ...
            if(document.frmDeputationRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                               ...
                               // alert(divisionflag);
                                ...
                                var url="../../../../../../LongLeaveDetailReportServ.rep?OLevel=division&circles="+circle;
                              // document.frmDeputationRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
...
{
    //alert('submit');
        var url="../../../../../../LongLeaveDetailReportServ.rep?OLevel=submit" ;
    ...
    document.frmDeputationRep.action="../../../../../../LongLeaveDetailReportServ.rep";
