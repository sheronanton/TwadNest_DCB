...
function getRegion()
    {
      //  alert(regionflag);
        ...
        if(regionflag==true)
        {
         ...
         var url="../../../../../../LongLeaveReportServ_New_Interface?OLevel=region" ;
        //alert(url);
                            ...
                            if(region!="")
                            {
                              // alert("inside 1");
                               ...
                               // alert("region1..."+region);
                                ...
                                var url="../../../../../../LongLeaveReportServ_New_Interface?OLevel=circle&regions="+region;
                             //   alert(url);
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
      ...
      if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../LongLeaveReportServ_New_Interface?OLevel=division&circles="+circle+"&offtype="+offtype+"&regions="+region;
                             //alert(url);
                ...
                else
                {
                             ...
                             if(document.frmValidationSummaryRep.chkcircle.checked==true)
                             {
                                      ...
                                      //  var url="../../../../../../ListofEmpValidationSummaryServ.rep?OLevel=division&circles="+circle;
                                      offtype=offtype.substring(0,offtype.length-1);
                                      var url="../../../../../../LongLeaveReportServ_New_Interface?OLevel=division&circles="+circle+"&offtype="+offtype;
...
function frmsubmit()
{
    ...
    //alert('inside submit');
        var url="../../../../../../LongLeaveReportServ_New_Interface?OLevel=submit";
    ...
    document.frmValidationSummaryRep.action="../../../../../../LongLeaveReportServ_New_Interface";
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../LongLeaveReportServ_New_Interface?OLevel=offtype" ;
         //alert(url);
...
function nullcheck()
{
   alert('inside nullcheck');
  
    if(document.frmValidationSummaryRep.txtDateFrom.value.length==0 && document.frmValidationSummaryRep.txtDateFrom.value=="")
    {
       alert('Please Enter the From Date');
       document.frmValidationSummaryRep.txtDateFrom.focus();
       return false;
    }
    
    
     else if(document.frmValidationSummaryRep.txtDateTo.value.length==0 && document.frmValidationSummaryRep.txtDateTo.value=="")
    {
       alert('Please Enter the To Date');
       document.frmValidationSummaryRep.txtDateTo.focus();
       return false;
    }
