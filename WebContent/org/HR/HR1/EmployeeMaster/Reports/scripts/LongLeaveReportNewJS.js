...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.LongLeaveReport.cmbolevel.options[document.LongLeaveReport.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../LongLeaveReportNewServ.rep?OLevel=region" ;
     // alert(url);
      ...
      if(document.LongLeaveReport.chkregion)
      {
               if(document.LongLeaveReport.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../LongLeaveReportNewServ.rep?OLevel=circle&regions="+region;
                              // document.LongLeaveReport.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
            ...
            if(document.LongLeaveReport.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                               ...
                               // alert(divisionflag);
                                ...
                                var url="../../../../../../LongLeaveReportNewServ.rep?OLevel=division&circles="+circle;
                              // document.LongLeaveReport.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
...
{
    //alert('submit');
        var url="../../../../../../LongLeaveReportNewServ.rep?OLevel=submit" ;
    ...
    document.LongLeaveReport.action="../../../../../../LongLeaveReportNewServ.rep";
