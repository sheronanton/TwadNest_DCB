...
function getRegion()
    {
      //  alert(regionflag);
        ...
        if(regionflag==true)
        {
         ...
         var url="../../../../../../RelievalTransferReportServ_New_Interface?OLevel=region" ;
        //alert(url);
                            ...
                            if(region!="")
                            {
                              // alert("inside 1");
                               ...
                               // alert("region1..."+region);
                                ...
                                var url="../../../../../../RelievalTransferReportServ_New_Interface?OLevel=circle&regions="+region;
                             //   alert(url);
                              // document.frmValidationSummaryRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
      ...
      if(document.frmValidationSummaryRep.chkcircle)
      {
            ...
            if(document.frmValidationSummaryRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                              ...
                              var url="../../../../../../RelievalTransferReportServ_New_Interface?OLevel=division&circles="+circle+"&offtype="+offtype+"&regions="+region;
                             //alert(url);
                ...
                else
                {
                             ...
                             if(document.frmValidationSummaryRep.chkcircle.checked==true)
                             {
                                      ...
                                      region=region.substring(0,region.length-1);
                                      //alert(region);
                                      var url="../../../../../../RelievalTransferReportServ_New_Interface?OLevel=division&circles="+circle+"&offtype="+offtype;
                                      //alert(url);
                                      // document.frmValidationSummaryRep.cmbregion.focus();
                                        var req=getTransport();
                                        req.open("GET",url,false);        
...
function frmsubmit()
{
    ...
    //alert('inside submit');
        var url="../../../../../../RelievalTransferReportServ_New_Interface?OLevel=submit";
    ...
    document.frmValidationSummaryRep.action="../../../../../../RelievalTransferReportServ_New_Interface";
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmValidationSummaryRep.cmbolevel.options[document.frmValidationSummaryRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../RelievalTransferReportServ_New_Interface?OLevel=offtype" ;
         //alert(url);
