 ...
 function getOfficesByLevel()
    {
        ...
        var level=document.RelievalTransferReport.cmbControllingLevel.options[document.RelievalTransferReport.cmbControllingLevel.selectedIndex].value;
        var levelt=document.RelievalTransferReport.cmbControllingLevel.options[document.RelievalTransferReport.cmbControllingLevel.selectedIndex].text;
       
        
        document.RelievalTransferReport.chkall.checked=false;
        ...
        if(level=="DN" || level=="SD" || level=="SN" )
        {
            ...
            document.RelievalTransferReport.cmbOfficeType.focus();      
    ...
    function loadOfficesByLevel(level)
    {
        ...
        var url="../../../../../../RelievalTransferReportServ.rep?Command=level&level="+level;
 ...
 function getOfficesByType()
    {
        ...
        items1=null;
         ...
         items5=null;
         items6=null;
        var own=document.RelievalTransferReport.cmbOfficeType.options[document.RelievalTransferReport.cmbOfficeType.selectedIndex].value;
        if(own=="0")
        {
             var cmbpage=document.getElementById("cmbpage");
...
function loadPage(page)
{
            ...
            document.RelievalTransferReport.cmbpage.selectedIndex=page-1;
...
function btncancel()
{
 ...
 document.RelievalTransferReport.cmbControllingLevel.selectedIndex=0;
 var tbody=document.getElementById("tb");
                try{tbody.innerHTML="";}
                          catch(e) {tbody.innerText="";}
}
...
if(v && items5)
{
        ...
        else
        {
            ...
            document.RelievalTransferReport.txtseloff.value=s.substring(0,s.length-1);
            document.RelievalTransferReport.action="../../../../../../RelievalTransferReportServ.rep";
          document.RelievalTransferReport.method="POST";
...
{
//alert('hai');
var page=document.RelievalTransferReport.cmbpage.value;
...
function sellectall()
{
        ...
        if(v && items5)
        {
            if(document.RelievalTransferReport.chkall.checked==true)
            {
                for(i=0;i<items5.length;i++)
                {
                        items5[i]=true;
...
function changepagesize()
{
           ...
           __pagination=document.RelievalTransferReport.cmbpagination.value;
            var v=document.getElementsByName("sel");
            //alert(v);
        if(v && items5)
        {
