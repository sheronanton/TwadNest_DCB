...
function frmsubmit()
{
  var url="";
       ...
       var first_year=document.getElementById("tyear").value;
       var to_year=parseInt(first_year)+parseInt(4);
//       var last_year=new Array();
//       for(var i=0;i<5;i++)
//       {
//          last_year[i]=first_year+i+",";
//       }
//       last_year=last_year.substring(0,last_year.length-1);
       
    url=url+"&year="+first_year+"&to_year="+to_year;
...
//alert(url)
    document.frmValidationSummaryRep.action="../../../../../../Retire_Cadre_5years_serv_New?"+url;
