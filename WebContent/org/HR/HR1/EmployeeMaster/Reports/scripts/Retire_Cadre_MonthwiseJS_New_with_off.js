...
function frmsubmit()
{
 ...
 if(document.frmValidationSummaryRep.tyear.value=="" && document.frmValidationSummaryRep.tyear.value.length==0)
 {
   ...
   return false;
       ...
       var month= document.getElementById("cmbmon").value;
...
url=url+"&off_hierarchy="+off_hierarchy+"&off_level="+off_level+"&month="+month+"&year="+year;

    document.frmValidationSummaryRep.action="../../../../../../Retire_Cadre_Monthwise_New_Serv?"+url;
