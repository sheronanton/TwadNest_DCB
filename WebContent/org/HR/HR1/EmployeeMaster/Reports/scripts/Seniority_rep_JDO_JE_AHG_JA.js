...
function getcadre()
{
		...
		var url="../../../../../../Seniority_rep_JDO_JE_AHG_JA?command=getcadre&cadre_id="+cadre_id ;
...
function getdata()
{
	...
	if(val == true)
	{
	var url="../../../../../../Seniority_rep_JDO_JE_AHG_JA?OLevel=submit";
	...
	if(document.Seniority_rep_JDO_JE_AHG_JA.Seni_sta[0].checked==true)
    {
            url=url+"&Seni_sta=PRO";
           
            document.Seniority_rep_JDO_JE_AHG_JA.Seni_sta.value='PRO';
    }
    else if(document.Seniority_rep_JDO_JE_AHG_JA.Seni_sta[1].checked==true)
    {
            url=url+"&Seni_sta=All";
            document.Seniority_rep_JDO_JE_AHG_JA.Seni_sta.value='All';
    }
    else if(document.Seniority_rep_JDO_JE_AHG_JA.Seni_sta[2].checked==true)
    {
            url=url+"&Seni_sta=WRK";
             document.Seniority_rep_JDO_JE_AHG_JA.Seni_sta.value='WRK';
    }
	
	
	if(document.Seniority_rep_JDO_JE_AHG_JA.optoutputtype[0].checked==true)
    {
            url=url+"&optoutputtype=pdf";
           // document.HRM_seniority_rep.outputtype.value='pdf';
    }
    else if(document.Seniority_rep_JDO_JE_AHG_JA.optoutputtype[1].checked==true)
    {
            url=url+"&optoutputtype=excel";
            //document.HRM_seniority_rep.outputtype.value='excel';
    }
    else if(document.Seniority_rep_JDO_JE_AHG_JA.optoutputtype[2].checked==true)
    {
...
document.Seniority_rep_JDO_JE_AHG_JA.action="../../../../../../Seniority_rep_JDO_JE_AHG_JA";
document.Seniority_rep_JDO_JE_AHG_JA.method="POST";
document.Seniority_rep_JDO_JE_AHG_JA.submit();
	}
}
function valid()
{
   ...
   else if(document.Seniority_rep_JDO_JE_AHG_JA.Seni_sta[0].checked == false && document.Seniority_rep_JDO_JE_AHG_JA.Seni_sta[1].checked == false && document.Seniority_rep_JDO_JE_AHG_JA.Seni_sta[2].checked == false)
	{
			alert("Please Select Status !");
			return false;
	}
   else if(document.Seniority_rep_JDO_JE_AHG_JA.Seni_sta[0].checked == true)
	{
