...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.frmEmployeeDetailRep.cmbolevel.options[document.frmEmployeeDetailRep.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../UnRoleEmp_ReportServ_Individual.rep?OLevel=region" ;
     // alert(url);
      ...
      if(document.frmEmployeeDetailRep.chkregion)
      {
               if(document.frmEmployeeDetailRep.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../UnRoleEmp_ReportServ_Individual.rep?OLevel=circle&regions="+region;
                              // document.frmEmployeeDetailRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,true);        
                                req.onreadystatechange=function()
            ...
            if(document.frmEmployeeDetailRep.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                               ...
                               // alert(divisionflag);
                                ...
                                var url="../../../../../../UnRoleEmp_ReportServ_Individual.rep?OLevel=division&circles="+circle;
                              // document.frmEmployeeDetailRep.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,true);        
                                req.onreadystatechange=function()
...
{
    //alert('submit');
        var url="../../../../../../UnRoleEmp_ReportServ_Individual.rep?OLevel=submit" ;
     ...
     /*   //Designatin validation
        if(document.frmEmployeeDetailRep.optdesignation[0].checked==true)
        {
                url=url+"&designationlevel=all";
                 document.frmEmployeeDetailRep.designationlevel.value='all';
        }
        else
        {
             
                url=url+"&designationlevel=specific";
                document.frmEmployeeDetailRep.designationlevel.value='specific';
                var type=document.frmEmployeeDetailRep.cmbsgroup.options[document.frmEmployeeDetailRep.cmbsgroup.selectedIndex].value;
                if(type=="0")
                {
                    alert('Select the Service Group');
                    document.frmEmployeeDetailRep.cmbsgroup.focus(); 
                    return;
                }
                var type=document.frmEmployeeDetailRep.cmbdes.options[document.frmEmployeeDetailRep.cmbdes.selectedIndex].value;
                
                 if(type=="0")
                 {
                    alert('Select the Designation');
                    document.frmEmployeeDetailRep.cmbdes.focus(); 
                    return;
                 }
                 else
                 {
                    url=url+"&designation="+type;
                     document.frmEmployeeDetailRep.designation.value=type;
                 }
     ...
     /*   //select the order 
        if(document.frmEmployeeDetailRep.optordertype[0].checked==true)
        {
                url=url+"&ordertype=off-des";
                 document.frmEmployeeDetailRep.ordertype.value='off-des';
        }
        else 
        {
                url=url+"&ordertype=des-off";
                 document.frmEmployeeDetailRep.ordertype.value='des-off';
        }*/

    //alert(url);
    
    document.frmEmployeeDetailRep.action=url;
