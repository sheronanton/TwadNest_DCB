...
function servicepopup()
{
    ...
    winemp= window.open("../../../../../../org/HR/HR1/EmployeeMaster/jsps/EmpServicePopup_test.jsp","Employee_Search_for_Emp_Editing","status=1,height=500,width=600,resizable=YES, scrollbars=yes"); 
...
function callServer(command,param)
{
      if(command=="Existg")
       ...
       //startwaiting(document.frmEmployeeProfile) ; 
          url="../../../../../../db_EmployeeProfileServSR?Command=Existg&EmpId=" + strEmpId;
         // alert(url);
...
function existRow(baseResponse)
    {
              ...
              { 
                 ...
                 // document.frmEmployeeProfile.txtEmpId1.disabled=true;
                 
                  //var epho=baseResponse.getElementsByTagName("epho")[0].firstChild.nodeValue; 
                  //alert(epho);
                 ...
                 // alert(exist);
                  ...
                  if((exist != "jpg") && (exist!="gif"))
                  {
                     ...
                     alert("Photo has not been uploaded");                              
                     epho="sample_emp.bmp";
                     //alert(epho)  
                     document.getElementById("photoPath").value=epho;
                  }  
                  ...
                  else   
                  {
                     ...
                     document.getElementById("photoPath").value=epho;
                     //alert(document.getElementById("photoPath").value);
                   } 
                   
                   var process=baseResponse.getElementsByTagName("status")[0].firstChild.nodeValue;
                   //alert(process);
              ...
              else if(flag=="failure")
              {
                ...
                document.frmEmployeeProfile.txtEmpId1.focus();
                document.frmEmployeeProfile.txtEmpId1.value='';
                ocument.frmEmployeeProfile.txtEmployee.value='';
                document.frmEmployeeProfile.txtGpf.value='';
                return false;
              }
              ...
              {
                alert("Given Employee Id is not in your controlling office, Please check the current Posting of the Employee");
                document.frmEmployeeProfile.txtEmpId1.focus();
                document.frmEmployeeProfile.txtEmpId1.value='';
                document.frmEmployeeProfile.txtEmployee.value='';
                document.frmEmployeeProfile.txtGpf.value='';
...
function btnsubmit()
{
      ...
      //  {
              ...
              //alert(path1);
	var val=validation();
	//var valid=callServer('Existg','null');
	if(val == true )
		{
         
              document.frmEmployeeProfile.action="../../../../../../db_EmployeeProfileServSR";
...
function validation()
{
		if(document.getElementById("txtEmpId1").value=="")
			{
				alert("Please Select Employee Id");
				document.getElementById("txtEmpId1").focus();
				return false;
	         }
