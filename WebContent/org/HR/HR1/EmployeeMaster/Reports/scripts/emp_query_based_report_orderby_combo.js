...
function selectoption2()
{
  ...
  {
   // alert(document.frmEmployeeorderby_combo.rad_off[1].checked);
    var offlevel=document.getElementById("trofficeselection");
    offlevel.style.display="block";
    //document.getElementById("divallhier").style.display='block';
  ...
  {
   // alert(document.frmEmployeeorderby_combo.rad_off[2].checked);
     var offlevel=document.getElementById("trofficeselection");
    offlevel.style.display="block";
    //document.getElementById("divallhier").style.display='block';
  ...
  else if(document.frmEmployeeorderby_combo.rad_off[0].checked)
  {
     var offlevel=document.getElementById("trofficeselection");
    offlevel.style.display="block";
    //document.getElementById("divallhier").style.display='block';
  ...
  document.frmEmployeeorderby_combo.cmbcircle.disabled=true;
   // document.frmEmployeeorderby_combo.cmbofftype.disabled=true;
    document.frmEmployeeorderby_combo.cmbdivision.disabled=true;
        ...
        req.onreadystatechange=function()
        {
            ...
            if(req.status==200)
            {
                 // alert(req.responseText);               
                  ...
                  document.frmEmployeeorderby_combo.cmbcircle.disabled=false;
                   var iframe=document.getElementById("diviframecircle");
                            iframe.style.visibility='hidden';
                   var iframe=document.getElementById("diviframedivision");
                            iframe.style.visibility='hidden';
...
function getCircle(cir)
{
      //alert("inside getcircle");
       ...
       var region="";
     //   var type=document.frmEmployeeorderby_combo.cmbolevel.options[document.frmEmployeeorderby_combo.cmbolevel.selectedIndex].value;
    ...
    //  if(document.frmEmployeeorderby_combo.chkregion)
      //{
          ...
          //alert(document.frmEmployeeorderby_combo.chkregion);
           
               if(document.frmEmployeeorderby_combo.chkregion.length > 0)
              {
                 ...
                 //alert(document.frmEmployeeorderby_combo.chkregion.length);
                            ...
                            {
                              //  alert("document.frmEmployeeorderby_combo.chkregion[i].checked..."+document.frmEmployeeorderby_combo.chkregion[i].checked);
                                 ...
                                 if(circleflag==true && cir=='null')
                                {
                                  //     alert("inside 2");
                                         var iframe=document.getElementById("diviframecircle");
                                            iframe.style.visibility='visible';
                                          iframe.focus();
                                           document.frmEmployeeorderby_combo.cmbdivision.disabled=false;
                                      //  return;
                                }
...
//         }   
         ...
         if(document.frmEmployeeorderby_combo.chkregion.length>0)
              {
                   for(i=0;i<document.frmEmployeeorderby_combo.chkregion.length;i++)
                            {
                            //  alert(document.frmEmployeeorderby_combo.chkregion[i].value);
                                    if(document.frmEmployeeorderby_combo.chkregion[i].checked==true)
                                            region= region+document.frmEmployeeorderby_combo.chkregion[i].value +",";
                                          // alert('region...'+region);
       ...
       if(document.frmEmployeeorderby_combo.chkofftype)
       {
               
         if(document.frmEmployeeorderby_combo.chkofftype.length)
         {
                    
                  for(i=0;i<document.frmEmployeeorderby_combo.chkofftype.length;i++)
                  {
                    if(document.frmEmployeeorderby_combo.chkofftype[i].checked==true)
                     offtype= offtype+"'"+document.frmEmployeeorderby_combo.chkofftype[i].value+"'"+",";            
   ...
   if(document.frmEmployeeorderby_combo.chkregion)
      {
            ...
            for(i=0;i<document.frmEmployeeorderby_combo.chkregion.length;i++)
            {
                    document.frmEmployeeorderby_combo.chkregion[i].checked=true;
   ...
   if(document.frmEmployeeorderby_combo.chkofftype)
      {
            ...
            for(i=0;i<document.frmEmployeeorderby_combo.chkofftype.length;i++)
            {
                    document.frmEmployeeorderby_combo.chkofftype[i].checked=true;
    ...
    if(document.frmEmployeeorderby_combo.chkcircle)
      {
            ...
            for(i=0;i<document.frmEmployeeorderby_combo.chkcircle.length;i++)
            {
                    document.frmEmployeeorderby_combo.chkcircle[i].checked=true;
    ...
    if(document.frmEmployeeorderby_combo.chkdivision)
      {
            ...
            {
                    document.frmEmployeeorderby_combo.chkdivision[i].checked=true;
...
function oftypeonchange()
{
     ...
     if(document.frmEmployeeorderby_combo.rad_off[3].checked)
     {
    ...
    //alert('inside submit');
        var url="../../../../../../ListofWorkingEmpSRCtlOfficeServ_New_Interface?OLevel=submit";
                         ...
                         if(document.frmEmployeeorderby_combo.rad_off[1].checked)    
                          ...
                          else if(document.frmEmployeeorderby_combo.rad_off[2].checked) 
       ...
       // }
        ...
        if(document.frmEmployeeorderby_combo.optoutputtype[0].checked==true)
        {
                url=url+"&outputtype=pdf";
                document.frmEmployeeorderby_combo.outputtype.value='pdf';
        }
        else if(document.frmEmployeeorderby_combo.optoutputtype[1].checked==true)
        {
                url=url+"&outputtype=excel";
                document.frmEmployeeorderby_combo.outputtype.value='excel';
        }
        else if(document.frmEmployeeorderby_combo.optoutputtype[2].checked==true)
        {
                url=url+"&outputtype=html";
                 document.frmEmployeeorderby_combo.outputtype.value='html';
        }
        
   
    
    document.frmEmployeeorderby_combo.action="../../../../../../ListofWorkingEmpSRCtlOfficeServ_New_Interface";
...
function getofftype()
    {
      //  alert(regionflag);
       ...
       // var type=document.frmEmployeeorderby_combo.cmbolevel.options[document.frmEmployeeorderby_combo.cmbolevel.selectedIndex].value;
        ...
        document.frmEmployeeorderby_combo.cmbofftype.focus();
        var req=getTransport();
        req.open("GET",url,true);        
        req.onreadystatechange=function()
        {
...
change=0;
    ...
    if(change!=0)
    {
    	document.frmEmployeeorderby_combo.Submit3.disabled=false;
  	  //document.frmValidationSummaryRep.Submit4.disabled=false;
  	  //document.frmValidationSummaryRep.validate.disabled=true;
    }
    /*
     * 
     *  document.frmValidationSummaryRep.Submit3.disabled=true;
                    	  document.frmValidationSummaryRep.Submit4.disabled=true;
                    	  document.frmValidationSummaryRep.validate.disabled=true;
     */
