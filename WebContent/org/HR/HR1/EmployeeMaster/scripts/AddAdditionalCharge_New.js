...
function doParentJob(jobid,deptid)
{
    ...
    if(jobflag==true)
    {
        document.frmCurrentPosting.txtDept_Id_work1.value=deptid;
        document.frmCurrentPosting.txtOffice_Id1.value=jobid ;
        doFunction('Load1',true);
        return true
    }
    else
    {
        document.frmCurrentPosting.txtDept_Id1.value=deptid;
        document.frmCurrentPosting.txtOthOffice_Id1.value=jobid ;
        doFunction('Load1',false);
        return true
    }
...
function notNull()
{
    ...
    if((document.frmCurrentPosting.txtEmployeeid.value==null)||(document.frmCurrentPosting.txtEmployeeid.value.length==0))
    {
     ...
     if(isNaN(document.frmCurrentPosting.txtEmployeeid.value))
    {
    ...
    if((document.frmCurrentPosting.cmbsgroup1.value=="0")||(document.frmCurrentPosting.cmbsgroup1.value.length==0))
    {
    	alert("Select a Service Group");
    	 return false;
        ...
        if((document.frmCurrentPosting.cmbDesignation1.value=="0")||(document.frmCurrentPosting.cmbDesignation1.value.length==0))
        {
        ...
        else
        {
                ...
                if(type!="")
                {
                    ...
                    {
                          // alert('deputation');
                            if((document.frmCurrentPosting.txtDept_Id_work1.value=='')||(document.frmCurrentPosting.txtDept_Id_work1.value.length==0))
                            {
                    ...
                    else  if(type=='WKG')
                    {
                            ...
                            if((document.frmCurrentPosting.txtOffice_Id1.value==null)||(document.frmCurrentPosting.txtOffice_Id1.value.length==0))
                            {
                                alert("Select Office Id");
                                document.frmCurrentPosting.txtOffice_Id.focus();
                                return false;
                            }
                            if((document.frmCurrentPosting.txtOffice_Name1.value==null)||(document.frmCurrentPosting.txtOffice_Name1.value.length==0))
                            {
                                alert("Enter Office Name");
                                document.frmCurrentPosting.txtOffice_Id.focus();
                                return false;
                            }
                            if((document.frmCurrentPosting.txtOffice_Address11.value==null)||(document.frmCurrentPosting.txtOffice_Address11.value.length==0))
                            {
                                alert("Enter Office Address");
                                document.frmCurrentPosting.txtOffice_Id.focus();
                                return false;
                            }
                             if((document.frmCurrentPosting.txtWorkDateFrom1.value==null)||(document.frmCurrentPosting.txtWorkDateFrom1.value.length==0))
                            {
                                alert("Enter a value for Date from ");
...
function doFunction(Command,param)
{
   // alert("command:"+Command);
	...
	if(Command=='load_grid1')
	{
                ...
                var url="../../../../../AddAdditionalCharge_New?Command=load_grid1";
       ...
       // alert(check);
        if(check)
        {
               statuswaiting(document.frmCurrentPosting) ;
                    document.frmCurrentPosting.action="../../../../../AddAdditionalCharge_New?Command=Validate&txtEmployeeid="+empid;
    ...
    else if(Command=="Load1")
    {
          var  Office_Id=0;
          var   Dept_Id;
          var current_emp_working=document.getElementById("txtOffice_Id").value;
         // alert(current_emp_working+"   SSSS");
...
//         if(current_emp_working==Office_Id)
//        	 {
//        	 alert("Additional Charge Office should not be same as current posting office");
//        	 document.getElementById("txtOffice_Id1").value="";
//        	 document.getElementById("txtOffice_Id1").focus();
//        	 }
//         else
//        	 {
     ...
     else if(Command=='AddPost')
    {
       ...
       // alert(check);
        ...
        //   if(checkPost())
           {
               statuswaiting(document.frmCurrentPosting) ;
                    document.frmCurrentPosting.action="../../../../../AddAdditionalCharge_New?Command=AddPost&txtEmployeeid="+empid;
                         document.frmCurrentPosting.method="POST";
                         document.frmCurrentPosting.submit();
                       return;   
            }   
...
//      	th.setAttribute("style", "border-bottom: 1px solid #000;");
        ...
        var table=document.getElementById("gridTable");
    	   ...
    	   var SLNO=baseResponse.getElementsByTagName("SLNO")[i].firstChild.nodeValue;
            ...
            var ADDL_CHARGE_STATUS=baseResponse.getElementsByTagName("ADDL_CHARGE_STATUS")[i].firstChild.nodeValue;
...
//		        	td.setAttribute("style", "border-bottom: 1px solid #000;");
            ...
            if((process_flow_status_id=="CR" || process_flow_status_id=="MD") && ADDL_CHARGE_STATUS=="CR")
        	{
...
//	if(Exist=="Existed")
//		{
//		alert("Already This Employee has an unfreezed record,\n"+"Please use Update or Validate Forms");
//		document.getElementById("txtEmployeeid").value="";
//		}
	if(Exist=="Not Existed" || Exist=="Existed")
		{
		 var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
	     if(flag=="success")
	    {
...
//			        	td.setAttribute("style", "border-bottom: 1px solid #000;");
	     ...
	     else if(flag=="failure2")
	    {
	    	 var table=document.getElementById("gridTable");
	            ...
	            var id=document.frmCurrentPosting.txtEmployeeid.value;
	            alert(" Can not view Additional charge for "+id+"!");
	            clr();
	    }
	     else if(flag=="failure3")
	    {
	    	 var table=document.getElementById("gridTable");
	            ...
	            var id=document.frmCurrentPosting.txtEmployeeid.value;
	            alert("Given Employee Id " +id+" has no SR control Office. Can not view Additional charge!");
	            clr();
	    }
	    else if(flag=="failure4")
	    {
	    	 var table=document.getElementById("gridTable");
	            ...
	            var id=document.frmCurrentPosting.txtEmployeeid.value;
	            alert("Can not view Additional charge. Access Denined!");
	           clr();
	    }
	    else if(flag=="norecord")
	    {
	    	 var table=document.getElementById("gridTable");
	            ...
	            var id=document.frmCurrentPosting.txtEmployeeid.value;
	            alert("There is no record to view for this Employee!");
	           clr();
	    }
...
{
//alert(val);
       var url="../../../../../AddAdditionalCharge_New?Command=SerGroup&cmbdes="+val;
                req.open("GET",url,true);
                req.onreadystatechange=handleResponse;
                if(window.XMLHttpRequest)
                        req.send(null);
...
function callCheckPost()
{
  
    var empid=document.frmCurrentPosting.txtEmployeeid.value;
    alert(empid)
    var offid=document.frmCurrentPosting.txtOffice_Id1.value;
    alert("office id is:"+offid);
    var dsg=document.frmCurrentPosting.cmbDesignation1.options[document.frmCurrentPosting.cmbDesignation1.selectedIndex].value;
    alert(dsg);
      //  if(dsg!=0)
       // {
        var url="../../../../../AddAdditionalCharge_New?Command=checkPost&offid="+offid+"&cmbdesig="+dsg ;
        alert(url);
        var req1=getTransport();
        alert(req1);
    ...
    if(req1.readyState==4)
        {
          ...
          { 
                ...
                if(flag=='failure')
                  {
                  alert('Employee Already Exists in this post')
                  return false;
                  }
               else 
                 {
...
{
	alert("**");
	var offid=document.getElementById("txtOffice_Id1").value;
	var empid=document.getElementById("txtEmployeeid").value;
	var url="../../../../../HRE_OfficeDetailServ.view?command=Load&OfficeId="+offid+"&txtDept_Id="+Dept_Id+"&disigid="+dsg+"&empid="+empid;
    alert(url);
	var req1=getTransport();
     req1.open("GET",url,true);        
     req1.onreadystatechange=function()
