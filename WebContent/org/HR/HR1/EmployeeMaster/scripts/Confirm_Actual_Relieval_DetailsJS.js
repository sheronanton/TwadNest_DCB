...
{
//alert("hhii");
  /*  if(document.EmpRelieval.txttempidOffId.value.length==0)
    {
...
{
      eid=document.EmpRelieval.cmb_EmpId.options[document.EmpRelieval.cmb_EmpId.selectedIndex].value;
   // alert(eid);
    ...
    {
      var reason=document.EmpRelieval.cmbReason.options[document.EmpRelieval.cmbReason.selectedIndex].value;
    ...
    {       
        ...
        var offid=document.EmpRelieval.txtOffId.value;
         var reason=document.EmpRelieval.cmbReason.options[document.EmpRelieval.cmbReason.selectedIndex].value;
            var url="../../../../../Confirm_Actual_Relieval_Serv.view?Command=loademp&txtEmployeeid="+eid+"&offid="+offid+"&reasonid="+reason;
             //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Confirm_Actual_Relieval_Serv.view?Command=office&oid="+oid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Confirm_Actual_Relieval_Serv.view?Command=dept&oid="+oid+"&deptid="+deptid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Confirm_Actual_Relieval_Serv.view?Command=desig&desigid="+desigid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
...
//alert('aaa');
    ...
    {  //alert("success");
        ...
        var proceed_no=baseResponse.getElementsByTagName("proceed_no")[0].firstChild.nodeValue;
        
        var proceed_date=baseResponse.getElementsByTagName("proceed_date")[0].firstChild.nodeValue;
        var proceed_sub=baseResponse.getElementsByTagName("proceed_sub")[0].firstChild.nodeValue;
        var proceed_ref=baseResponse.getElementsByTagName("proceed_ref")[0].firstChild.nodeValue;
        var add_para1=baseResponse.getElementsByTagName("add_para1")[0].firstChild.nodeValue;
        var add_para2=baseResponse.getElementsByTagName("add_para2")[0].firstChild.nodeValue;
        var copy_to=baseResponse.getElementsByTagName("copy_to")[0].firstChild.nodeValue;
        var presid_officer=baseResponse.getElementsByTagName("presid_officer")[0].firstChild.nodeValue;
        var presid_officer_desig=baseResponse.getElementsByTagName("presid_officer_desig")[0].firstChild.nodeValue;
        var suffix=baseResponse.getElementsByTagName("suffix")[0].firstChild.nodeValue;
        var individ_add=baseResponse.getElementsByTagName("individ_add")[0].firstChild.nodeValue;
        var prefix=baseResponse.getElementsByTagName("prefix")[0].firstChild.nodeValue;
...
//alert(maxfromdate);
        ...
        document.EmpRelieval.txtPNo.value=proceed_no;
        document.EmpRelieval.txtT_proc_Date.value=procdate;
        document.EmpRelieval.txtSub.value=proceed_sub;
        document.EmpRelieval.txtRef.value=proceed_ref;
        if(add_para1=="-")
        {
        add_para1="";
        }
        ...
        add_para1=add_para1;
        document.EmpRelieval.txtAdd1.value=add_para1;
        if(add_para2=="-")
        {
        add_para2="";
        }
        ...
        add_para2=add_para2;
        document.EmpRelieval.txtAdd2.value=add_para2;
        document.EmpRelieval.txtcopy.value=copy_to;
        document.EmpRelieval.txtPO.value=presid_officer;
        if(suffix=="-")
        {
        suffix="";
        }
        ...
        suffix=suffix;
        document.EmpRelieval.txtSuf.value=suffix;
        document.EmpRelieval.txtPref.value=prefix;
        document.EmpRelieval.txtPOD.value=presid_officer_desig;
                        
                                  
        document.EmpRelieval.cmb_relproc_no.value=proceed_no;
        if(r_noon=='FN')
        {
        ...
        else if(r_noon=='AN')
        {
          ...
          if(individ_add=='Y')
        {
         document.EmpRelieval.rad_indi[0].checked=true;
        }
        else if(individ_add=='N')
        {
           document.EmpRelieval.rad_indi[1].checked=true;
        }
        /*var reasonid=document.getElementById("cmbReason").value;
        alert(reasonid);
...
function getOther()
{
  ...
  else
  {
    if(reas=='TRN')
    {
     ...
     var url="../../../../../Confirm_Actual_Relieval_Serv.view?Command=GetOtherDet&OrderId="+ord+"&Emp="+eid+"&reas="+reas;
     //alert(url);
     var req=getTransport();
...
function  butconfirm()
{
window.confirm("Do You Want To Relieval This Employee");
}
