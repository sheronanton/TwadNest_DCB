...
function doFunction(Command,param)
{
  ...
  if(Command=="loademp")
  {
    var url="../../../../../Create_Deputation_OrderServ?Command=loademp&txtEmployeeid="+eid+"&offid="+ofid;
  ...
  else if(Command=="office")
  {
            ...
            var url="../../../../../Create_Deputation_OrderServ?Command=office&oid="+oid;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
   ...
   else if(Command=="getDet")
   {
      ...
      var url="../../../../../Create_Deputation_OrderServ?Command=getDet&order="+ord_id+"&offid="+off_id;
     // alert(url);
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
   ...
   else if(Command=="Add")
   {
      ...
      var url="../../../../../Create_Deputation_OrderServ?Command=Add&txtEmployeeid="+eid+"&offid="+ofid+"&department="+dpn_deptid+"&depn_offid="+dpnofid+"&reason_id="+reas_id+"&reason="+reas+"&pro_desig="+new_desig+"&dpn_designation="+dpn_desig+"&repost="+rep+"&ta_da="+req_transf+"&order="+new_ord;
     //alert(url);
      var req=getTransport();
      req.open("GET",url,true);
   ...
   else if(Command=="Update")
   {
      ...
      var url="../../../../../Create_Deputation_OrderServ?Command=Update&txtEmployeeid="+eid+"&offid="+ofid+"&repost="+rep+"&trfoff="+trof+"&desig_id="+desi+"&order="+ord;
   ...
   {
      var url="../../../../../Create_Deputation_OrderServ?Command=Delete&txtEmployeeid="+eid+"&offid="+ofid+"&order="+ord;
   ...
   {
      var url="../../../../../Create_Deputation_OrderServ?Command=ProcId&txtoffid="+ofid;
   ...
   else if(Command=="desig")
   {
     var desig=document.frmTransfer.txtP_desigId.value;
      ...
      var url="../../../../../Create_Deputation_OrderServ?Command=Desig&txtDesigid="+desig;
   ...
   else if(Command=="dept")
   {
     ...
     var url="../../../../../Create_Deputation_OrderServ?Command=Deptid&dept_id="+depart+"&office_id="+dpt_offid;
...
{
   //alert(val); 
    var url="../../../../../Create_Deputation_OrderServ?Command=SerGroup&cmbdes="+val;
    //alert(url);
    var req= getTransport();
    req.open("GET",url,true);
    req.onreadystatechange=function()
