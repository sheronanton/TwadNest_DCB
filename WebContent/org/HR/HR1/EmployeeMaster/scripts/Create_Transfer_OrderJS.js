...
function doFunction(Command,param)
{
  ...
  if(Command=="loademp")
  {
    ...
    //alert("the login office id is"+logofid);
    var url="../../../../../Create_Transfer_OrderServ?Command=loademp&txtEmployeeid="+eid+"&offid="+ofid+"&pro_id="+new_ord+"&logofid="+logofid;
  ...
  else if(Command=="office")
  {
   ...
   else if(Command=="getDet")
   {
      ...
      var url="../../../../../Create_Transfer_OrderServ?Command=getDet&order="+ord_id+"&offid="+off_id;
     // alert(url);
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
   ...
   else if(Command=="Add")
   {
      ...
      */
      ...
      var url="../../../../../Create_Transfer_OrderServ?Command=Add&txtEmployeeid="+eid+"&offid="+ofid+"&repost="+rep+"&trfoff="+trof+"&desig_id="+desi+"&order="+new_ord+"&reason_id="+reas+"&req_trans="+req_transf;
      //alert(url);
      var req=getTransport();
      req.open("GET",url,true);
   ...
   else if(Command=="Update")
   {
      ...
      var url="../../../../../Create_Transfer_OrderServ?Command=Update&txtEmployeeid="+eid+"&offid="+ofid+"&repost="+rep+"&trfoff="+trof+"&desig_id="+desi+"&order="+ord;
   ...
   {
      var url="../../../../../Create_Transfer_OrderServ?Command=Delete&txtEmployeeid="+eid+"&offid="+ofid+"&order="+ord;
   ...
   {
      var url="../../../../../Create_Transfer_OrderServ?Command=ProcId&txtoffid="+ofid;
   ...
   else if(Command=="desig")
   {
     var desig=document.frmTransfer.txtP_desigId.value;
      ...
      var url="../../../../../Create_Transfer_OrderServ?Command=Desig&txtDesigid="+desig;
       ...
       else
       {
        ...
        alert(items[8]);*/
          ...
          var cell3=document.createElement("TD");
           ...
           {
             var cell4=document.createElement("TD");             
             var desid=document.createTextNode(trf_desig);
             cell4.appendChild(desid);
...
{
   //alert(val); 
    var url="../../../../../Create_Transfer_OrderServ?Command=SerGroup&cmbdes="+val;
    //alert(url);
    var req= getTransport();
    req.open("GET",url,true);
    req.onreadystatechange=function()
