...
function doFunction(Command,param)
{
    ...
    if(Command=='loadempedit')
    {
        ...
        if(check )
        {
                ...
                var url="../../../../../CurrentPostingServ.view?Command=loadempvalid&txtEmployeeid="+empid;
    ...
    else if(Command=='loadempeditstatus')
    {
        ...
        if(check )
        {
                ...
                var url="../../../../../CurrentPostingServ.view?Command=loadempvalidStatus&txtEmployeeid="+empid;
               // var req=getTransport();
              // alert(req);
                req.open("GET",url,true);
                req.onreadystatechange=handleResponse;
       ...
       // alert(check);
        if(check)
        {
               statuswaiting(document.frmCurrentPosting) ;
                    document.frmCurrentPosting.action="../../../../../CurrentPostingServ.view?Command=Validate&txtEmployeeid="+empid;
    ...
    else if(Command=='ValidateStatus')
    {
        ...
        if(check)
        {
               ...
               cmbstatus=document.frmCurrentPosting.cmbstatus.value;
                    document.frmCurrentPosting.action="../../../../../CurrentPostingServ.view?Command=ValidateStatus&txtEmployeeid="+empid+"&cmbstatus="+cmbstatus;
                         document.frmCurrentPosting.method="POST";
                         document.frmCurrentPosting.submit();
                       return;   
...
function handleResponse()
{
    ...
    if(req.readyState==4)
    {
        if(req.status==200)
        {
            ...
            if(Command=="loadempvalid")
            {
                loadEmp(baseResponse);
            }
            else  if(Command=="loadempvalidStatus")
            {
                loadEmpStatus(baseResponse);
            }
...
//                 paybillsubgroup="";
    ...
    {
            var id=document.frmCurrentPosting.txtEmployeeid.value;
            alert("You have no Validate Posting. Can not Create Current Posting for "+id+"!");
            clr();
    }
     else if(flag=="failure3")
    {
            var id=document.frmCurrentPosting.txtEmployeeid.value;
            alert("Given Employee Id " +id+" has no SR control Office. Can not Validate Current Posting!");
            clr();
    }
    else if(flag=="failure4")
    {
            var id=document.frmCurrentPosting.txtEmployeeid.value;
            alert("Can not Validate Current Posting. Access Denined!");
           clr();
    }
    else if(flag=="norecord")
    {
            var id=document.frmCurrentPosting.txtEmployeeid.value;
            alert("There is no record to Validate for this Employee!");
           clr();
    }
...
function loadEmpStatus(baseResponse)
{
     ...
     if(flag=="success")
    {
           ...
           clr();
            ...
            var type=EMPLOYEE_STATUS_ID;
           // alert("dfd");
            document.frmCurrentPosting.txtstatus.value=type;
            if(EMPLOYEE_STATUS_ID=='LLV'||EMPLOYEE_STATUS_ID=='UAL'||EMPLOYEE_STATUS_ID=='SUS')
            {
             disableAll();
             ...
             /*if(PROCESS_FLOW_STATUS_ID=="FR")
             {
                 ...
                 if(admin=='YES')
                 {
                 	alert('Record is Freezed ,Use Edit form for Updation' );
                 	document.frmCurrentPosting.cmdedit.disabled=true;;
                 	return false;
                 }
                 else
            ...
            {
            	alert("Employee Status doesnt belong to Long leave,Unauthorised or Suspend");
            	document.frmCurrentPosting.cmdedit.disabled=true;
            	return false;
            }
