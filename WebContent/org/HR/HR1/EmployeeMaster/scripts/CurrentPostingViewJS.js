...
function doFunction(Command,param)
{
    ...
    if(Command=='loadempview')
    {
        ...
        if(check )
        {
                ...
                var url="../../../../../CurrentPostingServ.view?Command=loadempview&txtEmployeeid="+empid;
...
function loadEmp(baseResponse)
{
    ...
    {
            var id=document.frmCurrentPosting.txtEmployeeid.value;
            alert(" Can not view Current Posting for "+id+"!");
            clr();
    }
     else if(flag=="failure3")
    {
            var id=document.frmCurrentPosting.txtEmployeeid.value;
            alert("Given Employee Id " +id+" has no SR control Office. Can not view Current Posting!");
            clr();
    }
    else if(flag=="failure4")
    {
            var id=document.frmCurrentPosting.txtEmployeeid.value;
            alert("Can not view Current Posting. Access Denined!");
           clr();
    }
