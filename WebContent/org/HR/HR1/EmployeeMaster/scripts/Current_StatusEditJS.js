...
function doFunction(Command,param)
{
    ...
    if(Command=='loadempedit1')
    {
        ...
        if(check )
        {
                ...
                var url="../../../../../CurrentPostingServ.view?Command=loadempedit1&txtEmployeeid="+empid;
...
//        load_paybill();
    ...
    if(Command=='loadempedit')
    {
        ...
        if(check )
        {
                ...
                var url="../../../../../CurrentPostingServ.view?Command=loadempedit&txtEmployeeid="+empid;
               // var req=getTransport();
              // alert(req);
              alert(url);
                req.open("GET",url,true);
...
//        load_paybill();
    ...
    else if(Command=='updation')
    {
    	...
    	// if(check)
         //{
                ...
                var txtWorkDateFrom=document.getElementById("txtWorkDateFrom").value;
                var emp_sts_id=document.getElementById("emp_sts_id").value;
                var txtworkremark=document.getElementById("txtworkremark").value;
              // alert("txtWorkDateFrom--->"+txtWorkDateFrom+ " ====emp_sts_id===>"+emp_sts_id+"-txtworkremark"+txtworkremark);
                     document.frmCurrentPosting.action="../../../../../CurrentPostingServ.view?Command=updation_office&txtEmployeeid="+empid+"&txtWorkDateFrom="+txtWorkDateFrom+"&emp_sts_id="+emp_sts_id+"&txtworkremark="+txtworkremark;
                          document.frmCurrentPosting.method="POST";
                          document.frmCurrentPosting.submit();
                          document.frmCurrentPosting.cmdedit1.disabled=false;
     ...
     else if(Command=='Validated')
    {
    	...
    	// if(check)
         //{
                ...
                var txtworkremark=document.getElementById("txtworkremark").value;
              // alert("txtWorkDateFrom--->"+txtWorkDateFrom+ " ====emp_sts_id===>"+emp_sts_id+"-txtworkremark"+txtworkremark);
                     document.frmCurrentPosting.action="../../../../../CurrentPostingServ.view?Command=Validate_office&txtEmployeeid="+empid+"&txtWorkDateFrom="+txtWorkDateFrom+"&emp_sts_id="+emp_sts_id+"&txtworkremark="+txtworkremark;
                          document.frmCurrentPosting.method="POST";
                          document.frmCurrentPosting.submit();
                        return;   
    ...
    else if(Command=='Update')
    {
       ...
       // alert(check);
        ...
        {
               statuswaiting(document.frmCurrentPosting) ;
                    document.frmCurrentPosting.action="../../../../../CurrentPostingServ.view?Command=UpdateStatus&txtEmployeeid="+empid;
                         document.frmCurrentPosting.method="POST";
                         document.frmCurrentPosting.submit();
                       return;   
    ...
    else if(Command=="Delete")
    {
        ...
        {
                statuswaiting(document.frmCurrentPosting) ;
                var url="../../../../../CurrentPostingServ.view?Command=Delete&txtEmployeeid="+empid;
                 url=url+"&txtSNo="+slno;
                req.open("GET",url,true);
                req.onreadystatechange=handleResponse;
                if(window.XMLHttpRequest)
    ...
    else if(flag=="success")
    {
        ...
        //  alert("dfdgfsdg");
           ...
           //alert(OFFICE_ID)
            ...
            var EMPLOYEE_STATUS_DESC=baseResponse.getElementsByTagName("EMPLOYEE_STATUS_DESC")[0].firstChild.nodeValue;
            ...
            document.frmCurrentPosting.txtOffice_Name.value=OFFICE_NAME;
           // document.frmCurrentPosting.txtWorkDateFrom.value=DATE_EFFECTIVE_FROM;
            ...
            document.frmCurrentPosting.txtstatus.value=EMPLOYEE_STATUS_DESC;
...
//                 paybillsubgroup="";
    ...
    {
    	alert("This Employee Dose not have office Id");
    	clr();
    }
     ...
     else if(flag=="failure4")
    {
     ...
     else if(flag=="emp_status")
     {
    	 alert("Employee Status does not in LLU, UAL or SUS ");
    	 clr();
     }
    else if(flag="noteligible")
    {
...
function load_paybill()
{
	...
	var url="../../../../../CurrentPostingServ.view?Command=load_paybill&emp_id="+emp_id;
...
function load_paybill_by_off()
{
	...
	//alert(off_id1);
	var url="../../../../../CurrentPostingServ.view?Command=load_paybill_by_off&off_id1="+off_id1;
...
function load_curr_data()
{
	...
	var url="../../../../../CurrentPostingServ.view?Command=load_curr_data&emp_id="+emp_id;
