...
function doFunction(command)
{
   ...
   if(command=="getDet")
   {
      ...
      var url="../../../../../Edit_Dept_Willingness_DetailsServ?command=getDet&order="+ord_id+"&offid="+off_id;
      //alert(url);
   ...
   else if(command=="add")
   {
        ...
        if(c)
        {
            ...
            var url="../../../../../Edit_Dept_Willingness_DetailsServ?command=add&offid="+offid+"&refid="+refid+"&eid="+eid+"&willingdate="+willingdate;
            var req=getTransport();
            req.open("GET",url,true);
            req.onreadystatechange=function()
            {
   ...
   else if(command=="delete")
   {
        ...
        if(c)
        {
            ...
            var url="../../../../../Edit_Dept_Willingness_DetailsServ?command=delete&offid="+offid+"&refid="+refid+"&eid="+eid;
            var req=getTransport();
            req.open("GET",url,true);
            req.onreadystatechange=function()
            {
   ...
   else if(command=="update")
   {
        ...
        if(c)
        {
            ...
            var eid=document.frmDeptWilling.txtEmployeeid.value;  
            var willingdate=document.frmDeptWilling.txtPDat.value;             
            var url="../../../../../Edit_Dept_Willingness_DetailsServ?command=update&offid="+offid+"&refid="+refid+"&eid="+eid+"&willingdate="+willingdate;
            var req=getTransport();
            req.open("GET",url,true);
            req.onreadystatechange=function()
            {
...
function fnsubmit()
{
    var url="../../../../../Edit_Dept_Willingness_DetailsServ?command=submit";  
    var empid="";
    var willingdate="";
