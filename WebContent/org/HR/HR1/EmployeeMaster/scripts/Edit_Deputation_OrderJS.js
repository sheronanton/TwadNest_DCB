...
function doFunction(Command,param)
{
        ...
        var dpn_deptid=document.frmTransfer.cmb_Deptid.options[document.frmTransfer.cmb_Deptid.selectedIndex].value;
        var dpn_offid=document.frmTransfer.txtT_OffId.value;
        
        var dpnofid;
        if(dpn_offid==null || dpn_offid=="")
        {
          dpnofid=0;
        }
        else
        ...
        var reas_id=document.frmTransfer.cmbreasid.options[document.frmTransfer.cmbreasid.selectedIndex].value;
        
        var reas=document.frmTransfer.cmbreasid.options[document.frmTransfer.cmbreasid.selectedIndex].text;
        
        
        
        dpn_desig=document.frmTransfer.txtP_DesigName.value;
  ...
  if(Command=="loademp")
  {
    var url="../../../../../Edit_Deputation_OrderServ?Command=loademp&txtEmployeeid="+eid+"&offid="+ofid;
  ...
  else if(Command=="office")
  {
            ...
            var url="../../../../../Edit_Deputation_OrderServ?Command=office&oid="+oid;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
   ...
   else if(Command=="getDet")
   {
      ...
      var url="../../../../../Edit_Deputation_OrderServ?Command=getDet&order="+ord+"&offid="+off_id;
     // alert(url);
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
   ...
   else if(Command=="Add")
   {
      ...
      var new_desig;
        if(reas_id==1)
        {
          new_desig=document.frmTransfer.cmbDesignation.options[document.frmTransfer.cmbDesignation.selectedIndex].value;
        }
        else
        {
          new_desig=document.frmTransfer.txt_desid.value; 
        }
      //var url="../../../../../Create_Deputation_OrderServ?Command=Add&txtEmployeeid="+eid+"&offid="+ofid+"&repost="+rep+"&trfoff="+trof+"&desig_id="+desi+"&order="+new_ord+"&reason_id="+reasid+"&req_trans="+req_transf+"&indi_addr="+indi_addr+"&department="+depart;
      var url="../../../../../Edit_Deputation_OrderServ?Command=Add&txtEmployeeid="+eid+"&offid="+ofid+"&department="+dpn_deptid+"&depn_offid="+dpnofid+"&reason_id="+reas_id+"&reason="+reas+"&pro_desig="+new_desig+"&dpn_designation="+dpn_desig+"&repost="+rep+"&ta_da="+req_transf+"&order="+ord;
      //alert(url);
      var req=getTransport();
      req.open("GET",url,true);
   ...
   else if(Command=="Update")
   {
      ...
      var url="../../../../../Edit_Deputation_OrderServ?Command=Update&txtEmployeeid="+eid+"&offid="+ofid+"&department="+dpn_deptid+"&depn_offid="+dpn_offid+"&reason_id="+reas_id+"&reason="+reas+"&pro_desig="+new_desig+"&dpn_designation="+dpn_desig+"&repost="+rep+"&ta_da="+req_transf+"&order="+ord;
      //alert(url);
      var req=getTransport();
      req.open("GET",url,true);
   ...
   {
      var url="../../../../../Edit_Deputation_OrderServ?Command=Delete&txtEmployeeid="+eid+"&offid="+ofid+"&order="+ord;
   ...
   else if(Command=="desig")
   {
     var desig=document.frmTransfer.txtP_desigId.value;
      ...
      var url="../../../../../Edit_Deputation_OrderServ?Command=Desig&txtDesigid="+desig;
    ...
    else if(Command=="panelemp")
   {
      var proced_id=document.frmTransfer.cmd_procedid.value;
      var off_id=document.frmTransfer.txtOffId.value;
      
      var url="../../../../../Create_Deputation_OrderServ?Command=panelemp&proced_id="+proced_id+"&offid="+off_id;
     // alert(url);
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
    ...
    else if(Command=="panelempdet")
   {
      var proced_id=document.frmTransfer.cmd_procedid.value;
      var off_id=document.frmTransfer.txtOffId.value;
      var empid=document.frmTransfer.cmdempid.value;
      
      var url="../../../../../Create_Deputation_OrderServ?Command=panelempdet&proced_id="+proced_id+"&offid="+off_id+"&empid="+empid;
     // alert(url);
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
   ...
   else if(Command=="dept")
   {
     ...
     var url="../../../../../Edit_Deputation_OrderServ?Command=Deptid&dept_id="+depart+"&office_id="+dpt_offid;
     //alert(url);
     var req=getTransport();
...
function handleResponse(req)
{
  if(req.readyState==4)
  {
    if(req.status==200)
    {
      ...
      {
        panelEmp(baseResponse);
      }
       else if(Command=="panelempdet")
      {
        panelEmpDet(baseResponse);
      }
    }
  }
...
function panelEmp(baseResponse)
{
    var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
   // alert(flag);
    if(flag=="success")
    {
        var det=baseResponse.getElementsByTagName("details");//.firstChild.nodeValue;
        var emp_id=new Array();
        //var emp_name=new Array();
       // var dept_office_name=new Array();
        var cmdempid=document.getElementById("cmdempid");
        cmdempid.innerHTML="";
        for(var i=0;i<det.length;i++)
        {
            emp_id[i]=baseResponse.getElementsByTagName("eid")[i].firstChild.nodeValue;
        ...
        {
        cmdempid.add(option,null);
        }
        for(var i=0;i<det.length;i++)
        {
        var option=document.createElement("OPTION");
        option.value=emp_id[i];
        
        option.text=emp_id[i];
...
function panelEmpDet(baseResponse)
{
  var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
  //alert(flag);
    if(flag=="success")
    {  
       ...
       // var dob=baseResponse.getElementsByTagName("dob")[0].firstChild.nodeValue;
        ...
        var other_deptid=baseResponse.getElementsByTagName("other_deptid")[0].firstChild.nodeValue;
        var other_deptname=baseResponse.getElementsByTagName("other_deptname")[0].firstChild.nodeValue;
        var other_offid=baseResponse.getElementsByTagName("other_offid")[0].firstChild.nodeValue;
        var other_offname=baseResponse.getElementsByTagName("other_offname")[0].firstChild.nodeValue;
     ...
     //   maxsession=baseResponse.getElementsByTagName("maxsession")[0].firstChild.nodeValue;
        ...
        // document.frmTransfer.cmb_Deptid.options[document.frmTransfer.cmd_Deptid.selectedIndex].value=other_deptid;
        //document.frmTransfer.cmb_Deptid.options[document.frmTransfer.cmd_Deptid.selectedIndex].=other_deptid;
         document.frmTransfer.cmb_Deptid.value=other_deptid;
           document.frmTransfer.txtT_OffId.value=other_offid;
            document.frmTransfer.txtT_OffName.value=other_offname;
         ...
         {     
            ...
            if(service)
            {
              ...
              for(i=0;i<service.length;i++)
              {
                ...
                //alert(empid[i]);
                tr_ofid[i]=service[i].getElementsByTagName("dpn_office_id")[0].firstChild.nodeValue;
                //alert(tr_ofid[i])
          ...
          var cell3=document.createElement("TD");
           ...
           var cell7=document.createElement("TD");
           var dpn_desig=document.createTextNode(tdpn_desig[i]);
           cell7.appendChild(dpn_desig);
           mycurrent_row.appendChild(cell7);
           
           var cell8=document.createElement("TD");
           var reasn=document.createTextNode(reas_name[i]);
           cell8.appendChild(reasn);
            var reas_id=document.createElement("input");
            reas_id.type="hidden";
            reas_id.name="reason_id";
            reas_id.id="reason_id";
            reas_id.value=reas[i];
           cell8.appendChild(reas_id); 
           mycurrent_row.appendChild(cell8);
...
function loadValuesFromTable(rid)
{
  ...
  // alert(document.frmTransfer.trf_offid.value);
   ...
   document.frmTransfer.cmb_Deptid.value=rcells.item(4).firstChild.nodeValue;
   
     
   //document.frmTransfer.txtT_OffId.value=rcells.item(5).lastChild.value;
   
   if(rcells.item(5).lastChild.value==0)
   {
      document.frmTransfer.txtT_OffId.value="";
   }
   else
   ...
   document.frmTransfer.txtT_OffName.value=rcells.item(5).firstChild.nodeValue; 
   
   document.frmTransfer.txtP_DesigName.value=rcells.item(6).firstChild.nodeValue;
   
   document.frmTransfer.cmbreasid.value=rcells.item(7).lastChild.value;     
     var ser_id=document.getElementById("cmbdesig");
     var clas=document.getElementById("cmbsgroup");
     var desi=document.getElementById("cmbDesignation");
     if(rcells.item(7).lastChild.value==1)
     {      
       ser_id.style.display="block";
       ser_id.disabled=false;
       clas.disabled=false;
       desi.disabled=false;
     }
     else if(rcells.item(7).lastChild.value==2)
     {
       ser_id.style.display="block";
       ser_id.disabled=true;
       clas.disabled=true;
       desi.disabled=true;
     }
...
function upDat(baseResponse)
{
   ...
   if(flag=="success")
   {
     ...
     /*
       ...
       items[4]=document.frmTransfer.cmbreasid.options[document.frmTransfer.cmbreasid.selectedIndex].text;
       
       if(document.frmTransfer.radTransfer[0].checked==true)
       {
         items[5]=document.frmTransfer.radTransfer[0].value;
       }
       else
       {
         items[5]=document.frmTransfer.radTransfer[1].value;
       }
       
      
       
       if(document.frmTransfer.txtT_OffName.value=="")
       {
         items[7]="";
       }
       else
       {
       items[7]=document.frmTransfer.txtT_OffName.value;
       }
       
       items[8]=document.frmTransfer.cmb_Deptid.options[document.frmTransfer.cmb_Deptid.selectedIndex].value;
       
       */
       
       
       items[3]=document.frmTransfer.cmb_Deptid.options[document.frmTransfer.cmb_Deptid.selectedIndex].value;
       
       items[4]=document.frmTransfer.txtT_OffId.value;
       
       items[41]=document.frmTransfer.txtT_OffName.value;
       
       items[6]=document.frmTransfer.cmbreasid.options[document.frmTransfer.cmbreasid.selectedIndex].value;
       
       items[7]=document.frmTransfer.cmbreasid.options[document.frmTransfer.cmbreasid.selectedIndex].text;
       
       if(items[6]=='1')
       {
         items[1]=document.frmTransfer.cmbDesignation.options[document.frmTransfer.cmbDesignation.selectedIndex].text;
         items[11]=document.frmTransfer.cmbDesignation.options[document.frmTransfer.cmbDesignation.selectedIndex].valuee;
       }
       else if(items[6]=='2')
       {
         items[1]=document.frmTransfer.txtEmpDesig.value;
         items[11]=document.frmTransfer.txt_desid.value;
       }
       ...
       if(document.frmTransfer.radT_Repost[0].checked==true)
       {
         items[9]=document.frmTransfer.radT_Repost[0].value;
       }
       else
       {
         items[9]=document.frmTransfer.radT_Repost[1].value;
       }
       
       if(document.frmTransfer.radTransfer[0].checked==true)
       {
         items[10]=document.frmTransfer.radTransfer[0].value;
       }
       else
       {
         items[10]=document.frmTransfer.radTransfer[1].value;
       }
       ...
       rcells.item(3).lastChild.value=items[11];
       rcells.item(4).firstChild.nodeValue=items[3];
       rcells.item(5).firstChild.nodeValue=items[41];
       rcells.item(5).lastChild.value=items[4];
       rcells.item(6).firstChild.nodeValue=items[8];
       rcells.item(7).firstChild.nodeValue=items[7];
       rcells.item(7).lastChild.value=items[6];
       rcells.item(8).firstChild.nodeValue=items[9];
       rcells.item(9).firstChild.nodeValue=items[10];
...
function clData()
{
        ...
        //var depid1=document.getElementById("cmb_Deptid");
        //depid1.innerHTML='';
        document.frmTransfer.cmb_Deptid.value='0';
...
{
   //alert(val); 
    var url="../../../../../Edit_Deputation_OrderServ?Command=SerGroup&cmbdes="+val;
    //alert(url);
    var req= getTransport();
    req.open("GET",url,true);
    req.onreadystatechange=function()
...
function checkNull()
{
 ...
 /* if((document.frmTransfer.txtT_OffId.value=="") || (document.frmTransfer.txtT_OffId.value.length==0))
  {
    alert('Please Select Other Department Office Id');
    return false;
  }*/
