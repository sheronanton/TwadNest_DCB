...
function doFunction(Command,param)
{
    ...
    {       
        ...
        //alert("EID:"+eid);
            ...
            var url="../../../../../Edit_Relieval_serv.view?Command=loademp_spl&txtEmployeeid="+eid+"&offid="+offid;
         //alert(url);
        ...
        else if(Command=="loadReason")
        {
         ...
         {
         var url="../../../../../Edit_Relieval_serv.view?Command=loadReason&txtEmployeeid="+eid+"&txtOffId="+txtOffId+"&txtRel_SLNO="+txtRel_SLNO;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        // alert("here");
         ...
         if(txtRel_SLNO.length!=0)
         {
         var url="../../../../../Edit_Relieval_serv.view?Command=Validate_loadReason&txtEmployeeid="+eid+"&txtOffId="+txtOffId+"&txtRel_SLNO="+txtRel_SLNO;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
...
function loadEmployee(baseResponse)
{
    ...
    {  //alert("success");
        ...
        if(document.EmpRelieval.txtOffId.value!=offid)
    	{
        	SRctrl= confirm("Employee Office is different from your office ,Do you really want to proceed??");
