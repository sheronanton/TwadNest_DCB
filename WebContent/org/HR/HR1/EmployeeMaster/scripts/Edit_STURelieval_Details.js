...
function servicepopup()
{
    ...
    winemp= window.open("../../../../../org/HR/HR1/EmployeeMaster/jsps/EmpStudyRelievalPopup.jsp","mywindow1","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    winemp.moveTo(250,250);  
    winemp.focus();
...
{   
    ...
    else if(document.EmpRelieval.txtRel_SLNO.value.length==0 )
    {
...
function doFunction(Command,param)
{
    ...
    {       
        ...
        //alert("EID:"+eid);
            ...
            var url="../../../../../Edit_STURelieval_serv.view?Command=loademp&txtEmployeeid="+eid+"&offid="+offid;
            //alert(url);
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Create_STRRelieval_ReportServ.view?Command=office&oid="+oid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Create_STRRelieval_ReportServ.view?Command=dept&oid="+oid+"&deptid="+deptid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Create_STRRelieval_ReportServ.view?Command=desig&desigid="+desigid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        else if(Command=="loadReason")
        {
         ...
         {
         var url="../../../../../Edit_STURelieval_serv.view?Command=loadReason&txtEmployeeid="+eid+"&txtOffId="+txtOffId+"&txtRel_SLNO="+txtRel_SLNO;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        // alert("here");
         ...
         if(txtRel_SLNO.length!=0)
         {
         var url="../../../../../Edit_STURelieval_serv.view?Command=Validate_loadReason&txtEmployeeid="+eid+"&txtOffId="+txtOffId+"&txtRel_SLNO="+txtRel_SLNO;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
...
function loadEmployee(baseResponse)
{
    ...
    {  //alert("success");
       ...
       //  var  maxfromdate=baseResponse.getElementsByTagName("maxfromdate")[0].firstChild.nodeValue;
      ...
      document.EmpRelieval.txtDepDoj.value=maxfromdate;
        ...
        document.EmpRelieval.txtInstName.value=inst_name;
        document.EmpRelieval.txtInstLocation.value=inst_location;
        document.EmpRelieval.txtCourseName.value=course_name;
    ...
    {
        var eid=document.EmpRelieval.txtEmployeeid.value;
        alert("Employee Id '"+eid+"' doesn't have any record for editing.");
        document.EmpRelieval.txtEmployeeid.value="";
        document.EmpRelieval.txtEmployeeid.focus();
        document.EmpRelieval.txtEmpName.value="";
        //document.EmpRelieval.txtEmpDesig.value="";
    ...
    {
        var eid=document.EmpRelieval.txtEmployeeid.value;
        alert("Employee Id '"+eid+"' is not on Deputation.");
        document.EmpRelieval.txtEmployeeid.value="";
        document.EmpRelieval.txtEmployeeid.focus();
        document.EmpRelieval.txtEmpName.value="";
       // document.EmpRelieval.txtEmpDesig.value="";
...
{   
    ...
    else if(Reason=='DPN')
    {
            ...
            document.getElementById("txtD_ODep_OffId").value=baseResponse.getElementsByTagName("od_oid")[0].firstChild.nodeValue;
