...
function doFunction(Command,param)
{
  ...
  if(Command=="loademp")
  {
  var logofid=document.frmTransfer.txtOffId.value;
    var url="../../../../../Edit_Transfer_OrderServ?Command=loademp&txtEmployeeid="+eid+"&offid="+ofid+"&logofid="+logofid;
  ...
  else if(Command=="office")
  {
   ...
   else if(Command=="getDet")
   {
      ...
      var url="../../../../../Edit_Transfer_OrderServ?Command=getDet&order="+ord_id+"&offid="+off_id;
     // alert(url);
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
   ...
   else if(Command=="Add")
   {
      ...
      var url="../../../../../Edit_Transfer_OrderServ?Command=Add&txtEmployeeid="+eid+"&offid="+ofid+"&repost="+rep+"&trfoff="+trof+"&desig_id="+desi+"&order="+ord+"&reason_id="+reas+"&req_trans="+td;
      //alert(url);
      var req=getTransport();
      req.open("GET",url,true);
   ...
   else if(Command=="Update")
   {
      ...
      {
        desi=document.frmTransfer.cmbDesignation.options[document.frmTransfer.cmbDesignation.selectedIndex].value;
        document.frmTransfer.cmbDesignation.disabled = false;
        document.frmTransfer.cmbsgroup.disabled = false;
        //rs.style.display="block";
        //rs.disabled=false;
      }
      else
      {
       desi=document.frmTransfer.txt_desid.value;
       desi_name=document.frmTransfer.txtEmpDesig.value;
       document.frmTransfer.cmbDesignation.disabled = true;
       document.frmTransfer.cmbsgroup.disabled = true;
       //alert('desi...'+desi);
       //alert('desi name...'+desi_name);
        //rs.style.display="none";
        //rs.disabled=true;
      }
      ...
      var url="../../../../../Edit_Transfer_OrderServ?Command=Update&txtEmployeeid="+eid+"&offid="+ofid+"&repost="+rep+"&trfoff="+trof+"&desig_id="+desi+"&order="+ord+"&reason="+reas+"&ta_da="+td;
   ...
   {
      var url="../../../../../Edit_Transfer_OrderServ?Command=Delete&txtEmployeeid="+eid+"&offid="+ofid+"&order="+ord;
...
function loadEmployee(baseResponse)
{
  var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
    ...
    else if(flag=="failure1")
    {
     ...
     else if(flag=="failuredpn")
    {
        var eid=document.frmTransfer.txtEmployeeid.value;
        alert("Employee Id '"+eid+"' is under deputation");
        document.frmTransfer.txtEmployeeid.value="";
        document.frmTransfer.txtEmployeeid.focus();
        document.frmTransfer.txtEmpName.value="";
        document.frmTransfer.txtEmpDesig.value="";
     ...
     else if(flag=="failured")
    {
      ...
      else if(flag=="failurevrs")
    {
            
            alert("Employee Id '"+eid+"' does not exist");
            document.frmTransfer.txtEmployeeid.value="";
            document.frmTransfer.txtEmployeeid.focus();
            document.frmTransfer.txtEmpName.value="";
            document.frmTransfer.txtEmpDesig.value="";
    ...
    {
    var eid=document.frmTransfer.txtEmployeeid.value;
    alert("Employee Id '"+eid+"' is not under ur juridiction");
    document.frmTransfer.txtEmployeeid.value="";
    document.frmTransfer.txtEmployeeid.focus();
    document.frmTransfer.txtEmpName.value="";
    document.frmTransfer.txtEmpDesig.value="";
         ...
         {     
            ...
            if(service)
            {
              ...
              for(i=0;i<service.length;i++)
              {
                ...
                reas_id[i]=service[i].getElementsByTagName("reason_id")[0].firstChild.nodeValue;
          ...
          var cell3=document.createElement("TD");
           ...
           var reasn_id=document.createElement("input");
           reasn_id.type="hidden";
           reasn_id.name="reas_id";
           reasn_id.id="reas_id";
           reasn_id.value=reas_id[i];
           cell6.appendChild(reasn_id);               
         ...
         items[7]=document.frmTransfer.radTransfer[1].value;
          ...
          var cell3=document.createElement("TD");
           ...
           cell6.appendChild(reson);
             ...
             reason_id.name="reasnid";
             reason_id.id="reasnid";
             reason_id.value=items[6];
           cell6.appendChild(reason_id);  
           mycurrent_row.appendChild(cell6);
...
function loadValuesFromTable(rid)
{
   ...
   var rs1=document.getElementById("cmbDesignation");
   var sg=document.getElementById("cmbdesig");
   var tdl=document.getElementById("td_label");
   var tdc=document.getElementById("td_cmb"); 
   
   /*
   if((rcells.item(5).lastChild.value==2) || (rcells.item(5).lastChild.value==6))
   {      
   ...
   document.frmTransfer.cmbreasid.value=rcells.item(5).lastChild.value;
   ...
   if(flag=="success")
   {
     ...
     var items=new Array();
       ...
       */
       ...
       rcells.item(6).firstChild.nodeValue=items[2];
...
/*
function selectProId()
{
  var id=document.frmTransfer.opt_proid.options[document.frmTransfer.opt_proid.selectedIndex].value;
  alert(id);
  if(id != 0)
  {
    document.frmTransfer.txtPid.value=id;
  }
}*/
