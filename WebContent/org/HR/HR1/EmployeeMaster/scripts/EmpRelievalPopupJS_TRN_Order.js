 ...
 function getDesignation()
  ...
  
  {
      ...
      try{
       ...
       var cell=document.getElementById("divpre");
        ...
        cell.style.display="none";
        cell.innerText='';
       var url="../../../../../EmpRelievalPopupServ_TRN_Order.view?Command=Emp&cmbsgroup=" + group ;
  ...
  
  {
       ...
       var cell=document.getElementById("divpre");
        ...
        cell.style.display="none";
        cell.innerText='';
       var url="../../../../../EmpRelievalPopupServ_TRN_Order.view?Command=GPF&txtgpf=" + group ;
     ...
     function loadOfficesByType(type)
    {
       ...
       var url="../../../../../EmpRelievalPopupServ_TRN_Order.view?Command=SGroup&cmbsgroup=" + type ;
        var req=getTransport();
        req.open("GET",url,true);        
        req.onreadystatechange=function()
        {
