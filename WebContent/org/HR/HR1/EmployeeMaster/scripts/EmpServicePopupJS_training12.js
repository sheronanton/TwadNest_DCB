 ...
 function getDesignation()
  ...
  
  {
      ...
      try{
       ...
       var cell=document.getElementById("divpre");
        ...
        cell.style.display="none";
        cell.innerText='';
    	var target_office=document.getElementById("target_office").value;
    	
    	
    	
       var url="../../../../../EmpServicePopupServ_training12.view?Command=Emp&txtEmpName=" + name+"&target_office="+target_office ;
       //alert("url:"+url);
       //url=url+"&cmbdes="+des+"&txtEmpName="+name+"&target_office="+target_office;
       //alert(url);
     
      /* var url="../../../../../EmpServicePopupServ_training12.view?Command=Emp&cmbsgroup=" + group ;
       url=url+"&cmbdes="+des+"&txtEmpName="+name+"&target_office="+target_office;
       alert(url);*/
  ...
  
  {
       ...
       var cell=document.getElementById("divpre");
        ...
        cell.innerText='';
        var target_office=document.getElementById("target_office").value;
       var url="../../../../../EmpServicePopupServ_training12.view?Command=GPF&txtgpf=" + group+"&target_office="+target_office ;
      // alert(url);
        var req=getTransport();
        req.open("GET",url,true);        
        req.onreadystatechange=function()
     ...
     function loadOfficesByType(type)
    {
       ...
       var url="../../../../../EmpServicePopupServ_training12.view?Command=SGroup&cmbsgroup=" + type ;
        var req=getTransport();
        req.open("GET",url,true);        
        req.onreadystatechange=function()
        {
