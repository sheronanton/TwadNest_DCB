 ...
 function getDesignation()
  ...
  
  {
      ...
      try{
       ...
       var cell=document.getElementById("divpre");
        ...
        cell.style.display="none";
        cell.innerText='';
       var url="../../../../../EmpStudyRelievalPopupServ.view?Command=Emp&cmbsgroup=" + group ;
  ...
  
  {
       ...
       var cell=document.getElementById("divpre");
        ...
        cell.style.display="none";
        cell.innerText='';
       var url="../../../../../EmpStudyRelievalPopupServ.view?Command=GPF&txtgpf=" + group ;
     ...
     function loadOfficesByType(type)
    {
       ...
       var url="../../../../../EmpStudyRelievalPopupServ.view?Command=SGroup&cmbsgroup=" + type ;
        var req=getTransport();
        req.open("GET",url,true);        
        req.onreadystatechange=function()
        {
