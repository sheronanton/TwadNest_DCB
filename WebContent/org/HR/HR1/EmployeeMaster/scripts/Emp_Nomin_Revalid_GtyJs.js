...
if(Command=='efocus')
 ...
 for(var i=1;i<=tbody.rows.length;i++)
        ...
        if(d==0)
    {
     ...
     var url="../../../../../Emp_Nomin_Revalid_Gty?Command=loadnominee&txtEmployeeid="+empid+"&nominee="+nominee;
      ...
      service=null;
       var cell=document.getElementById("divpre");
        ...
        var fund_id=document.EMP_NOMINEE.fund_id.value;
                var url="../../../../../Emp_Nomin_Revalid_Gty?Command=loademp&txtEmployeeid="+empid+"&fund_id="+fund_id;
                req.open("POST",url,true);
                req.onreadystatechange=handleResponse;
                if(window.XMLHttpRequest)
                        req.send(null);
 ...
 for(var i=1;i<=tbody.rows.length;i++)
  ...
  // alert( tb.rows.length);
        ...
        if(parseFloat(sum)==100)
        {
                ...
                if(confirm('Do You want to Revalidate all records?'))
                {
                      //  statuswaiting(document.EMP_NOMINEE) ;
                      
                         var fund_id=document.EMP_NOMINEE.fund_id.value;
                        var url="../../../../../Emp_Nomin_Revalid_Gty?Command=Validate&txtEmployeeid="+empid;
...
else if(Command=="Load")
    {
           if(!(empid==null || empid.length==0))
           {
                ...
                // alert(fund_id);
                  //startwaiting(document.EMP_NOMINEE) ;
                var url="../../../../../Emp_Nomin_Revalid_Gty?Command=Load&txtEmployeeid="+empid;
                url=url+"&fund_id="+fund_id
               // alert("url"+url)
                req.open("POST",url,true);
                req.onreadystatechange=handleResponse;
  ...
  /*  else if(Command=='Submit')
    {
        ...
        {
                //startwaiting(document.EMP_NOMINEE) ;
                var url="../../../../../Emp_Nomin_Revalid_Gty?Command=Submit&txtEmployeeid="+empid;
                req.open("POST",url,true);
                req.onreadystatechange=handleResponse;
                if(window.XMLHttpRequest)
                        req.send(null);
     ...
     if(flag=="success")
    {
                      ...
                      //  alert(status);
                        if (status=='FR')
                        {
                            ...
                            alert("Employee's Nomination Details yet to be Freezed");
                        }
            else 
            {
...
function onSubmit()
{
  ...
  // alert( tb.rows.length);
        ...
        if(parseFloat(sum)==100)
        {
                var url="../../../../../Emp_Nomin_Revalid_Gty?Command=submit&record="+record+"&txtEmployeeid="+empid+"&fund_id="+fund_id+"&nomindate="+nomindate;
               // alert(url);
