...
var total=0;
 ...
 for(var i=1;i<=tbody.rows.length;i++)
        ...
        if(d==0)
    {
     var url="../../../../../Emp_Nomination_Gty_Servlet?Command=loadnominee&txtEmployeeid="+empid+"&nominee="+nominee;
      ...
      service=null;
       var cell=document.getElementById("divpre");
        ...
        var fund_id=document.EMP_NOMINEE.fund_id.value;
                var url="../../../../../Emp_Nomination_Gty_Servlet?Command=loademp&txtEmployeeid="+empid+"&fund_id="+fund_id;
                req.open("POST",url,true);
                req.onreadystatechange=handleResponse;
                if(window.XMLHttpRequest)
                        req.send(null);
            ...
            else
             {
              ...
              //alert(relationship_id);
                ...
                //alert("age  "+age);
                    ...
                    var url="../../../../../Emp_Nomination_Gty_Servlet?Command=Add&txtEmployeeid="+empid;
...
clr();
    ...
    else if(Command=="Load")
    {
           if(!(empid==null || empid.length==0))
           {
                ...
                // alert(fund_id);
                  //startwaiting(document.EMP_NOMINEE) ;
                var url="../../../../../Emp_Nomination_Gty_Servlet?Command=Load&txtEmployeeid="+empid;
  ...
  /*  else if(Command=='Submit')
    {
        ...
        {
                //startwaiting(document.EMP_NOMINEE) ;
                var url="../../../../../Emp_Nomination_Gty_Servlet?Command=Submit&txtEmployeeid="+empid;
                req.open("POST",url,true);
                req.onreadystatechange=handleResponse;
                if(window.XMLHttpRequest)
                        req.send(null);
...
function onSubmit()
{
   ...
   // var nomindate=documemt.EMP_NOMINEE.Nomin_Date.value;
    ...
    {   var record = ""; 
        ...
        {
                var url="../../../../../Emp_Nomination_Gty_Servlet?Command=submit&record="+record+"&txtEmployeeid="+empid+"&fund_id="+fund_id+"&nomindate="+nomindate;
               // alert(url);
