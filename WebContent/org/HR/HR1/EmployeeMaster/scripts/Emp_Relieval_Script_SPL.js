...
function doFunction(Command,param)
{
    ...
    {
    var url="../../../../../Create_Emp_servlet.view?Command=Suspension&txtEmployeeid="+eid+"&reasonid="+reason;
            //alert(url);
    ...
    {       
        ...
        var offid=document.EmpRelieval.txtOffId.value;
            var url="../../../../../Create_Emp_servlet.view?Command=loademp_spl&txtEmployeeid="+eid+"&offid="+offid;
   ...
   /*     else if(Command=="loademp1")
        {   //alert(eid);
        var offid=document.EmpRelieval.txtOffId.value;
            var url="../../../../../Create_Emp_servlet.view?Command=loademp1&txtEmployeeid="+eid+"&offid="+offid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
...
//alert('aaa');
    ...
    {  //alert("success");
        ...
        if(document.EmpRelieval.txtOffId.value!=offid)
        	{var SRctrl= confirm("Employee Office is different from your office ,Do you really want to proceed??");
          
        	}
        if((SRctrl)||(document.EmpRelieval.txtOffId.value==offid))
        {
