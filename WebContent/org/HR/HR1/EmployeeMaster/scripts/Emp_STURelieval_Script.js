...
function doFunction(Command,param)
{
    ...
    {       
        ...
        var offid=document.EmpRelieval.txtOffId.value;
            var url="../../../../../Create_STURelieval_ReportServ.view?Command=loademp&txtEmployeeid="+eid+"&offid="+offid;
            //alert(url);
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Create_STURelieval_ReportServ.view?Command=office&oid="+oid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Create_STURelieval_ReportServ.view?Command=dept&oid="+oid+"&deptid="+deptid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Create_STURelieval_ReportServ.view?Command=desig&desigid="+desigid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
...
function loadEmployee(baseResponse)
{
    ...
    {
        var eid=document.EmpRelieval.txtEmployeeid.value;
        alert("Employee Id '"+eid+"' is not in Study Leave status. So can not create Study Leave relieval.");
        document.EmpRelieval.txtEmployeeid.value="";
        document.EmpRelieval.txtEmployeeid.focus();
        document.EmpRelieval.txtEmpName.value="";
        //document.EmpRelieval.txtEmpDesig.value="";
