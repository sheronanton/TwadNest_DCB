 ...
 function getDesignation()
  ...
  
  {
      ...
      try{
       ...
       var cell=document.getElementById("divpre");
        ...
        cell.style.display="none";
        cell.innerText='';
       var url="../../../../../EmpdthPopupServ.view?Command=Emp&cmbsgroup=" + group ;
  ...
  
  {
       ...
       var cell=document.getElementById("divpre");
        ...
        cell.style.display="none";
        cell.innerText='';
       var url="../../../../../EmpdthPopupServ.view?Command=GPF&txtgpf=" + group ;
     ...
     function loadOfficesByType(type)
    {
       ...
       var url="../../../../../EmpdthPopupServ.view?Command=SGroup&cmbsgroup=" + type ;
        var req=getTransport();
        req.open("GET",url,true);        
        req.onreadystatechange=function()
        {
          ...
          { 
                ...
                else if(flag=="sessionout")
            {
                ...
                {   
                   ...
                   /*
                     Getting the employee tag from the xml framed in servlet
                   */
               
                    service=response.getElementsByTagName("employee");
                     
                   /*
                     If the employee tag exists
                   */  
                    ...
                    /*
                      grid tbody id is stored in a variable.
                      Making the grid clear by assigning null value to variable tbody.
                    */  
                 ...
                 /*checking the length of the employee tag
                   If it is true the length is divided by default value and if the value is not 0
                   then total block variable is incremented
                 */           
                            if(service.length>0)
                            {
                                    ...
                                    /*
                                     getting the page combo box id and stored in a variable and making the
                                     combo box null.
                                  ...
                                  /*
                                    creating the element option and adding the calculated value to this
                                    combo box.
                                  */  
...
function loadPage(page)
{
          ...
          /*
            The page is passed as an argument to this function.
          
            This function is used to load the employee details in the grid.    
            
            If employee id is selected by clicking radio button the corresponding value is passed as an
            argument to pick function.
          */
            var i=0;
            var c=0;
...
{
   /*
     the selected employee id is stored in a variable.
   */
//alert(t.value);
    s=t.value;
}
