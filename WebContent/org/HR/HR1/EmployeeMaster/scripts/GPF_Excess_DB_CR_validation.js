...
function getDeatils5()
{
	...
	var url="../../../../../gpfExcessCRUpdation?command=get1&jid="+jid;
...
function viewjournal(id)
{
	...
	//alert(url);
	    window.open('GPF_Excess_DB_CR_updationPopup.jsp?command=view&'+url,'Summaryreport','width=700,height=600,menubar=yes,status=yes,location=yes,toolbar=yes,scrollbars=yes');
}
function edit(queryString)
{
	...
	selectMonth();
	 var url="../../../../../gpfExcessCRUpdation?"+queryString;
...
//	alert(FUND_CATEGORY);
	...
	if(FUND_CATEGORY=="Regular")
	{
		document.GPF_missing_cr_db_validation.slipPrint[0].disabled=false;
		document.GPF_missing_cr_db_validation.slipPrint[1].disabled=false;
		document.GPF_missing_cr_db_validation.slipPrint[2].disabled=false;
	}
	else
	{
		document.GPF_missing_cr_db_validation.slipPrint[0].disabled=true;
		document.GPF_missing_cr_db_validation.slipPrint[1].disabled=true;
		document.GPF_missing_cr_db_validation.slipPrint[2].disabled=true;
...
{
	 var jid=document.getElementById("jid").value;
	 var url="../../../../../gpfExcessCRUpdation?command=checkbalnce&jid="+jid;
    var req=getTransport();
    req.open("GET",url,true);     
...
function gettransactiondetails()
{
    ...
    var url="../../../../../gpfExcessCRUpdation?command=get&jid="+jid;
    req1.open("GET",url,true);     
   // document.Hrm_TransJoinForm1.valid.disabled=false;
...
//alert("");
			 ...
			 if(document.GPF_missing_cr_db_validation.typecredit[0].checked)
			 {
				...
				if(falg){
					...
					parm=parm+"&slipPrint="+slipPrint+"&Install_no="+Install_no+"&totalNOInstall="+totalNOInstall;
					 var url="../../../../../gpfExcessCRUpdation?command=update&"+parm;
     ...
     url="../../../../../GPF_Excess_DB_CR?command=checkgpf1&gpf_no="+gpf_no+"&misstype="+misstype+"&categorytype="+categorytype+"&relmonth="+relmonth+"&relyear="+relyear+"&jid="+jid;
	...
	if(res=="success")
	{
		if(response.getElementsByTagName("value")[0].firstChild.nodeValue=="validate")
		{
			...
			//document.GPF_missing_cr_db_validation.update.disable=false;
			 //document.GPF_missing_cr_db_validation.action = document.GPF_missing_cr_db_validation.path.value+"/org/HR/HR1/EmployeeMaster/jsps/GPF_Excess_DB_CR_Validate.jsp";
...
function acheadcode(){
	 var req=getTransport();
	   ...
	   if(acheadcode!=""){
       url="../../../../../gpfExcessCRUpdation?command=achead&acheadcode="+acheadcode;
       url=url+"&sid="+Math.random();
       req.open("GET",url,true);
       req.onreadystatechange=function()
	    {
...
function validatenew()
{
	...
	var jid=document.getElementById("jid").value;
	 var url="../../../../../gpfExcessCRUpdation?command=validate&jid="+jid;
...
function getrefresh()
{
    ...
    var url="../../../../../gpfExcessCRUpdation?command=getCR&jid="+jid;
    ...
    document.getElementById("ac_head_code").value="0";
 	document.getElementById("descr").value="";
 	 document.getElementById("intrestDiv").style.display='none';
	   document.getElementById("intrestDiv1").style.display='none';
	   document.getElementById("int_year").value=0;
	   if(window.opener.document.GPF_missing_cr_db_validation.missing_type[0].checked)
		{
		 for(i=0;i<document.GPF_missing_cr_db_validation.slipPrint.length;i++)
	      	{
	         document.GPF_missing_cr_db_validation.slipPrint[i].disabled=false;
...
var	url="../../../../../gpfExcessCRUpdation?command=updateMaster&unit="+unit+"&gpfno="+gpfno+"&misstype="+misstype;
