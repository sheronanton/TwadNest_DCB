...
/*function loadDetails(authNo){
    ...
    loadDefault();
    url="../../../../../GPF_Final_Settlement_Validate.view?command=get&gpf_no="+gpf_no+"&auth_no="+authNo;
    	   ...
    	   try {
            ...
            {	
                ...
                {	
  					...
  					var process_flow=response.getElementsByTagName("PROCESS_FLOW_STATUS_ID")[0].firstChild.nodeValue;
                	...
                	if(process_flow=='FR')
                		{
                			alert("This GPF_NO Already Freezed");
                			document.Hrm_GpfSettlementForm.updateBtn.disabled=true;
                	...
                	//alert('This GPF_No Does not Exist OR Does not Updated');
                	document.Hrm_GpfSettlementForm.txtGpfNo.focus();                	
            ...
            else if(command=="Check")
        	{
        		...
        		if(count!=0)
        		...
        		else
        			{
        				...
        				if(flag=="failure")
    					{		
        					alert("There is no record for this GPF_NO");
    						clearData();
	...
	if(xmlhttp==null)
	{
        ...
        { 
        	...
        	//alert("with in validate...");
					...
					//alert(flag);
						...
						url="../../../../../GPF_Final_Settlement_Validate.view?command=Update&gpf_no="+gpf_no+"&emp_id="+emp_id+"&prefix="+prefix+"&pro_officer_name="+pro_officer_name+"&suffix="+suffix;
						...
						url=url+"&dth_Relation="+dth_Relation+"&dth_date2="+dth_date2;
                        xmlhttp.open("GET",url,true);
        ...
        if(command=="report")
			...
			//alert("dth_Legal_person...."+dth_Legal_person);
				...
				url="../../../../../GPF_Final_Settlement_Validate.view?command=report&gpf_no="+gpf_no+"&emp_id="+emp_id+"&prefix="+prefix+"&pro_officer_name="+pro_officer_name+"&suffix="+suffix;
				url=url+"&pro_desingnation="+pro_desingnation+"&letter_no="+letter_no+"&letter_date="+letter_date+"&jur_off="+jur_off+"&jur_add1="+jur_add1+"&jur_add2="+jur_add2+"&jur_add3="+jur_add3+"&jur_pincode="+jur_pincode;
				url=url+"&relieve_status="+relieve_status+"&relieve_date="+relieve_date+"&intrest_upto="+intrest_upto+"&subject="+subject+"&reference="+reference;
				url=url+"&txtLastSlipClosingBal="+txtLastSlipClosingBal+"&regu_acc_unit_code="+regu_acc_unit_code+"&txtImpoundBal="+txtImpoundBal+"&imp_acc_unit_code="+imp_acc_unit_code+"&txtSubscriptionCredit="+txtSubscriptionCredit+"&imp_2003="+imp_2003+"&txtSubscriptionDebit="+txtSubscriptionDebit+"&da_acc_unit="+da_acc_unit;
    ...
    else if(command=="Draft")
    {
               // alert("draft....");
                	gpf_no=document.getElementById("txtGpfNo").value; 	                
						...
						url="../../../../../GPF_Final_Settlement_Validate.view?command=Draft&gpf_no="+gpf_no;
		               // alert("URL======="+url);
				        xmlhttp.open("GET",url,true);
				        xmlhttp.onreadystatechange=stateChangedd;
				        xmlhttp.send(null);
...
//    }
    ...
    else if(command=="Validate")
    {
		...
		if(checkAllComboSelected()){
			url="../../../../../GPF_Final_Settlement_Validate.view?command=Validate&gpf_no="+gpf_no+"&relieve_status="+relieve_status+"&relieve_date="+relieve_date+"&int_tobe_calc_month="+int_tobe_calc_month+"&int_tobe_calc_year="+int_tobe_calc_year;
    ...
    {  
        ...
        loadDefault();
        url="../../../../../GPF_Final_Settlement_Validate.view?command=get&gpf_no="+gpf_no;        
    ...
    {  
        ...
        var gpf_no=document.Hrm_GpfSettlementForm.txtGpfNo.value;
        url="../../../../../GPF_Final_Settlement_Validate.view?command=Delete&gpf_no="+gpf_no;        
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChangedd;
        xmlhttp.send(null); 
    }    
        ...
        url="../../../../../GPF_Final_Settlement_Validate.view?command=LoadYear&relieve_date="+relvDate;        
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChangedd;
        xmlhttp.send(null);
        ...
        url="../../../../../GPF_Final_Settlement_Validate.view?command=LoadMonth&relieve_date="+relvDate+"&listYear="+rlvYear;        
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChangedd;
        xmlhttp.send(null);
    }
...
function Autho_Letter_Date()
{
	var auth_date=document.getElementById("letter_date").value;
	
		var validformat=/^\d{2}\/\d{2}\/\d{4}$/ //Basic check for format validity
			var returnval=false
			if (!validformat.test(auth_date))
			alert("Invalid Date Format. Please correct and submit again.")
			else{ //Detailed check for valid date ranges
			var monthfield=auth_date.split("/")[0]
			var dayfield=auth_date.split("/")[1]
			var yearfield=auth_date.split("/")[2]
...
//		}
	...
	var for_off1=document.getElementById("for_off1").value; 
	if(for_off1=="" || for_off1==null)
	{
		alert("Please Enter Forwarding Officer Name");
		return false;
	}
	
	
	var for_design1=document.getElementById("for_design1").value; 
	if(for_design1=="" || for_design1==null)
	{
		alert("Please Enter Forwarding Officer Designation");
		return false;
	}
...
function officedetailsss(ctlOffice)
{
        //alert('hai');
				...
				if(command=="copy_to")
				 ...
				 if(command=="record_count")
					...
					//alert("FLAG === "+flag);
						if(flag=="success")
							{
								var count_record=response.getElementsByTagName("TOTAL")[0].firstChild.nodeValue;
