...
function check()
{
    ...
    /*    if(balance<amt)
        {
        	alert("Impound Amount should not exceed balance***check()" );
...
if(xmlhttp==null)
{
    ...
    return;
        ...
        { 	//alert("123");
                if(nullCheck())
                {
                  ...
                  /*   else if(balance<amount)
                     {
                    	 alert("Impound Amount should not exceed balance****2" );
                         document.getElementById("amount").value="";
                         flag=0; 
                     }*/
                    if(flag==1)
        ...
        url="../../../../../GPF_Impound.view?command=Add&office_id="+office_id+"&division_id="+division_id+"&gpf_no="+gpf_no+"&emp_id="+emp_id+"&ac_month="+ac_month+"&ac_year="+ac_year+"&type_trans="+type_trans+"&amount="+amount+"&date_trans="+date_trans+"&remarks="+remarks+"&rel_month="+rel_month+"&rel_year="+rel_year+"&impound_type="+impound_type+"&install_type="+install_type+"&fin_year="+fin_year;
    ...
    {              
                if(nullCheck())
                {
                 ...
                 if(impound_type=='ImpReg')
                 {
                  ...
                  balance=balance+balance_per;
                   ...
                   /* if(diff_amt>balance)
                    {
                        alert("Impound Amount should not exceed balance" );
                        document.getElementById("amount").value="";
                    }
                    else
                    {	*/
        ...
        url="../../../../../GPF_Impound.view?command=Update&office_id="+office_id+"&division_id="+division_id+"&gpf_no="+gpf_no+"&emp_id="+emp_id+"&ac_month="+ac_month+"&ac_year="+ac_year+"&type_trans="+type_trans+"&amount="+amount+"&date_trans="+date_trans+"&remarks="+remarks+"&rel_month="+rel_month+"&rel_year="+rel_year+"&impound_type="+impound_type+"&fin_year="+fin_year+"&install_type="+install_type+"&dis_sl_no="+dis_sl_no;
       // alert(url);
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
  ...
  //    }
   ...
   // alert("her"+document.Hrm_TransJoinFormpop.txtGpfNo.value)	;
    	if((document.Hrm_TransJoinFormpop.txtGpfNo.value=="")||(document.Hrm_TransJoinFormpop.txtGpfNo.value.length==0))
        {
   ...
   // document.getElementById("txtGpfNo").value="";
    ...
    url="../../../../../GPF_Impound.view?command=get&gpf_no="+gpf_no+"&impound_type="+impound_type+"&fin_year="+fin_year+"&type_trans="+type_trans;
       ...
       if(xmlhttp.status==200)
       {
            ...
            //	alert(flag);
               ...
               /*    if(balance==0)
                    {
                	   //trial
                	   var ac_mon=document.Hrm_TransJoinFormpop.ac_month.value;
                	   var ac_yer=document.Hrm_TransJoinFormpop.ac_year.value;
                	   var gt_date=new Date();
                	   gt_date.setFullYear(ac_yer, (ac_mon-1), 1);
                	  // alert("Date is "+gt_date);
                	   var val_date=new Date();
                	   val_date.setFullYear(2010, 8, 1);
                	 //  alert(gt_date>val_date);   END Trial
                	   if(gt_date>val_date)
                        alert("This Employee's Impound processes has completed , No Balance for further proceedings ");
                	   else{
                        var answer = confirm ("No Balance! Want to Proceed. ")
                        if (answer)
                	 ...
                	 //  alert(gt_date>val_date);   END Trial
                	   if(gt_date>val_date)
                        ...
                        var answer = confirm ("Negative Balance! Want to Proceed. ")
                        if (answer)
                        	 document.Hrm_TransJoinFormpop.trans[1].disabled=false;	 
                        else
                        {
...
function nullCheck()
{
       // alert("inside null chek");
         if((document.Hrm_TransJoinFormpop.txtEmpId.value=="")||(document.Hrm_TransJoinFormpop.txtEmpId.value=="0"))
        {
