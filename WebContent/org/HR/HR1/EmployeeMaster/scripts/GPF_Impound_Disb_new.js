       ...
       if(xmlhttp.status==200)
       {
            ...
            {            	
                ...
                if(flag=='success')
                {
                    ...
                    var processfloweid=response.getElementsByTagName("processflowid")[0].firstChild.nodeValue;
                ...
                clearCalc();
                var status=response.getElementsByTagName("flag")[1].firstChild.nodeValue;
                if(status=="calculation"){                	                	
                	document.getElementById('ImpReg_cr2').value=response.getElementsByTagName("TWOCRTOTAL")[0].firstChild.nodeValue;
                	document.getElementById('ImpReg_db2').value=response.getElementsByTagName("TWODRTOTAL")[0].firstChild.nodeValue;
                	document.getElementById('ImpReg_total2').value=response.getElementsByTagName("TWOTOAL")[0].firstChild.nodeValue;
                	document.getElementById('ImpReg_cr3').value=response.getElementsByTagName("THREECRTOTAL")[0].firstChild.nodeValue;
                	document.getElementById('ImpReg_db3').value=response.getElementsByTagName("THREEDRTOTAL")[0].firstChild.nodeValue;
                	document.getElementById('ImpReg_total3').value=response.getElementsByTagName("THREETOAL")[0].firstChild.nodeValue;
                	document.getElementById('Imp2003_cr2').value=response.getElementsByTagName("TWOCRTOTAL3")[0].firstChild.nodeValue;
                	document.getElementById('Imp2003_db2').value=response.getElementsByTagName("TWODRTOTAL3")[0].firstChild.nodeValue;
                	document.getElementById('Imp2003_total2').value=response.getElementsByTagName("TWOTOAL3")[0].firstChild.nodeValue;
                	document.getElementById('Imp2003_cr3').value=response.getElementsByTagName("THREECRTOTAL3")[0].firstChild.nodeValue;
                	document.getElementById('Imp2003_db3').value=response.getElementsByTagName("THREEDRTOTAL3")[0].firstChild.nodeValue;
                	document.getElementById('Imp2003_total3').value=response.getElementsByTagName("THREETOAL3")[0].firstChild.nodeValue;
                }
            }            
...
if(xmlhttp==null)
{
     ...
     if(command=="acc_head_code")
    {
        ...
        url="../../../../../GPF_Impound_new.view?command=acc_head_code&type_trans="+type_trans+"&impound_type="+impound_type;
    ...
    else if(command=="Delete")
    {
        ...
        url="../../../../../GPF_Impound_new.view?command=Delete&office_id="+office_id+"&division_id="+division_id+"&gpf_no="+gpf_no+"&emp_id="+emp_id+"&ac_month="+ac_month+"&ac_year="+ac_year+"&type_trans="+type_trans+"&amount="+amount+"&date_trans="+date_trans+"&remarks="+remarks+"&rel_month="+rel_month+"&rel_year="+rel_year+"&impound_type="+impound_type+"&fin_year="+fin_year+"&dis_sl_no="+dis_sl_no;;
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null);      
    ...
    {   
        ...
        url="../../../../../GPF_Impound_new.view?command=getone&fin_year="+fin_year+"&unit="+unit+"&ac_year="+ac_year+"&ac_month="+ac_month;
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null); 
    ...
    {   
        ...
        url="../../../../../GPF_Impound_new.view?command=AdjustmentJournal&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&command1=journal1";
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
    ...
    {   
  	//alert("AdjustmentJournal1");
        ...
        url="../../../../../GPF_Impound_new.view?command=AdjustmentJournal&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&command1=journal2";
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=function()
        {
...
function impoundpopup(comfun)
{
   ...
   if(comfun=="Add"){
	   ...
	   winemp= window.open("../../../../../org/HR/HR1/EmployeeMaster/jsps/GPF_Impound_Disb_Popup_new.jsp?command=Add&officeid="+officeid+"&finyear="+finyear+"&unit="+unit+"&acmonth="+acmonth+"&acyear="+acyear+"","mywindow1","status=1,height=500,width=500,resizable=YES, scrollbars=yes");
...
function validate1(){
	...
	url="../../../../../GPF_Impound_new.view?command=validate&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&officeid="+officeid;
...
function clearall()
{
	...
	document.Hrm_TransJoinForm.ac_month.options[0].selected='selected';
     ...
     document.getElementById("ImpReg_cr2").value="";
     document.getElementById("ImpReg_cr3").value="";
     document.getElementById("ImpReg_db2").value="";
     document.getElementById("ImpReg_db3").value="";
     document.getElementById("ImpReg_total2").value="";
     document.getElementById("ImpReg_total3").value="";
     
     document.getElementById("Imp2003_cr2").value="";
     document.getElementById("Imp2003_cr3").value="";
     document.getElementById("Imp2003_db2").value="";
     document.getElementById("Imp2003_db3").value="";
     document.getElementById("Imp2003_total2").value="";
     document.getElementById("Imp2003_total3").value="";
...
function partial()
{
	...
	{
	var url="../../../../../GPF_Impound_new.view?command=partial&gpf_no="+par_gpfno;
	 url=url+"&sid="+Math.random();
	  //alert(url);
     xmlhttp.open("GET",url,true);
     xmlhttp.onreadystatechange=stateChanged;
