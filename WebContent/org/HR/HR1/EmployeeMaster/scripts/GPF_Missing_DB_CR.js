	...
	var checkflag1=true;
	 if(gpf_no==""){
	  ...
	  var flag=0;
	      ...
	      {
	          flag=1;
	          categorytype=document.getElementById("impound_type").value;
	      }
	 ...
	 url="../../../../../GPF_Missing_DB_CR?command=checkgpf&gpf_no="+gpf_no+"&misstype="+misstype+"&categorytype="+categorytype+"&relmonth="+relmonth+"&relyear="+relyear;
	          ...
	          var    command=response.getElementsByTagName("command")[0].firstChild.nodeValue;
	           ...
	           if(command=="checkgpf")
	           {
	               ...
	               else if(flag=='retried')
	               {
	            	   ...
	            	   //starts new function added on 26 feb 2011 
...
// check condition alert for retired after slipyear
	            	   ...
	            	   //ends ...new function added on 26 feb 2011 
	            	   else
	            	   {
	            		   document.getElementById("intrestDiv").style.display='none';
		            	   document.getElementById("intrestDiv1").style.display='none';
	            	   ...
	            	   if(nullcheck1()){
	            			...
	            			var relyear=document.getElementById("rel_year").value;
	            			   ...
	            			   winemp= window.open("../../../../../org/HR/HR1/EmployeeMaster/jsps/GPF_Missing_DB_CR_Popup.jsp?command=add&gpfno="+gpfno+"&amount="+amount+"&relmonth="+relmonth+"&relyear="+relyear+"&missingtype="+missingtype+"","mywi","status=1,height=500,width=500,resizable=YES, scrollbars=yes");
...
nullcheck1();
		...
		url="../../../../../GPF_Missing_DB_CR?command=CheckExistingRecords&gpf_no="+gpf_no+"&misstype="+misstype+"categorytype="+categorytype+"relmonth="+relmonth+"relyear="+relyear;
	       xmlhttp.open("GET",url,true);
...
//alert('jhh'+document.getElementById("txtGpfNo").value);
	...
	{
		alert('Please Select Missing Credit/Debit');
		return false;
	}
...
function pick(i){
     ...
     // alert("../../../../../org/HR/HR1/EmployeeMaster/jsps/GPF_Missing_DB_CR_Popup.jsp?command=update&ugpfno="+ugpfno+"&uachead="+achead+"&relmonth="+relmonth+"&relyear="+relyear+"&uamount="+uamount+"&uremark="+uremark+"&gpfno="+gpfno+"&amount="+amount+"&missingtype="+missingtype+"&splachead="+splachead+"&seqno="+i+"","mywi","status=1,height=500,width=500,resizable=YES, scrollbars=yes");     
      ...
      winemp= window.open("../../../../../org/HR/HR1/EmployeeMaster/jsps/GPF_Missing_DB_CR_Popup.jsp?command=update&ugpfno="+ugpfno+"&uachead="+achead+"&usplachead="+usplachead+"&relmonth="+relmonth+"&relyear="+relyear+"&uamount="+uamount+"&uremark="+uremark+"&gpfno="+gpfno+"&amount="+amount+"&missingtype="+missingtype+"&splachead="+splachead+"&seqno="+i+"&intmonth="+intmonth+"&intyear="+intyear+"","mywi","status=1,height=500,width=500,resizable=YES, scrollbars=yes");
	  winemp.moveTo(250,250);  
	  winemp.focus();     
...
function addvalues()
{
	...
	//alert("after try---");
	url="../../../../../GPF_Missing_DB_CR?command=Add&unit="+unit+"&gpfno="+gpfno+"&misstype="+misstype+"&amount="+amount+"&jno="+jno+"&date="+date+"&remark="+remark;
	//alert(url);
...
//alert(url);
 ...
 // xmlhttp.onreadystatechange=stateChanged;
	...
	//alert("6567");
	 ...
	 url="../../../../../GPF_Missing_DB_CR?command=Addtrn&achead="+achead+"&other_gpfno="+other_gpfno+"&other_amount="+other_amount+"&rel_month="+rel_month+"&rel_year="+rel_year+"&missingtype="+missingtype+"&spl_ac_head="+spl_ac_head+"&int_year="+intyear+"&int_month="+intmonth;
