       ...
       if(xmlhttp.status==200)
       {
    	 ...
    	 //   alert(xmlhttp.responseText);
            ...
            {       
               ...
               document.getElementById("totrefund").value=parseInt(totrefamount,10);
...
//*****For debit the subscription amount and refund amount from adjustment journal**********	
            ...
            var result=tagresult.firstChild.nodeValue;
           	...
           	if(result=="Valid" && final_diff_sub==0 && final_diff_ref==0 ){
...
function call(command,fileType)
{
	...
	if(xmlhttp==null){
        ...
        {                
        	if(nullCheckpop())
        	{
                ...
                url="../../../../../GPF_Subscription.view?command=Add&office_id="+office_id+"&gpf_no="+gpf_no+"&division_id="+division_id+"&emp_id="+emp_id+"&ac_month="+ac_month+"&ac_year="+ac_year+"&type_trans="+type_trans+"&remarks="+remarks+"&rel_month="+rel_month+"&rel_year="+rel_year;
    ...
    { 
       ...
       url="../../../../../GPF_Subscription.view?command=Update&office_id="+office_id+"&gpf_no="+gpf_no+"&emp_id="+emp_id+"&ac_month="+ac_month+"&ac_year="+ac_year+"&type_trans="+type_trans+"&remarks="+remarks+"&rel_month="+rel_month+"&rel_year="+rel_year;
    ...
    {           //office_id=document.getElementById("txtOffId").value;
    	 ...
    	 sub_no=document.getElementById("sub_no").value;          
    	 url="../../../../../GPF_Subscription.view?command=Delete&gpf_no="+gpf_no+"&sub_no="+sub_no+"&ac_month="+ac_month+"&ac_year="+ac_year;
    ...
    { 
       ...
       var acyear=document.forms[0].ac_year.value;
  	   var unit=document.forms[0].Acc_unit_code.value;
  	   if(acmonth>0){
	        url="../../../../../GPF_Subscription.view?command=getone&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&fileType=s";
	        url=url+"&sid="+Math.random();
	        xmlhttp.open("GET",url,true);
	        xmlhttp.onreadystatechange=function()
	        {
    ...
    {   
       ...
       var officeid=document.forms[0].txtOffId.value;
        ...
        url="../../../../../GPF_Subscription.view?command=getupload&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&fileType=s"+"&offId="+officeid;
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=function()
        {
        ...
        xmlhttp.send(null);  
    		 ...
    		 url="../../../../../GPF_Subscription.view?command=getupload&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&fileType=s";
    	        url=url+"&sid="+Math.random();
    	        xmlhttp.open("GET",url,true);
    	        xmlhttp.onreadystatechange=function()
    	        {
    ...
    {   
        ...
        url="../../../../../GPF_Subscription.view?command=trialbalance&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit;
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=function()
        {
    ...
    {   
        ...
        url="../../../../../GPF_Subscription.view?command=AdjustmentJournal&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&command1=journal1";
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=function()
        {
 ...
 //	alert("AdjustmentJournal1 in call");
        ...
        url="../../../../../GPF_Subscription.view?command=AdjustmentJournal&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&command1=journal2";
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=function()
        {
...
function pick(i){
	...
	acmonth=k+1;  
      ...
      if(emp_name_val==" " || emp_name_val==null){
    	 ...
    	 // alert(gpfno);
    	  winemp= window.open("../../../../../org/HR/HR1/EmployeeMaster/jsps/GPF_Subscription_Popup.jsp?command=update&officeid="+officeid+"&acmonth="+acmonth+"&acyear="+acyear+"&gpfno="+gpfno+"&relmonth="+relmonth+"&unit="+unit+"&relyear="+relyear+"&subamount="+subamount+"&arramount="+arramount+"&refamount="+refamount+"&filetype="+filetype+"&reftot="+reftot+"&refins="+refins+"&sub_no="+sub_no+"&remark="+remark+"&updation=0&subscribe_slno="+subscribe_slno+"","mywindow1","status=1,height=500,width=500,resizable=YES, scrollbars=yes");
    	  winemp.moveTo(250,250);  
    	  winemp.focus();
      }
      else{
    	  winemp= window.open("../../../../../org/HR/HR1/EmployeeMaster/jsps/GPF_Subscription_Popup.jsp?command=update&officeid="+officeid+"&acmonth="+acmonth+"&acyear="+acyear+"&gpfno="+gpfno+"&relmonth="+relmonth+"&unit="+unit+"&relyear="+relyear+"&subamount="+subamount+"&arramount="+arramount+"&refamount="+refamount+"&filetype="+filetype+"&reftot="+reftot+"&refins="+refins+"&sub_no="+sub_no+"&remark="+remark+"&updation=1&subscribe_slno="+subscribe_slno+"","mywindow1","status=1,height=500,width=500,resizable=YES, scrollbars=yes");
    	  winemp.moveTo(250,250);  
    	  winemp.focus();
      }
