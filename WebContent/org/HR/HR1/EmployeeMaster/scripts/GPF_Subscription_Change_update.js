...
document.Hrm_TransJoinForm.eff_month.value="";
document.Hrm_TransJoinForm.eff_year.value="";
		...
		req.onreadystatechange = function() {
			if (req.readyState == 4) {
				...
				//	document.Hrm_TransJoinForm.validate.disabled = true;
					document.Hrm_TransJoinForm.Delete.disabled = true;
					...
					document.Hrm_TransJoinForm.Delete.disabled = false;
				}
					}
				}
				}
...
function updateResponse(response) {
	...
	if (res == "success") {
		...
		if (response.getElementsByTagName("command")[0].firstChild.nodeValue == "Update") {
