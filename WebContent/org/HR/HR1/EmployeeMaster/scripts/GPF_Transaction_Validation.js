       ...
       var unit_id;
        ...
        { 
        	...
        	if(nullCheck())
        	{
                ...
                url="../../../../../GPF_Transaction_Validation?command=Add&unit_id="+unit_id+"&ac_month="+ac_month+"&ac_year="+ac_year+"&finyear="+finyear;
    ...
    {   
      // var officeid=document.getElementById("txtOffId").value;
       var acmonth=document.forms[0].ac_month.value;
        ...
        url="../../../../../GPF_Transaction_Validation?command=trialbalance&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit;
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null);  
       ...
       if(xmlhttp.status==200)
       {
            ...
            if(command=="trialbalance")
            {
                ...
                //	document.getElementById("sub_credit").value=response.getElementsByTagName("sub_credit")[0].firstChild.nodeValue;
                	...
                	document.getElementById("withdrawal_debit").value=response.getElementsByTagName("withdrawal_debit")[0].firstChild.nodeValue;
...
{	
	...
	{
	var url="../../../../../GPF_Transaction_Validation?command=partial&gpf_no="+par_gpfno;
	 url=url+"&sid="+Math.random();
	// alert(url);
     xmlhttp.open("GET",url,true);
     xmlhttp.onreadystatechange=stateChanged;
...
function getFinancialYear(par_gpfno)
{
	...
	var url="../../../../../GPF_Transaction_Validation?command=FinancialYear_partial&gpf_no="+par_gpfno;
	 url=url+"&sid="+Math.random();
	 //alert(url);
    xmlhttp.open("GET",url,true);
...
function emp_details()
{
	...
	{
	var url="../../../../../GPF_Transaction_Validation?command=empDetails&gpf_no="+gpf_no;
	 url=url+"&sid="+Math.random();
	 //alert(url);
     xmlhttp.open("GET",url,true);
     xmlhttp.onreadystatechange=stateChanged;
...
function emp_detailsWorking()
{
	...
	{
	var url="../../../../../GPF_Transaction_Validation?command=empDetailsWorking&gpf_no="+gpf_no;
	 url=url+"&sid="+Math.random();
	 //alert(url);
     xmlhttp.open("GET",url,true);
     xmlhttp.onreadystatechange=stateChanged;
...
function emp_detailsRetired()
{
	...
	{
	var url="../../../../../GPF_Transaction_Validation?command=empDetailsRetired&gpf_no="+gpf_no;
	 url=url+"&sid="+Math.random();
	 //alert(url);
     xmlhttp.open("GET",url,true);
     xmlhttp.onreadystatechange=stateChanged;
...
{	
	var fin_year=document.getElementById("fin_year");
	fin_year.innerHTML="";
	 if(xmlhttp.readyState==4)
	    {
