...
function subscribepopup(comfun)
{
   ...
   if(comfun=='Add'){
	   ...
	   winemp= window.open("../../../../../org/HR/HR1/EmployeeMaster/jsps/GPF_Withdrawal_Popup_new.jsp?command=Add&officeid="+officeid+"&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&updation=1"+"","mywindow1","status=1,height=500,width=500,resizable=YES, scrollbars=yes");
       ...
       if(xmlhttp.status==200)
       {
            ...
            else if(command=="getone")
            {
                ...
                if(flag=='success')
                {
                  ...
                  //-----new changes-------
                    var trans_type=response.getElementsByTagName("TYPE_TRANS")[i].firstChild.nodeValue;
                    
                    if(trans_type=="null"||trans_type==null||trans_type=="")
                    {
                  	 trans_type="DB";
                    }
                   ...
                   var test="a"+seq;
                    ...
                    var tdtran=document.createElement("TD");
                    var  trans_type1=document.createTextNode(trans_type);
                    tdtran.appendChild(trans_type1);
                    ...
                    var subamount_db=response.getElementsByTagName("subamount_db")[0].firstChild.nodeValue; 
                    var subamount_db_null=response.getElementsByTagName("subamount_db_null")[0].firstChild.nodeValue; 
                    var subamount_cr=response.getElementsByTagName("subamount_cr")[0].firstChild.nodeValue; 
                    
                    var subamount_db_d=response.getElementsByTagName("subamount_db_d")[0].firstChild.nodeValue; 
                    var subamount_cr_d=response.getElementsByTagName("subamount_cr_d")[0].firstChild.nodeValue; 
                    var subamount_db_d_null=response.getElementsByTagName("subamount_db_d_null")[0].firstChild.nodeValue; 
                    
                    var da_total=response.getElementsByTagName("da_total")[0].firstChild.nodeValue; 
                    
                    total_d=parseInt(subamount_db,10)+parseInt(subamount_db_null,10)-parseInt(subamount_cr,10);
                   
                
                  
               document.getElementById("firstamount").value=total_d;
               db_tot=parseInt(subamount_db,10)+parseInt(subamount_db_d,10)+parseInt(subamount_db_null,10)+parseInt(subamount_db_d_null,10)-parseInt(da_total,10);
               cr_tot=parseInt(subamount_cr,10)+parseInt(subamount_cr_d,10);
               
            document.getElementById("db_total").value=db_tot;
              
               
             document.getElementById("cr_total").value=cr_tot;
             
              
               document.getElementById("da_total").value=parseInt(da_total,10);
           if(len>0){
        	   data_value="true";
                   ...
                   var seq1=0;
                    for(var i=0;i<len;i++)
                    {
                     ...
                     /**    var tdg=document.createElement("TD");
                         ...
                         // ----new changes------
                         var subamount_cr_u=response.getElementsByTagName("subamount_cr_u")[0].firstChild.nodeValue; 
                         var subamount_db_u=response.getElementsByTagName("subamount_db_u")[0].firstChild.nodeValue; 
                         var subamount_db_u_null=response.getElementsByTagName("subamount_db_u_null")[0].firstChild.nodeValue; 
                        
                         total_u=parseInt(subamount_db_u,10)+parseInt(subamount_db_u_null,10)-parseInt(subamount_cr_u,10);
                         dbu=parseInt(subamount_db_u,10);
                         cru=parseInt(subamount_cr_u,10);
                        
                         
                 document.getElementById("ufirstamount").value=total_u;
...
if(xmlhttp==null)
{
    ...
    {   
       ...
       var acmonth=document.forms[0].ac_month.value;
        ...
        url="../../../../../GPF_Withdrawal_New_new?command=getone&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&fileType=w";
        url=url+"&sid="+Math.random();
    ...
    {   
        ...
        url="../../../../../GPF_Withdrawal_New_new?command=getupload&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&fileType=w"+"&offId="+officeid;
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null); 
    		 ...
    		 url="../../../../../GPF_Withdrawal_New_new?command=getupload&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&fileType=w";
    	        url=url+"&sid="+Math.random();
    	        xmlhttp.open("GET",url,true);
    	        xmlhttp.onreadystatechange=stateChanged;
    	        xmlhttp.send(null); 
    ...
    {   
       ...
       var acmonth=document.forms[0].ac_month.value;
        ...
        url="../../../../../GPF_Withdrawal_New_new?command=trialbalance&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit;
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null);  
    ...
    {   
        ...
        url="../../../../../GPF_Withdrawal_New_new?command=AdjustmentJournal&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&command1=journal1";
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
    ...
    {   
        ...
        url="../../../../../GPF_Withdrawal_New_new?command=AdjustmentJournal&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit+"&command1=journal2";
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=function()
        {
    ...
    {   
    	...
    	url="../../../../../GPF_Withdrawal_New_new.view?command=getpop&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit;
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null);  
...
if(xmlhttp==null)
{
    ...
    var unit_name=document.getElementById("unit_name").value;
        ...
        url="../../../../../GPF_Withdrawal_New_new?command=unit&unit_name="+unit_name;
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null);   
...
function pick(i){
    ...
    var rel_month_year=rcells.item(4).lastChild.nodeValue.split("-");
      ...
      var officeid=document.forms[0].txtOffId.value;
      var type_trans=rcells.item(10).firstChild.nodeValue;
      var with_slno=rcells.item(11).lastChild.value;
    

      if(emp_name_val==" " || emp_name_val==null){
    	  alert("Only Deletion can perform.Because employee master details not available");
    	  winemp= window.open("../../../../../org/HR/HR1/EmployeeMaster/jsps/GPF_Withdrawal_Popup_new.jsp?command=update&officeid="+officeid+"&acmonth="+acmonth+"&acyear="+acyear+"&gpfno="+gpfno+"&relmonth="+relmonth+"&unit="+unit+"&relyear="+relyear+"&amount="+amount+"&filetype="+filetype+"&reftot="+reftot+"&refins="+refins+"&typeTrans="+type_trans+"&remark="+remark+"&type="+type+"&date="+date+"&updation=0&with_slno="+with_slno+"","mywindow1","status=1,height=500,width=500,resizable=YES, scrollbars=yes");
    	  winemp.moveTo(250,250);  
    	  winemp.focus();
...
url="../../../../../GPF_Withdrawal_New_new?command=getone&acmonth="+acmonth+"&acyear="+acyear+"&unit="+unit;
url=url+"&sid="+Math.random();
xmlhttp.open("GET",url,true);
xmlhttp.onreadystatechange=stateChanged;
xmlhttp.send(null);  
