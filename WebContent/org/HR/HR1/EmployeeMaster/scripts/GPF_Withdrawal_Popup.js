...
if(xmlhttp==null)
{
        ...
        { 
        	...
        	if(nullCheckpop())
        	{
               ...
               type=document.Hrm_TransJoinFormpop.type.value;
                ...
                url="../../../../../GPF_Withdrawal_New?command=Add&office_id="+office_id+"&gpf_no="+gpf_no+"&division_id="+division_id+"&emp_id="+emp_id+"&ac_month="+ac_month+"&ac_year="+ac_year+"&remarks="+remarks+"&rel_month="+rel_month+"&rel_year="+rel_year+"&unit="+unit;
                url=url+"&ref_no="+ref_no+"&type="+type+"&date="+date+"&ref_total="+ref_total;
    ...
    { 
     ...
     //   alert(document.Hrm_TransJoinFormpop.date.length());
       ...
       url="../../../../../GPF_Withdrawal_New?command=Update&office_id="+office_id+"&gpf_no="+gpf_no+"&emp_id="+emp_id+"&ac_month="+ac_month+"&ac_year="+ac_year+"&remarks="+remarks+"&rel_month="+rel_month+"&rel_year="+rel_year+"&with_slno="+with_slno;
       url=url+"&filetype="+filetype+"&ref_no="+ref_no+"&division_id="+division_id+"&ref_total="+ref_total;
       url=url+"&amount="+amount+"&date="+date+"&type="+type+"&old_type="+old_type;             
    ...
    { 
    	//office_id=document.getElementById("txtOffId").value;
    	 ...
    	 division_id=document.getElementById("oldcode").value;
    	 with_slno=document.getElementById("with_slno").value;
         url="../../../../../GPF_Withdrawal_New?command=Delete&gpf_no="+gpf_no+"&ac_month="+ac_month+"&filetype="+filetype+"&ac_year="+ac_year+"&with_type="+with_type+"&rel_month="+rel_month+"&rel_year="+rel_year+"&division_id="+division_id+"&with_slno="+with_slno;
