...
if(xmlhttp==null)
{
    ...
    return;
        ...
        { 
          ...
          url="../../../../../GPF_Withdrawal_Status?command=Add&w_id="+w_id+"&w_desc="+w_desc;    
    ...
    { 
          ...
          url="../../../../../GPF_Withdrawal_Status?command=Update&w_id="+w_id+"&w_desc="+w_desc;    
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null); 
    ...
    {                            w_id=document.getElementById("w_id").value;
          ...
          url="../../../../../GPF_Withdrawal_Status?command=Delete&w_id="+w_id;    
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null); 
    ...
    {   
            document.Hrm_TransJoinForm.w_id.focus();
        url="../../../../../GPF_Withdrawal_Status?command=get";
        url=url+"&sid="+Math.random();
        xmlhttp.open("GET",url,true);
       xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null); 
...
{
alert("Enter the Withdrawl Status Id ");
}

else if(document.Hrm_TransJoinForm.w_desc.value=="")
{
alert("Enter the withdrawl Status description");
}
