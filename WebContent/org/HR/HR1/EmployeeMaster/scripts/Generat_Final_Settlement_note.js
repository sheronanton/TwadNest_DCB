...
/*function loadDetails(authNo){
    ...
    loadDefault();
    url="../../../../../Generat_Final_Settlement_note.view?command=get&gpf_no="+gpf_no+"&auth_no="+authNo;
                ...
                {	
                		...
                		if(relieval_reason=="DTH")
            			{
	        				...
	        				for(var i=0;i<cccounts;i++)
	        					...
	        					//copyies=response.getElementsByTagName("COPY_TO")[i].firstChild.nodeValue;
	        					//if(copyies)
	        					//len=copyies.length-1;
	        					//alert(len);
	        					//copyies=copyies.substring(0,len-1);
	        					//alert(copyies);
            				...
            				//alert("document.Hrm_GpfSettlementForm.copy.value======"+document.Hrm_GpfSettlementForm.copy.value);
...
//						}
                		...
                		var PRESID_OFFICER_SUFFIX=response.getElementsByTagName("PRESID_OFFICER_SUFFIX")[0].firstChild.nodeValue;
                		if(PRESID_OFFICER_SUFFIX=='null')
                		{
                			document.Hrm_GpfSettlementForm.suffix.value="";
                		}
                		else
                			{
                				document.Hrm_GpfSettlementForm.suffix.value=PRESID_OFFICER_SUFFIX;
                			}
...
//                		document.Hrm_GpfSettlementForm.any_comments.value=response.getElementsByTagName("ADDL_CONDITIONS")[0].firstChild.nodeValue;
                    ...
                    alert("This GPF_NO is not valid");
                    clearData();
                }
...
xmlhttp=getxmlhttpObject();
	...
	if(xmlhttp==null)
	{
        ...
        { 
					...
					if(checkAllComboSelected()){
						url="../../../../../Generat_Final_Settlement_note.view?command=Add&gpf_no="+gpf_no+"&emp_id="+emp_id+"&prefix="+prefix+"&pro_officer_name="+pro_officer_name+"&suffix="+suffix;
    	...
    	//alert("document.Hrm_GpfSettlementForm.radRlv.length===="+document.Hrm_GpfSettlementForm.radRlv.length);
    	for(var i=0;i<document.Hrm_GpfSettlementForm.radRlv.length;i++)
    		{
    ...
    //	alert("COPY ===== "+copy);
    	...
    	//	{
    			//alert("copy array's values===="+copy_array[i]);
    	//	}
 			...
 			var txtImpoundBal=document.getElementById("txtImpoundBal").value;
                 ...
                 var listMonth=document.getElementById("listMonth").value; 
                    ...
                    if(listYear=="select" || listMonth=="select")
                    	...
                    	{
    	document.Hrm_GpfSettlementForm.action = "../../../../../Generat_Final_Settlement_note.view?gpf_no="
    							+gpf_no+"&auth_date="+auth_date+"&LEGAL_HEIR_NAME="+LEGAL_HEIR_NAME+"&rel_reason="+rel_reason+ "&cmbReportType="+cmbReportType+"&txtLastSlipClosingBal="+txtLastSlipClosingBal+"&txtImpoundBal="+txtImpoundBal+"&txtSubscriptionCredit="+txtSubscriptionCredit+"&txtSubscriptionDebit="+txtSubscriptionDebit+"&intrest_upto="+intrest_upto+"&copy="+copy+"&copy_array="+copy_array+"&length="+length+"&designation="+designation+"&comEmpId="+comEmpId;
    							alert("URLL==="+document.Hrm_GpfSettlementForm.action);
...
//					if(checkAllComboSelected()){
						url="../../../../../Generat_Final_Settlement_note.view?command=Draft&gpf_no="+gpf_no;
...
//    }
    ...
    else if(command=="Validate")
    {
		...
		if(checkAllComboSelected()){
			url="../../../../../Generat_Final_Settlement_note.view?command=Validate&gpf_no="+gpf_no+"&relieve_status="+relieve_status+"&relieve_date="+relieve_date+"&int_tobe_calc_month="+int_tobe_calc_month+"&int_tobe_calc_year="+int_tobe_calc_year;
    ...
    {  
        ...
        loadDefault();
        url="../../../../../Generat_Final_Settlement_note.view?command=get&gpf_no="+gpf_no;        
    ...
    {  
        ...
        var gpf_no=document.Hrm_GpfSettlementForm.txtGpfNo.value;
        url="../../../../../Generat_Final_Settlement_note.view?command=Delete&gpf_no="+gpf_no;        
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null); 
    }    
        ...
        url="../../../../../Generat_Final_Settlement_note.view?command=LoadYear&relieve_date="+relvDate;        
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null);
        ...
        url="../../../../../Generat_Final_Settlement_note.view?command=LoadMonth&relieve_date="+relvDate+"&listYear="+rlvYear;        
        xmlhttp.open("GET",url,true);
        xmlhttp.onreadystatechange=stateChanged;
        xmlhttp.send(null);
    }
