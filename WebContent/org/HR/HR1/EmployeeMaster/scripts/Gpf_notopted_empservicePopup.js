 ...
 function getDesignation()
  ...
  
  {
      ...
      try{
       ...
       var cell=document.getElementById("divpre");
        ...
        cell.style.display="none";
        cell.innerText='';
       var url="../../../../../Gpf_notopted_EmpServicePopupServ.view?Command=Emp&cmbsgroup=" + group ;
  ...
  
  {
       ...
       var cell=document.getElementById("divpre");
        ...
        cell.style.display="none";
        cell.innerText='';
       var url="../../../../../Gpf_notopted_EmpServicePopupServ.view?Command=GPF&txtgpf=" + group ;
     ...
     function loadOfficesByType(type)
    {
       ...
       var url="../../../../../Gpf_notopted_EmpServicePopupServ.view?Command=SGroup&cmbsgroup=" + type ;
        var req=getTransport();
        req.open("GET",url,true);        
        req.onreadystatechange=function()
        {
