...
//		}
//	
//	var imgfile=document.frmEmployee.userImage.value;
//	
...
////		{
////		alert("Hello");
////		var imgvalue=document.getElementById("userImage").value;
////		
////		alert("imgvalue==="+imgvalue);
////		var img=imgvalue.split(".");
...
////		
////		alert(imgFormat);
////		if(imgFormat=="gif" || imgFormat=="GIF" || imgFormat=="jpeg" || imgFormat=="JPEG" || imgFormat=="jpg" || imgFormat=="JPG" || imgFormat=="png" || imgFormat=="PNG")
////			
////			{
////			return true;
////			}
...
function getDeptId()
{
        ...
        {
           var des=document.getElementById("txtDept_Id");
           des.innerHTML='';
        }
}

function loadDeptByType(type)
{
     ...
     {
            startwaiting(document.HRE_EmployeeServiceDetails) ;
            var url="../../../../../EmpDeptPopupServ.view?Command=DeptId";
           //alert(url);
            var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
     ...
     {
            startwaiting(document.HRE_EmployeeServiceDetails) ;
            var url="../../../../../EmpDeptPopupServ.view?Command=DeptIdTwad";
            // alert(url);
            var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
     ...
     if(req.readyState==4)
        {
          ...
          { 
                ...
                if(flag=="failure")
                {
                    alert("No Department Id exists under this level");
                }
                else if(flag=="sessionout")
            {
                alert('Session is closed');
...
function  loadDepartmentTwad(req)
{
     if(req.readyState==4)
       {
          if(req.status==200)
