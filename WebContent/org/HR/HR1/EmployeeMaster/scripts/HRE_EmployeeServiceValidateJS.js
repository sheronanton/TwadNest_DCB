   ...
   document.HRE_EmployeeServiceDetails.txtEmployee.value="";
    ...
    if(Command=='loademp')
    {
       var tbody=document.getElementById("tb");
        ...
        if(check )
        {
         document.HRE_EmployeeServiceDetails.cmdchkgap.disabled=false;
       ...
       var cell=document.getElementById("divpre");
        ...
        cell.innerText='';
               // alert('load emp');
                if(param=='exist')
                {
                var url="../../../../../HRE_EmployeeServiceValidateServ.view?Command=loademp&txtEmployeeid="+empid+"&param=exist";
                }
                else
                {
                var url="../../../../../HRE_EmployeeServiceValidateServ.view?Command=loademp&txtEmployeeid="+empid;
                }
    ...
    else if(Command=="Interval")
    {
           if(!(empid==null || empid.length==0))
           {
               ...
               {
                    startwaiting(document.HRE_EmployeeServiceDetails) ;
                    var url="../../../../../HRE_EmployeeServiceValidateServ.view?Command=Interval&txtEmployeeid="+empid;
                    //alert("url is---->"+url);
                    req.open("GET",url,true);
                    req.onreadystatechange=handleResponse;
                    if(window.XMLHttpRequest)
...
function IntervalFun(baseResponse)
{
    ...
    if(flag=="failure")
    {
         if(confirm('There is some intervals in SR.Do you want to show?'))
         {
            intervalpopup();
        }
    }
    ...
    {
           alert('There is no Intervals. Records are freezed');
        ...
        document.HRE_EmployeeServiceDetails.txtEmployeeid.focus();
          // document.HRE_EmployeeServiceDetails.cmdchkgap.disabled=true;
