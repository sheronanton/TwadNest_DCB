...
function doParentJob(jobid,deptid)
{
    ...
    {
        document.Hrm_TransJoinForm.txtDepId.value=deptid;
       // document.Hrm_TransJoinForm.txtDepName.value=deptid;
        document.Hrm_TransJoinForm.txtDepOffId.value= jobid ;
...
function servicepopup()
{
    ...
    winemp= window.open("EmpDeputationJoiningPopup.jsp","mywindow_ESP1","status=1,height=400,width=500,resizable=YES, scrollbars=yes"); 
...
{   
    ...
    */
     ...
     else if((document.Hrm_TransJoinForm.txtDepOffId.value==null)||(document.Hrm_TransJoinForm.txtDepOffId.value.length==0))
    {
        alert("Select the Other Office Name");
        document.Hrm_TransJoinForm.txtDepOffId.focus();
        return false;
    }
    ...
    if((document.Hrm_TransJoinForm.txtOffice_Id.value==null)||(document.Hrm_TransJoinForm.txtOffice_Id.value.length==0))
    {
   ...
   if(empstatus!='WKG')
    ...
    /* else if((document.Hrm_TransJoinForm.comDesign.value==null)||(document.Hrm_TransJoinForm.comDesign.value.length==0))
    {
   ...
   else
   {
    ...
    if(Command=="Add")
    {
        var flagg=nullch();
                    ...
                    if(flagg==true)
                    {
                        var url="../../../../../HrmTransDPNJoinServ.view?Command=dispDesign&txtOffId="+OffCode+"&JYear="+a[2];
                            //alert(url);
     ...
     else if(Command=="Load")
    {
      ...
      var   Dept_Id;
             ...
             if(param==true)
            {
                ...
                jobflag=true;
                Dept_Id=document.Hrm_TransJoinForm.txtDept_Id_work.value;
               Office_Id =document.Hrm_TransJoinForm.txtOffice_Id.value;
        ...
        else if(Command=="disp")
        {
            ...
            var url="../../../../../HrmTransDPNJoinServ.view?Command=disp&txtEmpId="+EmpId;
            alert(url);
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
        ...
        else if(Command=="dispEmp")
        {
            ...
            clr();
            var url="../../../../../HrmTransDPNJoinServ.view?Command=dispEmp&comEmpId="+EmpId;
           //  alert(url);
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
...
function dispEmpRow(baseResponse)
{
  ...
  /*  if(empstatus!='WKG')
    ...
    else
    {
        ...
        var otherdeptoffice=baseResponse.getElementsByTagName("otherdeptoffice")[0].firstChild.nodeValue;
         if(otherdeptoffice=='null')
                                    otherdeptoffice='';
       document.Hrm_TransJoinForm.txtDepDoj.value=maxtodate;
       // document.Hrm_TransJoinForm.txtDepName.value=otherdeptname;
      //  document.Hrm_TransJoinForm.txtDepOffName.value=otherdeptoffice;
       ...
       if(other_dept_id=='0')
        ...
        if(other_office_id=='0')
            other_office_id='';
    // document.Hrm_TransJoinForm.txtDepName.value=other_dept_id;       
    document.Hrm_TransJoinForm.txtDepId.value=other_dept_id;
    ...
    document.Hrm_TransJoinForm.txtDepOffId.value=other_office_id;
    //alert(other_office_id);
    //document.Hrm_TransJoinForm.txtDepOffName.value=other_office_id;
    
    // alert(document.Hrm_TransJoinForm.txtDepOffId.value);
    ...
    {
        alert("Can not give a Deputation for this employee. This employee is not releived for Deputation.");
        document.Hrm_TransJoinForm.txtEmpId.value="";
        document.Hrm_TransJoinForm.txtDOB.value="";
        document.Hrm_TransJoinForm.txtGpfNo.value="";
        document.Hrm_TransJoinForm.comEmpId.value="";
    ...
    {
        alert("This Employee  is on Study Leave.\n So cann't create a new joining record for this Employee");
        document.Hrm_TransJoinForm.txtEmpId.value="";
        document.Hrm_TransJoinForm.txtDOB.value="";
        document.Hrm_TransJoinForm.txtGpfNo.value="";
        document.Hrm_TransJoinForm.comEmpId.value="";
        ...
        var compsession;
         if(document.Hrm_TransJoinForm.optFNAN[0].checked==true)
           ...
           else
           {
            ...
            var other_dept_id=document.Hrm_TransJoinForm.txtDepId.value;
            var other_office_id=document.Hrm_TransJoinForm.txtDepOffId.value;
            var sr_cntrl_offid=document.Hrm_TransJoinForm.txtOffice_Id.value;
   
           //var url="../../../../../HrmTransDPNJoinServ.view?Command=Add&txtOffId="+OffCode+"&txtEmpId="+EmpId+"&txtJR="+jj+"&radFNAN="+radvalue+"&txtDOJ="+DOJ+"&comDesign="+design+"&comPostTow="+postcount+"&txtRemarks="+rem+"&JYear="+a[2]+"&empstatus="+empstatus;//+"&compdate="+compdate+"&compsession="+compsession;
           var url="../../../../../HrmTransDPNJoinServ.view?Command=Add&txtOffId="+OffCode+"&txtEmpId="+EmpId+"&txtJR="+jj+"&radFNAN="+radvalue+"&txtDOJ="+DOJ+"&txtRemarks="+rem+"&JYear="+a[2]+"&empstatus="+empstatus;
                ...
                if(req.status==200)
                {
                      ...
                      if(flag=="failure")
                      {
                         alert("failed to retrieve the values");
                                ...
                                document.Hrm_TransJoinForm.txtDepId.value='';
                                document.Hrm_TransJoinForm.txtDepOffId.value='';
                        ...
                        else
                      {
                          ...
                          for(var i=0;i<value.length;i++)
                          {
                              ...
                              document.Hrm_TransJoinForm.txtDepOffId.value=name;
                               }      
                         }  
                ...
                if(req.status==200)
                {
                      ...
                      if(flag=="failure")
                      {
                         alert("failed to retrieve the values");
                                ...
                                document.Hrm_TransJoinForm.txtOffice_Name.value='';
...
{
  var dept_id=document.Hrm_TransJoinForm.txtDepId.options[document.Hrm_TransJoinForm.txtDepId.selectedIndex].value;
  //alert(dept_id);
  
     var url="../../../../../HrmTransDPNJoinServ.view?Command=depName&txtDepId="+dept_id;
     //alert(url);
     var req=getTransport();
                              //alert("test");
     req.open("GET",url,true); 
