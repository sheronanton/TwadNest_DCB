...
function doFunction(Command,param)
{
    ...
    if(Command=='loadempedit')
    {
        ...
        if(check )
        {
                ...
                var url="../../../../../ModifyEmployeeGradeServ?Command=loadempedit&txtEmployeeid="+empid;
     ...
     //   var check=notNull('Update');
      //  alert(check);
           //statuswaiting(document.frmCurrentPosting) ;
            //   alert('inside check')
                    document.frmCurrentPosting.action="../../../../../ModifyEmployeeGradeServ?Command=Update&txtEmployeeid="+empid+"&officegrade="+officegrade;
