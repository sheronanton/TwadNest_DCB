...
function doFunction(Command,param)
{
    ...
    {
    var url="../../../../../hrm_Create_Emp_servlet_new?Command=Suspension&txtEmployeeid="+eid+"&reasonid="+reason;
            //alert(url);
    ...
    {       
        ...
        var offid=document.EmpRelieval.txtOffId.value;
            var url="../../../../../hrm_Create_Emp_servlet_new?Command=loademp&txtEmployeeid="+eid+"&offid="+offid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
   ...
   /*     else if(Command=="loademp1")
        {   //alert(eid);
        var offid=document.EmpRelieval.txtOffId.value;
            var url="../../../../../hrm_Create_Emp_servlet_new?Command=loademp1&txtEmployeeid="+eid+"&offid="+offid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../hrm_Create_Emp_servlet_new?Command=office&oid="+oid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../hrm_Create_Emp_servlet_new?Command=dept&oid="+oid+"&deptid="+deptid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../hrm_Create_Emp_servlet_new?Command=desig&desigid="+desigid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
...
//alert(maxfromdate);
    ...
    else if(flag=="failure2")
    {
        ...
        rerd= confirm("Employee Id '"+eid+"' already has an unfrezeed relieval record ,Do you want to Edit Details ?");
