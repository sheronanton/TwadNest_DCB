...
var url="../../../../../New_HrmTransJoinServ_New?Command=getsupgroup&off_id="+off_id+"&group_id="+group_id;
  ...
  //alert(JRId);
   ...
   else
   {
    ...
    if(Command=="Add")
    {
        ...
        if(flagg==true)
        {
            var url="../../../../../New_HrmTransJoinServ_New?Command=dispDesign&txtOffId="+OffCode+"&JYear="+a[2];
        ...
        else if(Command=="disp")
        {
            ...
            var url="../../../../../New_HrmTransJoinServ_New?Command=disp&txtEmpId="+EmpId;
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
        ...
        else if(Command=="dispEmp")
        {
           ...
           */
            ...
            clr();
            var url="../../../../../New_HrmTransJoinServ_New?Command=dispEmp&comEmpId="+EmpId+"&office_id="+office_id;
             //alert(url);
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
...
function dispEmpRow(baseResponse)
{
    ...
    if((flag=="success"))
    {
    	 var inclusion=baseResponse.getElementsByTagName("inclusion")[0].firstChild.nodeValue;
    	
    	 if(inclusion=="NO")
    	 {
    	
    	 alert("This Employee  is already  included in your group");
    	 }
    	 else
    	 if(inclusion=='WKG')
    	 {
    		 var sid=baseResponse.getElementsByTagName("of_name")[0].firstChild.nodeValue;
    	var SRctrl= confirm("This Employee is already  Working in "+sid+ ". Do you want to include in your group ... ");
...
else
{
     ...
     else if(flag=="failure3_1")
    {
        ...
        alert("The Employee belongs to the  Pay Bill process at "+officename+".\n So can not create a new joining record for this Employee");
        document.Hrm_TransJoinForm.txtEmpId.value="";
        document.Hrm_TransJoinForm.txtDOB.value="";
        document.Hrm_TransJoinForm.txtGpfNo.value="";
        document.Hrm_TransJoinForm.comEmpId.value="";
    ...
    {
        alert("This Employee  has already in retired status.\n So can not create a new joining record for this Employee");
        document.Hrm_TransJoinForm.txtEmpId.value="";
        document.Hrm_TransJoinForm.txtDOB.value="";
        document.Hrm_TransJoinForm.txtGpfNo.value="";
        document.Hrm_TransJoinForm.comEmpId.value="";
    ...
    {
        alert("This Employee  is in Abroad. So cann't create a new joining in TWAD Board ");
        document.Hrm_TransJoinForm.txtEmpId.value="";
        document.Hrm_TransJoinForm.txtDOB.value="";
        document.Hrm_TransJoinForm.txtGpfNo.value="";
        document.Hrm_TransJoinForm.comEmpId.value="";
   ...
   else if(document.Hrm_TransJoinForm.Office_Grade[3].checked==true)
   {
    ...
    paybill=0;
    	...
    	groupid=document.Hrm_TransJoinForm.pay_group_id.value;
           ...
           var url="../../../../../New_HrmTransJoinServ_New?Command=Add&txtOffId="+OffCode+
              "&txtEmpId="+EmpId+"&radFNAN="+radvalue+"&txtDOJ="+DOJ+"&comDesign="+design+
...
function postcount(){
var postid;
	var desigcode=document.Hrm_TransJoinForm.comDesign.value;
