       ...
       if(command=="Load")
         { 
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_DPNJoinReportValid_Servlet.view?command=Load&EName=" + strEmpName;
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
                    {
        ...
        if(command=="Load1")
         { 
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_DPNJoinReportValid_Servlet.view?command=Load1&EName=" + strEmpName;
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
                    {
         ...
         { 
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_DPNJoinReportValid_Servlet.view?command=LoadEmp&EName=" + strEmpName;
         ...
         { 
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_DPNJoinReportValid_Servlet.view?command=LoadSer&txtser=" + strSerid+"&EName=" + strEmpName;
                    //alert(url);
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
           ...
           if(command=="Update")
            {
                 ...
                 var other_dept_id=document.frmEmployee.txtDepId.value;
                        ...
                        //var url="../../../../../Employee_DPNJoinReportValid_Servlet.view?command=Update&txtOffId="+strOffId+"&txtEmpId="+strEmpName+"&txtDOJ="+strYear+"&radFNAN="+radvalue+"&cmbdes="+design+"&comPostTow="+postcount+"&txtRemarks="+rem+"&JoinId="+strJoinId+"&comProcFlowId="+strProcessId+"&txtjoindate="+strJdate+"&empstatus="+empstatus;//+"&compdate="+compdate+"&compsession="+compsession;
                        var url="../../../../../Employee_DPNJoinReportValid_Servlet.view?command=Update&txtOffId="+strOffId+"&txtEmpId="+strEmpName+"&txtDOJ="+strYear+"&radFNAN="+radvalue+"&txtRemarks="+rem+"&JoinId="+strJoinId+"&comProcFlowId="+strProcessId+"&txtjoindate="+strJdate+"&empstatus="+empstatus;
        ...
        else if(command=="Delete")
        {
           ...
           if(confirm("Do You Really want to Delete it"))
                        {
                        startwaiting(document.frmEmployee) ;
            url="../../../../../Employee_DPNJoinReportValid_Servlet.view?command=Delete&txtEmpId="+strEmpName+"&JoinId="+strJoinId+"&txtOffId="+strOffId+"&txtDOJ="+strYear;
            //req.abort();
            var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
