       ...
       if(command=="Load")
         { 
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_JoinReportValid_Servlet.view?command=Load&EName=" + strEmpName;
                    //alert(url);
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
        ...
        if(command=="Load1")
         { 
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_JoinReportValid_Servlet.view?command=Load1&EName=" + strEmpName;
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
                    {
             ...
             if(command=="LoadEmp")
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_JoinReportValid_Servlet.view?command=LoadEmp&EName=" + strEmpName;
                    //alert(url);
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_JoinReportValid_Servlet.view?command=LoadSer&txtser=" + strSerid+"&EName=" + strEmpName;
                    //alert(url);
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
        ...
        else if(command=="Delete")
        {
           ...
           if(confirm("Do You Really want to Delete it"))
                        {
                        startwaiting(document.frmEmployee) ;
            url="../../../../../Employee_JoinReportValid_Servlet.view?command=Delete&txtEmpId="+strEmpName+"&JoinId="+strJoinId+"&txtOffId="+strOffId+"&txtDOJ="+strYear;
            //req.abort();
            var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
