...
function callServer1(command,param)
       ...
       if(command=="Load")
        ...
        if(command=="Load1")
         { 
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_JoinReportValid_Servlet_New.view?command=Load1&EName=" + strEmpName;
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
                    {
             ...
             if(command=="LoadEmp")
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_JoinReportValid_Servlet_New.view?command=LoadEmp&EName=" + strEmpName;
                    //alert(url);
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_JoinReportValid_Servlet_New.view?command=LoadSer&txtser=" + strSerid+"&EName=" + strEmpName;
                    //alert(url);
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
           ...
           // alert("update");
            ...
            paybill=0;
                ...
                var url="../../../../../Employee_JoinReportValid_Servlet_New.view?command=Update&txtOffId="+strOffId1+
        ...
        else if(command=="Delete")
        {
           ...
           if(confirm("Do You Really want to Delete it"))
                        {
                        startwaiting(document.frmEmployee) ;
            url="../../../../../Employee_JoinReportValid_Servlet_New.view?command=Delete&txtEmpId="+strEmpName+"&JoinId="+strJoinId+"&txtOffId="+strOffId+"&txtDOJ="+strYear;
            //req.abort();
            var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
 ...
 function getsubgroup_new(subgroup){
