       ...
       if(command=="Load")
         { 
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_JoinReport_Servlet.view?command=Load&EName=" + strEmpName;
                   // alert(url);
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
   ...
   if(document.frmEmployee.optjoin)
    ...
    else
    {
            ...
            wing=document.frmEmployee.cmbWing.value;
                         ...
                         var url="../../../../../Employee_JoinReport_Servlet.view?command=Update&txtOffId="+strOffId+"&txtEmpId="+strEmpName+"&txtDOJ="+strYear+"&radFNAN="+radvalue+"&cmbdes="+design+"&comPostTow="+postcount+"&txtRemarks="+rem+"&JoinId="+strJoinId+"&empstatus="+empstatus;//+"&compdate="+compdate+"&compsession="+compsession;
        ...
        else if(command=="Delete")
        {
           ...
           if(confirm("Do You Really want to Delete it"))
            {
            startwaiting(document.frmEmployee) ;
            url="../../../../../Employee_JoinReport_Servlet.view?command=Delete&txtEmpId="+strEmpName+"&JoinId="+strJoinId+"&txtOffId="+strOffId+"&txtDOJ="+strYear;
            //req.abort();
            var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
