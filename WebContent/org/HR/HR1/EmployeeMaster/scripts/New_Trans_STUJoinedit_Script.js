       ...
       if(command=="Load")
         { 
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../Employee_STUJoinReport_Servlet.view?command=Load&EName=" + strEmpName;
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
                    {
        ...
        var sr_cntrl_offid=document.frmEmployee.txtOffice_Id.value;
                        // var url="../../../../../Employee_STUJoinReport_Servlet.view?command=Update&txtOffId="+strOffId+"&txtEmpId="+strEmpName+"&txtDOJ="+strYear+"&radFNAN="+radvalue+"&cmbdes="+design+"&comPostTow="+postcount+"&txtRemarks="+rem+"&JoinId="+strJoinId+"&empstatus="+empstatus;//+"&compdate="+compdate+"&compsession="+compsession;
                         var url="../../../../../Employee_STUJoinReport_Servlet.view?command=Update&txtOffId="+strOffId+"&txtEmpId="+strEmpName+"&txtDOJ="+strYear+"&radFNAN="+radvalue+"&txtRemarks="+rem+"&JoinId="+strJoinId+"&empstatus="+empstatus;
        ...
        else if(command=="Delete")
        {
           ...
           if(confirm("Do You Really want to Delete it"))
            {
            startwaiting(document.frmEmployee) ;
            url="../../../../../Employee_STUJoinReport_Servlet.view?command=Delete&txtEmpId="+strEmpName+"&JoinId="+strJoinId+"&txtOffId="+strOffId+"&txtDOJ="+strYear;
            //req.abort();
            var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
