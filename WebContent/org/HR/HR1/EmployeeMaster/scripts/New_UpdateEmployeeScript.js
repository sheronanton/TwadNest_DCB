    ...
    if(command=="ExistgBasic")
       {
         ...
         startwaiting(document.frmEmployee) ; 
          url="../../../../../InsertEmployee3.con?command=ExistgBasic&EmpId=" + strEmpId + "&OfficeId=" + OfficeId;
           var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
                   ...
                   if(flag==0)
                    {
                         ...
                         startwaiting(document.frmEmployee) ; 
                        url="../../../../../InsertEmployee3.con?command=toUpdate&EmpId="+hstrEmpId+"&EmpDOB="+strDob+"&EmpGender="+strGender+"&Comm="+strCommunity+"&District="+strDistrict+"&EmpQual="+strQual+"&EmpmStatus="+strEmpmStatus+"&EmpDesig="+strDesig+"&EmpeStatus="+strEmpeStatus+"&EmpMarital="+strMarital+"&Remarks="+strRemarks+ "&Others=" +strOthers+ "&OtherState=" +strOtherState+"&EmpInitial="+strEmpInit+"&EmpPrefix="+strEmpPrefix+"&EmpName="+strEmpName+"&GpfNo="+strEmpGpfNo;
                        url=url+"&probation="+probation+"&dateOfRegPro="+dateOfRegPro+"&getting="+getting+"&Handicapped="+Handicapped+"&Consolid="+consolid+"&reg_date="+reg_date+"&Taluk="+strTaluk+"&DOR="+strDoR;
		                  ...
		                  if((DOR==null)||(DOR=='null'))
		                	{
		                	  ...
		                	  document.frmEmployee.Date_Of_Retirment.value=DOR;
				                  ...
				                  if(RecordStatus=='FR')
				                    ...
				                    if(RecordStatus=='MD')
				                  {
				                    document.frmEmployee.cmbRecordStatus.value="Modified";
				                    document.frmEmployee.txtEmpId1.disabled=true;
				                    document.frmEmployee.EmpId.value=document.frmEmployee.txtEmpId1.value
								      document.frmEmployee.txtEmpId1.focus();
				                  ...
				                  if(distr==999)
					                ...
					                {
				                	  callServers(baseResponse.getElementsByTagName("District")[0].firstChild.nodeValue);
					                    var id=document.getElementById("original");
					                        id.style.display='block';
					                        
					                        var id=document.getElementById("other");
					                        id.style.display='none';
					                        var Taluk=baseResponse.getElementsByTagName("Taluk")[0].firstChild.nodeValue; 
					                       
							                  if(Taluk==0)
							                	  Taluk=0;
							                  else
							                     document.frmEmployee.Native_Taluk.value=Taluk;
				              ...
				              //    callServers();
                                  ...
                                  var reg_date=baseResponse.getElementsByTagName("Regularisation_Date")[0].firstChild.nodeValue;   
                                  if(reg_date=='0')
                                   document.frmEmployee.reg_date.value="";
                                   else
                                      document.frmEmployee.reg_date.value=reg_date;
...
function nullCheck(n)
{
   ...
   else
   {
    ...
    if((document.frmEmployee.Native_District.value==0) || (document.frmEmployee.Native_District.value.length==0))
    {
    	 ...
    	 if((document.frmEmployee.Native_District.value!=999) && (document.frmEmployee.Native_Taluk.value==0) || (document.frmEmployee.Native_Taluk.value.length==0))
    	    {
  ...
  /*    if((document.frmEmployee.Employee_Status.value==0) || (document.frmEmployee.Employee_Status.value.length==0))
     ...
     if((document.frmEmployee.Post_Status.value=="NoVal") || (document.frmEmployee.Post_Status.value.length==0))
    {
     ...
     if((document.frmEmployee.Date_Of_Retirment.value==null) || (document.frmEmployee.Date_Of_Retirment.value.length==0))
     {
          alert("Please select Date of Retirement");
          document.frmEmployee.Date_Of_Retirment.focus();
          return false;
     }
