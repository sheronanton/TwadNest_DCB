       ...
       if(command=="Load")
        ...
        if(command=="Load1")
         { 
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../hrm_Employee_JoinReportValid_Servlet_new?command=Load1&EName=" + strEmpName;
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
                    {
             ...
             if(command=="LoadEmp")
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../hrm_Employee_JoinReportValid_Servlet_new?command=LoadEmp&EName=" + strEmpName;
                    //alert(url);
                    var req=getTransport();
                    req.open("GET",url,true); 
                    req.onreadystatechange=function()
                ...
                document.frmEmployee.Date_Of_Birth.value="";
                    ...
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../hrm_Employee_JoinReportValid_Servlet_new?command=LoadSer&txtser=" + strSerid+"&EName=" + strEmpName;
                    //alert(url);
                    var req=getTransport();
           ...
           // alert("update");
            ...
            paybill=0;
            	...
            	paybill=1;
            	subgroup=document.frmEmployee.pay_subgroup_id.value;
            	groupid=document.frmEmployee.pay_group_id.value;
            
                var url="../../../../../hrm_Employee_JoinReportValid_Servlet_new?command=Update&txtOffId="+strOffId1+
                ...
                "&txtjoindate="+strJdate+"&empstatus="+empstatus+"&dept_id="+dept_id;//+"&compdate="+compdate+"&compsession="+compsession;
                       url=url+"&optjoin="+optjoin+"&currentoffice="+strOffId+"&wing="+wing+"&paybill="+paybill+"&subgroup="+subgroup+"&groupid="+groupid;;
        ...
        else if(command=="Delete")
        {
           ...
           if(confirm("Do You Really want to Delete it"))
                        {
                        startwaiting(document.frmEmployee) ;
            url="../../../../../hrm_Employee_JoinReportValid_Servlet_new?command=Delete&txtEmpId="+strEmpName+"&JoinId="+strJoinId+"&txtOffId="+strOffId+"&txtDOJ="+strYear;
            //req.abort();
            var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
                         ...
                         for(j=0;j<empid.length;j++)
                          {
                            ...
                            /*
                             ...
                             else
                             {
                              ...
                              //alert("groupid====>"+groupid+"---pay_subgroup_id"+subgroup);
...
{ 
                  ...
                  if(flag=="success")
                  {
                    ...
                    //clearAll();
                            ...
                            var emp=document.getElementById("txtEmpId1").value;
                            var empname=document.getElementById("Employee_Name").value;
                            //var empdesig=document.getElementById("cmbdes").value;
                            var empdesig= (document.getElementById('cmbdes').options[document.getElementById('cmbdes').selectedIndex].text)
...
//                            alert(dates[2]);
                            var year=dates[2];
                            var month=dates[1];
                           // alert("'../../../../hrms/payroll/jsp/Hrm_pay_emp_breakup_earn_ded_details_joining.jsp?emp="+emp+"&empname="+empname+"&empdesign="+empdesig+"&year="+year+"&month="+month+"'");
                           ...
                           b=b+"<tr style=\"background-color: rgb(255,204,153);\"><td align=\"center\" colspan=\"2\"> <input type=\"button\" id=\"Back\" name=\"Back\" value=\"Back\"     onclick=\"javascript:window.location.reload( false );\"></input><input type=\"button\" id=\"update\" name=\"update\" value=\"Update Earnings and Deductions\"  onclick=\"javascript:window.location.href ='../../../../hrms/payroll/jsp/Hrm_pay_emp_breakup_earn_ded_details_joining.jsp?emp="+emp+"&empname="+empname+"&empdesign="+empdesig+"&year="+year+"&month="+month+"'\"   ></input></td></tr>";
...
function postcount(){
	var postid;
		var desigcode=document.frmEmployee.cmbdes.value;
		    	         ...
		    	         if(req.status==200)
		    	        {
		    	           ...
		    	           var baseResponse=req.responseXML.getElementsByTagName("response")[0];
		    	            ...
		    	            if(Command=='getPostid')
		    	            {
		    	            	...
		    	            	document.frmEmployee.comPostTow.value=postid;
		    	            }
		    	        }
		    	    }
		    };
