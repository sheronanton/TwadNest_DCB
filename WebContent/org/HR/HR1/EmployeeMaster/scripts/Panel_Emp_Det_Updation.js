...
//alert();
    ...
    var empid=document.Panel_Emp_Det_Updation.emp_id.value;
    //var slno=document.Panel_Emp_Det_Updation.txtSNo.value;
  ...
  /*   if(param!='null')
    ...
    if(Command=='loademp')
    {
      ...
      //  if(check )
        {
               // startwaiting(document.Panel_Emp_Det_Updation) ;
                service=null;
/*var cell=document.getElementById("divpre");
        ...
        cell.innerText='';*/
               ...
               /* if(param=='exist')
                ...
                {*/
                var cadre_id=document.Panel_Emp_Det_Updation.cadre_id.value;
                var url="../../../../../Panel_Emp_Det_Updation?Command=loademp&txtEmployeeid="+empid+"&cadre_id="+cadre_id;
               // alert("Admin   ->"+  url);
                //}
   ...
   // alert("added");
        ...
        if(check)
        {
               // statuswaiting(document.Panel_Emp_Det_Updation) ;
                //if(check)
                var Qual=document.Panel_Emp_Det_Updation.Panel_Emp_Det_Updation.value;
                var Spec=document.Panel_Emp_Det_Updation.Special.value;
                if(document.Panel_Emp_Det_Updation.reguniv[0].checked==true)
                       Reguniv='Y';
                else
                       Reguniv='N'; 
 ...
 for(var i=1;i<=tbody.rows.length;i++)
            ...
            var r=document.getElementById(i);
                ...
                {   
                    ...
                    var url="../../../../../Panel_Emp_Det_Updation?Command=Add&txtEmployeeid="+empid;
    ...
    else if(Command=="Delete")
    {
        ...
        {
               // statuswaiting(document.Panel_Emp_Det_Updation) ;
                  //var Nominee_Name=document.Panel_Emp_Det_Updation.Nominee_Name.value;
                  var txtSNo=document.Panel_Emp_Det_Updation.txtSNo.value;
               //   alert(txtSNo);
                var url="../../../../../Panel_Emp_Det_Updation?Command=Delete&txtEmployeeid="+empid;
     ...
     else if(Command=="Clear")
            {
                ...
                clr1();
                document.Panel_Emp_Det_Updation.cmdadd.style.display="block";
                document.Panel_Emp_Det_Updation.cmdupdate.style.display="none";
                //document.Panel_Emp_Det_Updation.cmdadd.disabled=false;
               // document.Panel_Emp_Det_Updation.cmdupdate.disabled=true;
                document.Panel_Emp_Det_Updation.cmddelete.disabled=true;
    ...
    else if(Command=="Load")
    {
           ...
           {
              //startwaiting(document.Panel_Emp_Det_Updation) ;
                var url="../../../../../Panel_Emp_Det_Updation?Command=Load&txtEmployeeid="+empid;
                req.open("POST",url,true);
                req.onreadystatechange=handleResponse;
                if(window.XMLHttpRequest)
                        req.send(null);
...
function insert()
{
	...
	//var panel_no="";
	//panel_no=document.getElementById("panel_no").value;
...
//alert(emp_id)
	...
	for ( var i = 0; i < senio_no.length; i++) {
		...
		var pst_ise = Posting_issued[i];
		//var com_rot=com_rot_code[i];
		var pst_date=post_order_date[i];
		//var date_re = date_relg[i];
		var remar=remarks[i];
		surl = surl + "&senio=" + senio + "&seni_sub=" + seni_sub + "&pst_ise="
				+ pst_ise + "&pst_date=" + pst_date+"&remar="+remar+"&employee_id="+employee_id;

	}

	url="../../../../../Panel_Emp_Det_Updation?Command=Addvalues&cadre_id="
			+ cadre_id +"&panel_reg_no="+panel_reg_no+surl;
	alert("url is--->"+url);
	req.open("POST",url,true);              
...
function updation ()
{
	...
	url="../../../../../Panel_Emp_Det_Updation?Command=updation&cadre_id="
			+ cadre_id +"&panel_reg_no="+panel_reg_no+surl;
	alert("url is--->"+url);
	req.open("POST",url,true);              
	req.onreadystatechange=function()
...
//alert(emp_id)
	...
	for ( var i = 0; i < senio_no.length; i++) {
		...
		surl = surl + "&senio=" + senio + "&seni_sub=" + seni_sub + "&turn="
				+ turn + "&com_rot=" + com_rot+"&dob_ca="+dob_ca+"&date_re="+date_re+"&remar="+remar+"&employee_id="+employee_id;

	}

	url="../../../../../Panel_Emp_Det_Updation?Command=validation&cadre_id="
...
//alert(emp_id)
	...
	url="../../../../../Panel_Emp_Det_Updation?Command=deletion&cadre_id="
			+ cadre_id +"&emp_id="+emp_id;
	//alert("url is--->"+url);
	req.open("POST",url,true);              
	req.onreadystatechange=function()
    {
             ...
             if(Command=="Addvalues")
            {
             ...
             if(Command=="deletion")
        	 {
         	  ...
         	  if(flag=="success")
     			...
     			document.getElementById("CmdAdd").style.display="";
     			//document.getElementById("audit_id").selectedIndex=0;
     			//document.Panel_Emp_Det_Updation.submit();
     			clrs();
             	}
...
function getDataPanel()
{
	...
	//var cadre_id=document.getElementById("cadre_id").value;
	var panel_reg_no=document.getElementById("panel_reg_no").value;
	var url="../../../../../Panel_Emp_Det_Updation?Command=getDataPanel&panel_reg_no="+panel_reg_no;
   //alert("URL"+url);
    req.open("POST",url,true);              
    req.onreadystatechange=function()
    {
