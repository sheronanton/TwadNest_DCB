...
function getRegion()
    {
       // alert(regionflag);
        ...
        var type=document.RelievalTransferReport.cmbolevel.options[document.RelievalTransferReport.cmbolevel.selectedIndex].value;
         ...
         var url="../../../../../../RelievalTransferReportNewServ.rep?OLevel=region" ;
     // alert(url);
      ...
      if(document.RelievalTransferReport.chkregion)
      {
               if(document.RelievalTransferReport.chkregion.length)
              {
                            ...
                            if(region!="")
                            {
                                ...
                                var url="../../../../../../RelievalTransferReportNewServ.rep?OLevel=circle&regions="+region;
                              // document.RelievalTransferReport.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
            ...
            if(document.RelievalTransferReport.chkcircle.length)
            {
                            ...
                            if(circle!="")
                            {
                               ...
                               // alert(divisionflag);
                                ...
                                var url="../../../../../../RelievalTransferReportNewServ.rep?OLevel=division&circles="+circle;
                              // document.RelievalTransferReport.cmbregion.focus();
                                var req=getTransport();
                                req.open("GET",url,false);        
                                req.onreadystatechange=function()
...
{
    //alert('submit');
        var url="../../../../../../RelievalTransferReportNewServ.rep?OLevel=submit" ;
    ...
    document.RelievalTransferReport.action="../../../../../../RelievalTransferReportNewServ.rep";
