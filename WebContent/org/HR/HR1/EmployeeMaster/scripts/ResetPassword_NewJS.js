    ...
    if(Command=='test')
    {
        ...
        if(check )
        {
               // startwaiting(document.HRE_EmployeeServiceDetails) ;
                var url="../../../../../ResetPassword_new?Command=test&txtUserId="+userid+"&txtnewpass="+newpass;
                //alert(url);
     ...
     else if(command="Login")
          {
            ...
            url="../../../../../ResetPassword_new?Command=Login&txtUserId="+userid;
           // alert(url);
            req.open("GET",url,true);        
            req.onreadystatechange=handleResponse;
            req.send(null);    
                 ...
                 else if(Command=="Login")
              {
                ...
                // login(baseResponse);
                 var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
                    ...
                    if(flag=="failure2") 
                    {
                        alert("You Can't Reset Password For Privilege User!!!!");
                           document.frmchangepassword.txtUserId.value="";
                         document.frmchangepassword.txtnewPassword.value="";
                            document.frmchangepassword.txtconfirmPassword.value="";
                       document.frmchangepassword.txtUserId.focus();
