...
function frmrolesubmit()
{
 ...
 if(desigval!=0)
 {
    ...
    //  alert('inside submit 2');
        var url="../../../../../../Individual_User?Command=submit&roleval="+role_value+"&desigval="+desigval;
...
function CallRoles()
{
    ...
    var url="../../../../../../Individual_User?Command=Role&desigval="+desigval ;
    
   // var req1=getTransport();
        
    req.open("GET",url,true);   
    req.onreadystatechange=loadRoles;
       ...
       if(req.readyState==4)
            ...
            if(req.status==200)
                ...
                var i=0;
                 ...
                 response=req.responseXML.getElementsByTagName("response1")[0];
...
function frmroleremove()
{
 ...
 if(desigval!=0)
 {
    if(nullcheck_roles())
     {
    //  alert('inside submit 2');
        var url="../../../../../../Individual_User?Command=remove&roleval="+role_value+"&desigval="+desigval;
         if(document.frmValidationSummaryRep.OffType[1].checked==true)
         {
                  if(document.frmValidationSummaryRep.rad_off[0].checked)    
                       url=url+"&officeselected="+5000;  
                 ...
                 { 
                   ...
                   // stopwaiting(document.frmValidationSummaryRep);
                              if (flag=="Noemp" || flag=="failure")
                                ...
                                if(flag=="success")
                                {
                                    alert("Roles are Removed from users ");
                                    clearAll();
                                }
