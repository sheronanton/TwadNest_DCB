...
//alert();
    ...
    var empid=document.Seniority_Proceeding_list.emp_id.value;
...
/*var cell=document.getElementById("divpre");
        ...
        cell.innerText='';*/
               ...
               /* if(param=='exist')
                ...
                {*/
                var cadre_id=document.Seniority_Proceeding_list.cadre_id.value;
                var proc_no=document.Seniority_Proceeding_list.proc_no.value;
                var url="../../../../../Seniority_Proceeding_master_updation?Command=loademp&txtEmployeeid="+empid+"&cadre_id="+cadre_id+"&proc_no="+proc_no;
               // alert("Admin   ->"+  url);
                //}
 ...
 for(var i=1;i<=tbody.rows.length;i++)
            ...
            var r=document.getElementById(i);
                ...
                {   
                    ...
                    var url="../../../../../Seniority_Proceeding_master_updation?Command=Add&txtEmployeeid="+empid;
    ...
    else if(Command=="Delete")
    {
        ...
        if(confirm('Do You want to delete this record?'))
        {
               ...
               //   alert(txtSNo);
                var url="../../../../../Seniority_Proceeding_master_updation?Command=Delete&txtEmployeeid="+empid;
    ...
    else if(Command=="Load")
    {
           ...
           {
              //startwaiting(document.Seniority_Proceeding_list) ;
                var url="../../../../../Seniority_Proceeding_master_updation?Command=Load&txtEmployeeid="+empid;
                req.open("POST",url,true);
                req.onreadystatechange=handleResponse;
                if(window.XMLHttpRequest)
                        req.send(null);
...
var url="../../../../../Seniority_Proceeding_master_updation?Command=getProc&cadre="+cadre;
 //alert("Admin   ->"+  url);
          ...
          //  alert('test'+tagcommand);
            ...
            if(Command=="loademp")
            {
                ...
                if(flag=="success")
               {
                       ...
                       document.Seniority_Proceeding_list.emp_name.value=ename;
                       if(edob=="-")
                           edob="";
                       document.Seniority_Proceeding_list.dob.value=edob;
                     
                       if(egpf==0)
                           egpf="";
                      // document.Seniority_Proceeding_list.txtGpf.value=egpf;
                       document.Seniority_Proceeding_list.desig_id.value=DESIGNATION;
...
//alert(emp_id)
	...
	url="../../../../../Seniority_Proceeding_master_updation?Command=Addvalues&cadre_id="
...
//alert(emp_id)
	...
	url="../../../../../Seniority_Proceeding_master_updation?Command=updation&cadre_id="
			+ cadre_id +"&proc_no="+proc_no+surl;
	//alert("url is--->"+url);
	req.open("POST",url,true);              
	req.onreadystatechange=function()
...
//alert(emp_id)
	...
	url="../../../../../Seniority_Proceeding_master_updation?Command=validation&cadre_id="
			+ cadre_id +"&proc_no="+proc_no+surl;
	//alert("url is--->"+url);
	req.open("POST",url,true);              
	req.onreadystatechange=function()
...
//alert(emp_id)
	...
	url="../../../../../Seniority_Proceeding_master_updation?Command=deletion&cadre_id="
...
function getList()
{
	...
	var cadre_id=document.getElementById("cadre_id").value;
	var proc_no=document.getElementById("proc_no").value;
	var url="../../../../../Seniority_Proceeding_master_updation?Command=getList&proc_no="+proc_no+"&cadre_id="+cadre_id;
   //alert("URL"+url);
    req.open("POST",url,true);              
    req.onreadystatechange=function()
    {
