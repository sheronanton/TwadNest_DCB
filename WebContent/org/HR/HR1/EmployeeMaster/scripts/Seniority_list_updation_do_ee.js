...
var seni_pre_desig=new Array();
var date_of_join_pre_desig=new Array();
...
//alert();
    ...
    var empid=document.Seniority_list_updation_do_ee.emp_id.value;
  ...
  /*   if(param!='null')
    ...
    if(Command=='efocus')
    {
    document.Seniority_list_updation_do_ee.txtEmployeeid.focus();
       //alert("focus");
    }
    else
    if(Command=='loademp')
...
/*var cell=document.getElementById("divpre");
        ...
        cell.innerText='';*/
               ...
               /* if(param=='exist')
                ...
                {*/
                var cadre_id=document.Seniority_list_updation_do_ee.cadre_id.value;
                var proc_no=document.Seniority_list_updation_do_ee.proc_no.value;
                var url="../../../../../Seniority_list_updation_do_ee?Command=loademp&txtEmployeeid="+empid+"&cadre_id="+cadre_id+"&proc_no="+proc_no;
               // alert("Admin   ->"+  url);
                //}
 ...
 for(var i=1;i<=tbody.rows.length;i++)
            ...
            var r=document.getElementById(i);
                ...
                {   
                    ...
                    var url="../../../../../Seniority_list_updation_do_ee?Command=Add&txtEmployeeid="+empid;
    ...
    else if(Command=="Delete")
    {
        ...
        if(confirm('Do You want to delete this record?'))
        {
               ...
               //   alert(txtSNo);
                var url="../../../../../Seniority_list_updation_do_ee?Command=Delete&txtEmployeeid="+empid;
    ...
    else if(Command=="Load")
    {
           ...
           {
              //startwaiting(document.Seniority_Proceeding_list) ;
                var url="../../../../../Seniority_list_updation_do_ee?Command=Load&txtEmployeeid="+empid;
                req.open("POST",url,true);
                req.onreadystatechange=handleResponse;
                if(window.XMLHttpRequest)
                        req.send(null);
...
var url="../../../../../Seniority_list_updation_do_ee?Command=getProc&cadre="+cadre;
 //alert("Admin   ->"+  url);
          ...
          //  alert('test'+tagcommand);
            ...
            if(Command=="loademp")
            {
                ...
                if(flag=="success")
               {
                       ...
                       document.Seniority_list_updation_do_ee.emp_name.value=ename;
                       if(edob=="-")
                           edob="";
                       document.Seniority_list_updation_do_ee.dob.value=edob;
                     
                       if(egpf==0)
                           egpf="";
                      // document.Seniority_Proceeding_list.txtGpf.value=egpf;
                       document.Seniority_list_updation_do_ee.desig_id.value=DESIGNATION;
            ...
            else if(Command=="test")
            {
                ...
                if(flag=="failure")
                {
                         ...
                         document.Seniority_list_updation_do_ee.txtEmployeeid.value="";
                          var tbody=document.getElementById("tb");
...
function adds(cmdval)
{
    ...
    if(valid==true)
	{
		...
		seni_pre_desig[j]=document.getElementById("senio_no_pre_desig").value;
		date_of_join_pre_desig[j]=document.getElementById("doj_pre_desig").value;
...
deletion();
	...
	seni_pre_desig.splice(val, 1);
	date_of_join_pre_desig.splice(val, 1);
...
//alert("hadi")
	...
	for ( var i = 0; i < senio_no.length; i++) {
		...
		var td = document.createElement("td");
		td.innerHTML = seni_pre_desig[i];
		tr.appendChild(td);
		
		
		var td = document.createElement("td");
		td.innerHTML = date_of_join_pre_desig[i];
		tr.appendChild(td);
	...
	document.getElementById("senio_no_pre_desig").value="";
	document.getElementById("doj_pre_desig").value="";
...
function loadvalu(i) {
	...
	document.getElementById("senio_no_pre_desig").value=seni_pre_desig[i];
	document.getElementById("doj_pre_desig").value=date_of_join_pre_desig[i];
...
//alert(emp_id)
	...
	for ( var i = 0; i < senio_no.length; i++) {
		...
		var seni_no_pre_desig=seni_pre_desig[i];
		var date_of_join_pr_des=date_of_join_pre_desig[i];
		surl = surl + "&senio=" + senio + "&seni_sub=" + seni_sub + "&dob_ca="+dob_ca+"&remar="+remar+"&employee_id="+employee_id+"&ref_in_wh_post="+ref_in_wh_post+"&seni_no_pre_desig="+seni_no_pre_desig+"&date_of_join_pr_des="+date_of_join_pr_des;

	}

	url="../../../../../Seniority_list_updation_do_ee?Command=Addvalues&cadre_id="
...
//alert(emp_id)
	...
	url="../../../../../Seniority_list_updation_do_ee?Command=updation&cadre_id="
			+ cadre_id +"&proc_no="+proc_no+surl;
	//alert("url is--->"+url);
	req.open("POST",url,true);              
	req.onreadystatechange=function()
...
//alert(emp_id)
	...
	url="../../../../../Seniority_list_updation_do_ee?Command=validation&cadre_id="
			+ cadre_id +"&proc_no="+proc_no+surl;
	//alert("url is--->"+url);
	req.open("POST",url,true);              
	req.onreadystatechange=function()
...
//alert(emp_id)
	...
	url="../../../../../Seniority_list_updation_do_ee?Command=deletion&cadre_id="
...
function getList()
{
	...
	var cadre_id=document.getElementById("cadre_id").value;
	var proc_no=document.getElementById("proc_no").value;
	var url="../../../../../Seniority_list_updation_do_ee?Command=getList&proc_no="+proc_no+"&cadre_id="+cadre_id;
   //alert("URL"+url);
    req.open("POST",url,true);              
    req.onreadystatechange=function()
    {
...
function changepage()
{
 ...
 if(len > 0)
	...
	var SENIORITY_NO_PRE_DESIG= baseResponse.getElementsByTagName("SENIORITY_NO_PRE_DESIG")[i].firstChild.nodeValue;
	var DATE_OF_JOIN_PRE_DESIG= baseResponse.getElementsByTagName("DATE_OF_JOIN_PRE_DESIG")[i].firstChild.nodeValue;
	...
	/* if(DATE_OF_REGULARISATION==null || DATE_OF_REGULARISATION=="null")
	 ...
	 if(DATE_OF_JOIN_PRE_DESIG==null || DATE_OF_JOIN_PRE_DESIG=="null")
	 {
		 DATE_OF_JOIN_PRE_DESIG="";
	 }
	...
	if(SENIORITY_NO_PRE_DESIG=="0")
	{
		SENIORITY_NO_PRE_DESIG="";
	}
	 ...
	 // date_relg[i]=DATE_OF_REGULARISATION;
	  ...
	  ref_in_posted[i]=REFERENCE_IN_WHICH_POSTED;
	   seni_pre_desig[i]=SENIORITY_NO_PRE_DESIG;
	   date_of_join_pre_desig[i]=DATE_OF_JOIN_PRE_DESIG;
     ...
     var td = document.createElement("TD");
     var SENIORITY_NO_PRE_DESIG = document.createTextNode(SENIORITY_NO_PRE_DESIG);
     td.appendChild(SENIORITY_NO_PRE_DESIG);
     tr.appendChild(td);
     
     
     var td = document.createElement("TD");
     var DATE_OF_JOIN_PRE_DESIG = document.createTextNode(DATE_OF_JOIN_PRE_DESIG);
     td.appendChild(DATE_OF_JOIN_PRE_DESIG);
     tr.appendChild(td);
...
function vali()
{
	...
	else if(document.getElementById("senio_no_pre_desig").value=="")
	{
	alert("Please Enter  Seniority No In Previous Desiganiton");
	document.getElementById("senio_no_pre_desig").focus();
	return false;
	}
	 
	else if(document.getElementById("doj_pre_desig").value=="")
	{
	alert("Please Enter  Date Of joining in Previous Designation");
	document.getElementById("doj_pre_desig").focus();
	return false;
	}
...
function Compare(fdate,tdate)
{
	...
	if(ret==false)
	{
		alert("Date Of joining in the Cadre Should be greater than Date Of joining in Previous Designation ");
		document.getElementById(fdate).value="";
		document.getElementById(tdate).value="";
		return false;
	}
