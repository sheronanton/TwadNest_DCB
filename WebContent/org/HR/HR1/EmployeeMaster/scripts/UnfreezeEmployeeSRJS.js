...
function doFunction(Command,param)
{
    ...
    if(Command=='loadempedit')
    {
        ...
        if(check )
        {
                ...
                var url="../../../../../UnfreezeEmployeeSRServ?Command=loadempedit&txtEmployeeid="+empid;
    ...
    {
    /*if(document.frmCurrentPosting.Office_Grade[0].checked==true)
        officegrade='Normal';
    else if(document.frmCurrentPosting.Office_Grade[1].checked==true)
        officegrade='Selection';
    else if(document.frmCurrentPosting.Office_Grade[2].checked==true)
        officegrade='Special';
    else if(document.frmCurrentPosting.Office_Grade[3].checked==true)
        officegrade='Super Grade';
    else
        
        alert('select the grade');*/
 //  var officegrade=document.frmCurrentPosting.Office_Grade.value;
   //alert("inside update"+officegrade);
     //   var check=notNull('Update');
      //  alert(check);
           //statuswaiting(document.frmCurrentPosting) ;
            //   alert('inside check')
                    document.frmCurrentPosting.action="../../../../../UnfreezeEmployeeSRServ?Command=Update&txtEmployeeid="+empid;
...
//alert(flag)
    ...
    if(flag=="success1")
    {
           var estatus=baseResponse.getElementsByTagName("estatus")[0].firstChild.nodeValue;
          //alert(estatus);
           if(estatus=='VRS'||estatus=='SAN'||estatus=='DTH')
             {
          ...
          //  document.frmCurrentPosting.txtEmployeeid.value=id;
            ...
            document.getElementById("txtEmployee").value=ename;
            ...
            var officegrade=baseResponse.getElementsByTagName("officegrade")[0].firstChild.nodeValue;
            
            
            //alert(officegrade);
            /*if(officegrade=='Normal')
                document.frmCurrentPosting.Office_Grade[0].checked=true;
            else if(officegrade=='Selection')
            {
                //alert('comes inside selection')
                document.frmCurrentPosting.Office_Grade[1].checked=true;
                //alert('after selection')
            }    
            else if(officegrade=='Special')
                document.frmCurrentPosting.Office_Grade[2].checked=true;
            else if(officegrade=='Super Grade')
                document.frmCurrentPosting.Office_Grade[3].checked=true;    
            else if(officegrade=='null')
            {
            //alert('comes here')
                document.frmCurrentPosting.Office_Grade[0].checked=true;
            }    */
            ...
            else
            {
            	...
            	offname=baseResponse.getElementsByTagName("offname")[0].firstChild.nodeValue;
            }
            
            document.frmCurrentPosting.offname.value=offname;
          }  //clr();
    }
