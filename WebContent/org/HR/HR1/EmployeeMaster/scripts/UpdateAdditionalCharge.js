...
document.frmCurrentPosting.action="../../../../../CurrentPosting_AdditionalCharge?Command=Validatess&txtEmployeeid="+empid+"&slno="+slno+"&service_group="+cmbsgroup1+"&designation="+cmbDesignation1+"&grade="+grade+"&office_id="+txtOffice_Id1+"&date_effective="+txtWorkDateFrom1+"&date_effective_session="+date_effective_session+"&charge_type="+charge_type+"&remarks="+remarks;
   ...
   // alert(e_array[1]);
     var empid= e_array[0];
     var slno=e_array[1];
                var url="../../../../../UpdateAdditionalCharge?Command=loadempview&txtEmployeeid="+empid+"&slno="+slno;
    ...
    else if(Command=="Load1")
    {
       ...
       // alert(Office_Id +'   '+Dept_Id);
    	 ...
    	 {
    	 alert("The employee's Additional office must not be same as the current posting office");
    	 document.getElementById("txtOffice_Id1").value="";
    	 document.getElementById("txtOffice_Name1").value="";
    	 document.getElementById("txtOffice_Address11").value="";
       ...
       // alert(check);
        if(check)
        {
               statuswaiting(document.frmCurrentPosting) ;
                 var offid=document.frmCurrentPosting.cmbAddlChargeOffId.value;
              // alert("office id is:"+offid);
                    document.frmCurrentPosting.action="../../../../../CurrentPosting_AdditionalCharge?Command=Delete&txtEmployeeid="+empid+"&offid="+offid;
                         document.frmCurrentPosting.method="POST";
                         document.frmCurrentPosting.submit();
                       return;   
...
function loading_grid(baseResponse){
	...
	document.getElementById("txtEmployeeid").disabled=true;
      ...
      var th=document.createElement("th");					  						
		var id=document.createTextNode("Select");
      th.appendChild(id);
		    ...
		    for(var i=0;i<countss;i++)
      	   ...
      	   var SLNO=baseResponse.getElementsByTagName("SLNO")[i].firstChild.nodeValue;
              ...
              if(designations=='null')
              	designations='';
             // alert("process_flow_status_id--->"+process_flow_status_id);
           var table1=document.getElementById("gridTable");
					var row=document.createElement("tr");
					row.id=i;
 ...
 if(REMARKS=='null')
       ...
       if(type=='SUS')
        ...
        if(type=='ABS')
        {
            ...
            //alert(PROCESS_FLOW_SID+"     ======    ");
             if(PROCESS_FLOW_SID=="Not Freezed")
            	 {
                ...
                // alert(DESIGNATION_IDSS);
                 ...
                 //alert(ADDL_CHARGE_TYPESS);
                 var REMARKSSS=baseResponse.getElementsByTagName("REMARKSSS")[0].firstChild.nodeValue;
               
                 if(REMARKSSS=='null')
                	 REMARKSSS='';
                 
                 if(OFFICE_ADDRESS1SS=='null')
                	 OFFICE_ADDRESS1SS='';
                 if(OFFICE_ADDRESS2SS=='null')
                	 OFFICE_ADDRESS2SS='';
                 if(CITY_TOWN_NAMESS=='null')
                	 CITY_TOWN_NAMESS='';
    ...
    else if(flag=="failure1")
    {
          // alert(document.frmCurrentPosting.txtEmployeeid.value);
            var id=document.frmCurrentPosting.txtEmployeeid.value;
            alert("Can not Update Additional charge. Because Employee Id "+id+" is not under your Office!");
            clr();
    }
     else if(flag=="failure2")
    {
            var id=document.frmCurrentPosting.txtEmployeeid.value;
            alert("You have no Update Posting. Can not Create Additional charge for "+id+"!");
            clr();
    }
     else if(flag=="failure3")
    {
            var id=document.frmCurrentPosting.txtEmployeeid.value;
            alert("Given Employee Id " +id+" has no SR control Office. Can not Update Additional charge!");
            clr();
    }
     else if(flag=="failure4")
    {
            var id=document.frmCurrentPosting.txtEmployeeid.value;
            alert("Can not Additional charge. Access Denined!");
           clr();
    }
    else
    {
...
function checkempid()
{
    if(document.frmCurrentPosting.txtEmployeeid.value==null || document.frmCurrentPosting.txtEmployeeid.value.length==0)
    {
            alert('Select Employee Id from Grid');
