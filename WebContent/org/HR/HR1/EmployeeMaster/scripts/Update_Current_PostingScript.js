...
// function to clear all the combo and text fields and even the grid
 ...
 {        
        ...
        document.frmEmployee.cmbRecordStatus.selectedIndex=0;
...
function callServer1(command,param)
 {     
          ...
          var strDeptId;
             ...
             var strRecordStatus=document.frmEmployee.cmbRecordStatus.value;
              var strGrade;
        ...
        document.frmEmployee.cmbdes.selectedIndex=0;
         ...
         document.frmEmployee.Office_Name.value="";
          ...
          startwaiting(document.frmEmployee) ;
            url="../../../../../Validate_Current_Posting_Servlet.view?command=Load&EName=" + strEmpName;
           var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
        ...
        {
           startwaiting(document.frmEmployee) ;
            url="../../../../../Validate_Current_Posting_Servlet.view?command=Update&EName="+strEmpName+"&Desig=" + strDesig+ "&OffName="+strOffName+"&Dtjoin=" +strDtjoin +"&Remarks="+strRemarks+"&DeptId="+strDeptId+"&Grade="+strGrade+"&RecordStatus="+strRecordStatus;
            var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
            {
        ...
        else if(command=="ExistgOff")
       {
          ...
          startwaiting(document.frmEmployee) ;
          url="../../../../../Validate_Current_Posting_Servlet.view?command=ExistgOff&OffName=" + strOffId +"&DeptId="+strDeptId;
                    var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
            {
                  ...
                  if(tRecordStatus==null)
                     ...
                     else if(flag=="NoRecord")
                     {
                        var tempname=baseResponse.getElementsByTagName("EMPLOYEE_NAME")[0].firstChild.nodeValue; 
                         alert("This Employee -- " + tempname + "-- has no Designation and Office Details - Update the Details and Validate it");
                        document.frmEmployee.txtEmpId1.value="";
