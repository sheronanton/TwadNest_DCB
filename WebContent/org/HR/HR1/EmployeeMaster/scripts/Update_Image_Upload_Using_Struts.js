...
function Add_photo()
{
	...
	var url="../../../../../userImage.html?command=insert&empid="+employee_id;
	alert(url);
	var req1=getTransport1();
	    		...
	    		//alert("RESPONSE========="+req1.responseText);
	    		 ...
	    		 if(command == "Get_details")
	    			 ...
	    			 {	
		    			 ...
		    			 var counting=response.getElementsByTagName("counting")[0].firstChild.nodeValue;
							//alert(count);
							if(count!=0)
								{
				    		 ...
				    		 if(counting!=0)
				    		 {
				    			 document.getElementById("reupload").disabled=false;
				    				document.getElementById("upload").disabled=true;
				    		 }
				    		 else
				    		 {
				    			 document.getElementById("reupload").disabled=true;
				    				document.getElementById("upload").disabled=false;
				    		 }
