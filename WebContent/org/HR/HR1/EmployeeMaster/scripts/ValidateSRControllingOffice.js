  ...
  function checkForRedundancy()
{
   ...
   if((strEmpId=="")&&(strOffId=="")&&(strDtjoin=="")&&(strDeptId==""))
          {           
            ...
            {
                      startwaiting(document.frmEmployee) ;
                       url="../../../../../ValidateEmployeeControllingOffice.con?command=check&EName="+strEmpId;
...
function callServer1(command,param)
 {     
          ...
          {           
          startwaiting(document.frmEmployee) ;
                       url="../../../../../ValidateEmployeeControllingOffice.con?command=Add&EName="+strEmpName+"&OffName="+strOffName+"&Dtjoin=" +strDtjoin +"&DeptId="+strDeptId;
                       var req=getTransport();
                    req.open("GET",url,true);        
                    req.onreadystatechange=function()
                    {
       ...
       // document.frmEmployee.Employee_Initial.value="";
        ...
        document.frmEmployee.txtOffAddress.value="";
          document.frmEmployee.txtdtjoin.value="";
            ...
            startwaiting(document.frmEmployee) ;
            url="../../../../../ValidateEmployeeControllingOffice.con?command=Load&EName=" + strEmpName;
           var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
            {
       ...
       else if(command=="Delete")
        {
            ...
            if(check==true)
            {
               if(confirm("Do You Really want to Delete it"))
                {
                    startwaiting(document.frmEmployee) ;
                    url="../../../../../ValidateEmployeeControllingOffice.con?command=Delete&EName=" + strEmpName;
                    //req.abort();
                    var req=getTransport();
                    req.open("GET",url,true);        
                    req.onreadystatechange=function()
        ...
        else if(command=="Update")
        {
            ...
            {
               startwaiting(document.frmEmployee) ;
                url="../../../../../ValidateEmployeeControllingOffice.con?command=Update&EName="+strEmpName+"&OffName="+strOffName+"&Dtjoin=" +strDtjoin +"&DeptId="+strDeptId;
                var req=getTransport();
                req.open("GET",url,true);        
                req.onreadystatechange=function()
                {
        ...
        else if(command=="ExistgOff")
       {
          ...
          startwaiting(document.frmEmployee) ;
          url="../../../../../ValidateEmployeeControllingOffice.con?command=ExistgOff&OffName=" + strOffId +"&DeptId="+strDeptId;
                    var req=getTransport();
            req.open("GET",url,true);        
            req.onreadystatechange=function()
            {
                    ...
                    toffaddr= toffaddr+"\n" + tDistrict;
                      ...
                      else if(flag=="failure1")
                        {
                               //alert(document.frmEmployee.txtEmpId1.value);
                                ...
                                alert("Can not Validate SR Control Office. Because Employee Id "+id+" is not under your Office!");
                                clearAll();
                        }
                         else if(flag=="failure2")
                        {
                                var id=document.frmEmployee.txtEmployeeid.value;
                                alert("You have no Current Posting. Can not Validate SR Control Office for "+id+"!");
                                clearAll();
                        }
                         else if(flag=="failure3")
                        {
                                var id=document.frmEmployee.txtEmployeeid.value;
                                alert("Given Employee Id " +id+" has no SR control Office. Can not Validate SR Control Office!");
                                clearAll();
                        }
                         else if(flag=="failure4")
                        {
                                var id=document.frmEmployee.txtEmployeeid.value;
                                alert("Can not Validate SR Control Office. Access Denined!");
                               clearAll();
                        }
