...
function doFunction(command)
{
   if(command=="getDet")
   {
      ...
      var url="../../../../../Validate_Dept_Panel_DetailsServ?command=getDet&order="+ord_id+"&offid="+off_id;
   ...
   else if(command=="employee")
   {
      ...
      var url="../../../../../Validate_Dept_Panel_DetailsServ?command=employee&empid="+empid;
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
      {
   ...
   else if(command=="getProcedDet")
   {
      ...
      var off_id=document.frmDeptPanel.txtOffId.value;
      var url="../../../../../Validate_Dept_Panel_DetailsServ?command=getProcedDet&ord_id="+ord_id+"&panel_id="+panel_id+"&offid="+off_id;
      //alert(url);
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
   ...
   // alert("hhii");
      ...
      //alert("orid"+ord_id);
      var off_id=document.frmDeptPanel.txtOffId.value;
      var url="../../../../../Validate_Dept_Panel_DetailsServ?command=ProceedDetails&ord_id="+ord_id+"&offid="+off_id;
      //alert(url);
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
      ...
      else if(command=="add")
   {
        ...
        if(c)
        {
            ...
            var url="../../../../../Validate_Dept_Panel_DetailsServ?command=add&offid="+offid+"&refid="+refid+"&eid="+eid+"&remark="+remark;
            var req=getTransport();
            req.open("GET",url,true);
            req.onreadystatechange=function()
            {
   ...
   else if(command=="delete")
   {
            ...
            var url="../../../../../Validate_Dept_Panel_DetailsServ?command=delete&offid="+offid+"&refid="+refid+"&eid="+eid;
            var req=getTransport();
            req.open("GET",url,true);
            req.onreadystatechange=function()
            {
   ...
   else if(command=="update")
   {
            ...
            var eid=document.frmDeptPanel.txtEmployeeid.value;  
            var remark=document.frmDeptPanel.txtrem.value;             
            var url="../../../../../Validate_Dept_Panel_DetailsServ?command=update&offid="+offid+"&refid="+refid+"&eid="+eid+"&remark="+remark;
            var req=getTransport();
            req.open("GET",url,true);
            req.onreadystatechange=function()
            {
...
function fnsubmit()
{
    var url="../../../../../Validate_Dept_Panel_DetailsServ?command=submit";  
    var empid="";
    var remark="";  
    var remarks="";
