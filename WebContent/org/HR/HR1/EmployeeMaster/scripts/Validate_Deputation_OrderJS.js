...
function doFunction(Command,param)
{
  ...
  var dep_id=document.frmTransfer.cmb_Deptid.options[document.frmTransfer.cmb_Deptid.selectedIndex].value;
  ...
  {
   td=document.frmTransfer.radTransfer[0].value;
  }
  else
  {
   td=document.frmTransfer.radTransfer[1].value;
  }
  
  if(document.frmTransfer.rad_indi[0].checked==true)
  {
    pid=document.frmTransfer.rad_indi[0].value;
  }
  else
  {
   pid=document.frmTransfer.rad_indi[1].value;
  }
  //alert(rep);
  if(Command=="loademp")
  {
    var url="../../../../../Validate_Deputation_OrderServ?Command=loademp&txtEmployeeid="+eid+"&offid="+ofid;
  ...
  else if(Command=="office")
  {
            ...
            var url="../../../../../Validate_Deputation_OrderServ?Command=office&oid="+oid;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
   ...
   else if(Command=="getDet")
   {
      ...
      var url="../../../../../Validate_Deputation_OrderServ?Command=getDet&order="+ord_id+"&offid="+off_id;
     // alert(url);
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
   ...
   else if(Command=="Update")
   {
      ...
      else if(reas=='Deputation on Transfer')
      {
      ...
      var url="../../../../../Validate_Deputation_OrderServ?Command=Update&txtEmployeeid="+eid+"&offid="+ofid+"&repost="+rep+"&trfoff="+trof1+"&desig_id="+desi+"&order="+ord+"&reason="+reas+"&ta_da="+td+"&indi="+pid+"&depid="+dep_id;
      //alert(url);
      var req=getTransport();
      req.open("GET",url,true);
   ...
   {
      var url="../../../../../Validate_Deputation_OrderServ?Command=Delete&txtEmployeeid="+eid+"&offid="+ofid+"&order="+ord;
   ...
   else if(Command=="desig")
   {
     var desig=document.frmTransfer.txtP_desigId.value;
      ...
      var url="../../../../../Validate_Deputation_OrderServ?Command=Desig&txtDesigid="+desig;
   ...
   else if(Command=="dept")
   {
     ...
     var url="../../../../../Validate_Deputation_OrderServ?Command=Deptid&dept_id="+depart+"&office_id="+dpt_offid;
     //alert(url);
     var req=getTransport();
...
function loadValuesFromTable(rid)
{
  ...
  // alert(document.frmTransfer.trf_offid.value);
   ...
   var rs=document.getElementById("cmbsgroup");
   var rs1=document.getElementById("cmbDesignation");
  
   
   if(rcells.item(6).firstChild.nodeValue=="Deputation on Transfer")
   {      
   ...
   //alert('rcells.item(6).firstChild.nodeValue...'+rcells.item(6).firstChild.nodeValue);
   
   //document.frmTransfer.cmbreasid.options[document.frmTransfer.cmbreasid.selectedIndex].value
   document.frmTransfer.cmbreasid.value=rcells.item(6).firstChild.nodeValue;     
...
function upDat(baseResponse)
{
   ...
   if(flag=="success")
   {
     ...
     var items=new Array();
       ...
       if(document.frmTransfer.rad_indi[0].checked==true)
       {
         items[6]=document.frmTransfer.rad_indi[0].value;
       }
       else
       {
         items[6]=document.frmTransfer.rad_indi[1].value;
       }
       ...
       rcells.item(4).firstChild.nodeValue=items[8];
       rcells.item(5).firstChild.nodeValue=items[7];
       rcells.item(6).firstChild.nodeValue=items[4];
       rcells.item(7).firstChild.nodeValue=items[2];
       rcells.item(8).firstChild.nodeValue=items[5];
...
{
   //alert(val); 
    var url="../../../../../Validate_Deputation_OrderServ?Command=SerGroup&cmbdes="+val;
    //alert(url);
    var req= getTransport();
    req.open("GET",url,true);
    req.onreadystatechange=function()
