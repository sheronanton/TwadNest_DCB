   ...
   // alert(eid);
    ...
    {       
        ...
        var offid=document.EmpRelieval.txtOffId.value;
         var reason=document.EmpRelieval.cmbReason.options[document.EmpRelieval.cmbReason.selectedIndex].value;
            var url="../../../../../Edit_New_Relieval_Serv.view?Command=loademp&txtEmployeeid="+eid+"&offid="+offid+"&reasonid="+reason;
             //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Edit_New_Relieval_Serv.view?Command=office&oid="+oid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Edit_New_Relieval_Serv.view?Command=dept&oid="+oid+"&deptid="+deptid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
        ...
        {   //alert(eid);
            ...
            var url="../../../../../Edit_New_Relieval_Serv.view?Command=desig&desigid="+desigid;
            //alert(url);
            var req=getTransport();
            req.open("POST",url,true); 
            req.onreadystatechange=function()
...
function getOther()
{
  ...
  else
  {
    if(reas=='TRN')
    {
     ...
     var url="../../../../../Edit_New_Relieval_Serv.view?Command=GetOtherDet&OrderId="+ord+"&Emp="+eid+"&reas="+reas;
     //alert(url);
     var req=getTransport();
