...
function doFunction(Command,param)
{
  ...
  if(Command=="loademp")
  {
    var url="../../../../../Validate_Promotion_OrderServ?Command=loademp&txtEmployeeid="+eid+"&offid="+ofid;
  ...
  else if(Command=="office")
  {
            ...
            var url="../../../../../Validate_Promotion_OrderServ?Command=office&oid="+oid;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
   ...
   else if(Command=="getDet")
   {
      ...
      var url="../../../../../Validate_Promotion_OrderServ?Command=getDet&order="+ord+"&offid="+off_id;
     // alert(url);
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
   ...
   if(Command=="Add")
   {
      ...
      var url="../../../../../Validate_Promotion_OrderServ?Command=Add&txtEmployeeid="+eid+"&offid="+ofid+"&new_desig="+desnew+"&posting="+post+"&department="+departtid+"&post_offid="+offid+"&repost="+rep+"&ta_da="+req_transf+"&order="+ord;
      //alert(url);
      var req=getTransport();
      req.open("GET",url,true);
   ...
   else if(Command=="Update")
   {
      ...
      var url="../../../../../Validate_Promotion_OrderServ?Command=Update&txtEmployeeid="+eid+"&offid="+ofid+"&new_desig="+desnew+"&posting="+post+"&department="+departtid+"&post_offid="+offid+"&repost="+rep+"&ta_da="+req_transf+"&order="+ord;
      //alert(url);
      var req=getTransport();
      req.open("GET",url,true);
   ...
   {
      var url="../../../../../Validate_Promotion_OrderServ?Command=Delete&txtEmployeeid="+eid+"&offid="+ofid+"&order="+ord;
   ...
   else if(Command=="desig")
   {
     var desig=document.frmTransfer.txtP_desigId.value;
      ...
      var url="../../../../../Validate_Promotion_OrderServ?Command=Desig&txtDesigid="+desig;
   ...
   else if(Command=="dept")
   {
     ...
     var url="../../../../../Validate_Promotion_OrderServ?Command=Deptid&dept_id="+depart+"&office_id="+dpt_offid;
     //alert(url);
     var req=getTransport();
...
{
   //alert(val); 
    var url="../../../../../Validate_Promotion_OrderServ?Command=SerGroup&cmbdes="+val;
    //alert(url);
    var req= getTransport();
    req.open("GET",url,true);
    req.onreadystatechange=function()
...
function checkNull2()
{
  ...
  {
    alert('Please Enter Proceeding refence Date.');
    return false;
  }
