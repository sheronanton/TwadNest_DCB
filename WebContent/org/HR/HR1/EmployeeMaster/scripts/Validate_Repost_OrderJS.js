...
function doFunction(Command,param)
{
  ...
  if(Command=="loademp")
  {
    var url="../../../../../Edit_Repost_OrderServ?Command=loademp&txtEmployeeid="+eid+"&offid="+ofid+"&pro_id="+ord;
  ...
  if(Command=="editloademp")
  {
    var url="../../../../../Edit_Repost_OrderServ?Command=editloademp&txtEmployeeid="+eid+"&offid="+ofid+"&pro_id="+ord;
  ...
  else if(Command=="office")
  {
            ...
            var url="../../../../../Edit_Repost_OrderServ?Command=office&oid="+oid+"&loginid="+loginid;
            //alert(url);
            var req=getTransport();
            req.open("GET",url,true); 
            req.onreadystatechange=function()
   ...
   else if(Command=="getDet")
   {
      ...
      var url="../../../../../Edit_Repost_OrderServ?Command=getDet&order="+ord_id+"&offid="+off_id;
     // alert(url);
      var req=getTransport();
      req.open("GET",url,true);
      req.onreadystatechange=function()
   ...
   else if(Command=="Add")
   {
      ...
      */
      ...
      var url="../../../../../Edit_Repost_OrderServ?Command=Add&txtEmployeeid="+eid+"&offid="+ofid+"&repost="+rep+"&trfoff="+trof+"&order="+ord+"&req_trans="+req_transf+"&desig="+desig;
      //alert(url);
      var req=getTransport();
      req.open("GET",url,true);
   ...
   else if(Command=="Update")
   {
      ...
      if(c)
      {
      var url="../../../../../Edit_Repost_OrderServ?Command=Update&txtEmployeeid="+eid+"&offid="+ofid+"&repost="+rep+"&trfoff="+trof+"&order="+ord+"&req_trans="+req_transf+"&desig="+desig;
   ...
   {
      var url="../../../../../Edit_Repost_OrderServ?Command=Delete&txtEmployeeid="+eid+"&offid="+ofid+"&order="+ord;
   ...
   {
      var url="../../../../../Edit_Repost_OrderServ?Command=ProcId&txtoffid="+ofid;
   ...
   else if(Command=="desig")
   {
     var desig=document.frmTransfer.txtP_desigId.value;
      ...
      var url="../../../../../Edit_Repost_OrderServ?Command=Desig&txtDesigid="+desig;
...
function handleResponse(req)
{
  if(req.readyState==4)
  {
    if(req.status==200)
    {
      ...
      else if(Command=="editloademp")
      {      
         editloadEmployee(baseResponse);
      }
      else if(Command=="office")
      {
...
function loadEmployee(baseResponse)
{
  var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
    ...
    else if(flag=="failure5")
    {
            
            alert("Given Employee is already added in the List");
            document.frmTransfer.txtEmployeeid.value="";
            document.frmTransfer.txtEmployeeid.focus();
            document.frmTransfer.txtEmpName.value="";
            document.frmTransfer.txtEmpDesig.value="";
...
function editloadEmployee(baseResponse)
{
  var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
      ...
      if(cmd=='getDet')
      {
         ...
         {     
            ...
            if(service)
            {
              ...
              var repst=new Array();
              var ta_da=new Array();
              var ser_grp_id=new Array();
              var desig_id=new Array();
             ...
             // var designat=new Array();
              ...
              for(i=0;i<service.length;i++)
              {
                ...
                //alert(off_name[i])
                repst[i]=service[i].getElementsByTagName("repost_req")[0].firstChild.nodeValue;
                //alert(repos[i])
                ta_da[i]=service[i].getElementsByTagName("ta_da")[0].firstChild.nodeValue;
                
                 ser_grp_id[i]=service[i].getElementsByTagName("ser_grp_id")[0].firstChild.nodeValue;
               //  alert("ser_grp_id"+ser_grp_id[i]);
               
                 desig_id[i]=service[i].getElementsByTagName("desig_id")[0].firstChild.nodeValue;
                 //alert(desig_id[i]);
                 cat_id[i]=service[i].getElementsByTagName("cat_id")[0].firstChild.nodeValue;
           ...
           */
           ...
           cell4.appendChild(trf_off_name);
           ...
           cell4.appendChild(trf_off_id);  
           mycurrent_row.appendChild(cell4);
          if((cat_id[i]=='TRN')||(cat_id[i]=='RPT'))
           {
               //alert("in transfer and reposting");
               var cell5=document.createElement("TD");
               var repost=document.createTextNode(repst[i]);
               cell5.appendChild(repost);
               mycurrent_row.appendChild(cell5);
               
               var cell6=document.createElement("TD");
               var tada=document.createTextNode(ta_da[i]);
               cell6.appendChild(tada);
               mycurrent_row.appendChild(cell6);
           }
           
           else if(cat_id[i]=='PRO')
           {
               //alert("in promotion");
               var cell5=document.createElement("TD");
               var repost=document.createTextNode(repst[i]);
               ...
               var desid=document.createElement("input");
                 desid.type="hidden";
                 desid.name="desig";
                 desid.id="desig";
                 desid.value=desig_id[i];
               cell5.appendChild(desid);  
               mycurrent_row.appendChild(cell5);
               ...
               cell6.appendChild(tada);
                 ...
                 var serid=document.createElement("input");
                 serid.type="hidden";
                 serid.name="service";
                 serid.id="service";
                 serid.value=ser_grp_id[i];
               cell6.appendChild(serid);  
               mycurrent_row.appendChild(cell6);
           }
        ...
        /*   var cell7=document.createElement("TD");            
           ...
           var ref_cat=baseres.getElementsByTagName("cat_id")[0].firstChild.nodeValue;
           var ref_proc=baseres.getElementsByTagName("cat_order_id")[0].firstChild.nodeValue;
           var cat_pro_no=baseres.getElementsByTagName("cat_proc_no")[0].firstChild.nodeValue;
           var cat_pro_date=baseres.getElementsByTagName("cat_proc_date")[0].firstChild.nodeValue;
           //alert(ref_proc);
           
           if(ref_cat=='TRN')
           {
             document.frmTransfer.rad_ROC[0].checked=true;
              getPost_reas();
           }
           else if(ref_cat=='PRO')
           {
             document.frmTransfer.rad_ROC[1].checked=true;
              getPost_reas();
           }
           else
           {
             document.frmTransfer.rad_ROC[2].checked=true;
              getPost_reas();
           }
           
          document.frmTransfer.txtCatPro.value=cat_pro_no;
           
           var m1=cat_pro_date.split('-');
            cat_prodate=m1[2]+"/"+m1[1]+"/"+m1[0];
            
            if(cat_pro_date=='null')
             document.frmTransfer.txtProDat.value="";
            else 
             document.frmTransfer.txtProDat.value=cat_prodate;   
           ...
           if(pro_no=='null')
            ...
            if(pro_dat1=='null')
             ...
             var prefx=baseres.getElementsByTagName("prefix")[0].firstChild.nodeValue;
             var sufx=baseres.getElementsByTagName("suffix")[0].firstChild.nodeValue;
             ...
             if(prefx=='null')
                ...
                document.frmTransfer.txtPref.value=prefx;
                
             if(sufx=='null')
                document.frmTransfer.txtSuf.value="";
             else
                document.frmTransfer.txtSuf.value=sufx;   
...
function loadValuesFromTable(rid)
{
   ...
   {
     cat=document.frmTransfer.rad_ROC[0].value;
   }
   else if(document.frmTransfer.rad_ROC[1].checked==true)
   {
     cat=document.frmTransfer.rad_ROC[1].value;
   }
   else if(document.frmTransfer.rad_ROC[2].checked==true)
   {
     cat=document.frmTransfer.rad_ROC[2].value;
   }
  // alert(cat);
   document.frmTransfer.txtEmployeeid.value=rcells.item(1).firstChild.nodeValue;
   
   doFunction('editloademp','null');
   
   document.frmTransfer.txtEmpName.value=rcells.item(2).firstChild.nodeValue;
   
   document.frmTransfer.txtT_OffId.value=rcells.item(3).lastChild.value;
   
   document.frmTransfer.txtT_OffName.value=rcells.item(3).firstChild.nodeValue;
  ...
  if(cat=="PRO")
  {
  document.frmTransfer.cmbsgroup.value=rcells.item(5).lastChild.value;
    ...
    if(type!=0)
    {
         ...
         if(req.readyState==4)
     {
       ...
       { 
        ...
        document.frmTransfer.cmbDesignation.value=rcells.item(4).lastChild.value;
        }
...
function upDat(baseResponse)
{
   ...
   if(flag=="success")
   {
     ...
     var items=new Array();
       ...
       items[1]=document.frmTransfer.txtT_OffId.value;
       
       items[2]=document.frmTransfer.txtT_OffName.value;
       
       if(document.frmTransfer.radT_Repost[0].checked==true)
       {
       items[3]=document.frmTransfer.radT_Repost[0].value;
       }
       else
       {
        items[3]=document.frmTransfer.radT_Repost[1].value;
       }
       
       if(document.frmTransfer.radTransfer[0].checked==true)
       {
       items[4]=document.frmTransfer.radTransfer[0].value;
       }
       else
       {
        items[4]=document.frmTransfer.radTransfer[1].value;
       }
   ...
   else if(document.frmTransfer.rad_ROC[2].checked==true)
   {
     cat=document.frmTransfer.rad_ROC[2].value;
         ...
         items[8]=document.frmTransfer.cmbsgroup.options[document.frmTransfer.cmbsgroup.selectedIndex].value;
       items[9]=document.frmTransfer.cmbDesignation.options[document.frmTransfer.cmbDesignation.selectedIndex].value;
       ...
       rcells.item(3).lastChild.value=items[1];
       ...
       {
      // alert("hhi");
        rcells.item(4).lastChild.value=items[9];
        rcells.item(5).lastChild.value=items[8];
       }
...
function getReference()
{
  ...
  var url="../../../../../Edit_Repost_OrderServ?Command="+ord_cat+"&off_id="+off_id;
  var req=getTransport();
  req.open("GET",url,true);
...
function getDt()
{
  ...
  var pro_id=document.frmTransfer.cmbProceeding.options[document.frmTransfer.cmbProceeding.selectedIndex].value;
     ...
     startwaiting(document.frmTransfer);
       ...
       var url="../../../../../Edit_Repost_OrderServ?Command=getDt&category="+ord_cat+"&pid="+pro_id;
    ...
    if(req.status==200)
    {
      ...
      stopwaiting(document.frmTransfer);
       ...
       {        
         ...
         document.frmTransfer.txtProDat.value="";
       //      var prodet=document.frmTransfer.txtReason.value;
...
{
   //alert(val); 
    var url="../../../../../Edit_Repost_OrderServ?Command=SerGroup&cmbdes="+val;
    //alert(url);
    var req= getTransport();
    req.open("GET",url,true);
    req.onreadystatechange=function()
...
function checknull2()
{
 ...
 else if((document.frmTransfer.txtPDat.value=="") || (document.frmTransfer.txtPDat.value.length==0))
  {
    alert('Please Enter Proceeding reference Date.');
    return false;
  }
