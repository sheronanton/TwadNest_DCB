...
function getempDetails()
{
      ...
      var Emp_id=document.getElementById("Emp_id").value;
        ...
        var url="../../../../../EmpDetails_Current?command=getempDetails&Emp_id="+Emp_id;
       // alert(url)
      ...
      {      
    	  var flag=baseResponse.getElementsByTagName("flag")[0].firstChild.nodeValue;
    	    ...
    	    {  
    	    	...
    	    	var CPS_NO=baseResponse.getElementsByTagName("CPS_NO")[0].firstChild.nodeValue;
    	        var employee_id=baseResponse.getElementsByTagName("empid")[0].firstChild.nodeValue;
    	        var empname=baseResponse.getElementsByTagName("empname")[0].firstChild.nodeValue;
    	        var DESIGNATION=baseResponse.getElementsByTagName("desig")[0].firstChild.nodeValue;
    	        ...
    	        if(off_name==null||off_name=='null')
    	        	off_name="";
    	        document.getElementById("wrk_off").value=off_name;
    	       
    	        if(flag1=='null' || flag1=="" || flag1==null)
    	        {
    	        	flag1='N';
    	        }
    	        if(flags=='null' || flags=="" || flags==null)
    	        {
    	        	flags='N';
    	        }
    	      ...
    	      // alert(gpf_no);
    	        if(flags=='N' && flag1=='N')
    	        {
    	        	...
    	        	document.getElementById("gpf_no").innerHTML="No number yet to be alloted";
    	        	
    	        	document.getElementById("cps_no").innerHTML="No number yet to be alloted";
    	        
    	        }
    	        else if(flags=='Y'&& flag1=='Y')
    	        {
    	        	
//    	        	document.getElementById("gpf_no").disabled=true;
    	        	document.getElementById("gpf_no").innerHTML=gpf_no;
//    	        	document.getElementById("gpf_chec").checked="checked";
//    	        	document.getElementById("cps_no").disabled=true;
    	        	document.getElementById("cps_no").innerHTML=CPS_NO;
//    	        	document.getElementById("cps_chec").checked="checked";
    	        	
    	        	
    	        }
    	        else if(flags=='N' && flag1=='Y')
    	        {
//    	        	document.getElementById("cps_no").disabled=true;
    	        	document.getElementById("cps_no").innerHTML=CPS_NO;
    	        	document.getElementById("gpf_no").innerHTML="";
    	        	document.getElementById("cps_no").style.color="green";
//    	        	document.getElementById("cps_chec").checked="checked";
    	        	
    	        }
    	        else if(flags=='Y' && flag1=='N')
    	        {
//    	        	document.getElementById("gpf_no").disabled=true;
    	        	document.getElementById("gpf_no").innerHTML=gpf_no;
    	        	document.getElementById("cps_no").innerHTML="";
//    	        	document.getElementById("gpf_chec").checked="checked";
    	        	document.getElementById("gpf_no").style.color="green";
...
{
document.EmpDetailscurrent.Emp_id.value=emp;
getempDetails();
}
