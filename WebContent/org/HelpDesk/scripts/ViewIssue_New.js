...
function displaydetails()
{
    ...
    url="../../../ServletDisplayIssue_New.con?IssueId="+issueid;
...
function viewdetails()
{
    ...
    var url="";
    var issueid=document.frmHelp.txtis_id.value;
    //startwaiting(document.frmHelp);
    url="../../../ServletDisplayIssue_New.con?IssueId="+issueid;
    var req=getTransport();
    req.open("Get",url,true);
...
function processresponse(req)
{
    ...
    if(req.readyState==4)
    {
        if(req.status==200)
        {
            ...
            {
            alert("No such issue");
                document.frmHelp.txtis_id.value="";
               ...
               // document.frmHelp.cmbPriority.selectedIndex=0;
                ...
                document.frmHelp.txtis_id.focus();
            }
        }
