...
<html>
 ...
 try
 {
 if(button.equalsIgnoreCase("OtherUserProfileJSP.jsp"))
 {
 //out.print("window('','_parent','')");
 out.print("<input type=\"button\" onClick=\"window.open(\'"+request.getContextPath()+"/org/HR/HR1/EmployeeMaster/jsps/OtherUserProfileJSP.jsp\',\'_parent\','');\" value=\"Back\"/>");
 out.print("<input type=\"button\" onClick=\"window.open('','_parent','');window.close();\" value=\"  Ok  \"/>");
 }
 else if(button.equalsIgnoreCase("OtherUserProfileUpdateJSP.jsp"))
 {
        out.print("<input type=\"button\" onClick=\"window.open(\'"+request.getContextPath()+"/org/HR/HR1/EmployeeMaster/jsps/OtherUserProfileUpdateJSP.jsp\',\'_parent\','');\" value=\"Back\"/>");
        out.print("<input type=\"button\" onClick=\"window.open('','_parent','');window.close();\" value=\"  Ok  \"/>");
