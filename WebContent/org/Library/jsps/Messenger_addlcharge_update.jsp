...
<html>
 ...
 out.print("<input type=\"button\" onClick=\"window.open(\'"+request.getContextPath()+"/org/HR/HR1/EmployeeMaster/jsps/CurrentPosting_AdditionalCharge.jsp\',\'_parent\','');\" value=\"Back\"/>");
 out.print("<input type=\"button\" onClick=\"window.open('','_parent','');window.close();\" value=\"  Ok  \"/>");
 }
 else
 {
        out.print("<input type=\"button\" onClick=\"window.open(\'"+request.getContextPath()+"/org/HR/HR1/EmployeeMaster/jsps/CurrentPosting_ValidateJSP.jsp\',\'_parent\','');\" value=\"Back\"/>");
        out.print("<input type=\"button\" onClick=\"window.open('','_parent','');window.close();\" value=\"  Ok  \"/>");
