...
<html>
 ...
 %>
  ...
  <form name="frmCreateNews" enctype="multipart/form-data"  >
        ...
        <tr>
            <td>
                ...
                <tr>
                  ...
                  <td width="64%">
                  <input type="text" id="txtCaption" name="txtCaption" size="40" disabled="disabled" />
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td width="64%">       
                    <input type="text" id="txtatt_slno" name="txtatt_slno" size="10" disabled="disabled"/> 
                      ( System 'll Generate )
                  </td>
                </tr>               
