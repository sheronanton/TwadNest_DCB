...
<html>
  <head>
    ...
    <title>Create Caption Details</title>    
   
    <script type="text/javascript" src="../scripts/CreateCaptionDetailsJS.js"></script>
 ...
 %>
  <form name="frmCreateNews" method="POST" action="../../../ServletCreateCaptionDetails.con" onsubmit="return nullCheck()">
      <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Create Caption Details</b></center>
            </td>
        </tr>
        <tr>
            <td>
                ...
                <tr>
                  ...
                  <td width="64%">
                  <input type="text" id="txtCaption" name="txtCaption" size="40" onkeypress="return noEnter(event)"/>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td width="64%">
                  <textarea name="txtDesc" cols="30" rows="7" onkeypress="return noEnter(event)"></textarea>
                  <%
