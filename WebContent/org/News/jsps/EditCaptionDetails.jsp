...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/EditCaptionDetailsJS.js"></script>
 ...
 %>
  <form name="frmCreateNews" method="POST" action="../../../ServletEditCaptionDetails.con" onsubmit="return nullCheck()">
