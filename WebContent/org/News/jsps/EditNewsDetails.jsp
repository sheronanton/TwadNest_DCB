...
<html>
  <head>
    ...
    <script type="text/javascript" src="../scripts/EditNewsDetailsValidations.js"></script>
     <script type="text/javascript" src="../scripts/EditNewsDetailsAjax.js"></script>
 ...
 %>
  <form name="frmEditNews" method="POST" action="../../../ServletEditNewsDetails.con" onsubmit="return nullCheck()">
      <table width="100%" align="center">
        <tr>
            <td class="tdH">
                <center><b>Edit News Details</b></center>
            </td>
        </tr>
        <tr>
            <td>
         ...
         <!--       <tr>
                ...
                <tr>
                  ...
                  <td width="64%">
                           ...
                           <img src="../../../images/calendr3.gif"  onclick="showCalendarControl(document.frmEditNews.txtEventDate);" alt="Show Calendar"></img>
