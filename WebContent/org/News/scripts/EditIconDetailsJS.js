...
{
   var cid=document.frmCreateNews.cmbIcon.options[document.frmCreateNews.cmbIcon.selectedIndex].value;
   
   if(command=='Existg')
   {
     var url="../../../ServletEditIconDetails.con?command=Existg&caption="+cid;
...
function existRow(baseResponse)
{
  ...
  {
    alert('The News has been already Published');
    document.frmCreateNews.txtEventId.value="";
    document.frmCreateNews.txtEventId.focus();
    document.frmCreateNews.txtCaption.value="";
    document.frmCreateNews.txtDesc.value="";
