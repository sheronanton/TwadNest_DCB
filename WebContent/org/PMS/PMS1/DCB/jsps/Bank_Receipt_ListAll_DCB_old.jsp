...
<html>
  ...
  <table cellspacing="0" cellpadding="0" width="100%"  border="0">
      <tr class="tdH">
        <td colspan="2">
          <div align="center">
            <strong>List of Bank Receipt </strong>
          </div>
        </td>
      </tr>
    </table>
            ...
            <tr class="table">
                ...
                <td>
                  <div align="left">
                    ...
                    <select size="1" class="select" name="cmbAcc_UnitCode" id="cmbAcc_UnitCode" tabindex="1" onchange="LoadOffice(this.value);" >
              ...
              <tr class="table">
                ...
                <td>
                  ...
                  <div align="left">
                    <select size="1" class="select" name="cmbOffice_code" id="cmbOffice_code" tabindex="2">
                ...
                <td>
                  <div align="left">
                    <select  class="select" size="1" name="cmbStatus" id="cmbStatus" tabindex="3">
        ...
        <tr align="left">
          ...
          <div align="left">
              Cash Book Year &amp; Month&nbsp;&nbsp;<strong>:</strong>
                         <input type="text" class="tb1" name="txtCB_Year" id="txtCB_Year" tabindex="3"  maxlength="4" size="5" onkeypress="return numbersonly(event)">
         
          <select name="txtCB_Month"  id="txtCB_Month" tabindex="4" class="select">
          ...
          <option value="12">December</option>
           ...
           <input type="BUTTON" value="GO" class="tb1"  name="ByMonth" id="ByMonth"  tabindex="5" onclick="doFunction('searchByMonth','null')"/>
           </div>
          </td>
        </tr>
        <tr align="left">
          ...
          <div align="left">
              From Date &amp; To Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>:</strong>
                                   <input type="text" name="txtFrom_date" id="txtFrom_date"  tabindex="6" class="tb4" 
                    ...
                    <input type="text" name="txtTo_date" id="txtTo_date"  tabindex="7" class="tb4" 
                           maxlength="10" size="11"
                           onfocus="javascript:vDateType='3';"
                           onkeypress="return calins(event,this);"
                           onblur="return checkdt(this);"/>
                     ...
                     <img src="../../../../../images/calendr3.gif"
                         ...
                         alt="Show Calendar"></img>
            <input type="BUTTON" value="GO" name="ByMonth" id="ByMonth" class="tb1"  tabindex="8" onclick="doFunction('searchByDate','null')"/>
            </div>
          </td>          
        </tr>
     </table>
  ...
  <td>
   ...
   <table align="center" cellspacing="3" cellpadding="2" border="0"
                              ...
                              <tr>
                                <td>
                                  <div id="divcmbpage" style="display:none">
                                    Page&nbsp;&nbsp;<select name="cmbpage" class="select"
                                                            id="cmbpage"
      ...
      <td>
          <div align="center">
         <input type="button" id="cmdcancel" name="cancel" value="EXIT" onclick="btncancel()" class="fb2">
      </div>
      </td>
      </tr>
