 	 	...
 	 	<table  align=center   border="0"   width="95%"  cellspacing="0" cellpadding="2">
			<tr class="tdH">
 			...
 			<tr class="tdHeader">
        		...
        		<td valign="middle" width=10% > <select class='select'  id="subdiv" name="subdiv" onchange="list('show',2,this)"> </select></tD>
         		<td valign="middle"  width=20% align=right>Beneficiary Type</td>
        		<td valign="middle"  align=right > <select class='select'  id="bentype" name="bentype" onchange="list('show',3,this)" style="width:100pt"></select> </td>
        		
        	</tr> 
        	<tr class="tdH"><td colspan=10 align=right  height=4>
        	<b><font  > <label id="msg"> </label></font></b><input type="button" class="fb2" value="Refresh" onclick="javascript:window.location.reload();"></td></tr>
 			</table>
