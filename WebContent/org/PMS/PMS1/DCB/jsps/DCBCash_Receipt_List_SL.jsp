...
<html>
  ...
  <body class="table"><form name="Cash_Rec_Edit_List_Form" method="POST">
  <%
  Connection con=null;
  ResultSet rs=null;
      ...
      <table id="mytable" align="center" cellspacing="3" cellpadding="2"
        ...
        <tbody id="tbody" class="table">
          ...
          String sql="select SL_NO, ACCOUNT_HEAD_CODE ,CR_DR_INDICATOR ,"+
            "SUB_LEDGER_TYPE_CODE ,(select SL_CODENAME from SL_TYPE_CODE_NAME_VIEW where SL_TYPE=SUB_LEDGER_TYPE_CODE and SL_CODE=SUB_LEDGER_CODE) as SLNAME ,RECEIVED_FROM , AMOUNT, PARTICULARS "+
