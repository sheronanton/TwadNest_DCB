...
<title>CORPORATION_RUN_ON_SEPTEMBER_ ... EMBER_COLLECTION_FROM_FAS9 </title>
	...
	//	Office_id=obj.getValue("HRM_EMP_CURRENT_POSTING", "OFFICE_ID", "where EMPLOYEE_ID in ( select EMPLOYEE_ID	 from SEC_MST_USERS where USER_ID='"+userid+"')") ;
	 ...
	 <form name="list_demnad">
 	 	<table  align=center   border="0"   width="95%"  cellspacing="0" cellpadding="2">
			<tr class="tdH">
	 	   	        <th align="center" colspan=8 class="tdText"> <font    size="4"><b>CORPORATION_RUN_ON_SEPTEMBER_ ... EMBER_COLLECTION_FROM_FAS9   REPORT -- <%=Office_Name%> </b></font>  </th>
			</tr>
 			<tr class="tdHeader">
        	...
        	<!-- 	<td valign="middle" width=5%> <select class='select' id="month" name="month" style="width:90pt" onchange="list('show',1,this) "></select></tD> -->
        		...
        		<td valign="middle"  align=right > <select class='select'  id="bentype" name="bentype" onchange="list('show',9,this)" style="width:100pt"></select> </td> 
