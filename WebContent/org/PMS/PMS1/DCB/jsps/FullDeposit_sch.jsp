 ...
 String combo="";
	int row=0; 
			...
			String Date_dis=day+"/"+month+"/"+year;
			   Controller obj=new Controller();
				...
				if (Office_id.equals("")) Office_id="0";
		 		...
		 		String qry="SELECT BENEFICIARY_NAME,SCH_NAME "+
					" FROM "+
					...
					"     BENEFICIARY_TYPE_ID, "+
					  ...
					  " WHERE "+new_cond+" BENEFICIARY_TYPE_ID=18 "+
					...
					" AND btype.BEN_TYPE_ID=met.BENEFICIARY_TYPE_ID "+
					" JOIN "+
					"   ( SELECT SCH_SNO, SCH_NAME, SCH_TYPE_ID FROM PMS_SCH_MASTER "+
					"   )sch "+
					" ON sch.SCH_SNO     =met.SCHEME_SNO "+
					" AND sch.SCH_TYPE_ID=met.SCH_TYPE_ID"; 
		 		 table_column="BENEFICIARY_NAME,SCH_NAME";
				table_header="Beneficiary Name,Scheme Name";
				String table_td_set="width='35%','width='35%' ";
				table_heading=" Full Deposit Scheme - "+Office_Name+ "";
		...
		<form action="FullDeposit_demand.jsp" method="get" name="othercharges">
		 ...
		 <tr  > <td  valign="middle" colspan="3" align="center"><font size='4'> Full Deposit Scheme - <%=Office_Name%> </font> </td></tr>
					<TR><td>
					<%=html%></td>
					</TR>	  
          	<tr>
