...
<html>
  <head>
    ...
    <title>Division Scheme Mapping  | TWAD Nest - Phase II</title>
    <link href='../../../../../css/txtbox.css' rel='stylesheet' media='screen'/>
     <script type="text/javascript" src="../scripts/MapDivSch.js"></script>
     <script type="text/javascript" src="../scripts/Pagination.js"></script>
     <script type="text/javascript" src="../scripts/dcbvalidation.js"></script>
  </head>
 <body onload="callServer('LoadCmb'); callServer('Get');">
  	<form name="frmMapDivSch" action="">
  		<table border="0" width="90%" align="center" class="fb2">

		    <tr class="tdH" align="center" style="color:black">
		        <td colspan="2"> <div align="center"><strong>Division Scheme Mapping</strong></div></td>
		    </tr>
		    ...
		    <tr class="table">
		        <td>Scheme</td>
		        <td>
		        	<select class="select" name="sch" id="sch" onchange="callServer('Get');">
		    ...
		    <tr class="tdH" align="center">
		        <td colspan="2" >               
		                ...
		                <input class="fb2" type="button" name="Exit" value="Exit"  id="Exit" onclick="self.close()"/><img src="../../../../../images/help_images.jpg" height="18px" width="45px" style="vertical-align: bottom;" onClick="window.open('help1.jsp?fn=2','mywindow','scrollbars=yes')">              
		        </td>
		    </tr>
	    ...
	    <table id="existing" border="0" width="90%" align="center"  class="fb2">
	    	<tr>
