...
function setvalue(frm_off,sub_div_id)
{
//	alert(frm_off);
//	alert(sub_div_id);
 var frm_off=frm_off;
 var sub_div_id=sub_div_id;


 var url="../../../../../Office_Shift?command=loadvalue&frm_off="+frm_off+"&sub_div_id="+sub_div_id;
//   alert(url);
...
<body onload="setvalue('<%=request.getParameter("frm_off")%>','<%=request.getParameter("sub_div_id")%>')">
<br>
<br>
...
<tr >
	<td colspan="8" align="center" class="tdText" bgcolor="skyblue"><b>Sub Division :</b></td>
		<td colspan="8" align="center" class="tdText" ><b>  <%=request.getParameter("sub_div_Name")%>  (<%=request.getParameter("sub_div_id")%>)</b></td>
