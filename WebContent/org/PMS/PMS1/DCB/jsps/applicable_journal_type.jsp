...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<title>DCB Applicable Journal Type</title>
		<script type="text/javascript" src="../scripts/cellcreate.js"></script>
		<script type="text/javascript" src="../scripts/applicable_journal_type.js"></script>
	</head>
	...
	<table align="center" width="65%" height="" border="1" cellpadding="10" style="border-collapse: collapse;border-color: purple;"> 
		<tr style="background-color: #F5BCA9">
			<td align="center" colspan="2">
				DCB Applicable Journal Type
			</td>
		</tr>
		<tr>
			<td width="50%">Journal Type</td>
			<td><select id="jtype" name="jtype"></select></td>
		</tr>
