     ...
     " ( "+
		...
		" on BEN_TYPE.BEN_TYPE_ID=ben.BENEFICIARY_TYPE_ID  " + 
 		...
 		try {
			...
			while (rs.next())
			{
				...
				}else
				{
					...
					//	sch_tot+=Double.parseDouble(obj.isNull(rs.getString("amt"), 1));
				 	 if (sch_tot!=0)
					  {
						tab+="<tr><Td align=right colspan=5><font size='3' color=blue><b>Total</b></font></td><td class='tdText'  align=right><font size='3' color=blue><b>"+sch_tot+"</b></font></td></tr>";
			...
			tab+="<tr><Td align=right colspan=5><font size='3' color=blue><b>Total</b></font></td><td class='tdText'  align=right><font size='3' color=blue><b>"+sch_tot+"</b></font></td></tr>";
			tab+="<tr ><td colspan='5' align=right class=tdText><font color='red' size=4>Net Total</font></td><td align=right class=tdText><font color='red' size=4><b>"+tot_+"</b></font></td></tr></table>";
