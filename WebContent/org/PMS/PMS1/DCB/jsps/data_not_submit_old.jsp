		...
		String qry="select "+
		      ...
		      "( "+
		         ...
		         "   ( select "+ 
		           ...
		           "     BENEFICIARY_SNO  "+
		           "  from  "+
		       "    PMS_DCB_MST_BENEFICIARY_METRE  where   OFFICE_ID= "+Office_id + 
...
%> 
		...
		<Table class="fb2"    id="" width=75% align="center" border="1"   cellspacing="0" cellpadding="3" style="BORDER-COLLAPSE: collapse" border="1" borderColor="#92c2d8">
				...
				<tr>
			 		<td  colspan="2"  align="right"> <a href="metre_missing.jsp"><font color=red size=2><b>Meter Missing Status</b></font></a></td> 
			 	</tr>
				<Tr>
