...
function report(a)
{
	...
	var rtype=document.getElementById("rtype").value;
		var src="./../../../../../Water_Charges_Report?option="+rtype+"&year="+year+"&command=receipt_verificaiton_HO";
		window.open(src);
}
</script>
...
<table align="center" width="66%" cellpadding="10" cellspacing="0" border=1 bordercolor="darkgray">
  <tr>  
 		<td colspan="3" align="center">Receipt Verification - Head Office  </td>
 </tr>
 <tr class="tdText">
   <td>
     ...
     <tr> 
       ...
       <tr>
       	<td colspan="3" align="center">
       		<input type="button" value="View" onclick="report(1)">	
