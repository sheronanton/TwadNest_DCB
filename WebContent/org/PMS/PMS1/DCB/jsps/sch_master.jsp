...
<%  
	...
	<form id="sch_master" name="sch_master" method="GET"  >
      ...
      <tr><th align ="center" colspan ="5" class = "tdH">Scheme Master - <%=Office_Name%></th></tr>       
        ...
        <tr class="lbl">
	          <td width="20%"> <font  class="fnt"> Type</font></td>
      ...
      <table id="Existing" border="1" width="100%" cellspacing="3" class="table" align="center">
           <tr >
			<td colspan ="6" align="center">
        	    <A HREF="javascript:load(1);" > <font  class="fnt">Annual Maintenance Estimate </font></A>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
        		<A HREF="javascript:load(2);" > <font  class="fnt">Budget Estimate </font></A> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        	 	<A HREF="javascript:load(4);" > <font  class="fnt">Scheme Performance for Cut off</font></A>&nbsp;&nbsp;&nbsp;
        	 	<A HREF="javascript:load(3);" > <font  class="fnt">Scheme Performance for Month wise Entry </font></A>&nbsp;
        	 	<A HREF="javascript:load(5);" > <font  class="fnt">Scheme Performance for Month wise Edit</font></A>
         	    </td>  </tr> 
      <tr class="tdH" >
