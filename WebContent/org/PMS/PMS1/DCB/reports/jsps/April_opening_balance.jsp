...
<html>
<head>
<title>Opening Balance Schemewise - April </title>
...
function report(a)
{
	...
	{  
		...
		var src="../../../../../../Water_Charges_Report?option="+rtype+"&month="+month+"&year="+year+"&command=April_opening_balance";
		window.open(src);
	}  
	else
	{
...
<table align="center" width="50%" border="1"
	...
	cellpadding="10">
	<tr >
		<td align="center" colspan="2">Opening Balance Schemewise - April <Br> <%=Office_Name%> </td>
	</tr>
	 <tr><td>&nbsp;Year</td>
