...
//	var pmonth=document.getElementById("pmonth").value;	 
	window.open("../../../../../../Water_Charges_Report?command=DmDandcoll_new&pyear="+pyear+"&option="+reporttype+"&ftype="+ftype+"&Lmonth="+Lmonth+"&Lyear="+Lyear);	 
}	  
...
// alert("ftype is --> "+ ftype)
//	var pmonth=document.getElementById("pmonth").value;	 
	window.open("../../../../../../Water_Charges_Report?command=tariff_ben_count&pyear="+pyear+"&option="+reporttype+"&ftype="+ftype+"&month="+month);	
...
// alert("ftype is --> "+ ftype)
//	var pmonth=document.getElementById("pmonth").value;	 
	window.open("../../../../../../Water_Charges_Report?command=AllDandcoll_mon&pyear="+pyear+"&option="+reporttype+"&ftype="+ftype+"&month="+month);	
...
function dmd3()
{
	...
	window.open("../../../../../../Water_Charges_Report?command=Ben_count&option="+reporttype);	
...
%>  
	<table align="center" width="60%" border=1 class="table" cellpadding="20" cellspacing="0" style="vertical-align: top;">
		<tr class="tdH">
			<th colspan="4" align="center"> DCB COMMON DATA  <br><%=Office_name %></th>
		</tr>			
	    <Tr>
		    <td>  
				 Financial Year 
		...
		<td colspan="2"> 
			...
			<input type="button" value="Ben count" class="fb2"   onclick="dmd3()">
		</td> 
	</tr>
	<tr>
			 	<th colspan=3 align="center" > 
					...
					<input type="button" value="Financial Report" class="fb2"   onclick="dmd()">
					<input type="button" value="Month Report" class="fb2"   onclick="dmd1()">
