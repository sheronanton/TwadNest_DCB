...
function sch()
{
	...
	alert(" reporttype is "+reporttype);
	alert(" ftype is "+ftype);
	//var s="../../../../../../Water_Charges_Report?pmonth="+pmonth+"&command=FIN_YEAR_REPORT_HO&pyear="+pyear+"&option="+reporttype;	
	window.open("../../../../../../Water_Charges_Report?pmonth="+pmonth+"&command=SCH_REPORT_HO&year="+year+"&option="+reporttype);	 
}
...
// alert("ftype is --> "+ ftype)
//	var pmonth=document.getElementById("pmonth").value;	 
	window.open("../../../../../../Water_Charges_Report?command=PQandDmdmonth&pyear="+pyear+"&option="+reporttype+"&ftype="+ftype+"&Lmonth="+Lmonth+"&Lyear="+Lyear);	 
}
...
// alert("ftype is --> "+ ftype)
//	var pmonth=document.getElementById("pmonth").value;	 
	window.open("../../../../../../Water_Charges_Report?command=PQandDmd&pyear="+pyear+"&option="+reporttype+"&ftype="+ftype+"&Lmonth="+Lmonth+"&Lyear="+Lyear);	 
}	  
...
<%
	...
	try
	{
	  ...
	  //  Office_id=obj.getValue("HRM_EMP_CURRENT_POSTING", "OFFICE_ID", "where EMPLOYEE_ID in ( select EMPLOYEE_ID	 from SEC_MST_USERS where USER_ID='"+userid+"')") ;   
	   ...
	   int year_present = cal.get(Calendar.YEAR);
...
%>  
	    ...
	    <Tr>
         ...
         <Tr>
		    <td> 
			 ...
			 <select class="select" id="year" name="year"  tabindex="5" onchange="report_period_verify(document.getElementById('month'),this)" style="width: 80pt;">
                <option value="0" selected="selected">Select</option>
                  <%
    ...
    </select> <input type="button" value="Tariff" class="fb2"   onclick="dmd5()"></td>
			 </Tr>
			 <tr class="tdText"> <td>Report in</td>
	 	<td>
	 		<select id="ftype" name="ftype"  style="width: 100pt" class="select" >
	 			<option value="1" selected="selected" >Actual</option>			
	...
	<tr>
				...
				<input type="button" value="Ben Typewise PQ(Financial)" class="fb2"   onclick="dmd1()">
					<input type="button" value="Ben Typewise PQ(Monthwise)" class="fb2"   onclick="dmd2()">
					<input type="button" value="Schemewise DMD&COLL" class="fb2"   onclick="sch()">
					<input type="button" onclick="check()" value="Click if null" >
