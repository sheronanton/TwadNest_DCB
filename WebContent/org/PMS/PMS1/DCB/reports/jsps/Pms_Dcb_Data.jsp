...
<table border="1" width="75%" align="center" cellpadding="4" cellspacing="0" class="alerts2" >
 ...
 <tr> 
 	...
 	<td colspan="2"><select id='rin' name='rin' class="select">
 		 ...
 		 <option value="2" selected>Actual</option>
 		</select>
...
<option selected="" value="6777"><%=Office_Name %></option>
 ...
 <tr>
    ...
    <input type="button" name="Print" value="Print" class="bprint"  id="cmdprint" onclick="funcmddata(document.getElementById('pr_type').value);"  style="font-style: italic;font-weight:bold;font-size: 7;color:red"  />&nbsp;<input type="button" name="Clear" value="Clear" id="clear" onclick="refresh();" style="font-style: italic;font-weight:bold;font-size: 7;color:blue" class="fb2"> 
