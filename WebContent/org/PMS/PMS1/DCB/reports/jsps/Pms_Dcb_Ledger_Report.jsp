...
<%@page import="java.sql.Connection"%><html>
	<head>
		...
		<link href='../../../../../../css/AME.css' rel='stylesheet' media='screen'/>
	 	<script type="text/javascript" src="../scripts/Pms_Dcb_Ledger_Report.js"></script>
...
<table border="1" width="75%" align="center" cellpadding="4" cellspacing="0" class="alerts2" >
 ...
 <tr> 
 	<td colspan="2"  class="tdText">Report  in</td>
 	<td colspan="2"><select id='rin' name='rin' class="select">
 		 <option value="0">Select</option>
 		 <option value="1" selected >Lakhs</option>
 		 <option value="2">Actual</option>
 		</select>
 		<% if (Office_id.equalsIgnoreCase("5000")) { %>
 		<input type="button" name="Print" value="Print All Division Booklet. (old)" class="bprint" id="cmdprint" onclick="funcmdprint(document.getElementById('pr_type').value);" style="font-style: italic;font-weight:bold;font-size: 7;color:red">
 		<% } else {%>
 		<input type="button" name="Print_int" value="Print with Interest" class="bprint" id="cmdprint" onclick="funcmdprint3();" style="font-style: italic;font-weight:bold;font-size: 7;color:red">
 		<% } %>
  	</td>
 </tr>
...
<option selected="" value="6777"><%=Office_Name %></option>
 ...
 <tr>
    <td colspan="4" align="center"> 
  	<% if (Office_id.equalsIgnoreCase("5000")) { %>
  	<input type="button" name="Print" value="DCB  Beneficiary Wise" class="bprint" onclick="funcmdprint1();" style="font-style: italic;font-weight:bold;font-size: 7;color:red"/>
  	<% } %>
    <input type="button" name="Print" value="Print" class="bprint"  id="cmdprint" onclick="funcmdprint(document.getElementById('pr_type').value);"  style="font-style: italic;font-weight:bold;font-size: 7;color:red"  />&nbsp;<input type="button" name="Clear" value="Clear" id="clear" onclick="refresh();" style="font-style: italic;font-weight:bold;font-size: 7;color:blue" class="fb2"> 
