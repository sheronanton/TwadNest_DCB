...
<table border="1" width="75%" align="center" cellpadding="4" cellspacing="0" class="alerts2" >
 ...
 <td colspan="2">
  ...
  <tr>	<td class=tdText width="40%" colspan="2" >Division </td>
 	 <td colspan="2"><%=office_%>       <input type="button" name="Print" value="Print" class="bprint"  id="cmdprint" onclick="funcmdprintnew1(document.getElementById('pr_type').value);"  style="font-style: italic;font-weight:bold;font-size: 7;color:red"  />&nbsp; 
 	  </td>
 </tr>
  <tr>
 	<td colspan="4">
 ...
 <tr>
    ...
    <input type="button" name="Print ALL Division" value="Print All Division" class="bprint"  id="cmdprint" onclick="funcmdprintnew(document.getElementById('pr_type').value);"  style="font-style: italic;font-weight:bold;font-size: 7;color:red"  />&nbsp; 
