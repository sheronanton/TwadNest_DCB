...
<script type="text/javascript">
		function rld3()
		{
			...
			window.open("../../../../../../Water_Charges_Report?command=FIN_YEAR_DCB&pyear="+pyear);
		}
</script>
</head>
<body>
...
<table align="center" width="70%" border=1 class="table" cellpadding="10" cellspacing="0" style="vertical-align: top;">
	<tr>
		<td colspan="2" align="center" class="tdH">Statement of Scheme
		wise Demand, Collection, Balance for the Financial year</td>
	</tr>
	<Tr>
