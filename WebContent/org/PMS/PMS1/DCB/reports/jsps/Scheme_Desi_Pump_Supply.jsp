...
<body>
<%		double total_des=0.0,total_pump=0.0,total_supply=0.0;
		...
		try
		{
			...
			<tr class="tdH">
			<td colspan=6 align="center">Statement I showing the status of maintenance of CWSS / Board owned Schemes for the month of for the month of <%=mvalue%> <%=year%>	
			...
			while (er.hasNext())
			{
				...
				{
					case 1:
						total_des+=Double.parseDouble(b.toString());
						break;
					case 2:
						total_pump+=Double.parseDouble(b.toString());
						break;
					case 3:
						total_supply+=Double.parseDouble(b.toString());
						break;				
				}
			 	i++;
...
%>
	<tr>
		...
		<th  align="right"><%=df.format(total_des)%></th>
		<th  align="right"><%=df.format(total_pump)%></th>
		<th  align="right"><%=df.format(total_supply)%></th>
