...
%>	<link href="../../../../../css/txtbox.css" rel="stylesheet" media="screen"/>
	<table align="center" width="85%" border="1"  cellspacing="0" cellpadding="3" style="BORDER-COLLAPSE: collapse"   borderColor="#92c2d8">
			<tr bgcolor="#408080"> <td  colspan="4" align="center"><font color='white'> <%=Region_Title_Head%> DCB Statistics  </font></td></tr>
		...
		%>
			...
			<tr>
				...
				<tr>
					...
					<td  width="20%"  align="center"><font size=2><a href="count_div.jsp?oid=<%=oid%>">Click</a></font></td>
		...
		<tr>
					<td colspan=4 align="center">   <input class="fb2"   type="button" id="" value="Exit" onclick="javascript:window.close()" /></td>
		</tr> 
	</table>	
<a href="../../jsps/water_charges_journal_circle.jsp">test</a>
	</body> 
</html>
