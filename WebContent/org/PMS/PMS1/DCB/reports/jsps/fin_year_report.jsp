...
<title>DCB Financial Year Statement</title>
...
function rpt()  
{
	...
	if (year!=0 && DV!=0)
	var s= window.open("../../../../../../reg_menu_index?ref_sno=20&year="+year+"&DV="+DV,"","","");
	else
		alert("Select Financial year and Division Name ");   
}
function rpt1()    
{
	var year= document.getElementById("year").value;
	var DV= document.getElementById("DV").value;
	if (year!=0 && DV!=0)
	var s= window.open("../../../../../../reg_menu_index?ref_sno=210&year="+year+"&DV="+DV,"","","");
	else
		alert("Select Financial year and Division Name ");   
}
</script>
...
<body>
<form action="fin_year_report.jsp" method="get" name="myform">
<%  
 ...
 <tr>
	...
	<tr>	<td class=tdText width="40%"   > <font color="#0000A0"> Division </font></td>
     ...
     <tr>
     		...
     		<%
     			if (Integer.parseInt(Office_id)==5000)
		 		{%><input type="button" value="District Wise Net Due" onclick="rpt1()">
		 		<%} %> 
