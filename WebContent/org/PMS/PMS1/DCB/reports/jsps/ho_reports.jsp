		 ...
		 <tr class="tdH">
		    <td align="center" height="20px" colspan="4" height="10">
		    	<% System.out.println("Office_Name: " + Office_Name); %>
		  		 Opening Balance Report   <%=Office_Name%> <font class="tdText" color="red"><label id="msg"></label></font>		   
		    </td>
		 </tr>
		 <tr>
	 ...
	 <tr>
		...
		<td>
			<select id="bentype" name="bentype">
				...
				<option value="6">Village Panchayat</option>
				<option value="60">Village Panchayat Detailed</option>
		 ...
		 <tr class="tdH">
		 		...
		 		{%>
		 			...
		 			<input type="button" class="fb2" name="dash1" id="dash1"  value="Dashboard Report" onclick="callServer2('dbd');">	 	
		 			<input type="button" class="fb2" name="monthEndCharges" id="monthEndCharges"  value="Month End Balance" onclick="callServer2('monthEndBalance');">	
		 			...
		 			<input type="button" class="fb2" name="DmdColn" id="DmdColn"  value="Demand Collection" onclick="callServer2('DmdColn');">	 	
		 			<input type="button" class="fb2" name="CurColn" id="CurColn"  value="Current Collection" onclick="callServer2('CurColn');">		
		 			<input type="button" class="fb2" name="monthEndAbstract" id="monthEndAbstract"  value="Month End Abstract" onclick="callServer2('monthEndAbstract');">			
