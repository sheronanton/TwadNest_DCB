...
<script type="text/javascript">
	...
	function load_new3( )
	{
		...
		{ 
			window.open("md_abstract_stypewise_rev.jsp?pmonth="+pmonth+"&pyear="+pyear);
		}
	...
	function load_new2( )
	{
		...
		{
			window.open("mirroring_report.jsp?pmonth="+pmonth+"&pyear="+pyear);
		}
	}
</script>
...
<table border="1" width="62%" cellpadding="10" cellspacing="0" style="border-collapse: collapse;"  align="center">
		<tr  bgcolor="#3080A0">
			<td  colspan="4" align="center"><font color=white>Demand,Collection and Balance Statement <Br> Abstract Report </font></td>
		</tr> 
		<tr>
			<td>Year</td>
  		 ...
  		 <tr> 
  		 	<td colspan="4" align="center">
  		 		...
  		 		<input type="hidden" value="Revised Report" onclick="load_new3()">
  		 		<input type="hidden" value="M.D. Report" onclick="load_new2()">
