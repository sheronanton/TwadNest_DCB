...
<%	
				...
				"  WHERE YEAR="+pyear+" and BLOCK_SNO="+BLOCK_SNO+" "+off+" AND MONTH="+pmonth+" "+add_cond+"   "+add_cond2+"  AND SCH_TYPE_ID_SUB="+schtype+"  GROUP BY YEAR, MONTH,SCH_TYPE_ID_SUB, BENEFICIARY_NAME ORDER BY  BENEFICIARY_NAME "+
				"  )ac "+
