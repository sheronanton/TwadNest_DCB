...
<body>  
 ...
 String fn="",path_="";  
	...
	String userid="0",Office_id="",Office_Name="",pmonth="0",pyear="0",MD_GROUP="0";
	try
	{
		db_con=obj_new.con();
...
<%	
				...
				while(rs_dis2.next())
				{
					...
					*/
					...
					out.println("<td align='left' width='45%' ><a href=md_new_abstract_typewise.jsp?pmonth="+pmonth+"&pyear="+pyear+"&BEN_TYPE_GROUP="+BEN_TYPE_GROUP+">"+BEN_TYPE_GROUP_NAME+"&nbsp;</td>");
	 ...
	 pie_chart_xml+="</graph>";
%>  
<tr><td align="center" colspan="6"><input type="button"  style="color: red;font-weight: bold"  value="Close" onclick="javascript:window.close()">&nbsp;&nbsp;&nbsp;<a href="md_new_abs_btypewise_rpt.jsp?MD_GROUP=<%=MD_GROUP%>&pmonth=<%=pmonth%>&pyear=<%=pyear%>">Report Excel Download</a></td></tr>
</table>
