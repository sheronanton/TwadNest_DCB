...
<body >  
 <%
	...
	try
	{
		...
		String BLOCK_SNO=obj_new.setValue("BLOCK_SNO",request);
 ...
 %> 
<table border=1 class="ft" width="100%" cellpadding="5" cellspacing="0" style="border-collapse: collapse;"  align="center"> 
	<tr class="tdH">
...
<%	
				String user_query=" SELECT ROUND( TRUNC((OPENING_BAL_WC_8+DMD_UPTO_PRV_MNTH_WC_9)-(COLN_UPTO_PRV_MTH_YES_YR_WC_12+COLN_UPTO_PRV_MTH_CR_YR_DMD_13) ,4),4) AS ob,"+
				" ROUND(TRUNC(DMD_FOR_MTH_WC_10,4),4)AS dmd, ROUND(TRUNC((COLN_FOR_MTH_YES_YR_WC_14+COLN_FOR_MTH_WC_15),4),4)AS collection,"+
				" ROUND(TRUNC(BALANCE_18,4),4)AS balance,  BENEFICIARY_NAME "+
				" FROM "+  
...
<tr><td align="center"><input type=button value="Exit" onclick="window.close()"></td></tr></table></center>
</body>
</html>