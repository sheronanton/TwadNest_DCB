...
<body >  
 <%
 	String  Office_Name="",userid="",Office_id="" ,pmonth="0",pyear="0",schtype="0",DISTRICT_CODE="0" ;
...
<%	
				...
				" ROUND(TRUNC(BALANCE_18,3),3)AS balance, rpt.BLOCK_SNO,BLOCK_NAME "+
				" FROM "+  
...
<tr><td align="center"><input type=button value="Back" onclick="window.history.go(-1)">&nbsp;&nbsp;&nbsp;<a href="md_new_abstract_blockwiserpt.jsp?DISTRICT_CODE=<%=DISTRICT_CODE%>&schtype=<%=schtype%>&pmonth=<%=pmonth%>&pyear=<%=pyear%>">Report Excel Download</a></td></tr></table></center>
</body>
</html>