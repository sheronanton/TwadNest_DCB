...
{  
	...
	//window.open("md_new_abstract_benwise_mir.jsp?pmonth="+pmonth+"&pyear="+pyear+"&DISTRICT_CODE="+b+"&BLOCK_SNO="+a,"","","");
	 mywindow = window.open("md_new_abstract_benwise_mir.jsp?pmonth="+pmonth+"&pyear="+pyear+"&DISTRICT_CODE="+b+"&BLOCK_SNO="+a, "mywindow", "location=1,status=1,scrollbars=1,  width=600,height=600");
}  
</script>     
</head>
<body >  
...
<%	
				...
				" ROUND(TRUNC(BALANCE_18,4),4)AS balance, rpt.BLOCK_SNO,BLOCK_NAME "+
				" FROM "+  
				...
				while(rs_dis2.next())
				{
					...
					tot4+=Double.parseDouble(balance);  
					 ...
					 out.println("<tr  bgcolor='#CCFFFF'><td align='center' width='6%'>&nbsp;"+row+"&nbsp;</td>");
						out.println("<td align='left' width='45%' ><a href='javascript:ld("+BLOCK_SNO+","+DISTRICT_CODE+")'>"+BLOCK_NAME+"&nbsp;</td>");
					//out.println("<td align='left' width='45%' ><a href=md_new_abstract_benwise.jsp?DISTRICT_CODE="+DISTRICT_CODE+"&pmonth="+pmonth+"&pyear="+pyear+"&schtype="+schtype+"&BLOCK_SNO="+BLOCK_SNO+">"+BLOCK_NAME+"&nbsp;</td>");
...
%>  
</table> <input type=hidden id="pmonth" value="<%=pmonth%>">
