...
{    
	...
	parent.frames[4].location.href ="md_new_abstract_blockwise_mir.jsp?pmonth="+pmonth+"&pyear="+pyear+"&DISTRICT_CODE="+a;
}
</script>  
</head> 
<body>    
...
<table border=1 class="ft" width="100%" cellpadding="5" cellspacing="0" style="border-collapse: collapse;"  align="left"> 
	<tr class="tdH">
...
<%	
				...
				" ROUND(TRUNC(BALANCE_18,4),4)AS balance,rpt.DISTRICT_NAME,rpt.DISTRICT_CODE "+
				" FROM "+  
				...
				while(rs_dis2.next())
				{
					...
					out.println("<td align='left' width='45%' ><a href='javascript:ld("+DISTRICT_CODE+")'>"+DISTRICT_NAME+"&nbsp;</td>");
