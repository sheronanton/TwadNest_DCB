...
<%
				...
				// int total_month=obj.number_of_week(sel_year,sel_month,1);
				 int total_month=obj.number_of_week(nyear,nmonth,1);
%>
		...
		<tr>
		  ...
		  <td><font><label class="lbl">Month</label></font></td>	  	          
			   <td colspan="2">
          		...
          		<td>
          			...
          			if (sel_month !=0 && sel_year!=0)
          			{
		          			...
		          			while (as.hasNext() && ae.hasNext())  
		          			{
		          				...
		          				%>
		          				<tr>
		          				<Td><input type="text" id="sdate<%=j%>" value="<%=ds%>" maxlength="10" size="12"></td>
		          				<Td><input type="text" id="edate<%=j%>" value="<%=de%>" maxlength="10" size="12"></td>
          		...
          		<td><input type="hidden"  style="color: green;font-weight: bold"  value="Submit" onclick="rld12(15)">
          		<input type="button"  style="color: green;font-weight: bold"  value="Abstract" onclick="rld14(19)">          		
				&nbsp;<input type="button"  style="color: green;font-weight: bold"  value="Details" onclick="rld14(16)">
				</td>
       		...
       		<tr> 
       			<td class="tdText" align="center" colspan="3"> <input type="button"  style="color: red;font-weight: bold"  value="Close" onclick="javascript:window.close()">	</td>
       		</tr>
	</table>
