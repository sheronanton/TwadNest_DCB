 ...
 function rld11() 
{
	...
	var url="../../../../../../Pms_Dcb_Ledger_Report?pr="+rpt+"&option="+option+"&month="+smonth+"&year="+year;
...
%>
 <table border="1" width="55%" align="center" cellpadding="10" cellspacing="0" style="border-collapse: collapse" >
 <tr  bgcolor="#3080A0"><td colspan="3" align="center"><b><font color=white>Annexure - I</font></b></td></tr>
  <!--  <tr>  
	   ...
	   <tr><td colspan="3" align="center">Annexure Report</td></tr>   	--> 		 
		...
		<tr>
		  <td><font><label class="lbl">Month</label></font></td>	  	          
          	...
          	<tr>   
          		<td  width="25%">  
          			<font><label class="lbl">Annexure <font size='3'>-</font> I&nbsp;&nbsp; Report</label></font>    
          		</td>
          		<Td width="15%">	<select class="select" id="rpt"  style="width:240pt;">
          					<option value="0" selected>Select Report</option>         				
          					<option value="11"> Abstract</option>
          					<option value="12"> Division Wise Review</option>
          					<!-- <option value="121"> Division Wise Review - Details</option> -->  
          			</select>      
          		</td>
          	</tr>
       		...
       		<tr>
       			<td colspan="2" align="center"><input type="button"  style="color: green;font-weight: bold"  value="Print" onclick="rld11()">&nbsp;<input type="button"  style="color: red;font-weight: bold"  value="Close" onclick="javascript:window.close()">		</td>
       		</tr>
       		<a href="data_dynamic_find.jsp">.</a>
	</table>
