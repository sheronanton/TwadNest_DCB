...
function Show(unitcode,offid,yr,mon,recNo)
{
    ...
    Receipt_list_SL= window.open("DCB_Receipt_ListAll_SL.jsp?cmbAcc_UnitCode="+unitcode+"&cmbOffice_code="+offid+"&yr="+yr+"&mon="+mon+"&recNo="+recNo,"ReceiptDateSearch","status=1,height=500,width=500,resizable=YES, scrollbars=yes"); 
    Receipt_list_SL.moveTo(250,250);  
    Receipt_list_SL.focus();
...
{   
        ...
        {  
            ...
            {
                var txtReceipt_type='BR';
                var url="../../../../../DCB_Receipt_ListAll?Command=searchByMonth&cmbAcc_UnitCode="+cmbAcc_UnitCode+
        ...
        {  
           ...
           if(txtCB_Year.length!=0 && txtCB_Month.length!=0 && txtFrom_date.length!=0 && txtTo_date.length!=0)
            {
                var txtReceipt_type='BR';
                var url="../../../../../DCB_Receipt_ListAll?Command=searchByDate&cmbAcc_UnitCode="+cmbAcc_UnitCode+
                     ...
                     c++;
                      ...
                      for(j=0;j<4;j++)
                        ...
                        */
                        ...
                        //alert("error in line 360:::"+document.getElementById("Ucode").value);
