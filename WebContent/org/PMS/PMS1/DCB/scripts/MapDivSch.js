...
//********************************* CallServer Response Coding ***************************************//
                ...
                if(req.status==200)
                {
                    ...
                    else if(cmd == 'Get')
                    {
                            ...
                            for(var i=0; i<len; i++)
                            {
                            		...
                            		var scheme =new String(row[i].getElementsByTagName('scheme')[0].firstChild.nodeValue);
	...
	function edit(rid)
	{
		...
		var total_len=document.getElementById('sch').options.length;
		document.getElementById('sch').value = rcells.item(3).firstChild.nodeValue;
