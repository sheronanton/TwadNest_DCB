...
function divisionname()
{
    ...
    if (xmlhttp==null)
     ...
     url="../../../../../Pms_Dcb_Beneficiary_OB_Entry_Status?command=divisionname";
...
function loadbeneficiarytype()
{
    ...
    if (xmlhttp==null)
     ...
     url="../../../../../Pms_Dcb_Beneficiary_OB_Entry_Status?command=loadbeneficiarytype";
     url=url+"&sid="+Math.random();
...
function loadsubdivision()
{
    ...
    url="../../../../../Pms_Dcb_Beneficiary_OB_Entry_Status?command=loadsubdivision";
  //  alert(url);
    url=url+"&sid="+Math.random();
    xmlhttp.open("GET",url,true);
    xmlhttp.onreadystatechange= function()
...
function loadbeneficiaryname()
{
    ...
    url="../../../../../Pms_Dcb_Beneficiary_OB_Entry_Status?command=loadbeneficiaryname&beneficiaryType="+Beneficiarytype;
  //  alert(url);
...
function loadReport()
{
    ...
    url="../../../../../Pms_Dcb_Beneficiary_OB_Entry_Status?command=loadReport" +
            ...
            { 
                if(flagres=='success')
                {
                 ...
                 for(var i=0;i<BENEFICIARY_SNO_len;i++)
                 {
                	 ...
                	 var cell3=cell("TD","label","Edit","Edit",SchemeName,4,"","","","","","","");
                     ...
                     var apc_c=baseres.getElementsByTagName("apc")[i].firstChild.nodeValue;
                     apc_c=(apc_c==1)?"Y":"N";
                     var apc_cell=cell("TD","label","Edit","Edit",apc_c,4,"","","","","","","");
                     
                     var dmdmonth=baseres.getElementsByTagName("apc")[i].firstChild.nodeValue;
                     dmdmonth=(dmdmonth==1)?"Y":"N";
                     var dmdmonth_cell=cell("TD","label","Edit","Edit",dmdmonth,4,"","","'color: red'","","","","");
                    ...
                    new_row.appendChild(cell3);
                     ...
                     new_row.appendChild(apc_cell);
                     new_row.appendChild(dmdmonth_cell);
...
function reportPdf()
{
	    ...
	    var subDivision= document.getElementById("SubDivision").value;
	    var beneficiaryName= document.getElementById("Beneficiary_Name").value;
	    window.open("../../../../../Pms_Dcb_Beneficiary_OB_Entry_Status?command=pdf&beneficiaryType="+
