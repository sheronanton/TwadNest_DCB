...
function clearAll()
{
 ...
 function loadOfficesByType1(type)
 {
        ...
        var type=document.frmValidationSummaryRep.cmbsgroup1.options[document.frmValidationSummaryRep.cmbsgroup1.selectedIndex].value;
        var url="../../../../../../Role_Assigning_to_template.av?Command=Desig&cmbsgroup=" + type ;
       //alert(url);
...
function frmsubmit()
{
   // alert('inside submit');
      ...
      var desigval=document.frmValidationSummaryRep.roletemp.value;
      //alert(desigval);
     if(nullcheck_roles())
         var url="../../../Role_Assigning_to_template.av?Command=submit&roleval="+role_value+"&temp_id="+desigval;
     // alert(url);
          var req=getTransport();
    ...
    if(flag=="fail")
    {
       alert("Roles not inserted ");
    }
    else
    {   
         alert("Roles inserted successfully ");
         clearAll();
    }  
              }
...
function CallRoles()
{
    ...
    var url="../../../Role_Assigning_to_template.av?Command=role&temp_id="+desigval ;
