 ...
 {     
          ...
          {           
                ...
                if(flag==true)
                {
                   ...
                   //url="../../../ServletUpdatingRoles_FAS.con?command=Add&txtSysId="+strSysId+"&txtName=" + strName + "&txtDesc=" + strDesc;
                    url="../../../ServletUpdatingRoles_FAS.con?command=Add&txtSysId="+strSysId+"&txtName=" + strName + "&Orderseq=" + Orderseq;
          ...
          else if(command=="Delete")
          {
                ...
                var txtUserId=document.frmMasterSub.txtUserId.value;
                startwaiting(document.frmMasterSub) ;
                //url="../../../ServletUpdatingRoles_FAS.con?command=Delete&txtSysId="+strSysId+"&txtName=" + strName+"&txtDesc="+strDesc;    
                url="../../../ServletUpdatingRoles_FAS.con?command=Delete&txtSysId="+strSysId+"&txtName=" + strName;    
                url=url+"&txtUserId="+txtUserId;
                //alert(url);
                req.open("GET",url,true);        
                req.onreadystatechange=processResponse;
          ...
          {
            startwaiting(document.frmMasterSub) ;
               url="../../../ServletUpdatingRoles_FAS.con?command=combo";
                req.open("GET",url,true);        
                req.onreadystatechange=processResponse;
                req.send(null);          
          ...
          else if(command=="Login")
          {
           ...
           // alert(txtUserId);
            //startwaiting(document.frmMasterSub);
            url="../../../ServletUpdatingRoles_FAS.con?command=LoginUid&txtUserId="+txtUserId;
            //alert(url);
            req.open("GET",url,true);        
            req.onreadystatechange=processResponse;
            req.send(null);    
           ...
           else if(command="Login")
          {
            ...
            startwaiting(document.frmMasterSub) ;
            url="../../../ServletUpdatingRoles_FAS.con?command=Login&txtEmpId="+escape(txtSysId);
            req.open("GET",url,true);        
            req.onreadystatechange=processResponse;
            req.send(null);    
          }
