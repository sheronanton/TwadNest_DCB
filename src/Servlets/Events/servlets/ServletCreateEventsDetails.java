package Servlets.Events.servlets;
...
public class ServletCreateEventsDetails extends HttpServlet {
        ...
        response.setContentType(CONTENT_TYPE);
            ...
            //String strSecondaryId[]=null;
                  try
                  {
                        ...
                        System.out.println("values retrived sucessfully   :"+str_event_id+"  "+str_event_desc+"  "+str_event_venue+"  "+str_event_date +"  "+str_target_url);
                  }
                  catch(Exception e)
                  {
                    e.printStackTrace();
                  ...
                  {
                      String sql1="";        
                      sql1="insert into com_mst_events(EVENT_ID,EVENT_DESC,EVENT_VENUE,EVENT_DATE,TARGET_URL,EVENT_STATUS_ID) VALUES (?,?,?,?,?,'CD')";
                     ...
                     ps1.setDate(4,dateOfEvent); 
                      ...
                      if(str_target_url.startsWith("http://"))
                      {
                          ...
                          ps1.setString(5,trimed_url);
                      }
                      else {
                          ps1.setString(5,str_target_url);
                     ...
                     // ps1.close();
                      if(i>=1) {
                          ...
                          String msg="Event has been created successfully. Event ID : "+event_id+"";
                                                        msg=msg+"<br><br>";
