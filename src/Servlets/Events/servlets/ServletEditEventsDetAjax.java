...
public class ServletEditEventsDetAjax extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, 
        ...
        try
                 ...
                 //        ConnectionString = strdsn.trim() + "@" + strhostname.trim() + ":" + strportno.trim() + ":" +strsid.trim() ; // Oracle DB Connection 
                        ...
                        try{
                            String sql="select * from com_mst_events where event_id=?";
                            ...
                            results=ps.executeQuery();
                                if(results.next()) 
                                {
                                    ...
                                    str_event_desc=results.getString("event_desc");
                                    ...
                                    DateOfFormation = results.getDate("event_date");
                                    ...
                                    str_status=results.getString("event_status_id");
                                        //System.out.println("desc :"+str_status);
                                        
                                    System.out.println("values retrived sucessfully");    
                                    xml="<response><flag>success</flag><EventId>"+event_id+"</EventId><EventDesc>"+str_event_desc+"</EventDesc><EventVenue>"+str_event_venue+"</EventVenue><EventDate>"+DateToBeDisplayed+"</EventDate><TargetUrl>"+str_target_url+"</TargetUrl><EventStatus>"+str_status+"</EventStatus></response>";
                                    response.setContentType(CONTENT_TYPE);
