...
public class ServletEditEventsDetails extends HttpServlet {
            ...
            //String strSecondaryId[]=null;
                  ...
                  try
                  {
                     ...
                     // update COM_OFFICE_CONTROL set CONTROLLING_OFFICE_ID=?,DATE_EFFECTIVE_FROM=?,REMARKS=?,UPDATED_BY_USER_ID=?,UPDATED_DATE=? where Office_Id=?";  
                      sql1="update com_mst_events set EVENT_DESC=?,EVENT_VENUE=?,EVENT_DATE=?,TARGET_URL=?,EVENT_STATUS_ID='MD' where EVENT_ID=?";
                     ...
                     ps1.setDate(3,dateOfEvent); 
                      ...
                      if(str_target_url.startsWith("http://"))
                      {
                          ...
                          ps1.setString(4,trimed_url);
                      }
                      else {
                          ps1.setString(4,str_target_url);
                      ...
                      ps1.setInt(5,event_id);
                     System.out.println("b4 execute");
                     int i=ps1.executeUpdate();            
                     // ps1.close();
                      if(i>=1) {
                          System.out.println("values inserted successfully"); 
                          String msg="Event has been edited successfully.";
                                                        msg=msg+"<br><br>";
