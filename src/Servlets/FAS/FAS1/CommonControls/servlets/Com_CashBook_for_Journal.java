...
public class Com_CashBook_for_Journal extends HttpServlet {
   ...
   /*   if((dt<=25) && (mn<=8) && (yer<=2007) ) 
      ...
      else 
      {
       ...
       /**
        *  There is Full Cash book month and year for General and Liability Journal.
        *  So There is no need to find out cashbook month and year 
        */
