...
public class Edit_STURelieval_serv extends HttpServlet {
 ...
 xml + "<flag>success</flag><eid>" + eid + "</eid><ename>" +
   ...
   "</offid>";
                                ...
                                try {
                                    ...
                                    ps =
  con.prepareStatement("select OFFICE_ID,EMPLOYEE_ID,RELIEVAL_SLNO,STUDIES_COMPLETION_DATE ,SESSION_AN_OR_FN,  REMARKS,PROCESS_FLOW_STATUS_ID from HRM_EMP_STU_COMPLETION where OFFICE_ID=? and EMPLOYEE_ID=? and (PROCESS_FLOW_STATUS_ID='CR' or PROCESS_FLOW_STATUS_ID='MD')");
                                    ps.setInt(1, offid);
                                    ps.setInt(2, eid);
 ...
 xml + "<re_slno>" + rs.getInt("RELIEVAL_SLNO") + "</re_slno><dor>" +
   rs.getDate("STUDIES_COMPLETION_DATE") + "</dor><r_noon>" +
   rs.getString("SESSION_AN_OR_FN") + "</r_noon><remark>" +
