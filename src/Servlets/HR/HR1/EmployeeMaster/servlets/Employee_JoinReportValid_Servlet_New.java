...
public class Employee_JoinReportValid_Servlet_New extends HttpServlet {
                        ...
                        if(!results.next())
                        {
                           ...
                           /*
                            ...
                            if(currentStatus.equalsIgnoreCase("WKG")) {
                                xml=xml+"<flag>failure</flag><flag>Given employee has been working status.Can not post again.</flag>";
                                flag=true;
                            }
                ...
                if(paybill==1)
                {
                	...
                	try
                	{
                		...
                		pst.executeUpdate();
                         ...
                         psnew1=connection.prepareStatement("insert into HRM_PAY_BILL_GROUP_EMP_LINK(EMPLOYEE_ID,ACCOUNTING_UNIT_ID,ACCOUNTING_FOR_OFFICE_ID,PAY_BILL_GROUP_ID,PAY_BILL_SUBGROUP_ID,DATE_EFFECTIVE_FROM,UPDATED_BY_USER_ID,UPDATED_DATE,PROCESS_FLOW_ID,REMARKS ) values(?,?,?,?,?,?,?,?,?,?)");
                         psnew1.setInt(1,strEmpName);
                         psnew1.setInt(2,acc_unit);
                         psnew1.setInt(3,OffId);
                         psnew1.setString(4,groupid);
                         psnew1.setString(5,subgroupid);
                         psnew1.setDate(6,dtjoin);
