...
public class hrm_Edit_Relieval_serv_new extends HttpServlet {
    ...
    {   
        ...
        int noaccunit=0;
        try{txtOffId=Integer.parseInt(request.getParameter("txtOffId"));}catch(Exception e){}
        ...
        {   
            ...
            try {
                    ...
                    if(flag)
                            {    
                        ps=con.prepareStatement("select EMPLOYEE_ID,EMPLOYEE_STATUS_ID  from HRM_EMP_CURRENT_POSTING where  EMPLOYEE_ID=? ");
                        ps.setInt(1,eid);
                        rs=ps.executeQuery();
                        if(!rs.next())
                        {
                        ...
                        {
                                if(rs.getString("EMPLOYEE_STATUS_ID")!=null && !rs.getString("EMPLOYEE_STATUS_ID").equalsIgnoreCase("DPN"))
                                {
                                       ...
                                       if(rs.next())
                                       {
                                        xml=xml+"<flag>success</flag><eid>"+eid+"</eid><ename>"+rs.getString("EMPLOYEE_NAME")+"</ename><desig>"+rs.getString("DESIGNATION")+"</desig><desid>"+rs.getInt("DESIGNATION_ID")+"</desid><offid>"+rs.getInt("OFFICE_ID")+"</offid>";
                                        ps.close();
                                        rs.close();
                                        ...
                                        System.out.println("here is ok relieval");
                                         ...
                                         ps=con.prepareStatement("SELECT EMPLOYEE_ID, " +
																	"  OFFICE_ID, " +
																	"  DESIGNATION_ID, " +
																	"  DATE_EFFECTIVE_FROM, " +
																	"  REMARKS " +
                                         ...
                                         if(rs.next())
                                         {
                                        	 xml=xml+"<addl>exist</addl>";
                                         }
                                         else
                                        	 xml=xml+"<addl>notexist</addl>";
                                      }
                                        else
                                        {
                                           System.out.println("2nd im here");
                                    ...
                                    //deputation checking
                                    xml="<response><command>loademp</command><flag>failure3</flag>";
                                }
        ...
        else if(strCommand.equalsIgnoreCase("Delete"))
        {
            ...
            try {
                ...
                //ps=con.prepareStatement("delete from HRM_EMP_RELIEVAL_DETAILS where OFFICE_ID=? and EMPLOYEE_ID=? and (PROCESS_FLOW_STATUS_ID='CR' or PROCESS_FLOW_STATUS_ID='MD') and RELIEVAL_SLNO=?");
                 ps=con.prepareStatement("update HRM_EMP_RELIEVAL_DETAILS set PROCESS_FLOW_STATUS_ID='DL',UPDATED_BY_USER_ID=?,UPDATED_DATE=?  where OFFICE_ID=? and EMPLOYEE_ID=?  and RELIEVAL_SLNO=?");
        ...
        else if(strCommand.equalsIgnoreCase("office"))
        {
            ...
            try {
                ...
                rs2=ps2.executeQuery();
                if(rs2.next()) 
                   xml=xml+"<flag>success</flag><oid>"+oid+"</oid><oname>"+rs2.getString("OFFICE_NAME")+"</oname>";
                 else
        ...
        else if(strCommand.equalsIgnoreCase("desig"))
        {
            ...
            try {
                int desigid=0;
                String designame="";
                try{desigid=Integer.parseInt(request.getParameter("desigid"));}catch(Exception e){}
                ps2=con.prepareStatement("select DESIGNATION from HRM_MST_DESIGNATIONS where DESIGNATION_ID=?" );
                ps2.setInt(1,desigid);
                rs2=ps2.executeQuery();
                if(rs2.next()) 
                   xml=xml+"<flag>success</flag><designame>"+rs2.getString("DESIGNATION")+"</designame>";
                 else
                   xml=xml+"<flag>failure</flag>";
                ps2.close();
                rs2.close();
        ...
        else if(strCommand.equalsIgnoreCase("dept"))
        {
            ...
            try {
                ...
                rs2=ps2.executeQuery();
                if(rs2.next()) 
                   xml=xml+"<flag>success</flag><dname>"+rs2.getString("OTHER_DEPT_NAME")+"</dname>";
                 else
                ...
                rs2=ps2.executeQuery();
                if(rs2.next()) 
                   xml=xml+"<oname>"+rs2.getString("OTHER_DEPT_OFFICE_NAME")+"</oname>";
                 else
        ...
        else if(strCommand.equalsIgnoreCase("loadReason"))
        {
            String CONTENT_TYPE = "text/xml; charset=windows-1252";
            response.setContentType(CONTENT_TYPE);
             try{txtRel_SLNO=Integer.parseInt(request.getParameter("txtRel_SLNO"));}catch(Exception e){}
             System.out.println("txt"+txtRel_SLNO);
            xml="<response><command>loadReason</command>";
            try
            {
            //ps=con.prepareStatement("select OFFICE_ID,EMPLOYEE_ID,RELIEVAL_SLNO,DATE_OF_RELIEVAL ,RELIEVAL_FN_AN, RELIEVAL_REASON_ID, REMARKS from HRM_EMP_RELIEVAL_DETAILS where OFFICE_ID=? and EMPLOYEE_ID=? and RELIEVAL_SLNO=?");
             ps=con.prepareStatement("select OFFICE_ID,EMPLOYEE_ID,RELIEVAL_SLNO,DATE_OF_RELIEVAL ,RELIEVAL_FN_AN, RELIEVAL_REASON_ID, REMARKS,PROCESS_FLOW_STATUS_ID from HRM_EMP_RELIEVAL_DETAILS where OFFICE_ID=? and EMPLOYEE_ID=? and RELIEVAL_SLNO=?");
            ...
            {
            //xml=xml+"<flag>success</flag>"+"<re_slno>"+rs.getInt("RELIEVAL_SLNO")+"</re_slno><dor>"+rs.getDate("DATE_OF_RELIEVAL")+"</dor><r_noon>"+rs.getString("RELIEVAL_FN_AN")+"</r_noon><r_rid>"+rs.getString("RELIEVAL_REASON_ID")+"</r_rid><remark>"+rs.getString("REMARKS")+"</remark>";
             xml=xml+"<flag>success</flag>"+"<re_slno>"+rs.getInt("RELIEVAL_SLNO")+"</re_slno><dor>"+rs.getDate("DATE_OF_RELIEVAL")+"</dor><r_noon>"+rs.getString("RELIEVAL_FN_AN")+"</r_noon><r_rid>"+rs.getString("RELIEVAL_REASON_ID")+"</r_rid><remark>"+rs.getString("REMARKS")+"</remark><pro_status>"+rs.getString("PROCESS_FLOW_STATUS_ID")+"</pro_status>";
            //  xml=xml+"<re_slno>"+rs.getInt("RELIEVAL_SLNO")+"</re_slno><dor>"+rs.getDate("DATE_OF_RELIEVAL")+"</dor><r_noon>"+rs.getString("RELIEVAL_FN_AN")+"</r_noon><r_rid>"+rs.getString("RELIEVAL_REASON_ID")+"</r_rid><remark>"+(rs.getString("REMARKS")==null?"null":rs.getString("REMARKS"))+"</remark>";
            ...
            rs.close();
                if((cmbReason).equalsIgnoreCase("PRO"))
                {
                ps=con.prepareStatement("select  NEW_DESIGNATION_ID, OFFICE_TO_POSTED_ID,REPOSTING_REQD, PROMOTION_PROCEED_DATE, PROMOTION_PROCEED_NO  from HRM_EMP_RELIEVAL_PRO where OFFICE_ID=? and EMPLOYEE_ID=? and  RELIEVAL_SLNO=?");
                ps.setInt(1,txtOffId);
                ps.setInt(2,eid);
                ps.setInt(3,txtRel_SLNO);
                rs=ps.executeQuery();
                    if(rs.next())
                    {
                    xml=xml+"<post_oid>"+rs.getInt("OFFICE_TO_POSTED_ID")+"</post_oid><des_id>"+rs.getInt("NEW_DESIGNATION_ID")+"</des_id><repost_req>"+rs.getString("REPOSTING_REQD")+"</repost_req><t_pr_date>"+rs.getDate("PROMOTION_PROCEED_DATE")+"</t_pr_date><t_pr_no>"+rs.getString("PROMOTION_PROCEED_NO")+"</t_pr_no>";
                    }
                    int ofid=0;
                    ofid=rs.getInt("OFFICE_TO_POSTED_ID");
                    ps2=con.prepareStatement("select OFFICE_NAME from COM_MST_OFFICES where OFFICE_ID=?" );
            ...
            {
                System.out.println("2nd im here");
                xml="<response><command>loadReason</command><flag>failure</flag>";
            }
         }
         catch(Exception e)
         {
        ...
        {   
             ...
             System.out.println("bbbb"+confirm+"aaaa");
                    ...
                    try 
                     {
                          ...
                          if(Proc_Status.equalsIgnoreCase("FR"))
                          {
                            ...
                            if(rs.next()) {
                              String rid=rs.getString("RELIEVAL_REASON_ID");
                              if(!(rid.equalsIgnoreCase("SUS")||rid.equalsIgnoreCase("VRS") || rid.equalsIgnoreCase("DIS") || rid.equalsIgnoreCase("SAN") || rid.equalsIgnoreCase("DTH") || rid.equalsIgnoreCase("RES")||rid.equalsIgnoreCase("UAL")) ) {
                                  String sql1="";
                                  if(rid.equalsIgnoreCase("TRN")) { 
                                      sql1="delete from HRM_EMP_RELIEVAL_TRN where OFFICE_ID=? and RELIEVAL_SLNO=?";
                                  }
                                  ...
                                  if(!(rid.equalsIgnoreCase("SUS") || rid.equalsIgnoreCase("VRS") || rid.equalsIgnoreCase("DIS")|| rid.equalsIgnoreCase("SAN") || rid.equalsIgnoreCase("DTH")|| rid.equalsIgnoreCase("ABR") || rid.equalsIgnoreCase("RES")|| rid.equalsIgnoreCase("MEV") || rid.equalsIgnoreCase("CMR")))
                                  {
                                  System.out.println("sql1:"+sql);
                                  ps=con.prepareStatement(sql1);
                                  ps.setInt(1,officeid);
                     ...
                     try 
                      {
                           ...
                           if(Proc_Status.equalsIgnoreCase("FR"))
                           {
                               ...
                               if((cmbReason.equalsIgnoreCase("VRS") || cmbReason.equalsIgnoreCase("DIS")|| cmbReason.equalsIgnoreCase("SAN")  || cmbReason.equalsIgnoreCase("DTH") ||cmbReason.equalsIgnoreCase("RES")||cmbReason.equalsIgnoreCase("MEV") || cmbReason.equalsIgnoreCase("CMR")))
                               {
                               ps=con.prepareStatement("update SEC_MST_USERS set LOGIN_ENABLED='0' where EMPLOYEE_ID=?  ");
                               ps.setInt(1,txtEmployeeid);
                               ps.executeUpdate();
