...
import java.util.*;
public class EduQual_Servlet extends HttpServlet 
{
        ...
        if(strCommand.equalsIgnoreCase("Delete"))
                {
                    ...
                    try
                    {
                        CallableStatement pstmt = connection.prepareCall("{call QUALDEL(?)}");
                ...
                else if(strCommand.equalsIgnoreCase("Update"))
                {
                    ...
                    try
                    {
                        CallableStatement pstmt = connection.prepareCall("{call QUALUPDATE(?,?)}");
                                            System.out.println(pstmt);
                                                pstmt.setInt(1, strQualId);
            ...
            else if(strCommand.equalsIgnoreCase("Add"))
                    {
                        ...
                        try
                        {
                          CallableStatement pstmt = connection.prepareCall("{call QUALID(?,?)}");
                                      System.out.println(pstmt);
