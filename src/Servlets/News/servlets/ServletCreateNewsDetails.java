...
public class ServletCreateNewsDetails extends HttpServlet {
...
System.out.println(">>>---servlet called");
            ...
            try
              ...
              //       ConnectionString = strdsn.trim() + "@" + strhostname.trim() + ":" + strportno.trim() + ":" +strsid.trim() ;
                    ...
                    String str_event_id="",str_event_desc="",str_event_venue="",str_event_date="",str_target_url="",trimed_url="";
                    int event_id=0;
            //String strSecondaryId[]=null;
                  try
                  {
                        str_event_id = request.getParameter("txtEventId1");
                        str_event_desc = request.getParameter("txtEventDesc");
                        //str_event_venue = request.getParameter("txtEventVenue");
                        str_event_date = request.getParameter("txtEventDate_h");
                        ...
                        System.out.println("values retrived sucessfully   :"+str_event_id+"  "+str_event_desc+"  "+str_event_date +"  "+str_target_url);
                  }
                  catch(Exception e)
                  {
                    e.printStackTrace();
                  ...
                  {
                      String sql1="";        
                      sql1="insert into com_mst_news (news_id,news_desc,news_date,target_url,news_status_id) values (?,?,(select sysdate from dual),?,'CD')";
                      //sql1="insert into com_mst_news(NEWS_ID,NEWS_DESC,NEWS_DATE,TARGET_URL,NEWS_STATUS_ID) VALUES (?,?,?,?,'CD')";
                     ...
                     System.out.println("query : " + sql1);
                      ...
                      ps1.setString(2,str_event_desc);
                      System.out.println("desc " + str_event_desc);
                      //ps1.setString(3,str_event_venue);
                  ...
                  */   
                   ...
                   if(str_target_url.startsWith("http://"))
                   {
                       ...
                       ps1.setString(3,trimed_url);
                   }
                   else {
                       ps1.setString(3,str_target_url);
                     ...
                     // ps1.close();
                      if(i>=1) {
                          ...
                          String msg="News has been created successfully. Event ID : "+event_id+"";
                                                        msg=msg+"<br><br>";
