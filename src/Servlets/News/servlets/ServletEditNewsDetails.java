...
public class ServletEditNewsDetails extends HttpServlet {
...
System.out.println("Servlet Edit News Called ");
              try
              {
            ...
            //String strSecondaryId[]=null;
                  ...
                  try
                  {
                     ...
                     // update COM_OFFICE_CONTROL set CONTROLLING_OFFICE_ID=?,DATE_EFFECTIVE_FROM=?,REMARKS=?,UPDATED_BY_USER_ID=?,UPDATED_DATE=? where Office_Id=?";  
                      sql1="update com_mst_news set NEWS_DESC=?,NEWS_DATE=(select sysdate from dual),TARGET_URL=?,NEWS_STATUS_ID='MD' where NEWS_ID=?";
                 ...
                 */    
                  ...
                  if(str_target_url.startsWith("http://"))
                  {
                     ...
                     //ps1.setString(2,str_target_url);
                      ...
                      ps1.setInt(3,event_id);
                     System.out.println("b4 execute");
                     int i=ps1.executeUpdate();            
                     // ps1.close();
                      if(i>=1) {
                          System.out.println("values inserted successfully"); 
                          String msg="News has been edited successfully.";
                                                        msg=msg+"<br><br>";
