...
public class ReqRegn_Servlet extends HttpServlet 
{
      ...
      else if(strCommand.equalsIgnoreCase("Load_Edit_verifyRegID"))
      {
         ...
         {      
           System.out.println("edit");
             ...
             "REGN_STATE_COVERAGE," +
             "to_char(REGN_VALID_UPTO,'DD/MM/YYYY') AS REGN_VALID_UPTO_VALUE,REGN_ALIAS_CODE,JURISDICTION from  " +
           ...
           if(rs.next())
           {
             ...
             xml=xml+"<CONTRACTOR_NAME>"+rs.getString("CONTRACTOR_NAME")+"</CONTRACTOR_NAME>";
               xml=xml+"<ADDRESS>"+((rs.getString("ADDRESS")==null)?"":rs.getString("ADDRESS"))+"</ADDRESS>";
               xml=xml+"<PHONE>"+((rs.getString("phone_no")==null)?"":rs.getString("phone_no"))+"</PHONE>";
               xml=xml+"<EMAIL>"+((rs.getString("EMAIL")==null)?"":rs.getString("EMAIL"))+"</EMAIL>";
               ...
               xml=xml+"<JURISDICTION>"+rs.getString("JURISDICTION")+"</JURISDICTION>";
             xml=xml+"</value>";
           }  
          else 
           {
