...
*/
	     ...
	     public class Ben_Collection_amount_new extends HttpServlet {
	     	private static final String CONTENT_TYPE = "text/html; charset=windows-1252";
	     	private static final long serialVersionUID = 1L;
	     	public Ben_Collection_amount_new() 
	         {
	             super();
	         }
	      ...
	      //          path = getServletContext().getRealPath("/WEB-INF/ReportSrc/Collection_amount_fas.jasper");
	                 path = getServletContext().getRealPath("/WEB-INF/ReportSrc/B11_FAS_Repoprt.jasper");
	             ...
	             else if (txtCB_Month == 12)
					{
	     			...
	     			parameters.put("month", txtCB_Month); 
	     			parameters.put("monthstr", monthstr); 
	     			parameters.put("year", txtCB_Year); 
	     			parameters.put("office_id", cmbAcc_UnitCode); 
	     			parameters.put("Demand_month", Demand_month);
	     			parameters.put("Demand_year", Demand_year);
