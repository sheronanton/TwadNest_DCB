...
public class OpeningBalanceReportnew extends HttpServlet 
{
			...
			throws ServletException, IOException 
	{
		...
		System.out.println(strCommand);
		 	if ("missing2".equalsIgnoreCase(flag)) 
				{  
		            ...
		            System.out.println("reportFileeeeeeeeeeeeeeeee"+reportFile);
		           ...
		           /* if (!reportFile.exists())
		            ...
		            try {
		                System.out.println("calling servlet...");
		                    ...
		                    reportFile1 =
		                    	reportFile1 = new File(getServletContext().getRealPath("/WEB-INF/ReportSrc/obmissing_sch_wise.jasper"));
		                ...
		                JasperReport jasperReport =
		                    (JasperReport)JRLoader.loadObject(reportFile1.getPath());
		               ...
		               // String rtype = "PDF"; // request.getParameter("cmbReportType");
		                ...
		                if (option.equalsIgnoreCase("3")) {
		                    ...
		                    response.setHeader("Content-Disposition",
		                                       "attachment;filename=\"Fund_Transfer_HO.html\"");
...
//							obj.getValue("COM_MST_OFFICES","OFFICE_NAME", "where OFFICE_ID=" + Office_id)
	...
	{
		System.out.println("excel stsrt now");
			try {
			response.setContentType("application/vnd.ms-excel");
	...
	{
		System.out.println("H stsrt now");
		try {    
