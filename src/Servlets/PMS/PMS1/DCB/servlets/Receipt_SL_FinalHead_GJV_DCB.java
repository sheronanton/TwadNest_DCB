...
public class Receipt_SL_FinalHead_GJV_DCB extends HttpServlet
{
...
{      
     ...
     try {
             ps=con.prepareStatement("select ACCOUNT_HEAD_CODE,ACCOUNT_HEAD_DESC,BALANCE_TYPE,SUB_LEDGER_TYPE_APPLICABLE,REMARKS,sl_mandatory from COM_MST_ACCOUNT_HEADS where USAGE_STATUS='Y' and ACCOUNT_HEAD_CODE=? and ACCOUNT_HEAD_CODE in" +
             		" ( 110101,110102,110103,110104,550401,550112,550520,550310,459031,550102,459037,100101 )");
