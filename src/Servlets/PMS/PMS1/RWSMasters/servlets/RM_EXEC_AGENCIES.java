...
public class RM_EXEC_AGENCIES extends HttpServlet
{
                      ...
                      HttpServletResponse response) throws ServletException, IOException 
    {
        ...
        { 
            ...
            System.out.println("sid" + svtid);
            svtname=request.getParameter("sname");
            System.out.println("sname" + svtname );
            String xml="<response>";
            String sql;
           /* sql="insert into RWS_MST_EXEC_AGENCIES values(?,?)";
            try
            {
            ...
            try 
            {
                cs=conn.prepareCall("{call RM_EXEC_AGENCIES(?,?,?,?)}") ; 
        ...
        {
                System.out.println("DUPLICATION first");
                svtid=request.getParameter("sid");
                String sql="";                
                String xml="<response>";
                sql="select EXEC_AGENCY_ID from RWS_MST_EXEC_AGENCIES where EXEC_AGENCY_ID=?";
        ...
        else if(action.equalsIgnoreCase("dup2"))
        {
                ...
                String sql="";                
                String xml="<response>";
                sql="select EXEC_AGENCY_NAME from RWS_MST_EXEC_AGENCIES where EXEC_AGENCY_NAME=?";
        ...
        else if(action.equalsIgnoreCase("deleting"))
        {
                ...
                String sql="";
                String xml="<response>";
                sql="delete from RWS_MST_EXEC_AGENCIES where EXEC_AGENCY_ID=?";
                try
                {
                    System.out.println(svtid);
                    ps=conn.prepareStatement(sql);
        ...
        else if(action.equalsIgnoreCase("updating"))
        {
                ...
                String sql="";
                String xml="<response>";
                /*sql="update RWS_MST_EXEC_AGENCIES set EXEC_AGENCY_NAME=? where EXEC_AGENCY_ID=?";
                try
                {
