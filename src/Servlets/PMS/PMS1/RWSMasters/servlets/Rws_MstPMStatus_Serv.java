...
public class Rws_MstPMStatus_Serv extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, 
        ...
        try {
            ...
            strname=request.getParameter("txtpmsttype");
            System.out.println("assign...."+strname);
            strcode=Integer.parseInt(request.getParameter("txtpmsttypeid"));
        ...
        if(strCommand.equalsIgnoreCase("Add")) {
            ...
            try
            {
             ...
             CallableStatement cs=con.prepareCall("{call RWS_MST_MSTPMSTATUS_GENID (?,?,?)}" );
            //cs.setInt(1,strcode);
            ...
            try {
                ps=con.prepareStatement("select * from RWS_MST_PUMPMAIN_STATUS where PUMPMAIN_STATUS_ID=?");
                ps.setInt(1,strcode);
                rs=ps.executeQuery();
                int i=0;
                while(rs.next()) {
            ...
            try {
                ps=con.prepareStatement("select * from RWS_MST_PUMPMAIN_STATUS where PUMPMAIN_STATUS=?");
            ...
            try {
                ps=con.prepareStatement("delete from RWS_MST_PUMPMAIN_STATUS where PUMPMAIN_STATUS_ID=?");
                ps.setInt(1,strcode);
                ps.executeUpdate();
            ...
            try {
                ...
                ps=con.prepareStatement("update RWS_MST_PUMPMAIN_STATUS set PUMPMAIN_STATUS=? where PUMPMAIN_STATUS_ID=?");
                ps.setString(1,strname);
                ps.setInt(2,strcode);
                ps.executeUpdate();
