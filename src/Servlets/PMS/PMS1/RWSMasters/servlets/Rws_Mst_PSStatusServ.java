...
public class Rws_Mst_PSStatusServ extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, 
        ...
        try {
            ...
            strname=request.getParameter("txtpsstype");
            System.out.println("assign...."+strname);
            strcode=Integer.parseInt(request.getParameter("txtpsstypeid"));
        ...
        if(strCommand.equalsIgnoreCase("Add")) {
            ...
            try
            {
             ...
             CallableStatement cs=con.prepareCall("{call RWS_MST_PSSTATUS_GENID (?,?,?)}" );
            //cs.setInt(1,strcode);
            ...
            try {
                ps=con.prepareStatement("select * from RWS_MST_PUMPSET_STATUS where PUMPSET_STATUS_ID=?");
                ps.setInt(1,strcode);
                rs=ps.executeQuery();
                int i=0;
                while(rs.next()) {
            ...
            try {
                ps=con.prepareStatement("select * from RWS_MST_PUMPSET_STATUS where PUMPSET_STATUS=?");
            ...
            try {
                ps=con.prepareStatement("delete from RWS_MST_PUMPSET_STATUS where PUMPSET_STATUS_ID=?");
                ps.setInt(1,strcode);
                ps.executeUpdate();
            ...
            try {
                ...
                ps=con.prepareStatement("update RWS_MST_PUMPSET_STATUS set PUMPSET_STATUS=? where PUMPSET_STATUS_ID=?");
                ps.setString(1,strname);
                ps.setInt(2,strcode);
                ps.executeUpdate();
