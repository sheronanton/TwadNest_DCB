...
public class Rws_Mst_PSTypeServ extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, 
        ...
        try {
            ...
            strname=request.getParameter("txtpstype");
            System.out.println("assign...."+strname);
            strcode=Integer.parseInt(request.getParameter("txtpstypeid"));
        ...
        if(strCommand.equalsIgnoreCase("Add")) {
            ...
            try
            {
             ...
             CallableStatement cs=con.prepareCall("{call RWS_MST_PSTYPE_GENID (?,?,?)}" );
            //cs.setInt(1,strcode);
            ...
            try {
                ps=con.prepareStatement("select * from RWS_MST_PUMPSET_TYPES where PUMPSET_TYPE_ID=?");
                ps.setInt(1,strcode);
                rs=ps.executeQuery();
                int i=0;
                while(rs.next()) {
            ...
            try {
                ps=con.prepareStatement("select * from RWS_MST_PUMPSET_TYPES where PUMPSET_TYPE=?");
            ...
            try {
                ps=con.prepareStatement("delete from RWS_MST_PUMPSET_TYPES where PUMPSET_TYPE_ID=?");
                ps.setInt(1,strcode);
                ps.executeUpdate();
            ...
            try {
                ...
                ps=con.prepareStatement("update RWS_MST_PUMPSET_TYPES set PUMPSET_TYPE=? where PUMPSET_TYPE_ID=?");
                ps.setString(1,strname);
                ps.setInt(2,strcode);
                ps.executeUpdate();
