...
public class Rws_Mst_SoilSubSTRataTypes_Serv extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, 
        ...
        try {
            ...
            strname=request.getParameter("txtSoilSubSTRataTypes");
            System.out.println("assign Name....::"+strname);
            strcode=Integer.parseInt(request.getParameter("txtSoilSubSTRataTypesid"));
        ...
        if(strCommand.equalsIgnoreCase("Add")) {
            ...
            try
            {
             ...
             CallableStatement cs=con.prepareCall("{call RES_MST_SOILLSUBSTRATA_GENID (?,?,?)}" );
            //cs.setInt(1,strcode);
          ...
          /*  try {
            ...
            try {
                ps=con.prepareStatement("select * from RWS_MST_SOILSUBSTRATA_TYPE where SOIL_SUBSTRATA_TYPE_ID=?");
                ps.setInt(1,strcode);
                rs=ps.executeQuery();
                int i=0;
                while(rs.next()) {
            ...
            try {
               System.out.println("novali name:::"+strname);
                ps=con.prepareStatement("select * from RWS_MST_SOILSUBSTRATA_TYPE where SOIL_SUBSTRATA_TYPE=?");
            ...
            try {
                ps=con.prepareStatement("delete from RWS_MST_SOILSUBSTRATA_TYPE where SOIL_SUBSTRATA_TYPE_ID=?");
                ps.setInt(1,strcode);
                ps.executeUpdate();
            ...
            try {
                ...
                ps=con.prepareStatement("update RWS_MST_SOILSUBSTRATA_TYPE set SOIL_SUBSTRATA_TYPE=? where SOIL_SUBSTRATA_TYPE_ID=?");
                ps.setString(1,strname);
                ps.setInt(2,strcode);
                ps.executeUpdate();
                xml=xml+"<flag>success</flag>";
