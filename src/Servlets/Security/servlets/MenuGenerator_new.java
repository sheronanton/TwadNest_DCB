...
public class MenuGenerator_new extends HttpServlet
{
  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
     ...
     // int hisRoleId=0;
      ...
      try
      {
        ...
        System.out.println("checking  Role Is............................:"+hisRoleId);
            ...
            catch(Exception e)
            {
              ...
              return;
               ...
               try
               {
                   ...
                   //String AssignedSubSystems="select distinct(order_seq_no),(Sub_System_Id) from SEC_MST_ROLE_MENUS where Role_Id in ("+hisRoleId+") and Major_System_Id=? and Minor_System_Id=? order by order_seq_no";
                    String AssignedSubSystems="select order_seq_no,(sub_system_id) from " + 
                                                " (" + 
                                                " select distinct(Sub_System_Id) from SEC_MST_ROLE_MENUS" + 
                                                " where Role_Id in ("+hisRoleId+") and Major_System_Id=?" + 
                                                " and Minor_System_Id=? " + 
                                                " )a" + 
                                                " inner join " + 
                                                " (" + 
                                                " select order_seq_no,sub_system_id as subsysid from sec_mst_subsystems " + 
                                                " where  Major_System_Id=?" + 
                                                " and Minor_System_Id=?" + 
                                                " )b" + 
                                                " on a.sub_system_id=b.subsysid" + 
                  ...
                  // System.out.println("Sub"+SubSystemID);
                   ps.setString(3,MajorSystemID);
                   // System.out.println("Major"+MajorSystemID);
                   ps.setString(4,SubSystemID);
